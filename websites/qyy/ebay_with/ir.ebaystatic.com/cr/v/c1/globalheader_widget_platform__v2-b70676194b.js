/* Global Gadget Platform V2 - GlobalHeaderFrontEnd$41.0.0 */ ! function(e, n) {
    ...
    function e() {
        ...
        (t = (t = o && o.load) && /Apple/.test(window.navigator.vendor) ? !((n = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent)) && parseInt(n[1], 10) < 603) : t) ? (o.load("1em Market Sans"), o.load("bold 1em Market Sans"), o.ready.then(i)) : (e = r, n = function() {
            var e = new FontFaceObserver("Market Sans"),
                n = new FontFaceObserver("Market Sans", {
                    weight: "bold"
                });
    ...
    function t(e, n) {
        ...
        for (var t = Object(e), i = 1; i < arguments.length; i++) {
            var o = arguments[i];
            if (null != o)
                for (var r = Object.keys(Object(o)), a = 0, d = r.length; a < d; a++) {
                    var s = r[a],
    ...
    o = document.fonts, n = "font-marketsans", r = "https://ir.ebaystatic.com/cr/v/c1/vendor/fontfaceobserver.js", "fontDisplay" in document.documentElement.style || localStorage && localStorage.getItem("ebay-font") === n || window.addEventListener("load", function() {
    ...
    function v(e, n, t, i) {
        var o = 3 < arguments.length && void 0 !== i ? i : "warn",
            r = void 0,
            a = m(e, n = p(n)),
            i = f(a),
            e = f(t);
        return "undefined" === e ? (t = "", e = "string") : "object" === e && function(e) {
            ...
            __isEmpty: !0
        }), "undefined" !== i ? i !== e && (r = l.TYPE_MISMATCH, a = t) : (r = l.DATA_MISSING, a = t), u && o && r && (r = r, n = n, t = t, u[o = o] && u[o]("event: %s, path: %s, default: %s", r, n, t)), a
    }
    var g = {
        has: function(e, n) {
    ...
    if ("undefined" != typeof Element)
        for (var h = ["matches", "matchesSelector", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"], w = 0; w < h.length; w++) {
            var y = h[w];
        ...
        k = {
            initAndRenderWidgets: function(o) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    a = void 0 === e ? "" : e;
                new T(t, n, function() {
                    var e = document.getElementById(j) || I(),
                    ...
                    var t = e.querySelectorAll("script"),
                        ...
                        e = "";
                    a && (e = (t = "null" === (t = r ? decodeURI(a) : a) ? "" : t).slice(t.indexOf(">") + 1, t.lastIndexOf("<")).trim()),
                        function(e) {
                            var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : document,
                                e = n.createTextNode(e),
    ...
    var _ = g.need,
        O = k.initAndRenderWidgets,
        D = k.initAndRenderOnDemandWidgets,
        b = function(e) {
            var n = e.renderedComponents,
                t = e.html,
                i = e.content,
                o = e.js,
                r = e.css,
        ...
        k = function(e) {
            ...
            n && (document.dispatchEvent(new CustomEvent(n, {
                detail: _(e, "content.response.modules", {})
    ...
    var R = (s(M, [{
        ...
        x = g.has,
        N = g.get,
        F = "X_EBAY_C_CORRELATION_SESSION",
        G = "raptor.require",
        z = "trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo",
        W = {
            readRaptorContext: function() {
                if (x(window, G)) return N(window, G, function() {})("ebay.context.Context")
            },
            ...
            if (n.route && (r.hasFullXhrUrl = !0), "HttpClient" in window) return new window.HttpClient(e, i, t, o, r, window).handlers({
                ...
                onerror: function(e) {
                    return function(e) {
                        ...
                        var t = new CustomEvent("gadget-request-error", {
                            detail: {
                                err: e,
                                parameters: n
                            }
