! function() {
    ...
    var H = (S.prototype.createIframe = function(e, t, n, i) {
        ...
        return "#gum-debug-mode" === window.location.hash ? l += "?debug=1&topUrl=" + s : l += "?topUrl=" + s, c && (l += "&origin=" + c), n && (E(n) ? (void 0 !== n.gdprApplies && (l += "&gdpr=" + (n.gdprApplies ? 1 : 0)), void 0 !== n.consentData && (l += "&gdpr_consent=" + n.consentData)) : F(n) && void 0 !== n.uspString && (l += "&us_privacy=" + n.uspString)), l += "#" + JSON.stringify(u), o.src = l, o.id = this.gumSyncFrameId, o.width = "0", o.height = "0", o.frameBorder = "0", o.setAttribute("style", "border-width:0px; margin:0px; display:none"), o.title = "Criteo GUM iframe", N.removeLater(i, o), o
    ...
    var Y = (I.prototype.trySetPageId = function(e, t) {
    ...
    var A = /^#(enable|disable)-criteo-tag-debug-mode(=(\d+))?$/;

    function Q(e, t, n, i, o) {
        if (function() {
                if (!document || !window.location.hash) return;
                var e = A.exec(window.location.hash);
    ...
    var R, X = (Z.prototype.isChrome = function() {
    ...
    }, Z.CRITEO_NET_TOKEN = "", Z.CRITEO_COM_TOKEN = "", Z.ATTRIBUTION_TRIGGER_URL_PREFIX = "https://measurement-api.criteo.com/conversiontracking", Z);
    ...
    if (!window.criteo_q || window.criteo_q instanceof Array) {
        ...
        window.criteo_q = function() {
            ...
            function _(e, t, n) {
                ...
                n.hasOwnProperty("type") && (i = n.type, delete n.type), O(n.account, t.disingScheduled), "sequential" === i && (n.dc = !0)
            }
            ...
            function A(e, t) {
                return !e.domReady && t.requiresDOM && "no" !== t.requiresDOM ? "blocking" === t.requiresDOM ? -1 : 0 : (delete t.requiresDOM, t.event ? (t.account && O(t.account, e.accounts), t.event = t.event.toLowerCase(), null) : (V(t), 1))
            }
                ...
                if (r.onFlush instanceof Function && (r.onFlush(), D.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")), 0 !== n.actions.length) {
                    ...
                    if (!a.manualDising && (!s || a.partialDis)) {
                        for (var g = [], v = 0, y = n.accounts; v < y.length; v++) {
                            var w = y[v];
                            x(n.disingScheduled, w) || g.push(w)
                        }
                        0 < g.length && function(e, t, n) {
                            var i = A(t, n);
                            null !== i || (_(e, t, n), t.actions.push(V(n)))
                        }(o, n, {
                            event: "callDising",
                            account: g
                        })
                    ...
                    var C = !1,
                        k = function(e, t, n, i, o) {
                            ...
                            null !== o.account && a.push("a=" + R(i, o.account, []));
                            "js" !== o.responseType && a.push("rt=" + R(i, o.responseType, []));
                            if (o.handlerParams) {
                                var s = decodeURIComponent(R(i, o.handlerParams, []));
                                s && a.push(s)
                            }
                            t.tryAppendUatParameter(a);
                            for (var c = 0; c < r.length; ++c) {
                                var u = r[c];
                                u.account && W(null === o.account ? void 0 : o.account, null === u.account ? void 0 : u.account) && delete u.account, a.push("p" + c + "=" + R(i, u, []))
                            }
                            n.fillQueryStringParams(a), null !== o.partnerPayload && a.push("pp=" + R(i, o.partnerPayload, []));
                    ...
                    var b = function() {
                        if (!C) {
                            ...
                            "function" == typeof r.onUrlGenerated ? r.onUrlGenerated(t.url) : "beacon" === o.requestType && navigator.sendBeacon ? navigator.sendBeacon(t.url) : I(n, a, r, t), D.info("DIS call triggered", t.url, k), n.eventSent = !0, T.registerTrigger(e), a.disOnce || (n.disingScheduled = [])
                        }
                    };
                    S(function(e) {
                        e && k.push.apply(k, function(e) {
                            var t = [];
                            return E(e) ? (void 0 !== e.gdprApplies && t.push("gra=" + (e.gdprApplies ? 1 : 0)), void 0 !== e.consentData && t.push("grs=" + e.consentData), void 0 !== e.version && t.push("grv=" + e.version)) : F(e) && (void 0 !== e.uspString && t.push("cs=" + e.uspString), void 0 !== e.version && t.push("cv=" + e.version)), t
                ...
                if (t instanceof Function) a = R(e, t(), n);
                    ...
                    for (var l in t)
                        if (t.hasOwnProperty(l)) {
                            var d = n.concat([l]);
                            u.push((i = e, o = l, void 0, r = d.join("."), (i.properties[r] ? i.properties[r] : o) + "=" + R(e, t[l], d)))
                        }
                    a += u.join("&")
            ...
            return P.catchAndStoreException(function() {
                return w.checkAcid(), w.checkClientSideIdentityStatus(), w.setCop(window),
                    function(e, t, n, i, o, r, a, s) {
                        ...
                        y.hooks.onInitialized instanceof Function ? (v.app.bodyReady = y.hooks.onInitialized(), D.warn("onInitialized hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")) : v.app.bodyReady = !0, S(function(e) {
        ...
        }(), $.adBlockDetector, window.criteo_q.adBlockDetector = $.adBlockDetector, (R = window.criteo_q).push.apply(R, $)
    }
}();