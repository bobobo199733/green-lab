    ...
    if ("undefined" !== typeof g) {
        ...
        a = {
            ...
            deleteSsrCookie: function() {
                ...
                if (!a) return !0;
                a.match(/http(s|):\/\/[^/$#?]+.rakuten.co.jp\//) ? (u = !0, document.cookie = "ss_r=;domain=.rakuten.co.jp;path=/;expires=Thu, 01 Jan 1970 00:00:00 GMT") : c.rslog.warn("do not delete cookie:domain is not same")
            },
        ...
        j.sendSubmitLog = function(b, f, d) {
            ...
            try {
                if (!b(f, d)) return c.rslog.error("fail setParamFunc"), !0;
