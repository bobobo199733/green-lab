...
function AppMeasurement_Module_ActivityMap(e) {
  ...
  function n() {
    if (o.scrollReachSelector) {
      var t = e.d.querySelector && e.d.querySelector(o.scrollReachSelector);
      t
        ? ((f = t.scrollTop || 0),
  ...
  function i(t, n, r, i, a) {
    var c, l;
    if (
      (((t.dataset && (l = t.dataset[n])) ||
        (t.getAttribute &&
          ((l = t.getAttribute("data-" + r)) || (l = t.getAttribute(r))))) &&
        (c = l),
      ...
      if (
        ...
        for (l = !1; n < t.length && o && ((r = t.charAt(n)), l || r !== o); )
          "\\" === r ? (l = !0) : ((varValue += r), (l = !1)), n++;
      }
      (o = varValue) && (e.w[i] = o);
    }
    return c || (a && e.w[i]);
  ...
  function a(e, t, n) {
    var i;
    return (i = o[t](e, n)) && r(l(i), o[t + "Exclusions"]);
  }
  function c(e, t, n) {
    var r;
    if (
  ...
  (o._g = function () {
    ...
    (o.link = function (e, t) {
      var n;
      if (t) n = r(l(t), o.linkExclusions);
      else if (
        (n = e) &&
        !(n = i(e, "sObjectId", "s-object-id", "s_objectID", 1))
      ) {
        var a, s;
        (s = r(l(e.innerText || e.textContent), o.linkExclusions)) ||
          (c(e, (a = []), (n = { a: void 0, t: void 0, s: void 0 })),
          (s = r(l(a.join("")))) ||
            (s = r(l(n.a ? n.a : n.t ? n.t : n.s ? n.s : void 0))) ||
            !(a = (a = e.tagName) && a.toUpperCase ? a.toUpperCase() : "") ||
            ("INPUT" == a || ("SUBMIT" == a && e.value)
              ? (s = r(l(e.value)))
              : "IMAGE" == a && e.src && (s = r(l(e.src))))),
          (n = s);
      }
      return n;
    }),
    (o.region = function (e) {
      for (var t, n = o.regionIDAttribute || "id"; e && (e = e.parentNode); ) {
