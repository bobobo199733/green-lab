...
(window._satellite = window._satellite || {}),
  (window._satellite.container = {
    buildInfo: {
      minified: !0,
      buildDate: "2022-10-05T14:39:50Z",
      turbineBuildDate: "2022-09-28T18:15:16Z",
      turbineVersion: "27.4.0",
    },
    environment: {
      id: "EN3ca599b396364deba81a6e8f25970c1a",
      stage: "production",
    },
    dataElements: {
      "Visitor - Industry": {
          ...
          source: function () {
            for (
              var e = document.getElementsByTagName("a"),
                t = [],
                a = (
                  window.pageData && pageData.page && pageData.page.productName
        ...
        settings: {
          source: function () {
            ...
            return (
              window.eventData &&
              eventData.page &&
              eventData.page.productAppVersion
                ? e.push(eventData.page.productAppVersion)
                : window.pageData &&
                  pageData.page &&
                  pageData.page.productAppVersion
                ? e.push(pageData.page.productAppVersion)
                : e.push("none"),
              window.eventData &&
              eventData.page &&
              eventData.page.recommenderVersion
                ? e.push(eventData.page.recommenderVersion)
                : window.pageData &&
                  pageData.page &&
                  pageData.page.recommenderVersion
      ...
      "Event - Survey Score": {
        modulePath: "core/src/lib/dataElements/javascriptVariable.js",
        settings: { path: "eventData.survey.score" },
      },
      "Event - Rows Exported": {
        defaultValue: "",
        storageDuration: "pageview",
      ...
      "Event - Survey Comment": {
        modulePath: "core/src/lib/dataElements/javascriptVariable.js",
        settings: { path: "eventData.survey.comment" },
      },
      ...
      "Event - Survey Meta Data": {
        ...
        settings: {
          source: function () {
            for (
              var e = ["type", "targeting", "question"], t = [], a = 0;
              a < e.length;
              a++
            ) {
              var n = e[a];
              eventData && eventData.survey && eventData.survey[n]
                ? t.push(eventData.survey[n])
                : t.push("none");
            }
            return t.join("^");
          },
      ...
      "Page - Business Unit": {
        ...
        settings: {
          source: function () {
            return (
              window.pageData && pageData.page && pageData.page.businessUnit
      ...
      "Event - NPS Score": {
        modulePath: "core/src/lib/dataElements/javascriptVariable.js",
        settings: { path: "eventData.nps.score" },
      },
      "Visitor - Account ID": {
        defaultValue: "",
        storageDuration: "pageview",
      ...
      "Event - NPS Comment": {
        modulePath: "core/src/lib/dataElements/javascriptVariable.js",
        settings: { path: "eventData.nps.comment" },
      },
      "Visitor - User ID": {
        defaultValue: "",
        storageDuration: "pageview",
    ...
    extensions: {
      "adobe-analytics": {
        ...
        hostedLibFilesBaseUrl:
          "https://assets.adobedtm.com/extensions/EP171e731c9ba34f1c950c36d26e3efd61/",
        settings: {
          ...
          customSetup: {
            source: function (e) {
                ...
                return function (n) {
                  ...
                  if (r)
                    do {
                      if (
                        r.getAttribute &&
                        ((regionId = r.getAttribute(t)), regionId)
                      )
                        return regionId.toLowerCase();
                      if (a && ("A" == r.tagName || "BUTTON" == r.tagName))
                        break;
                    } while (r && (r = r.parentNode));
                  var i = e.call(this, n);
                  return i && -1 !== i.indexOf("@")
                    ? (window.pageDataTracker &&
                        (i = pageDataTracker.md5(i).substring(0, 16)),
                      "DTM filtered (@):" + i)
                    : i;
                };
              }
              if (((window.s = e), !window.pageDataTracker)) return !1;
              pageDataTracker.mapAdobeVars(e),
                ...
                (e.ActivityMap.region = t(
                  e.ActivityMap.region,
                  "data-aa-region",
                  !1
                )),
                (e.ActivityMap.link = t(
                  e.ActivityMap.link,
                  "data-aa-name",
                  !0
                )),
                (e.usePlugins = !0),
                e.prop68 && "md" == e.prop68 && (e.trackOffline = !0),
                (e.cookieDomainPeriods = "2");
              for (
                var a = ["com", "edu", "gov", "ac", "org", "net", "co", "go"],
                  n = 0;
                n < a.length;
                n++
              )
                if (document.location.hostname.indexOf("." + a[n] + ".") > 0) {
                  e.cookieDomainPeriods = "3";
                  break;
                }
              (e.linkInternalFilters =
                (e.linkInternalFilters ? e.linkInternalFilters + "," : "") +
                  ...
                  if (
                    ...
                    try {
                      if (window.ddqueue && window.ddqueue.length > 0) {
                        var t = JSON.parse(window.ddqueue.shift());
                        (window.eventData = t.eventData),
                          (window.pageData = t.pageData);
                      }
                    } catch (e) {}
                    if (
                      ((pageData.page.lastTrackedPage =
                        pageData.page.analyticsPagename),
                      "object" != typeof window.eventData ||
                        ("newPage" != window.eventData.eventName &&
                          "searchResultsUpdated" !=
                            window.eventData.eventName) ||
                        (e.clearVars(),
                        (e.pageLoaded = !1),
                    ...
                    (e.eVar21 = _satellite.getVar("Promo - Clicked ID")),
                      e.eVar21 &&
                        ...
                        window.clickedPromoId &&
                          (window.clickedPromoId = void 0)),
                      e.getCustomReportSuites(),
                      ...
                      (e.prop32 = document.location.protocol.replace(
                        /\:/g,
                        ""
                      )),
                    ...
                    var r,
                      i = Visitor.getInstance(
                        "4D6368F454EC41940A4C98A6@AdobeOrg"
                      );
                    if (
                      ((e.eVar50 = i.getMarketingCloudVisitorID()), e.prop12)
                    ) {
                      var s = 0;
                      e.eVar33 &&
                        ...
                        (s = 1),
                        i.setCustomerIDs({
                          userid: { id: e.prop12, authState: s },
                        });
                    }
                    if (
                      (window.pageData &&
                        ...
                        (e.account = e.account.replace(/\-(prod)/gi, "-dev")),
                      e.campaign &&
                        e.prop2 &&
                      ...
                      if (
                        ((e.prop19 = e.getPreviousValue(e.pageName, "c19", "")),
                        e.prop19)
                      ) {
                      ...
                      var d = _satellite.getVar("Visitor - User ID"),
                        p = new Date();
                      if (d) {
                        d = d.toLowerCase();
                        var g = new Date(p.getFullYear(), 0, 1),
                          f = d + p.getFullYear() + p.getMonth();
                        (f = pageDataTracker.md5(f).substring(0, 20)),
                          (e.events = e.apl(e.events, "event203:" + f, ",", 2));
                        var m = d + p.getFullYear() + p.getMonth();
                        (m = e.productPrefix(m)),
                          (m = pageDataTracker.md5(m).substring(0, 20)),
                          (e.events = e.apl(e.events, "event320:" + m, ",", 2));
                        var v =
                          d +
                          p.getFullYear() +
                          Math.ceil(
                            ((p.getTime() - g.getTime()) / 864e5 +
                              g.getDay() +
                              1) /
                              7
                          );
                        (v = e.productPrefix(v)),
                          (v = pageDataTracker.md5(v).substring(0, 20)),
                          (e.events = e.apl(e.events, "event321:" + v, ",", 2));
                      }
                      ...
                      if (
                        (h &&
                          ...
                          (h += p.getFullYear()),
                          (h += p.getMonth()),
                          (h = pageDataTracker.md5(h).substring(0, 20)),
                          (e.events = e.apl(
                            e.events,
                            "event205:" + h,
                            ",",
                        ...
                        e.eVar72 &&
                          (e.events = e.apl(e.events, "event9", ",", 2)),
                        window.pageData &&
                          pageData.visitor &&
                        ...
                        var b = _satellite.getVar("Search - Results per Page");
                        e.getValOnce(
                          ...
                          b &&
                          (e.events = e.apl(e.events, "event13=" + b, ",", 2));
                      }
                      e.eVar117 &&
                      ...
                      var k = e.getValOnce("1", "e41", 0);
                      e.clickPast(k, "event41", "event42"),
                        e.events.indexOf("event41") > -1 &&
                          y &&
                          e.c_w("v31", y),
                        e.list3 &&
                          (e.events = e.apl(e.events, "event21", ",", 2));
                      var y = _satellite.getVar("Page - Load Timestamp"),
                        D = e.getPreviousValue(y, "v68", "") || y,
                        C = e.c_r("v31") || y;
                      if (y)
                        try {
                          var w = new Date(parseInt(y)),
                            T = w.getTime(),
                            S = this.isDST(w);
                          (e.eVar113 = (
                            Math.floor((T / 1e3 - 18e3 + 3600 * S) % 86400) + 1
                          ).toString()),
                            (e.linkTrackVars = e.apl(
                              e.linkTrackVars,
                              "eVar113",
                          ...
                          _satellite.notify(
                            "Error setting s.eVar113: " + e.message
                          );
                        }
                      if (y && D)
                        try {
                          var V = new Date(parseInt(y)),
                            P = new Date(parseInt(D)),
                            _ = new Date(parseInt(C)),
                            E = V.getTime() - P.getTime();
                          E > 0 && (e.eVar68 = "+" + (E / 1e3).toFixed(0)),
                            (e.currentVisitTime = (
                              (V.getTime() - _.getTime()) /
                              1e3
                            ).toFixed(0));
                      ...
                      if (
                        (e.eVar43 &&
                          (e.events = e.apl(e.events, "event26", ",", 2)),
                        e.eVar44 &&
                          (e.events = e.apl(e.events, "event17", ",", 2)),
                        ...
                        I &&
                          ((e.events = e.apl(e.events, I, ",", 2)),
                          "scView" == I &&
                            (e.events = e.apl(e.events, "scOpen", ",", 2)));
                      }
                      e.list2 &&
                        (e.events = e.apl(e.events, "event178", ",", 2));
                      try {
                        var A = sessionStorage.getItem("aamm");
                        A &&
                          (pageDataTracker.addMessage("b" + A),
                          sessionStorage.removeItem("aamm"));
                        var O = "_pageDataTracker_tpcf",
                          j = sessionStorage.getItem(O);
                        j &&
                          (pageDataTracker.addMessage(
                            "true" == j ? "3p1" : "3p0"
                          ),
                        ...
                        var L = pageDataTracker.getPerformance();
                        L.du &&
                          ((e.eVar114 = L.du),
                          (e.linkTrackVars = e.apl(
                            e.linkTrackVars,
                      ...
                      for (
                        ...
                        var F = e.Util.getQueryParam(x[R]) || "";
                        F && (N = !0), (M += F + "|");
                      }
                      if (
                        (N && (e.eVar125 = M),
                        ...
                        window.pageData && pageData.page)
                      )
                        for (var U = 0; U < 5; U++) {
                          var B = 2 * U + 306,
                            H = pageData.page["customPerformance" + (U + 1)];
                          isFinite(parseFloat(H)) &&
                            ((e.events = e.apl(
                              e.events,
                              "event" + B + "=" + parseFloat(H),
                              ",",
                              2
                            )),
                            (e.events = e.apl(
                    ...
                    if (
                      ...
                      if (
                        ...
                        var W = _satellite.getVar("Visitor - App Session ID"),
                          Y = pageDataTracker
                            .md5((W || "none") + r.id)
                            .substring(0, 20);
                        (e.events = e.apl(e.events, "event201:" + Y, ",", 2)),
                          r.type &&
                          ...
                          r.format &&
                            (null !== r.format.match(/\-X?HTML/gi)
                              ? ((I = ""),
                                (I =
                                  null !==
                                    r.format.match(/scope\-abstract/gi) ||
                    ...
                    e.products &&
                      ...
                      e.eVar15 &&
                        e.getValOnce(
                          _satellite.getVar("Search - Criteria"),
                          "e78",
                          0
                        ) &&
                    ...
                    var X = _satellite.getVar("Form - Step + Name");
                    if (
                      (X && "login:start" === X
                        ? ((e.linkTrackVars = e.apl(
                            e.linkTrackVars,
                        ...
                        ? ((I = ""),
                          (I =
                            X.indexOf("complete") > -1
                              ? "event" +
                                (X.indexOf("register") > -1 ||
                                X.indexOf("registration") > -1
                                  ? "2"
                                  : "47")
                              : "event" +
                                (X.indexOf("register") > -1 ||
                      ...
                      document.location.href.length > 255
                      ...
                      e.campaign && -1 !== e.campaign.indexOf("raven")
                        ...
                        : document.referrer &&
                          document.referrer.length > 255 &&
                          !e.referrer
                        ? (e.referrer = document.referrer.substring(0, 255))
                        : document.referrer ||
                          (e.referrer = e.Util.getQueryParam("aaref")),
                      e.prop8 &&
                        ((e.linkTrackVars = e.apl(
                          e.linkTrackVars,
                          "prop8",
                      ...
                      e.eVar103 &&
                        (e.eVar110 = e.eVar110 ? e.eVar110 : "D=c19"),
                      !e.isTracked("eVar103") &&
                        window.eventData &&
                      ...
                      e.events &&
                        e.events.split(",").indexOf("event2") > -1 &&
                    ...
                    var G = (d = _satellite.getVar("Visitor - User ID")).match(
                      /^ae:([0-9]+)$/i
                    );
                    G &&
                      G.length > 1 &&
                      ...
                      (e.prop38 = _satellite.getVar("Maturity Level")),
                      (e.linkTrackVars = e.apl(
                        e.linkTrackVars,
                        "prop38",
                        ",",
                      ...
                      (e.prop39 = _satellite.getVar("Source")),
                      (e.linkTrackVars = e.apl(
                        e.linkTrackVars,
                        "prop39",
                        ",",
                      ...
                      (e.abort = _satellite.getVar("s_blacklist"));
                  }
                }),
                (e.doPlugins = window.s_doPlugins),
                e.registerPreTrackCallback(function (e) {
              ...
              try {
                e.loadModule("Media"),
                  (e.Media.autoTrack = !1),
                  (e.Media.trackWhilePlaying = !1),
                  (e.Media.playerName = "elsevier video player"),
                  (e.Media.segmentByMilestones = !0),
                  (e.Media.trackMilestones = "50"),
                  (e.Media.trackUsingContextData = !0),
                  (e.Media.contextDataMapping = {
                  ...
                  (e.Media.trackVars = "prop17,eVar52,eVar1,eVar2,eVar3"),
                  (e.Media.trackEvents = "event66");
              } catch (e) {}
              if (
                ((e.isTracked = function (t) {
                  return -1 !== e.split(e.linkTrackVars, ",").indexOf(t);
                }),
                (e.productPrefix = function (e) {
                  if (
                    window.pageData &&
                    pageData.page &&
                    pageData.page.productName
                ...
                (e.trackEventsList = function (e, t) {
                  try {
                    for (
                      var a = e.events ? e.events.split(",") : [],
                        n = e.linkTrackEvents
                          ? e.linkTrackEvents.split(",")
                          : [],
                        r = [],
                        i = 0;
                      i < a.length;
                    ...
                    (e[t] = ""),
                      _satellite.notify("s.trackEventsList: " + a.message);
                  }
                }),
                (e.isDST = function (t) {
                  var a = !1;
                  try {
                    var n,
                      r,
                      i = e._tpDST[t.getFullYear()].split(/,/);
                    (n = new Date(i[0] + "/" + t.getFullYear())),
                      (r = new Date(i[1] + "/" + t.getFullYear())),
                      (n = new Date(n.getTime() + 42e4)),
                      (r = new Date(r.getTime() + 36e4)),
                      (a = t > n && t < r);
                  } catch (e) {
                    (a = !1),
                      _satellite.notify(
                        "s.isDST: Error checking for DST:" + e.message
                      );
                  }
                  return a;
                }),
                (e.getUrlWithHashbang = function () {
                  var e =
                  ...
                  try {
                    ...
                    for (
                      ...
                      for (
                        t.index === _regex.lastIndex && _regex.lastIndex++,
                          groupIndex = 0;
                        groupIndex < t.length;
                        groupIndex++
                      )
                        0 === groupIndex && (e = t[groupIndex].toString());
                  } catch (e) {
                    _satellite.notify("s.getUrlWithHashbang: " + e.message);
                  }
                  return e;
                }),
                (e.extractHostname = function (e) {
                  return (
                ...
                (e.extractRootDomain = function (t) {
                  var a = e.extractHostname(t),
                    n = a.split("."),
                    r = n.length;
                  return (
                    r > 2 &&
                ...
                (e.getCustomReportSuites = function () {
                  if ("jb" == e.prop2) {
                    var t = "dev",
                      a = "";
                    if (window.pageData && pageData.page) {
                      var n =
                          pageData.page.server || document.location.hostname,
                        r = e.Util.getQueryParam("code");
                      (t =
                        null ===
                        document.location.hostname.match(/\-(qa|test|stag)/g)
                          ? "prod"
                          : "dev"),
                        (a =
                          "cell" == n || "www.cell.com" == n || "cell-site" == r
                            ? "cell"
                            : "www.thelancet.com" == n || "lancet-site" == r
                            ? "the lancet"
                            : "other journal branded sites");
                    }
                    return (
                      (e.channel = a),
                      "elsevier-ha-" + t + ",elsevier-global-" + t
                    );
                  }
                  if (
                    window.pageData &&
                    pageData.page &&
                    pageData.page.secondaryProductName
                  ) {
                    var i = [
                        "sd",
                        "md",
                      ...
                      o =
                        ((t = "dev"),
                        pageData.page.secondaryProductName.toLowerCase());
                    if (
                      ...
                      return (
                        (e.eVar107 = o), e.account + ",elsevier-" + o + "-" + t
                      );
                    for (var c = 0; c < s.length; c++)
                      if (o == s[c][0].toLowerCase())
                        return (
                          (e.eVar107 = s[c][1]),
                          e.account + ",elsevier-" + s[c][1] + "-" + t
                        );
                    return (e.eVar107 = o), e.account;
                  }
                  return e.account;
                }),
                (e.removeFromList = function (e, t, a, n) {
                  (t = t || ","), (n = n || ",");
                  for (
                    var r = e.split(t), i = a.split(n), s = [], o = 0;
                    o < i.length;
                    o++
                  ) {
                ...
                (e.getKPIName = function () {
                  for (
                    var t = {
                      ...
                      n = e.prop2 && t[e.prop2] ? t[e.prop2] : t.default,
                      r = 0;
                    r < n.length;
                    r++
                  ) {
                    var i = n[r],
                      s = new RegExp("event" + i + "(,|$)", "g");
                    if (a[i] && e.events.match(s)) return a[i];
                  }
                  return "";
                }),
                (e.apl = new Function(
                ...
                function r(e) {
                  ...
                  return (
                    ...
                    (t = s.indexOf(" " + e + "=")),
                    (a =
                      (t = (s = t < 0 ? r.c_rr("s_sess") : s).indexOf(
                        " " + e + "="
                      )) < 0
                        ? t
                        : s.indexOf("|", t)),
                ...
                (e.c_rr = e.c_r),
                  (e.__ccucr = !0),
                  (e.c_rspers = i),
                  (e.c_r = e.cookieRead = r);
              }
              if (!e.__ccucw) {
                function s(e, t, a) {
                  var n = _satellite.getVar("Consent Adobe");
                  if (n && !1 === n.aa) return !1;
                  var r,
                    i,
                    s,
                    o,
                    ...
                    m = 0;
                  if (
                    (u.setTime(u.getTime() - 6e4),
                    l.c_rr(e) && l.c_wr(e, "", u),
                    (e = l.escape ? l.escape(e) : encodeURIComponent(e)),
                    (s = (r = l.c_rspers()).indexOf(" " + e + "=")) > -1 &&
                      ((r =
                        r.substring(0, s) + r.substring(r.indexOf(";", s) + 1)),
                      (f = 1)),
                    (s = (i = l.c_rr(g)).indexOf(" " + e + "=")) > -1 &&
                      ((i =
                        i.substring(0, s) + i.substring(i.indexOf(";", s) + 1)),
                      (m = 1)),
                    (u = new Date()),
                    a
                      ? (1 == a &&
                          ((c = (a = new Date()).getYear()),
                          a.setYear(c + 5 + (c < 1900 ? 1900 : 0))),
                        a.getTime() > u.getTime() &&
                          ((r +=
                            " " +
                            e +
                            "=" +
                            (l.escape ? l.escape(t) : encodeURIComponent(t)) +
                            "|" +
                            a.getTime() +
                            ";"),
                          (f = 1)))
                    ...
                    u.setTime(d), l.c_wr(p, r, u);
                  }
                  return (
                    t ==
                    l.c_r(l.unescape ? l.unescape(e) : decodeURIComponent(e))
                  );
                }
                (e.c_wr = e.c_w), (e.__ccucw = !0), (e.c_w = e.cookieWrite = s);
              }
              e.getFullReferringDomains = new Function(
                "var i,s=this,dr=window.document.referrer,n=s.linkInternalFilters.split(',');if(dr){var r=dr.split('/')[2],l=n.length;for(i=0;i<=l;i++){if(r.indexOf(n[i])!=-1){r='';i=l+1;}}return r}"
              );
            },
          },
          libraryCode: {
            type: "managed",
            accounts: {
              staging: ["elsevier-global-dev"],
              production: ["elsevier-global-prod"],
              development: ["elsevier-global-dev"],
            },
            useActivityMap: !0,
          ...
          "adobe-analytics/src/lib/actions/sendBeacon.js": {
            ...
            script: function (e, t, a, n) {
              ...
              var r = a("../sharedModules/getTracker"),
                i = a("../helpers/getNodeLinkText"),
                s = function (e) {
                  return e && e.nodeName && "a" === e.nodeName.toLowerCase();
                },
                o = function (e) {
                  return s(e) ? i(e) : "link clicked";
                },
                c = function (e, t, a) {
                  if ("page" === t.type)
                    ...
                    n.logger.info(
                      ...
                      e.tl(s(a) ? a : "true", r.linkType, r.linkName);
                  }
                };
                ...
                return r().then(
                  function (a) {
                    n.logger.info("Set variables on the tracker."),
                      i(a, e.trackerProperties),
                      e.customSetup &&
                        e.customSetup.source &&
                        e.customSetup.source.call(t.element, t, a);
                  },
                  function (e) {
          ...
          "adobe-analytics/src/lib/sharedModules/getTracker.js": {
            script: function (e, t, a, n) {
              ...
              var r,
                ...
                p = a("../helpers/generateVersion")(
                  n.buildInfo.turbineBuildDate
                ),
                g = "beforeSettings",
                f = n.getSharedModule("adobe-mcid", "mcid-instance"),
                m = function (e) {
                ...
                D =
                  ...
                  m(r.trackingCookieName)
                    ? d(r)
                        ...
                        .then(b)
                        .then(
                          k.bind(null, r.trackerProperties, r.customSetup || {})
                        )
                        .then(y.bind(null, r))
                    : s.reject(
          ...
          "adobe-analytics/src/lib/helpers/getNodeLinkText.js": {
            script: function (e) {
              ...
              var t = function (e) {
                ...
                a = /^(SCRIPT|STYLE|LINK|CANVAS|NOSCRIPT|#COMMENT)$/i,
                n = function (e) {
                      ...
                      ? (t.push(e),
                        e.childNodes &&
                          Array.prototype.slice
                            ...
                            .forEach(function (e) {
                              var n = r(e);
                              (t = t.concat(n.supportedNodes)),
                                (a = a || n.includesUnsupportedNodes);
                            }))
                      : (a = !0),
                    { supportedNodes: t, includesUnsupportedNodes: a }
                  );
                },
                i = function (e, t, a) {
                  var n;
                  return (
                    (a && a !== e.nodeName.toUpperCase()) ||
                      (n = e.getAttribute(t)),
                    n
                  );
                };
              e.exports = function (e) {
                var a = t(e.innerText || e.textContent),
                  n = r(e);
                if (!a || n.includesUnsupportedNodes) {
                  ...
                  n.supportedNodes.forEach(function (e) {
                    e.getAttribute &&
                      ((s = s || t(e.getAttribute("alt"))),
                      (o = o || t(e.getAttribute("title"))),
                      (c = c || t(i(e, "value", "INPUT"))),
                      (l = l || t(i(e, "src", "IMG")))),
                      e.nodeValue && u.push(e.nodeValue);
                  }),
                    (a = t(u.join(""))) || (a = t(s || o || c || l || ""));
                }
                return a;
              };
            },
              ...
              var r = a("@adobe/reactor-window"),
                i = {
                  ...
                  getReportSuites: function (e) {
                    var t = e.production;
                    return (
                      e[n.environment.stage] && (t = e[n.environment.stage]),
                      t.join(",")
                    );
                  },
              ...
              var r = a("@adobe/reactor-query-string"),
                ...
                g = function (e, t, a) {
                  ...
                  a[t].forEach(function (t) {
                    var a;
                    if ("value" === t.type) a = t.value;
                    else {
                      var r = s.exec(t.value);
                      if (r) a = n + "v" + r[1];
                      else {
              ...
              e.exports = function (e, t) {
                ...
                (t = t || {}),
                  ...
                  a.events &&
                    e.events &&
                    e.events.length > 0 &&
                    (a.events = e.events + "," + a.events);
                var r = t && t.events && t.events.length > 0,
                  i = u(e, a, r);
                i && (a.linkTrackVars = i);
                var s = d(e, t.events || []);
                s && (a.linkTrackEvents = s),
                  n.logger.info(
        ...
        modules: {
          ...
          "core/src/lib/dataElements/queryStringParameter.js": {
            ...
            script: function (e, t, a) {
              ...
              e.exports = function (e) {
                ...
                for (
                  var a = e.name.toLowerCase(), i = Object.keys(t), s = 0;
                  s < i.length;
                  s++
                ) {
                  var o = i[s];
              ...
              (window._satellite = window._satellite || {}),
                (window._satellite.track = function (e, t) {
                  ...
                  if (a) {
                    ...
                    t && s.push(t), n.logger.log.apply(n.logger, s);
                  } else
                    n.logger.log(
            ...
            script: function (e, t, a, n) {
              ...
              var r,
                ...
                m =
                  ...
                  (s = []),
                  (o = function () {
                    if (c.body) for (; s.length; ) i(s.shift());
                  ...
                  return i.settings.isExternal
                    ...
                    : ((a = u(i, s)),
                      v || "loading" !== c.readyState
                        ...
                        : c.write &&
                          !1 ===
                            n.propertySettings.ruleComponentSequencingEnabled
                        ? c.write(a.code)
                        : m(a.code),
                      a.promise);
              };
          ...
          "core/src/lib/events/click.js": {
            ...
            script: function (e, t, a) {
              ...
              var n = a("@adobe/reactor-window"),
                ...
                c = function (e) {
                  if (!e.ctrlKey && !e.metaKey && e.button !== s)
          ...
          "core/src/lib/helpers/getObjectProperty.js": {
            script: function (e) {
              ...
              e.exports = function (e, t) {
                for (
                  var a = t.split("."), n = e, r = 0, i = a.length;
                  r < i;
                  r++
                ) {
                  if (null == n) return;
                  ...
                  return (function (e) {
                    ...
                    function (e, t, a) {
                      ...
                      var u = r(a(2)),
                        ...
                        f = [],
                        m = null;
                      l(c, { streams: {}, queue: f, WriteStream: u.default });
                    },
                    function (e, t, a) {
                      "use strict";
                      function n(e) {
                          ...
                          return (
                            ...
                            (e.prototype._writeImpl = function (e) {
                              ...
                              for (
                                ...
                                (t = this.options.beforeWriteToken(t)) &&
                                  r.push(t);
                              r.length > 0 && this._writeStaticTokens(r),
                            ...
                            (e.prototype._walkChunk = function () {
                              for (
                                ...
                                if (!a || !s(e, "proxyof")) {
                                  a &&
                                    ((this.actuals[s(e, "id")] = e),
                                    o(e, "id"));
                                  var n =
                                    e.parentNode && s(e.parentNode, "proxyof");
                            ...
                            (e.prototype._buildStyle = function (e) {
                              ...
                              return (
                                ...
                                u.eachKey(e.attrs, function (e, a) {
                                  t.setAttribute(e, a);
                                }),
                                t
                              );
                              ...
                              if (-1 !== e.indexOf(">")) {
                                ...
                                if (r) {
                                  var i =
                                    ...
                                    (a = {}),
                                    (n = r[2]),
                                    r[2].replace(u.attr, function (e, r) {
                                      arguments[2] ||
                                      arguments[3] ||
                                      arguments[4] ||
                                      arguments[5]
          ...
          "core/src/lib/helpers/findPageScript.js": {
            script: function (e, t, a) {
              ...
              var n = a("@adobe/reactor-document"),
                r = function (e) {
                  for (
                    var t = n.querySelectorAll("script"), a = 0;
                    a < t.length;
                    a++
                  ) {
                    var r = t[a];
              ...
              e.exports = { getTurbine: i, byRegexPattern: r };
            },
          },
      ...
      "adobe-mcid": {
        ...
        hostedLibFilesBaseUrl:
          "https://assets.adobedtm.com/extensions/EP4413121ff4ce4a49869b12b0ea80c748/",
        settings: {
          orgId: "4D6368F454EC41940A4C98A6@AdobeOrg",
          variables: [
            ...
            script: function (e, t, a, n) {
              ...
              var r = a("@adobe/reactor-document"),
                ...
                c = function (e) {
                  ...
                  m && (a.isIabContext = m);
                  var v = e.getInstance(t.orgId, a);
                  return (
                    n.logger.info(
                      'Created instance using orgId: "' + t.orgId + '"'
                    ),
                    n.logger.info("Set variables: " + JSON.stringify(a)),
                ...
                l = function (e) {
                  return (n.getExtensionSettings().pathExclusions || []).some(
                    function (t) {
                ...
                ((function () {
                  ...
                  function g() {
                    ...
                    var n =
                      ...
                      s = n.preOptInApprovals,
                      o = n.isOptInStorageEnabled,
                      ...
                      m = Ve(i);
                    Pe(m, "Invalid `previousPermissions`!"),
                      Pe(s, "Invalid `preOptInApprovals`!");
                    var v = d({ cookieName: "adobeujs-optin" }, { cookies: f }),
                      h = this,
                      b = ee(h),
                      k = oe(),
                      y = De(m),
                    ...
                    (h.deny = a(!1)),
                      (h.approve = a(!0)),
                      (h.denyAll = h.deny.bind(h, se)),
                      (h.approveAll = h.approve.bind(h, se)),
                      ...
                      (h.registerPlugin = function (e) {
                        if (!e || !e.name || "function" != typeof e.onRegister)
                          throw new Error(Oe);
                        w[e.name] || ((w[e.name] = e), e.onRegister.call(e, h));
                      }),
                      (h.execute = Ie(w)),
                  ...
                  function m() {
                    ...
                    if (e !== window.top) {
                      ...
                      if (t) {
                        var a = {};
                        return (
                          (window.__tcfapi = function (e, n, r, i) {
                            var s = Math.random() + "",
                              o = {
                                __tcfapiCall: {
                                  command: e,
                  ...
                  function h() {
                    ...
                    var t,
                      a = oe(),
                      n = { transparencyAndConsentData: null },
                      r = function (e) {
                        var t =
                          arguments.length > 1 && void 0 !== arguments[1]
                            ? arguments[1]
                    ...
                    (e.fetchConsentData = function (e) {
                      ...
                      (e.isApproved = function (e) {
                        ...
                        if (n.transparencyAndConsentData)
                          return t(
                            null,
                            v(n.transparencyAndConsentData, ne[a], re[a])
                          );
                        var s = f(function (e, n) {
                          t(e, v(n, ne[a], re[a]));
                        }, r);
                        i({ category: a, callback: s });
                      }),
                    ...
                    var i = function (e) {
                        ...
                        a.add("FETCH_CONSENT_DATA", i),
                          s(function (e, i) {
                            if (i) {
                              var s = ke(e),
                                o = t.getMemoizedContent("iabConsentHash"),
                                c = pe(s.tcString).toString(32);
                              (s.consentString = e.tcString),
                                (s.hasConsentChangedSinceLastCmpPull = o !== c),
                                r("transparencyAndConsentData", s),
                  ...
                  var k,
                    ...
                    w = function (e) {
                      ...
                      (this.getMarketingCloudVisitorID = function (e) {
                        e = e || t;
                        var n = this.findField(C.MCMID, e),
                          r = a.call(this, C.MCMID, e);
                        return void 0 !== n ? n : r();
                      }),
                    ...
                    P = function () {
                      ...
                      Object.keys(S).forEach(a, this),
                        Object.keys(V).forEach(n, this);
                    },
                    _ = D.ASYNC_API_MAP,
                    E = function () {
                    ...
                    I = (function (e, t) {
                      ...
                      (a.getIeVersion = function () {
                        ...
                        (a.defineGlobalNamespace = function () {
                          return (
                            (window.adobe = a.isObject(window.adobe)
                              ? window.adobe
                              : {}),
                            window.adobe
                          );
                    ...
                    L = function (e, t) {
                      (this.parse = function (e) {
                        ...
                        (this.isInvalid = function (a) {
                          ...
                          var r = e !== n.orgID,
                            i = !t || a.origin !== t,
                            s = -1 === Object.keys(O).indexOf(n.prefix);
                          return r || i || s;
                        }),
                    ...
                    M = function (e, t, a, n) {
                      ...
                      function l(e) {
                        if (!v.isInvalid(e)) {
                          var t = v.parse(e);
                          (m = !1),
                            b.clearTimeout(g._handshakeTimeout),
                            b.removeEventListener("message", l),
                            r(new P(g)),
                            b.addEventListener("message", s),
                            g.setStateAndPublish(t.state),
                            g.callbackRegistry.hasCallbacks() && o(x.GETSTATE);
                        }
                      }
                      function u() {
                        f && postMessage
                          ? (b.addEventListener("message", l),
                            o(x.HANDSHAKE),
                            (g._handshakeTimeout = setTimeout(c, 250)))
                          : c();
                      }
                      function d() {
                    ...
                    B = function (e, t) {
                      ...
                      function n() {
                        ...
                        return (
                          e._loading &&
                            Object.keys(e._loading).forEach(function (a) {
                              if (e._loading[a]) {
                                var n = U[a];
                                t.push(n);
                              }
                      ...
                      return function (e) {
                        t.isInvalid(e) ||
                          (t.parse(e).prefix === N.HANDSHAKE ? s : o)(e.source);
                      };
                    },
                    H = function (e, t) {
                      function a(e) {
                    ...
                    Y = function (e, t) {
                      ...
                      for (a = n.length - 2; a >= 0; a--)
                        if (
                          ((r.domain = n.slice(a).join(".")),
                          W.set("test", "cookie", r))
                        )
                          return W.remove("test", r), r.domain;
                      return "";
                    },
                    X = {
                      compare: o,
                    ...
                    $ = function (e, t) {
                      ...
                      return {
                        ...
                        messagesPosted: [],
                        messagesReceived: [],
                        messageSendingInterval: K.POST_MESSAGE_ENABLED
                          ? null
                          : 100,
                        ...
                        requestToProcess: function (t) {
                          ...
                          if (t === Object(t) && t.ibs)
                            if (
                              ...
                              var i,
                                ...
                                c = !1;
                              for (
                                i = 0, s = this.jsonForComparison.length;
                                i < s;
                                i++
                              )
                                if (
                          ...
                          e.idSyncDisableSyncs ||
                            ...
                            (this.throttleTimerSet ||
                              ...
                              setTimeout(function () {
                                r.messageSendingInterval =
                                  K.POST_MESSAGE_ENABLED ? null : 150;
                              }, this.THROTTLE_START)),
                        ...
                        checkFirstPartyCookie: function (t, a, n) {
                          ...
                          var s,
                            ...
                            u = !1,
                            d = Math.ceil(
                              new Date().getTime() / K.MILLIS_PER_DAY
                            );
                          c
                            ? ((s = c.split("*")),
                              (l = (o = this.pruneSyncData(s, t.id, d))
                                .dataPresent),
                              (u = o.dataValid),
                              (l && u) || this.fireSync(r, t, a, s, i, d))
                            : ((s = []), this.fireSync(r, t, a, s, i, d));
                        },
                        ...
                        fireSync: function (t, a, n, r, i, s) {
                          ...
                          if (t) {
                                ...
                                f.addEventListener(
                                  ...
                                  (function (t, a, n, r) {
                                    return function () {
                                      ...
                                      if (d)
                                        for (
                                          c = 0, l = (s = d.split("*")).length;
                                          c < l;
                                          c++
                                        )
                                          (u = s[c]).match("^" + a.id + "-") ||
                                            p.push(u);
                                      o.setSyncTrackingData(p, a, n, r);
                                    };
                                  })(this.onPagePixels.length, a, i, s)
                                ),
                                  (f.src = (d ? g : "") + u),
                            ...
                            this.addMessage(n),
                              this.setSyncTrackingData(r, a, i, s);
                        },
                        addMessage: function (t) {
                          ...
                          this.messages.push(
                            (K.POST_MESSAGE_ENABLED ? "" : a) + t
                          );
                        },
                        setSyncTrackingData: function (t, a, n, r) {
                          t.push(a.id + "-" + (r + Math.ceil(a.ttl / 60 / 24))),
                        ...
                        canMakeSyncIDCall: function (t, a) {
                          return (
                            e._forceSyncIDCall ||
                            !t ||
                            a - t > K.DAYS_BETWEEN_SYNC_ID_CALLS
                          );
                        },
                    ...
                    ne = (t((k = {}), ae.AAM, 565), t(k, ae.ECID, 565), k),
                    re =
                      (t((y = {}), ae.AAM, [1, 10]), t(y, ae.ECID, [1, 10]), y),
                    ...
                    oe = function () {
                      ...
                      return (
                          ...
                          if (e.callbacks[t]) {
                            ...
                            try {
                              for (; e.callbacks[t].length; ) {
                                ...
                                "function" == typeof n
                                  ? n.apply(null, a)
                                  : n instanceof Array && n[1].apply(n[0], a);
                              }
                        ...
                        (e.executeAll = function (t, a) {
                          (a || (t && !c(t))) &&
                            Object.keys(e.callbacks).forEach(function (a) {
                    ...
                    he = function (e) {
                      ...
                      return (
                        ...
                        me(e).every(function (e) {
                          return (
                            se.indexOf(e) > -1 || (t && ie.indexOf(e) > -1)
                          );
                        })
                      );
                    },
                    ...
                    Ce = function (e) {
                      return (
                        void 0 === e || (Te(e) ? he(Object.keys(e), !0) : we(e))
                      );
                    },
                    we = function (e) {
                      try {
                        var t = JSON.parse(e);
                        return !!e && fe(e, "string") && he(Object.keys(t), !0);
                      } catch (e) {
                        return !1;
                      }
                    },
                    Te = function (e) {
                      return (
                        null !== e && fe(e, "object") && !1 === Array.isArray(e)
                      );
                    },
                    Se = function () {},
                    Ve = function (e) {
                    ...
                    Ee = function (e) {
                      return _e(e).filter(function (e, t, a) {
                        return a.indexOf(e) === t;
                      });
                    },
                    Ie = function (e) {
                  ...
                  var je = Object.freeze({ OptIn: g, IabPlugin: h }),
                    Le = function (e, t) {
                                ...
                                l.length &&
                                  setTimeout(function () {
                                    var t = new Image(),
                                      a = l.shift();
                                    (t.src = a.url),
                                      i.onPageDestinationsFired.push(a),
                                      e();
                                  }, 100);
                              })();
                          }
                    ...
                    xe = function e(t) {
                      ...
                      for (
                        c[c.length] = (l / s) | 0, c[c.length] = l, r = 0;
                        r < c.length;
                  ...
                  var Fe = function (t, a, n) {
                    function r() {
                      k._customerIDsHashChanged = !1;
                    }
                    function i(e) {
                      var t = e;
                      return function (e) {
                        var a = e || V.location.href;
                        try {
                          var n = k._extractParamFromUri(a, t);
                    ...
                    function s(e) {
                      ...
                      t(e[O], k.setMarketingCloudVisitorID, O),
                        k._setFieldExpire(R, -1),
                        t(e[M], k.setAnalyticsVisitorID);
                    }
                    function o(e) {
                      (e = e || {}),
                        (k._supplementalDataIDCurrent =
                          e.supplementalDataIDCurrent || ""),
                        (k._supplementalDataIDCurrentConsumed =
                          e.supplementalDataIDCurrentConsumed || {}),
                        (k._supplementalDataIDLast =
                          e.supplementalDataIDLast || ""),
                        (k._supplementalDataIDLastConsumed =
                    ...
                    function l(e) {
                      var t = e.minutesToLive,
                        a = "";
                      return (
                        (k.idSyncDisableSyncs || k.disableIdSyncs) &&
                    ...
                    function u() {
                      return !(
                        !k.configs.doesOptInApply ||
                        (y.optIn.isComplete && d())
                      );
                    }
                    function d() {
                      return k.configs.doesOptInApply && k.configs.isIabContext
                        ? y.optIn.isApproved(y.optIn.Categories.ECID) && T
                    ...
                    function g() {
                      var e = k._getAudienceManagerURLData(),
                        t = e.url;
                      return k._loadData(A, t, null, e);
                    }
                    function f(e, t) {
                    ...
                    (P.version = k.version),
                      ...
                      (k._il[k._in] = k),
                      V.s_c_in++,
                      (k._instanceType = "regular"),
                      (k._log = { requests: [] }),
                      (k.marketingCloudOrgID = t),
                      (k.cookieName = "AMCV_" + t),
                      (k.sessionCookieName = "AMCVS_" + t);
                    var _ = {};
                    a &&
                      a.secureCookie &&
                      a.sameSiteCookie &&
                      ...
                      (k.cookieDomain = k.useLocalStorage ? "" : Y(null, _)),
                      (k.loadSSL = !0),
                      (k.loadTimeout = 3e4),
                      (k.CORSErrors = []),
                      (k.marketingCloudServer = k.audienceManagerServer =
                        "dpm.demdex.net"),
                      (k.sdidParamExpiry = 30);
                    var E = null,
                      A = "MC",
                      O = "MCMID",
                      j = "MCIDTS",
                      ...
                      G = J(k);
                    (k.FIELDS = D.FIELDS),
                      (k.cookieRead = function (e) {
                        return k.useLocalStorage
                          ? e === k.sessionCookieName
                            ? sessionStorage.getItem(e)
                            : localStorage.getItem(e)
                          : W.get(e);
                      }),
                      (k.cookieWrite = function (e, t, a) {
                        var n = "" + t;
                        if (k.useLocalStorage)
                          return e === k.sessionCookieName
                            ? sessionStorage.setItem(e, n)
                            : localStorage.setItem(e, n);
                        var r = k.cookieLifetime
                            ? ("" + k.cookieLifetime).toUpperCase()
                            : "",
                          i = {
                            expires: a,
                            domain: k.cookieDomain,
                            cookieLifetime: r,
                          };
                        return (
                          k.configs &&
                            k.configs.secureCookie &&
                            "https:" === location.protocol &&
                            (i.secure = !0),
                          k.configs &&
                            k.configs.sameSiteCookie &&
                            "https:" === location.protocol &&
                            (i.sameSite =
                              D.SAME_SITE_VALUES[
                                k.configs.sameSiteCookie.toUpperCase()
                              ] || "Lax"),
                          W.set(e, n, i)
                        );
                      }),
                      ...
                      (k.resetState = function (e) {
                        e ? k._mergeServerState(e) : o();
                      }),
                      (k._isAllowedDone = !1),
                      (k._isAllowedFlag = !1),
                      (k.isAllowed = function () {
                        return (
                          k._isAllowedDone ||
                            ((k._isAllowedDone = !0),
                            (k.cookieRead(k.cookieName) ||
                              k.cookieWrite(k.cookieName, "T", 1)) &&
                              (k._isAllowedFlag = !0)),
                          "T" === k.cookieRead(k.cookieName) &&
                            k.removeCookie(k.cookieName),
                          k._isAllowedFlag
                        );
                      }),
                      (k.setMarketingCloudVisitorID = function (e) {
                        k._setMarketingCloudFields(e);
                      }),
                      (k._use1stPartyMarketingCloudServer = !1),
                      (k.getMarketingCloudVisitorID = function (e, t) {
                        k.marketingCloudServer &&
                          k.marketingCloudServer.indexOf(".demdex.net") < 0 &&
                          (k._use1stPartyMarketingCloudServer = !0);
                        var a = k._getAudienceManagerURLData(
                            "_setMarketingCloudFields"
                          ),
                          n = a.url;
                        return k._getRemoteField(O, n, e, t, a);
                      });
                    var Q = function (e, t) {
                      var a = {};
                      k.getMarketingCloudVisitorID(function () {
                    ...
                    (k.getVisitorValues = function (e, t) {
                      var a = {
                          MCMID: {
                            fn: k.getMarketingCloudVisitorID,
                            args: [!0],
                            context: k,
                          },
                          MCOPTOUT: {
                          ...
                          MCAID: {
                            fn: k.getAnalyticsVisitorID,
                            args: [!0],
                            context: k,
                          },
                          MCAAMLH: {
                            fn: k.getAudienceManagerLocationHint,
                            args: [!0],
                            context: k,
                          },
                          MCAAMB: {
                            fn: k.getAudienceManagerBlob,
                            args: [!0],
                            context: k,
                          },
                        },
                        n = t && t.length ? I.pluck(a, t) : a;
                      t && -1 === t.indexOf("MCAID") ? Q(e, t) : H(n, e);
                    }),
                      (k._currentCustomerIDs = {}),
                      (k._customerIDsHashChanged = !1),
                      (k._newCustomerIDsHash = ""),
                      (k.setCustomerIDs = function (t, a) {
                        if (!k.isOptedOut() && t) {
                          if (!I.isObject(t) || I.isObjectEmpty(t)) return !1;
                          var n, i, s, o;
                          for (n in (k._readVisitor(), t))
                            if (
                              U(n) &&
                              ((k._currentCustomerIDs.dataSources =
                                k._currentCustomerIDs.dataSources || {}),
                              (a = (i = t[n]).hasOwnProperty("hashType")
                                ? i.hashType
                                : a),
                              i)
                            )
                              if ("object" === e(i)) {
                                ...
                                null != i.authState &&
                                  ...
                                  (k._currentCustomerIDs.dataSources[n] = c);
                              } else if (a) {
                                if (!(o = Me(Ne(i), a))) return;
                                k._currentCustomerIDs.dataSources[n] = {
                                  id: o,
                                  hashType: a,
                                };
                              } else
                          ...
                          var l = k.getCustomerIDs(!0),
                            u = k._getField("MCCIDH"),
                            d = "";
                          for (s in (u || (u = 0), l)) {
                            var p = l[s];
                          ...
                          (k._newCustomerIDsHash = String(k._hash(d))),
                            k._newCustomerIDsHash !== u &&
                              ((k._customerIDsHashChanged = !0),
                              k._mapCustomerIDs(r));
                        }
                      }),
                      (k.syncIdentity = function (t, a) {
                        if (!k.isOptedOut() && t) {
                          if (!I.isObject(t) || I.isObjectEmpty(t)) return !1;
                          var n, i, s, o, c;
                          for (n in (k._readVisitor(), t))
                            if (
                              U(n) &&
                              ((k._currentCustomerIDs.nameSpaces =
                                k._currentCustomerIDs.nameSpaces || {}),
                              (a = (i = t[n]).hasOwnProperty("hashType")
                                ? i.hashType
                                : a),
                              ...
                              null != i.authState &&
                                ...
                                i.dataSource &&
                                  ((k._currentCustomerIDs.dataSources =
                                    k._currentCustomerIDs.dataSources || {}),
                                  (o = i.dataSource),
                                  (k._currentCustomerIDs.dataSources[o] = l)),
                                (k._currentCustomerIDs.nameSpaces[n] = l);
                            }
                          var u = k.getCustomerIDs(!0),
                            d = k._getField("MCCIDH"),
                            p = "";
                          for (c in (d || (d = "0"), u)) {
                            var g = u[c];
                          ...
                          (k._newCustomerIDsHash = String(k._hash(p))),
                            k._newCustomerIDsHash !== d &&
                              ((k._customerIDsHashChanged = !0),
                              k._mapCustomerIDs(r));
                        }
                      }),
                      (k.getCustomerIDs = function (e) {
                        k._readVisitor();
                        var t,
                          a,
                          n = { dataSources: {}, nameSpaces: {} },
                          r = k._currentCustomerIDs.dataSources;
                        for (t in r)
                          U(t) &&
                            (a = r[t]).id &&
                        ...
                        var i = k._currentCustomerIDs.nameSpaces;
                        for (t in i)
                          U(t) &&
                            (a = i[t]).id &&
                      ...
                      (k.setAnalyticsVisitorID = function (e) {
                        k._setAnalyticsFields(e);
                      }),
                      (k.getAnalyticsVisitorID = function (e, t, a) {
                        if (!te.isTrackingServerPopulated() && !a)
                          return k._callCallback(e, [""]), "";
                        var n = "";
                        if (
                          (a ||
                            (n = k.getMarketingCloudVisitorID(function () {
                              k.getAnalyticsVisitorID(e, !0);
                            })),
                          n || a)
                        ) {
                          var r = a ? k.marketingCloudServer : k.trackingServer,
                            i = "";
                          k.loadSSL &&
                            (a
                              ? k.marketingCloudServerSecure &&
                                (r = k.marketingCloudServerSecure)
                              : k.trackingServerSecure &&
                                (r = k.trackingServerSecure));
                          var s = {};
                          if (r) {
                            var o =
                                "http" +
                              ...
                              c =
                                ...
                                k.version +
                                "&mcorgid=" +
                                encodeURIComponent(k.marketingCloudOrgID) +
                                (n ? "&mid=" + encodeURIComponent(n) : "") +
                                (k.idSyncDisable3rdPartySyncing ||
                                k.disableThirdPartyCookies
                                  ? "&d_coppa=true"
                                  : ""),
                              l = [
                                "s_c_il",
                          ...
                          return (
                            (s.url = i),
                            k._getRemoteField(a ? O : M, i, e, t, s)
                          );
                        }
                        return "";
                      }),
                      (k.getAudienceManagerLocationHint = function (e, t) {
                        if (
                          k.getMarketingCloudVisitorID(function () {
                            k.getAudienceManagerLocationHint(e, !0);
                          })
                        ) {
                          var a = k._getField(M);
                          if (
                            (!a &&
                              ...
                              (a = k.getAnalyticsVisitorID(function () {
                                k.getAudienceManagerLocationHint(e, !0);
                              })),
                            ...
                            var n = k._getAudienceManagerURLData(),
                              r = n.url;
                            return k._getRemoteField("MCAAMLH", r, e, t, n);
                          }
                        }
                        return "";
                      }),
                      (k.getLocationHint = k.getAudienceManagerLocationHint),
                      (k.getAudienceManagerBlob = function (e, t) {
                        if (
                          k.getMarketingCloudVisitorID(function () {
                            k.getAudienceManagerBlob(e, !0);
                          })
                        ) {
                          var a = k._getField(M);
                          if (
                            ...
                            var n = k._getAudienceManagerURLData(),
                              r = n.url;
                            return (
                              k._customerIDsHashChanged &&
                                k._setFieldExpire(R, -1),
                              k._getRemoteField(R, r, e, t, n)
                            );
                          }
                        }
                        return "";
                      ...
                      (k._supplementalDataIDLast = ""),
                      (k._supplementalDataIDLastConsumed = {}),
                      (k.getSupplementalDataID = function (e, t) {
                        k._supplementalDataIDCurrent ||
                          t ||
                          (k._supplementalDataIDCurrent = k._generateID(1));
                        var a = k._supplementalDataIDCurrent;
                        return (
                          k._supplementalDataIDLast &&
                          !k._supplementalDataIDLastConsumed[e]
                            ? ((a = k._supplementalDataIDLast),
                              (k._supplementalDataIDLastConsumed[e] = !0))
                            : a &&
                              (k._supplementalDataIDCurrentConsumed[e] &&
                                ((k._supplementalDataIDLast =
                                  k._supplementalDataIDCurrent),
                                (k._supplementalDataIDLastConsumed =
                                  k._supplementalDataIDCurrentConsumed),
                                (k._supplementalDataIDCurrent = a =
                                  t ? "" : k._generateID(1)),
                                (k._supplementalDataIDCurrentConsumed = {})),
                              a &&
                                (k._supplementalDataIDCurrentConsumed[e] = !0)),
                          a
                        );
                      });
                    var Z = !1;
                    (k._liberatedOptOut = null),
                      (k.getOptOut = function (e, t) {
                        var a = k._getAudienceManagerURLData(
                            "_setMarketingCloudFields"
                          ),
                          n = a.url;
                        if (d())
                          return k._getRemoteField("MCOPTOUT", n, e, t, a);
                        if (
                          (k._registerCallback("liberatedOptOut", e),
                          null !== k._liberatedOptOut)
                        )
                          return (
                            k._callAllCallbacks("liberatedOptOut", [
                              k._liberatedOptOut,
                            ]),
                            (Z = !1),
                            k._liberatedOptOut
                        ...
                        return (
                          ...
                          (b[r] = function (e) {
                            if (e === Object(e)) {
                              var t,
                                a,
                                n = I.parseOptOut(e, t, F);
                              (t = n.optOut),
                                (a = 1e3 * n.d_ottl),
                                (k._liberatedOptOut = t),
                                setTimeout(function () {
                                  k._liberatedOptOut = null;
                                }, a);
                            }
                            k._callAllCallbacks("liberatedOptOut", [t]),
                              (Z = !1);
                          }),
                          G.fireCORS(a),
                          null
                      ...
                      (k.isOptedOut = function (e, t, a) {
                        t || (t = P.OptOut.GLOBAL);
                        var n = k.getOptOut(function (a) {
                          var n = a === P.OptOut.GLOBAL || a.indexOf(t) >= 0;
                          k._callCallback(e, [n]);
                        }, a);
                        return n
                          ? n === P.OptOut.GLOBAL || n.indexOf(t) >= 0
                          : null;
                      });
                    var ee = { subscribed: !1, callbacks: [] };
                    (k.onReceiveEcid = function (e) {
                      if (d()) return k.getMarketingCloudVisitorID(e, !0);
                      (ee.subscribed = !0),
                        e && "function" == typeof e && ee.callbacks.push(e);
                    }),
                      (k._fields = null),
                      (k._fieldsExpired = null),
                      (k._hash = function (e) {
                        var t,
                          a = 0;
                        if (e)
                      ...
                      (k._generateID = z),
                      (k._generateLocalMID = function () {
                        var e = k._generateID(0);
                        return (re.isClientSideMarketingCloudVisitorID = !0), e;
                      }),
                      (k._callbackList = null),
                      (k._callCallback = function (e, t) {
                        try {
                          "function" == typeof e
                            ? e.apply(V, t)
                            : e[1].apply(e[0], t);
                      ...
                      (k._registerCallback = function (e, t) {
                        t &&
                          (null == k._callbackList && (k._callbackList = {}),
                          null == k._callbackList[e] &&
                            (k._callbackList[e] = []),
                          k._callbackList[e].push(t));
                      }),
                      (k._callAllCallbacks = function (e, t) {
                        if (null != k._callbackList) {
                          var a = k._callbackList[e];
                          if (a)
                            for (; a.length > 0; )
                              k._callCallback(a.shift(), t);
                        }
                      }),
                      (k._addQuerystringParam = function (e, t, a, n) {
                        var r =
                      ...
                      (k._extractParamFromUri = function (e, t) {
                        var a = new RegExp("[\\?&#]" + t + "=([^&#]*)").exec(e);
                        if (a && a.length) return decodeURIComponent(a[1]);
                      }),
                      (k._parseAdobeMcFromUrl = i(K.ADOBE_MC)),
                      (k._parseAdobeMcSdidFromUrl = i(K.ADOBE_MC_SDID)),
                      (k._attemptToPopulateSdidFromUrl = function (e) {
                        var a = k._parseAdobeMcSdidFromUrl(e),
                          n = 1e9;
                        a && a.TS && (n = te.getTimestampInSeconds() - a.TS),
                          a &&
                            a.SDID &&
                            a.MCORGID === t &&
                            n < k.sdidParamExpiry &&
                            ((k._supplementalDataIDCurrent = a.SDID),
                            (k._supplementalDataIDCurrentConsumed.SDID_URL_PARAM =
                              !0));
                      }),
                      (k._attemptToPopulateIdsFromUrl = function () {
                        var e = k._parseAdobeMcFromUrl();
                        if (e && e.TS) {
                          var a = te.getTimestampInSeconds() - e.TS;
                          if (
                            Math.floor(a / 60) > K.ADOBE_MC_TTL_IN_MIN ||
                            e.MCORGID !== t
                          )
                            return;
                          s(e);
                      ...
                      (k._mergeServerState = function (e) {
                        if (e)
                          try {
                            if (
                              (e = (function (e) {
                                return te.isObject(e) ? e : JSON.parse(e);
                              })(e))[k.marketingCloudOrgID]
                            ) {
                              var t = e[k.marketingCloudOrgID];
                              !(function (e) {
                                te.isObject(e) && k.setCustomerIDs(e);
                              })(t.customerIDs),
                                o(t.sdid);
                            }
                          } catch (e) {
                      ...
                      (k._timeout = null),
                      (k._loadData = function (e, t, a, n) {
                        (t = k._addQuerystringParam(t, "d_fieldgroup", e, 1)),
                          (n.url = k._addQuerystringParam(
                            n.url,
                            "d_fieldgroup",
                            e,
                            1
                          )),
                          (n.corsUrl = k._addQuerystringParam(
                            n.corsUrl,
                            "d_fieldgroup",
                            e,
                            1
                          )),
                          (re.fieldGroupObj[e] = !0),
                          n === Object(n) &&
                            n.corsUrl &&
                            "XMLHttpRequest" === G.corsMetadata.corsType &&
                            G.fireCORS(n, a, e);
                      }),
                      (k._clearTimeout = function (e) {
                        null != k._timeout &&
                          k._timeout[e] &&
                          (clearTimeout(k._timeout[e]), (k._timeout[e] = 0));
                      }),
                      (k._settingsDigest = 0),
                      (k._getSettingsDigest = function () {
                        if (!k._settingsDigest) {
                          var e = k.version;
                          k.audienceManagerServer &&
                            (e += "|" + k.audienceManagerServer),
                            k.audienceManagerServerSecure &&
                              (e += "|" + k.audienceManagerServerSecure),
                            (k._settingsDigest = k._hash(e));
                        }
                        return k._settingsDigest;
                      }),
                      (k._readVisitorDone = !1),
                      (k._readVisitor = function () {
                        if (!k._readVisitorDone) {
                          k._readVisitorDone = !0;
                          var e,
                            t,
                            a,
                            n,
                            r,
                            i,
                            s = k._getSettingsDigest(),
                            o = !1,
                            c = k.cookieRead(k.cookieName),
                            l = new Date();
                          if (
                            (c ||
                              S ||
                              k.discardTrackingServerECID ||
                              (c = k.cookieRead(K.FIRST_PARTY_SERVER_COOKIE)),
                            null == k._fields && (k._fields = {}),
                            c && "T" !== c)
                          )
                            for (
                              (c = c.split("|"))[0].match(/^[\-0-9]+$/) &&
                                (parseInt(c[0], 10) !== s && (o = !0),
                                c.shift()),
                                c.length % 2 == 1 && c.pop(),
                                e = 0;
                              e < c.length;
                              ...
                              (a = (t = c[e].split("-"))[0]),
                                ...
                                a &&
                                  ...
                                  r > 0 &&
                                    ...
                                    (l.getTime() >= 1e3 * r ||
                                      (i &&
                                        !k.cookieRead(k.sessionCookieName))) &&
                                      (k._fieldsExpired ||
                                        (k._fieldsExpired = {}),
                                      (k._fieldsExpired[a] = !0))));
                          !k._getField(M) &&
                            te.isTrackingServerPopulated() &&
                            (c = k.cookieRead("s_vi")) &&
                            (c = c.split("|")).length > 1 &&
                            ...
                            ((e = (n = c[1]).indexOf("[")) >= 0 &&
                              (n = n.substring(0, e)),
                            n &&
                              n.match(K.VALID_VISITOR_ID_REGEX) &&
                              k._setField(M, n));
                        }
                      }),
                      (k._appendVersionTo = function (e) {
                        var t = "vVersion|" + k.version,
                          a = e ? k._getCookieVersion(e) : null;
                        return (
                          a
                            ? X.areVersionsDifferent(a, k.version) &&
                              (e = e.replace(K.VERSION_REGEX, t))
                            : (e += (e ? "|" : "") + t),
                          e
                        );
                      }),
                      (k._writeVisitor = function () {
                        var e,
                          t,
                          a = k._getSettingsDigest();
                        for (e in k._fields)
                          U(e) &&
                            k._fields[e] &&
                            ...
                            (a +=
                              ...
                              "|" +
                              t));
                        (a = k._appendVersionTo(a)),
                          k.cookieWrite(k.cookieName, a, 1);
                      }),
                      (k._getField = function (e, t) {
                        return null == k._fields ||
                          (!t && k._fieldsExpired && k._fieldsExpired[e])
                          ? null
                          : k._fields[e];
                      }),
                      (k._setField = function (e, t, a) {
                        null == k._fields && (k._fields = {}),
                          (k._fields[e] = t),
                          a || k._writeVisitor();
                      }),
                      (k._getFieldList = function (e, t) {
                        var a = k._getField(e, t);
                        return a ? a.split("*") : null;
                      }),
                      (k._setFieldList = function (e, t, a) {
                        k._setField(e, t ? t.join("*") : "", a);
                      }),
                      (k._getFieldMap = function (e, t) {
                        var a = k._getFieldList(e, t);
                        if (a) {
                          var n,
                            r = {};
                      ...
                      (k._setFieldMap = function (e, t, a) {
                        var n,
                          r = null;
                        if (t)
                          for (n in ((r = []), t))
                            U(n) && (r.push(n), r.push(t[n]));
                        k._setFieldList(e, r, a);
                      }),
                      (k._setFieldExpire = function (e, t, a) {
                        var n = new Date();
                        n.setTime(n.getTime() + 1e3 * t),
                          ...
                          t < 0
                            ? (k._fieldsExpired || (k._fieldsExpired = {}),
                              (k._fieldsExpired[e] = !0))
                            : k._fieldsExpired && (k._fieldsExpired[e] = !1),
                          a &&
                            (k.cookieRead(k.sessionCookieName) ||
                              k.cookieWrite(k.sessionCookieName, "1"));
                      }),
                      (k._findVisitorID = function (t) {
                        return (
                          t &&
                            ("object" === e(t) &&
                              (t = t.d_mid
                            ...
                            t &&
                              ...
                              (t = F),
                            (t &&
                              (t === F || t.match(K.VALID_VISITOR_ID_REGEX))) ||
                              (t = "")),
                          t
                        );
                      }),
                      (k._setFields = function (t, a) {
                        if (
                          (k._clearTimeout(t),
                          null != k._loading && (k._loading[t] = !1),
                          re.fieldGroupObj[t] && re.setState(t, !1),
                          t === A)
                        ) {
                          !0 !== re.isClientSideMarketingCloudVisitorID &&
                            (re.isClientSideMarketingCloudVisitorID = !1);
                          var n = k._getField(O);
                          if (!n || k.overwriteCrossDomainMCIDAndAID) {
                            if (
                              !(n =
                                "object" === e(a) && a.mid
                                  ? a.mid
                              ...
                              if (
                                k._use1stPartyMarketingCloudServer &&
                                !k.tried1stPartyMarketingCloudServer
                              )
                                return (
                                  (k.tried1stPartyMarketingCloudServer = !0),
                                  void k.getAnalyticsVisitorID(null, !1, !0)
                                );
                              n = k._generateLocalMID();
                            }
                            k._setField(O, n);
                          }
                          (n && n !== F) || (n = ""),
                            "object" === e(a) &&
                              ...
                              k._use1stPartyMarketingCloudServer &&
                                a.mid &&
                                k._setFields(x, { id: a.id })),
                            k._callAllCallbacks(O, [n]);
                        }
                        if (t === N && "object" === e(a)) {
                          var r = 604800;
                          null != a.id_sync_ttl &&
                            a.id_sync_ttl &&
                            (r = parseInt(a.id_sync_ttl, 10));
                          var i = ae.getRegionAndCheckIfChanged(a, r);
                          k._callAllCallbacks("MCAAMLH", [i]);
                          var s = k._getField(R);
                          (a.d_blob || a.blob) &&
                            ((s = a.d_blob) || (s = a.blob),
                            k._setFieldExpire(R, r),
                            k._setField(R, s)),
                            s || (s = ""),
                            k._callAllCallbacks(R, [s]),
                            !a.error_msg &&
                              k._newCustomerIDsHash &&
                              k._setField("MCCIDH", k._newCustomerIDsHash);
                        }
                        if (t === x) {
                          var o = k._getField(M);
                          (o && !k.overwriteCrossDomainMCIDAndAID) ||
                            ((o = k._findVisitorID(a))
                              ? o !== F && k._setFieldExpire(R, -1)
                              : (o = F),
                            k._setField(M, o)),
                            (o && o !== F) || (o = ""),
                            k._callAllCallbacks(M, [o]);
                        }
                        if (k.idSyncDisableSyncs || k.disableIdSyncs)
                          ae.idCallNotProcesssed = !0;
                        else {
                          ae.idCallNotProcesssed = !1;
                          var c = {};
                          (c.ibs = a.ibs),
                            (c.subdomain = a.subdomain),
                            ae.processIDCallData(c);
                        }
                        if (a === Object(a)) {
                          var l, u;
                          d() && k.isAllowed() && (l = k._getField("MCOPTOUT"));
                          var p = I.parseOptOut(a, l, F);
                          (l = p.optOut),
                            (u = p.d_ottl),
                            k._setFieldExpire("MCOPTOUT", u, !0),
                            k._setField("MCOPTOUT", l),
                            k._callAllCallbacks("MCOPTOUT", [l]);
                        }
                      }),
                      (k._loading = null),
                      (k._getRemoteField = function (e, t, a, n, r) {
                        var i,
                          s = "",
                          o = te.isFirstPartyAnalyticsVisitorIDCall(e),
                          c = { MCAAMLH: !0, MCAAMB: !0 };
                        if (d() && k.isAllowed())
                          if (
                            (k._readVisitor(),
                            !(
                              !(s = k._getField(e, !0 === c[e])) ||
                              (k._fieldsExpired && k._fieldsExpired[e])
                            ) ||
                              (k.disableThirdPartyCalls && !o))
                          )
                            s ||
                              (e === O
                                ? (k._registerCallback(e, a),
                                  (s = k._generateLocalMID()),
                                  k.setMarketingCloudVisitorID(s))
                                : e === M
                                ? (k._registerCallback(e, a),
                                  (s = ""),
                                  k.setAnalyticsVisitorID(s))
                                : ((s = ""), (n = !0)));
                          else if (
                            (e === O || "MCOPTOUT" === e
                              ? (i = A)
                            ...
                            return (
                              !t ||
                                (null != k._loading && k._loading[i]) ||
                                (null == k._loading && (k._loading = {}),
                                (k._loading[i] = !0),
                                i === N && (w = 0),
                                k._loadData(
                                  i,
                              ...
                              k._registerCallback(e, a),
                              s || (t || k._setFields(i, { id: F }), "")
                            );
                        return (
                          (e !== O && e !== M) ||
                            s !== F ||
                            ((s = ""), (n = !0)),
                          a && n && k._callCallback(a, [s]),
                          e === O &&
                            ee.subscribed &&
                            (ee.callbacks &&
                              ee.callbacks.length &&
                      ...
                      (k._setMarketingCloudFields = function (e) {
                        k._readVisitor(), k._setFields(A, e);
                      }),
                      (k._mapCustomerIDs = function (e) {
                        k.getAudienceManagerBlob(e, !0);
                      }),
                      (k._setAnalyticsFields = function (e) {
                        k._readVisitor(), k._setFields(x, e);
                      }),
                      (k._setAudienceManagerFields = function (e) {
                        k._readVisitor(), k._setFields(N, e);
                      }),
                      (k._getAudienceManagerURLData = function (e) {
                        var t = k.audienceManagerServer,
                          a = "",
                          n = k._getField(O),
                          r = k._getField(R, !0),
                          i = k._getField(M),
                        ...
                        if (
                          (k.loadSSL &&
                            k.audienceManagerServerSecure &&
                            (t = k.audienceManagerServerSecure),
                          t)
                        ) {
                          var o,
                            c,
                            l,
                            u = k.getCustomerIDs(!0);
                          if (u)
                            for (c in u) {
                              var d = u[c];
                          ...
                          var g =
                            ...
                            f =
                              "d_visid_ver=" +
                              k.version +
                              (C && -1 !== g.indexOf("demdex.net")
                                ? "&gdpr=1&gdpr_consent=" + C
                                : "") +
                              (w && -1 !== g.indexOf("demdex.net")
                                ? "&d_cf=" + w
                                : "") +
                              "&d_rtbd=json&d_ver=2" +
                              (!n && k._use1stPartyMarketingCloudServer
                                ? "&d_verify=1"
                                : "") +
                              "&d_orgid=" +
                              encodeURIComponent(k.marketingCloudOrgID) +
                              "&d_nsid=" +
                              (k.idSyncContainerID || 0) +
                      ...
                      (k.appendVisitorIDsTo = function (e) {
                        try {
                          var t = [
                            [O, k._getField(O)],
                            [M, k._getField(M)],
                            ["MCORGID", k.marketingCloudOrgID],
                          ];
                          return k._addQuerystringParam(e, K.ADOBE_MC, c(t));
                        } catch (t) {
                          return e;
                        }
                      }),
                      (k.appendSupplementalDataIDTo = function (e, t) {
                        if (
                          !(t =
                            t ||
                            k.getSupplementalDataID(
                        ...
                        try {
                          ...
                          return k._addQuerystringParam(e, K.ADOBE_MC_SDID, a);
                        } catch (t) {
                          return e;
                        }
                      });
                    var te = {
                      ...
                      isFirstPartyAnalyticsVisitorIDCall: function (e, t, a) {
                        return (
                          e === M &&
                          (t || (t = k.trackingServer),
                          a || (a = k.trackingServerSecure),
                          !(
                            "string" != typeof (n = k.loadSSL ? a : t) ||
                            !n.length
                          ) &&
                            n.indexOf("2o7.net") < 0 &&
                      ...
                      removeCookie: function (e) {
                        W.remove(e, { domain: k.cookieDomain });
                      },
                      isTrackingServerPopulated: function () {
                        return !!k.trackingServer || !!k.trackingServerSecure;
                      },
                    ...
                    k._helpers = te;
                    var ae = $(k, P);
                    (k._destinationPublishing = ae), (k.timeoutMetricsLog = []);
                    var ne,
                      re = {
                    ...
                    (k.isClientSideMarketingCloudVisitorID = function () {
                      return re.isClientSideMarketingCloudVisitorID;
                    }),
                      (k.MCIDCallTimedOut = function () {
                        return re.MCIDCallTimedOut;
                      }),
                      (k.AnalyticsIDCallTimedOut = function () {
                        return re.AnalyticsIDCallTimedOut;
                      }),
                      (k.AAMIDCallTimedOut = function () {
                        return re.AAMIDCallTimedOut;
                      }),
                      (k.idSyncGetOnPageSyncInfo = function () {
                        return k._readVisitor(), k._getField("MCSYNCSOP");
                      }),
                      (k.idSyncByURL = function (e) {
                        if (!k.isOptedOut()) {
                          var t = l(e || {});
                      ...
                      (k.idSyncByDataSource = function (e) {
                        if (!k.isOptedOut())
                          return e === Object(e) &&
                      ...
                      Le(k, ae),
                      (k._getCookieVersion = function (e) {
                        e = e || k.cookieRead(k.cookieName);
                        var t = K.VERSION_REGEX.exec(e);
                        return t && t.length > 1 ? t[1] : null;
                      }),
                      (k._resetAmcvCookie = function (e) {
                        var t = k._getCookieVersion();
                        (t && !X.isLessThan(t, e)) ||
                          k.removeCookie(k.cookieName);
                      }),
                      (k.setAsCoopSafe = function () {
                        E = !0;
                      }),
                      (k.setAsCoopUnsafe = function () {
                        E = !1;
                      }),
                      (function () {
                        if (((k.configs = Object.create(null)), te.isObject(a)))
                          for (var e in a)
                            U(e) && ((k[e] = a[e]), (k.configs[e] = a[e]));
                      })(),
                      p(),
                      (k.init = function () {
                        (u() &&
                          (y.optIn.fetchPermissions(v, !0),
                          !y.optIn.isApproved(y.optIn.Categories.ECID))) ||
                          ne ||
                          ((ne = !0),
                          (function () {
                            if (te.isObject(a)) {
                              (k.idSyncContainerID = k.idSyncContainerID || 0),
                                (E =
                                  "boolean" == typeof k.isCoopSafe
                                    ? k.isCoopSafe
                                    : te.parseBoolean(k.isCoopSafe)),
                                k.resetBeforeVersion &&
                                  k._resetAmcvCookie(k.resetBeforeVersion),
                                k._attemptToPopulateIdsFromUrl(),
                                k._attemptToPopulateSdidFromUrl(),
                                k._readVisitor();
                              var e = k._getField(j),
                                t = Math.ceil(
                                  new Date().getTime() / K.MILLIS_PER_DAY
                                );
                              k.idSyncDisableSyncs ||
                                k.disableIdSyncs ||
                                !ae.canMakeSyncIDCall(e, t) ||
                                (k._setFieldExpire(R, -1), k._setField(j, t)),
                                k.getMarketingCloudVisitorID(),
                                k.getAudienceManagerLocationHint(),
                                k.getAudienceManagerBlob(),
                                k._mergeServerState(k.serverState);
                            } else
                              k._attemptToPopulateIdsFromUrl(),
                                k._attemptToPopulateSdidFromUrl();
                          })(),
                          ...
                          k.whitelistIframeDomains &&
                            K.POST_MESSAGE_ENABLED &&
                            ((k.whitelistIframeDomains =
                              k.whitelistIframeDomains instanceof Array
                                ? k.whitelistIframeDomains
                                : [k.whitelistIframeDomains]),
                            k.whitelistIframeDomains.forEach(function (e) {
                              var a = new L(t, e),
                                n = B(k, a);
                    ...
                    Be = function (e) {
                      if (I.isObject(e))
                        return Object.keys(e)
                          ...
                          .reduce(function (t, a) {
                            var n = Z.normalizeConfig(a, e[a]),
                              r = I.normalizeBoolean(n);
                            return (t[a] = r), t;
                          }, Object.create(null));
                    },
                    He = je.OptIn,
                  ...
                  (Ue.getInstance = function (e, t) {
                    ...
                    !(function (e) {
                      b.adobe.optIn =
                        ...
                        (function () {
                          ...
                          (a =
                            (a = a || Y()) === window.location.hostname
                              ? ""
                              : a),
                            (t.optInCookieDomain = a);
                          var n = new He(t, { cookies: W });
                    ...
                    var r = e.split("").reverse().join(""),
                      i = new Ue(e, null, r);
                    n.cookieDomain && (i.cookieDomain = n.cookieDomain),
                      n.sameSiteCookie &&
                        n.secureCookie &&
                        (i.configs = {
                    ...
                    var o =
                      ...
                      (!(function (e) {
                        ...
                        I.isFirefox()) &&
                      b.parent
                        ? new M(e, n, i, b.parent)
                        : new Ue(e, n, r);
                    return (i = null), o.init(), o;
                  }),
                    (function () {
                      function e() {
                        Ue.windowLoaded = !0;
    ...
    property: {
      ...
      id: "PR014ce6030bed451cb607c85b0470f621",
    },
    rules: [
      {
        ...
        actions: [
          {
            ...
            settings: {
              source:
                "https://assets.adobedtm.com/4a848ae9611a/032db4f73473/ba2a327146a1/RCa16d232f95a944c0aabdea6621a2ef94-source.min.js",
              language: "javascript",
              isExternal: !0,
            },
          },
        ...
        events: [
          {
            ...
            settings: {
              elementSelector: "a[data-sc-promo-id]",
            ...
            settings: {
              customSetup: {
                source: function () {
                  ...
                  e &&
                    (window.clickedPromoId =
                      (pageData.page.productName || "xx").toLowerCase() +
                      ":" +
                      e);
                },
              },
      ...
      {
        id: "RL99508f8fb3514787a846eda572546d03",
        name: "Event - Survey Submission",
        events: [
          {
            modulePath: "core/src/lib/events/directCall.js",
            settings: { identifier: "SurveySubmission" },
            ruleOrder: 50,
          },
        ],
        conditions: [],
                ...
                eVars: [
                  {
                    name: "eVar55",
                    type: "value",
                    value: "%Event - Survey Comment%",
                  },
                  { name: "eVar56", type: "alias", value: "prop43" },
                ],
                props: [
                  {
                    name: "prop43",
                    type: "value",
                    value: "%Event - Survey Meta Data%",
                  },
                ],
                events: [
                  { name: "event323" },
                  { name: "event322", value: "%Event - Survey Score%" },
                ],
              },
            },
          },
      ...
      {
        id: "RLfaddb90703a848cc9518d2a88403405a",
        name: "Event - Auto Suggest Term Clicked",
        events: [
          {
            modulePath: "core/src/lib/events/directCall.js",
            settings: { identifier: "autoSuggestTermClicked" },
            ruleOrder: 50,
          },
        ],
        conditions: [],
        actions: [
          {
            ...
            settings: {
              customSetup: {
                source: function (e, t) {
                  window.eventData &&
                    ...
                    ((t.eVar27 =
                      "letterct:" +
                      (eventData.search.suggestedLetterCount || "none") +
                      "|resultct:" +
                      (eventData.search.suggestedResultCount || "none") +
                      "|clickpos:" +
                      (eventData.search.suggestedClickPosition || "none")),
                    (t.eVar157 = eventData.search.typedTerm || ""),
                    (t.eVar156 = eventData.search.selectedTerm || ""),
                    (t.eVar162 = eventData.search.autoSuggestCategory || ""),
                    (t.eVar163 = eventData.search.autoSuggestDetails || ""),
                    (t.linkTrackVars = t.apl(
                      t.linkTrackVars,
                      "eVar27",
                      ",",
              ...
              trackerProperties: { events: [{ name: "event233" }] },
            },
          },
          {
            modulePath: "adobe-analytics/src/lib/actions/sendBeacon.js",
            settings: {
              type: "link",
              linkName: "auto suggest term clicked",
              linkType: "o",
            },
          },
        ],
      ...
      },
      {
        ...
        actions: [
          ...
          },
          {
            ...
            settings: {
              type: "link",
              linkName: "content-specific link click",
              linkType: "o",
            },
          },
        ],
      },
      {
        ...
        actions: [
                ...
                props: [
                  {
                    name: "prop55",
                    type: "value",
                    value: "%Event - Link Referral Name%",
                  },
                ],
              },
            },
          },
          {
            ...
            settings: {
              type: "link",
              linkName: "campaign referral click",
              linkType: "o",
            },
          },
        ],
      ...
      {
        id: "RLb1502ca8c14549a6914d42e022c2d767",
                ...
                eVars: [
                  {
                    name: "eVar37",
                    type: "value",
                    value: "%Event - LinkOut Destination%",
                  },
                  {
                    name: "eVar23",
                    type: "value",
        ...
        actions: [
          {
            modulePath: "adobe-analytics/src/lib/actions/setVariables.js",
            settings: {
              trackerProperties: { pageName: "%Page - Analytics Pagename%" },
            },
          },
          {
            modulePath: "adobe-analytics/src/lib/actions/sendBeacon.js",
                ...
                eVars: [
                  {
                    name: "eVar44",
                    type: "value",
                    value: "%Event - Updated User Fields%",
                  },
                ],
                events: [{ name: "event17" }],
              },
                ...
                eVars: [
                  {
                    name: "eVar12",
                    type: "value",
                    value: "%Event - Navigation Link Name%",
                  },
                ],
                props: [
                  {
      ...
      {
        id: "RL8536fefb2e6544a9ab6dedec6866a771",
        ...
        actions: [
          {
            ...
            settings: {
              source:
                "https://assets.adobedtm.com/4a848ae9611a/032db4f73473/ba2a327146a1/RCa5da170839744983875a4aa919b6b78c-source.min.js",
              language: "javascript",
              isExternal: !0,
            },
          },
      ...
      {
        id: "RLa7487c2c22fd46a9933433fcb14ac68a",
        name: "Event - NPS Submission",
        events: [
          {
            modulePath: "core/src/lib/events/directCall.js",
            settings: { identifier: "NPSSubmission" },
            ruleOrder: 50,
          },
        ],
        conditions: [],
                ...
                eVars: [
                  {
                    name: "eVar55",
                    type: "value",
                    value: "%Event - NPS Comment%",
                  },
                ],
                events: [
                  { name: "event323" },
                  { name: "event322", value: "%Event - NPS Score%" },
                ],
              },
            },
          },
        ...
        events: [
          {
            modulePath: "core/src/lib/events/click.js",
            settings: {
              elementSelector: "[data-aa-button]",
              bubbleFireIfChildFired: !1,
            },
            ruleOrder: 50,
          },
              ...
              customSetup: {
                source: function (e, t) {
                  (t.eVar124 = this.getAttribute("data-aa-button")),
                    ...
                    (window.eventData = {}),
                    (window.s_objectID = window.s_objectID
                      ? window.s_objectID
                      : "test");
                },
              },
      ...
      {
        id: "RL63bfd5128c33464eb6d37878e7ca3fbf",
        name: "websiteBot",
        events: [
          {
              ...
              source: function () {
                (exFlag =
                  ...
                  /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-||o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(
                    ...
                    ? ""
                    : "e"),
                  sessionStorage.getItem("aamm") ||
                    sessionStorage.setItem("aamm", "n" + exFlag),
                  document.addEventListener("mousemove", function e() {
                    document.removeEventListener("mousemove", e, !1),
                      sessionStorage.setItem("aamm", "y" + exFlag);
                  });
              },
            },
            ruleOrder: 50,
      ...
      {
        id: "RL83dc58a9338041ec94aebb8446b89555",
        name: "3rd-pcd",
        events: [
          {
            modulePath: "core/src/lib/events/customCode.js",
              ...
              source: function () {
                window.addEventListener("message", function (e) {
                  try {
                    0 ==
                      e.data.indexOf(
                        "---destpub-to-parent---canSetThirdPartyCookies"
                      ) &&
                      sessionStorage.setItem(
                        "_pageDataTracker_tpcf",
                        e.data.split("|")[1]
                      );
                  } catch (e) {}
                });
...
var _satellite = (function () {
  ...
  if (window.atob) {
    var y = document,
        ...
        if (i) {
          ...
          if (
            (e &&
              (/^((https?:)?\/\/).+/.test(e) || c(),
              /^\/\/.+/.test(e)
                ? (o.href = V.location.protocol + e)
                : (o.href = e)),
            o.hostname || c(),
            -1 === a.indexOf(o.hostname))
          ) {
            var l = new Error(
        ...
        return (
          V &&
            n.onDebugChanged(function (e) {
              e ? (V.dynamicHostResolver = p) : delete V.dynamicHostResolver;
            }),
          p
        );
      },
      ...
      O = function (e, t, a) {
        return function (n, r, i) {
          i = i || [];
          var s = e.getModuleExports(n.modulePath);
          if ("function" != typeof s) throw new Error(A);
          var o = e.getModuleDefinition(n.modulePath),
            c = n.settings || {};
          !n.hasTransformedFilePaths &&
            o.filePaths &&
            (a(c, o.filePaths, n.modulePath), (n.hasTransformedFilePaths = !0));
          var l = t(c, r);
          return s.bind(null, l).apply(null, i);
        };
      },
      j = function (e) {
      ...
      F = R.bind(null, L.LOG),
      U = R.bind(null, L.INFO),
      B = R.bind(null, L.DEBUG),
      H = R.bind(null, L.WARN),
      W = R.bind(null, L.ERROR),
      Y = function () {
        var e = N;
        (N = !0),
          R.apply(
      ...
      ee = {
        setValue: function (e, t, a) {
          ...
          switch (t) {
            case $.PAGEVIEW:
              return void (Q[e] = a);
            case $.SESSION:
              return void ((n = Z(a)) && J.setItem(e, n));
            case $.VISITOR:
              return void ((n = Z(a)) && K.setItem(e, n));
          }
        },
        getValue: function (e, t) {
          ...
          switch (t) {
            ...
            case $.SESSION:
              return null === (a = J.getItem(e)) ? a : JSON.parse(a);
            case $.VISITOR:
              return null === (a = K.getItem(e)) ? a : JSON.parse(a);
          }
        },
      },
      te = function (e, t, a, n) {
      ...
      ae = function (e, t, a, n, r) {
        return function (i, s) {
          ...
          var c,
            ...
            u = o.storageDuration;
          try {
            (c = e.getModuleExports(o.modulePath)),
              (l = e.getModuleDefinition(o.modulePath));
          } catch (e) {
            return void X.error(te(o, i, e.message, e.stack));
          }
          if ("function" == typeof c) {
            var d,
              p = o.settings || {};
            !o.hasTransformedFilePaths &&
              l.filePaths &&
              (r(p, l.filePaths, o.modulePath),
              (o.hasTransformedFilePaths = !0));
            try {
              d = c(a(p, s), s);
            } catch (e) {
              return void X.error(te(o, i, e.message, e.stack));
            ...
            return (
              ...
              null == d && null != o.defaultValue && (d = o.defaultValue),
              "string" == typeof d &&
                (o.cleanText && (d = j(d)),
                o.forceLowerCase && (d = d.toLowerCase())),
              d
            );
          }
          X.error(te(o, i, "Module did not export a function."));
        };
      },
      ne = {
        text: function (e) {
          ...
          n = function (e) {
            ...
            return (
              a.hasOwnProperty("exports") ||
                (a.exports = oe(a.definition.script, a.require, a.turbine)),
              a.exports
            );
          };
        return {
          registerModule: function (t, a, n, r, i) {
            var s = { definition: a, extensionName: n, require: r, turbine: i };
            (s.require = r), (e[t] = s);
          },
          hydrateCache: a,
          getModuleExports: n,
      ...
      de = function (e, t, a) {
        ...
        return (
          ...
          function (e, t) {
            return o.length > 10
              ? (X.error(
                  "Data element circular reference detected: " + o.join(" -> ")
                ),
                e)
              : s(e, t);
          }
    ...
    (c.prototype.catch = function (e) {
      ...
      (c.all = function (e) {
        return new c(function (t, a) {
          ...
          for (var s = r.length, o = 0; o < r.length; o++) n(o, r[o]);
        });
      }),
    ...
    var me = a(Object.freeze({ __proto__: null, default: c })),
      ve =
        ...
        return function (n, r, i, s) {
          return s.then(function () {
            ...
            return new ve(function (t, a) {
              ...
              ve.race([r, l]).then(t, a);
            })
              .catch(function (e) {
                return clearTimeout(s), (e = t(e)), a(n, r, e), ve.reject(e);
              })
              .then(function () {
                clearTimeout(s);
              });
        ...
        return function (i, s, o, c) {
          return c.then(function () {
            ...
            return new ve(function (t, a) {
              ...
              ve.race([n, s]).then(t, a);
            })
              .catch(function (e) {
                return clearTimeout(c), (e = t(e)), n(i, s, e), ve.reject(e);
              })
              .then(function (e) {
                if ((clearTimeout(c), !a(i, e))) return r(i, s), ve.reject();
              });
          });
        };
      },
      ...
      ye = function (e, t, a) {
        return function (n, r) {
          return (
            n.conditions &&
              n.conditions.forEach(function (t) {
                ke = e(t, n, r, ke);
              }),
            n.actions &&
      ...
      Pe = function (e, t, a, n) {
        return function (r, i, s) {
          var o = t(r);
          a.error(e(o, i.name, s)),
            n("ruleActionFailed", { rule: i, action: r });
        };
      },
      _e = function (e, t, a, n) {
        return function (r, i, s) {
      ...
      Ee = function (e, t, a) {
        return function (n, r) {
          var i = e(n);
          t.log('Condition "' + i + '" for rule "' + r.name + '" was not met.'),
            a("ruleConditionFailed", { rule: r, condition: n });
        };
      },
      Ie = function (e, t) {
        return function (a) {
          e.log('Rule "' + a.name + '" fired.'),
            t("ruleCompleted", { rule: a });
        };
      },
      Ae = function (e, t, a) {
        return function (n, r) {
          var i;
          if (n.actions)
            for (var s = 0; s < n.actions.length; s++) {
              i = n.actions[s];
              try {
                e(i, r, [r]);
              } catch (e) {
      ...
      $e = { get: Ke.get, set: Ke.set, remove: Ke.remove },
      Qe = function (e, t) {
        return new ve(function (a, n) {
          (t.onload = function () {
            a(t);
          }),
            (t.onerror = function () {
      ...
      at = function (e, t, a, n) {
        return (
          ...
          "object" == typeof e
            ? Object.keys(e)
                .map(function (n) {
                  var r = encodeURIComponent(tt(n)) + a;
                  return Array.isArray(e[n])
                    ? e[n]
                        ...
                        .join(t)
                    : r + encodeURIComponent(tt(e[n]));
                })
                .join(t)
            : n
            ? encodeURIComponent(tt(n)) + a + encodeURIComponent(tt(e))
            : ""
        );
      },
      nt = n(function (e, t) {
        (t.decode = t.parse = et), (t.encode = t.stringify = at);
      }),
      rt = "@adobe/reactor-",
      it = {
        cookie: $e,
      ...
      ot = function (e, t, a, n, r, i, s) {
        ...
        if (o) {
          ...
          Object.keys(o).forEach(function (p) {
            ...
            var m = Ye(n, f);
            if (g.modules) {
              var v = X.createPrefixedLogger(g.displayName),
                h = Xe(s, g.hostedLibFilesBaseUrl, c.minified),
                b = {
                  buildInfo: c,
                  environment: l,
      ...
      ut = function (e, t) {
        return function (a, n, r) {
          return e &&
            ...
            ? (n.forEach(function (e) {
                (Boolean(
                  null != r && /^core\/.*actions.*\/customCode\.js$/.test(r)
                ) &&
                  "source" === e &&
                  !a.isExternal) ||
                  k(e.split("."), a, t);
      ...
      dt = {
        getTurbine: function () {
          return lt(new RegExp(/(launch|satelliteLib)-[^\/]+.js(\?.*)?$/));
        },
        byRegexPattern: lt,
      }.getTurbine,
      pt = window._satellite;
    if (pt && !window.__satelliteLoaded) {
      window.__satelliteLoaded = !0;
      var gt = pt.container;
      delete pt.container;
      var ft = S({}, gt.buildInfo);
      Object.defineProperty(ft, "environment", {
        get: function () {
          return (
            ...
            gt.environment.stage
          );
        },
      }),
        (gt.buildInfo = ft);
      var mt,
        vt = I(q("localStorage"), X),
        ht = "";
      y.currentScript && y.currentScript.getAttribute("src")
        ? (ht = y.currentScript.getAttribute("src"))
        : dt() && (ht = dt().getAttribute("src"));
      try {
        mt = P(
          ht,
          Boolean(gt.company.dynamicCdnEnabled),
          gt.company.cdnAllowList,
          vt
        );
      } catch (e) {
        throw (X.warn("Please review the following error:"), e);
      }
      var bt,
        kt = ut(mt.isDynamicEnforced, mt.decorateWithDynamicHost),
        yt = ce(),
        Dt = gt.property.settings.undefinedVarsReturnEmpty,
        Ct = gt.property.settings.ruleComponentSequencingEnabled,
        wt = gt.dataElements || {},
        Tt = function (e) {
          return wt[e];
        },
        ...
        Vt = ae(yt, Tt, St, Dt, kt),
        Pt = {},
        _t = pe(Pt),
        Et = se(Pt, Tt),
        It = ie(Pt, Tt, Vt);
      (bt = de(Et, It, Dt)),
        ct(pt, gt, vt.setDebugEnabled, It, _t),
        ot(gt, yt, vt, bt, Vt, kt, mt.decorateWithDynamicHost);
      var At = ue(pt),
        Ot = O(yt, bt, kt),
        jt = Te(yt),
        Lt = Ee(jt, X, At),
        ...
        Rt = Ve(
          Oe(
            Ct,
            we(Ce(Ot, Le, Lt, xt), Ae(Ot, Mt, Nt)),
            ye(be(Ot, Fe, Le, xt, Lt), he(Ot, Fe, Mt), Nt),
            At
          ),
          Ot,
          He,
