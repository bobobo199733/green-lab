            ...
            o = function(e) {
                ...
                c.extend(b, {
                    ...
                    prepareData: function(a) {
                        ...
                        a.items[0] && a.items[0].end_time && f ? (a = a.items[0].end_time.split(/\D/), h = l[(new Date(a[0], a[1] - 1, a[2], a[3], a[4], a[5])).getDay()], f = f.replace(/#MON#/g, +a[1]), f = f.replace(/#DATE#/g, +a[2]), f = f.replace(/#HOUR#/g, +a[3]), f = f.replace(/#MIN#/g, a[4]), f = f.replace(/#WDAY#/g, h)) : f = "";
