...
__d("PolarisarraySplitChunks", [], function(a, b, c, d, e, f) {
    "use strict";
...
__d("PolarisnextTick", [], function(a, b, c, d, e, f) {
    "use strict";
    process && typeof process.nextTick === "function" ? a = function(a) {
        process.nextTick(a)
    } : typeof setImmediate === "function" ? a = function(a) {
        setImmediate(a)
    } : typeof window.setTimeout === "function" ? a = function(a) {
...
__d("PolarisforEachAsync", ["PolarisnextTick", "Promise"], function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("PolarisBaseGraphQLEventHandler", [], function(a, b, c, d, e, f) {
    "use strict";
...
__d("PolarisBdChallengeGraphQLEventHandler", ["JSResourceForInteraction", "PolarisBaseGraphQLEventHandler", "PolarisDirectLogger", "uuid", "xigRequireInterop"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function(a) {
        ...
        function b(b) {
            var e;
            e = a.call(this) || this;
            e.$BdChallengeGraphQLEventHandler1 = new(d("PolarisDirectLogger").DirectLogger)("BDChallengeGraphQLEventHandler", b);
            e.$BdChallengeGraphQLEventHandler1.debugTrace("bd_challenge_gql_handler_init");
            e.$BdChallengeGraphQLEventHandler2 = e.getGraphQLSubsciptionPrefix() + h + "/" + JSON.stringify({
                input_data: {
        ...
        e.processEventMessage = function(a) {
            ...
            if (b == null) {
                this.$BdChallengeGraphQLEventHandler1.debugTrace("parsed_message_bad_data");
                return
            }
            c("JSResourceForInteraction")("PolarisBDClientSignalCollectionTrigger").__setRef("PolarisBdChallengeGraphQLEventHandler").load().then(function(a) {
        ...
        e.getType = function() {
            return d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.BD_CHALLENGE
        };
        return b
    }(d("PolarisBaseGraphQLEventHandler").BaseGraphQLEventHandler);
    g.BdChallengeGraphQLEventHandler = a
}, 98);
__d("PolarisDirectBaseSubscription", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function() {
        function a(a, b, c, d) {
            var e = this;
            this.$5 = function(a) {
                ...
                if (a.length === 0) {
                    ...
                    return
                } else a[a.length - 1] === "\0" ? (b = a.substring(0, a.length - 1), e.$4.debugTrace("trimmed_null_char")) : b = a;
                var c = {};
                try {
                    c = JSON.parse(b)
                } catch (c) {
                    typeof c.message === "string" && c.message.includes("Unexpected token") && (c.jsonFirstChars = typeof b === "string" ? b.substr(0, 3) : null);
...
__d("PolarisPinnedQuestionGraphQLEventHandler", ["PolarisBaseGraphQLEventHandler", "uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function(a) {
        ...
        function b(b, d) {
            ...
            e.$PinnedQuestionGraphQLEventHandler2 = e.getGraphQLSubsciptionPrefix() + i + "/" + JSON.stringify({
                input_data: {
                    client_subscription_id: c("uuid")(),
        ...
        e.getType = function() {
            return d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION
        };
        return b
    }(d("PolarisBaseGraphQLEventHandler").BaseGraphQLEventHandler);
    g.PinnedQuestionGraphQLEventHandler = a
}, 98);
__d("PolarisPresenceGraphQLEventHandler", ["PolarisBaseGraphQLEventHandler", "PolarisDirectLogger", "uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function(a) {
        ...
        function b(b, e) {
            var f;
            f = a.call(this) || this;
            f.$PresenceGraphQLEventHandler2 = new(d("PolarisDirectLogger").DirectLogger)("PresenceGraphQLEventHandler", e);
            f.$PresenceGraphQLEventHandler1 = b;
            f.$PresenceGraphQLEventHandler2.debugTrace("presence_gql_handler_init");
            f.$PresenceGraphQLEventHandler3 = f.getGraphQLSubsciptionPrefix() + h + "/" + JSON.stringify({
                input_data: {
                    client_subscription_id: c("uuid")()
                }
            });
        ...
        e.processEventMessage = function(a) {
            a = a.presence_event;
            if (a == null) {
                this.$PresenceGraphQLEventHandler2.debugTrace("parsed_message_bad_data");
                return
            }
        ...
        e.getType = function() {
            return d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE
        };
        return b
    }(d("PolarisBaseGraphQLEventHandler").BaseGraphQLEventHandler);
    g.PresenceGraphQLEventHandler = a
}, 98);
__d("PolarisQuestionStatusGraphQLEventHandler", ["PolarisBaseGraphQLEventHandler", "uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function(a) {
        ...
        function b(b, d) {
            ...
            e.$QuestionStatusGraphQLEventHandler2 = e.getGraphQLSubsciptionPrefix() + i + "/" + JSON.stringify({
                input_data: {
                    client_subscription_id: c("uuid")(),
                    broadcast_id: String(d.id)
                }
        ...
        e.getType = function() {
            return d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.QUESTION_STATUS
        };
        return b
    }(d("PolarisBaseGraphQLEventHandler").BaseGraphQLEventHandler);
    g.QuestionStatusGraphQLEventHandler = a
}, 98);
__d("PolarisWaveGraphQLEventHandler", ["PolarisBaseGraphQLEventHandler", "PolarisConfig", "uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = "LIVE_WAVE",
        i = "17882305414154951";
    a = function(a) {
        ...
        function b(b, e) {
            ...
            f.$WaveGraphQLEventHandler2 = f.getGraphQLSubsciptionPrefix() + i + "/" + JSON.stringify({
                input_data: {
                    client_subscription_id: c("uuid")(),
...
__d("PolarisDirectGraphQLSubscription", ["PolarisBaseGraphQLEventHandler", "PolarisBdChallengeGraphQLEventHandler", "PolarisDirectBaseSubscription", "PolarisDirectLogger", "PolarisPinnedQuestionGraphQLEventHandler", "PolarisPresenceGraphQLEventHandler", "PolarisQuestionStatusGraphQLEventHandler", "PolarisWaveGraphQLEventHandler"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        function b(b, c, e) {
            e = new(d("PolarisDirectLogger").DirectLogger)("DirectGraphQLSubscription", e);
        ...
        c.$DirectGraphQLSubscription4 = function() {
            var a = Object.keys(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES);
            for (var b = 0; b < a.length; b++) {
                var c = a[b];
                d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES[c] !== d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE && d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES[c] !== d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE && d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES[c] !== d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION && !this.$DirectGraphQLSubscription5(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES[c]) && this.$DirectGraphQLSubscription2.debugTrace("invalid_handler_type")
            }
        };
        c.getSubTopics = function() {
            var a = [];
            for (var b = this.$DirectGraphQLSubscription3, c = Array.isArray(b), d = 0, b = c ? b : b[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var e;
                if (c) {
                    if (d >= b.length) break;
                    e = b[d++]
        ...
        c.processMessage = function(b) {
            for (var c = this.$DirectGraphQLSubscription3, d = Array.isArray(c), e = 0, c = d ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var f;
                if (d) {
                    if (e >= c.length) break;
                    f = c[e++]
        ...
        c.enableOrDisableEventHandlerByType = function(a, b) {
            b ? this.$DirectGraphQLSubscription5(a) || this.$DirectGraphQLSubscription2.debugTrace("invalid_handler_type") : this.$DirectGraphQLSubscription3["delete"](a);
            return this
        };
        c.$DirectGraphQLSubscription5 = function(a) {
            this.$DirectGraphQLSubscription3 || (this.$DirectGraphQLSubscription3 = new Map());
        ...
        c.$DirectGraphQLSubscription6 = function(a) {
            switch (a) {
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE:
                    return new(d("PolarisPresenceGraphQLEventHandler").PresenceGraphQLEventHandler)(this.$DirectGraphQLSubscription1, this.$DirectGraphQLSubscription2.getDebugId());
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.BD_CHALLENGE:
                    return new(d("PolarisBdChallengeGraphQLEventHandler").BdChallengeGraphQLEventHandler)(this.$DirectGraphQLSubscription2.getDebugId());
                default:
                    return null
            }
        };
        c.enableLiveEventHandler = function(a, b, c) {
            switch (c) {
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE:
                    this.$DirectGraphQLSubscription3.set(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE, new(d("PolarisWaveGraphQLEventHandler").WaveGraphQLEventHandler)(b, a));
                    return this;
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION:
                    this.$DirectGraphQLSubscription3.set(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION, new(d("PolarisPinnedQuestionGraphQLEventHandler").PinnedQuestionGraphQLEventHandler)(b, a));
                    return this;
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.QUESTION_STATUS:
                    this.$DirectGraphQLSubscription3.set(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.QUESTION_STATUS, new(d("PolarisQuestionStatusGraphQLEventHandler").QuestionStatusGraphQLEventHandler)(b, a));
                    return this;
                default:
                    return this
            }
        ...
        c.disableLiveEventHandler = function(a) {
            switch (a) {
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE:
                    this.$DirectGraphQLSubscription3["delete"](d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE);
                    return this;
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION:
                    this.$DirectGraphQLSubscription3["delete"](d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PINNED_QUESTION);
                    return this;
                case d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.QUESTION_STATUS:
                    this.$DirectGraphQLSubscription3["delete"](d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.QUESTION_STATUS);
                    return this;
                default:
                    return this
            }
        ...
        c.unsubscribeGraphQL = function() {
            this.unsubscribe(), this.enableOrDisableEventHandlerByType(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE, !1), this.enableOrDisableEventHandlerByType(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.WAVE, !1)
        };
        return b
    }(d("PolarisDirectBaseSubscription").DirectBaseSubscription);
    g.DirectGraphQLSubscription = a
}, 98);
__d("PolarisDirectIrisSubscription", ["PolarisDirectLogger", "Polarisunexpected", "isObject"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 1,
        i = 2,
        j = 1e3,
    ...
    a = function() {
        function a(a, b, e, f) {
            var g = this;
            this.$7 = function() {
                g.$6.logDirectClientEvent("ig_direct_iris_subscription", d("PolarisDirectLogger").DIRECT_CONTAINER_MODULES.ig_direct_realtime, babelHelpers["extends"]({}, g.$2, {
                    action: "attempt",
            ...
            this.$8 = function(a) {
                var b;
                if (typeof a === "string" || a instanceof String) try {
                    b = JSON.parse(a)
                } catch (a) {
                    ...
                    b = a
                } else c("isObject")(a) ? b = a : (c("Polarisunexpected")("Unknown sub iris response $(response)"), b = {
                    succeeded: !1
                });
                if (b.succeeded === !0) g.$6.logDirectClientEvent("ig_direct_iris_subscription", d("PolarisDirectLogger").DIRECT_CONTAINER_MODULES.ig_direct_realtime, babelHelpers["extends"]({}, g.$2, {
                    action: "success"
                })), g.$1.onIrisConnectivityChanged("Subscribed", g.$2.subscription_type);
                else {
                    g.$6.logDirectClientEvent("ig_direct_iris_subscription", d("PolarisDirectLogger").DIRECT_CONTAINER_MODULES.ig_direct_realtime, babelHelpers["extends"]({}, g.$2, b, {
                        action: "error"
                    }));
                    g.$1.onIrisConnectivityChanged("Unsubscribed");
            ...
            this.$6 = new(d("PolarisDirectLogger").DirectLogger)("DirectIrisSubscription", f);
        ...
        var b = a.prototype;
        b.subscribe = function() {
            this.$6.debugTrace("subscribe_start"), this.unsubscribe(), this.$3.subscribe("/ig_sub_iris_response", this.$8), this.$7(), this.$6.debugTrace("subscribe_end")
        };
        b.unsubscribe = function() {
            this.$6.debugTrace("unsubscribe_start"), this.$5 && (window.clearTimeout(this.$5), this.$5 = null), this.$3.unsubscribe("/ig_sub_iris_response"), this.$1.onIrisConnectivityChanged("Unsubscribed"), this.$6.debugTrace("unsubscribe_end")
        };
        return a
    }();
    g.DirectIrisSubscription = a
}, 98);
__d("PolarisDirectSkywalkerSubscription", ["PolarisConfig", "PolarisDirectBaseSubscription", "PolarisDirectLogger", "nullthrows"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = "/pubsub";
    a = function(a) {
        babelHelpers.inheritsLoose(b, a);
        ...
        function b(b, e, f) {
            f = new(d("PolarisDirectLogger").DirectLogger)("DirectSkywalkerSubscription", f);
            e = a.call(this, h, ["ig/u/v1/" + c("nullthrows")(d("PolarisConfig").getViewerId())], e, f) || this;
        ...
        e.parsePayload = function(b) {
            if (b.indexOf("/activity_indicator_id/") === -1) {
                this.$DirectSkywalkerSubscription2.debugTrace("not_activity_indicator_message");
                return null
            }
        ...
        e.processMessage = function(b) {
            ...
            if (!Array.isArray(c)) {
                this.$DirectSkywalkerSubscription2.debugTrace("parsed_message_bad_data", typeof c);
                return
            }
            for (var d = c, c = Array.isArray(d), e = 0, d = c ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var f;
                if (c) {
                    if (e >= d.length) break;
                    f = d[e++]
...
__d("PolarisLiveDeltaHandler", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function(a) {
        this.eventHandler = a
    };
...
__d("PolarisChannelClientID", ["uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = c("uuid")();
    a = {
        getID: function() {
...
__d("PolarisMqttEnv", [], function(a, b, c, d, e, f) {
    "use strict";
    a = Object.freeze({
        mqtt_ep_with_sid: 0,
    ...
    var g = function() {
        ...
        b.eventLogConnect = function(a) {
            a.sessionID, a.connectionStatus, a.duration, a.hostname, a.attemptNumber, a.failTotal, a.successTotal, a.subscribedTopics, a.publishes, a.errorCode, a.errorMessage
        };
        b.eventLogPull = function(a) {
            a.pullEventName, a.sessionID, a.status, a.duration, a.hostname, a.errorMessage
        };
        b.eventLogDisconnect = function(a) {
            a.sessionID, a.errorCode, a.errorMessage, a.duration
        };
        b.eventLogPublish = function(a) {
            a.sessionID, a.topic, a.connectionStatus, a.publishStatus
        };
...
__d("PolarisIrisSubscribeChecker", ["PolarisMqttEnv"], function(a, b, c, d, e, f) {
    "use strict";
...
__d("PolarisMqttAnalyticsHook", ["PolarisMqttEnv", "PolarisODS"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a() {
            this.$1 = c("PolarisMqttEnv").Env.getLoggerInstance(), this.$2 = 0, this.$3 = 0, this.$4 = 0, this.$5 = 0, c("PolarisODS").incr("web.mqtt.session_start"), c("PolarisMqttEnv").Env.isUserLoggedInNow() || c("PolarisODS").incr("web.mqtt.session_start.logout")
        }
        var b = a.prototype;
        b.onConnectAttempt = function() {
        ...
        b.onConnectSuccess = function() {
            this.$2 === 0 && c("PolarisODS").incr("web.mqtt.ws_connect_first_success"), this.$2++, c("PolarisODS").incr("web.mqtt.ws_connect_success")
        };
        b.onConnectionLost = function() {
        ...
        b.onPollRequestSuccess = function() {
            c("PolarisODS").incr("web.mqtt.polling_request_succeed"), this.$4 === 0 && c("PolarisODS").incr("web.mqtt.polling_first_success"), this.$4++
        };
...
__d("PolarisMqttConnectionHookCollection", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function() {
        function a() {
            this.$1 = new Set()
...
__d("PolarisMqttProtocolUtils", ["PolarisMqttEnv"], function(a, b, c, d, e, f) {
    "use strict";
    var g = b("PolarisMqttEnv").Env;
    ...
    b = function() {
        ...
        b.$6 = function() {
            var a = this;
            this.$3 ? (this.$3 = !1, this.$4(), this.$2 = g.setTimeout(function() {
                a.$6()
            }, this.$1)) : this.$5()
        };
        b.reset = function() {
...
__d("PolarisMqttUtils", ["PolarisMqttEnv"], function(a, b, c, d, e, f) {
    "use strict";
    var g = b("PolarisMqttEnv").Env,
        h = b("PolarisMqttEnv").MqttGkNames;
    c = {
        endpointWithSessionId: function(a, b) {
            return !g.genGk(h.mqtt_ep_with_sid) ? a : this.endpointWithExtraParameter(a, "sid", b.toString())
        },
        ...
        endpointWithExtraParameter: function(a, b, c) {
            return a.indexOf("?") > 0 ? a + "&" + b + "=" + c : a + "?" + b + "=" + c
        },
...
__d("PolarisMqttProtocolCodec", ["PolarisMqttProtocolUtils", "PolarisMqttUtils"], function(a, b, c, d, e, f) {
    "use strict";
    ...
    var w = function() {
        ...
        x = function(b) {
            ...
            c.encode = function() {
                ...
                this.messageIdentifier != null && (a = n(this.messageIdentifier, f, a));
                f.set(d, a);
                return c
            };
            return a
...
__d("PolarisMqttTypes", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function(a, b) {
...
__d("PolarisMqttProtocolClient", ["PolarisMqttEnv", "PolarisMqttProtocolCodec", "PolarisMqttProtocolUtils", "PolarisMqttTypes"], function(a, b, c, d, e, f) {
    "use strict";
    var g = b("PolarisMqttEnv").Env,
    ...
    d = function() {
                ...
                switch (a.messageType) {
                    ...
                    case h.PUBLISH:
                        if (a instanceof i.Publish) {
                            var d = a;
                            g.scheduleCallback(function() {
                                b.$2.onMessageArrived(d.topic, d.payloadMessage.payloadString)
                            });
                    ...
                    case h.UNSUBACK:
                        ...
                        break;
                    default:
                        b.$9.logError(new Error("MqttProtocolClient: Received unhandled message type: " + a.messageType), "Received unhandled message type");
        ...
        b.connect = function(a) {
            ...
            this.$7 = g.setTimeout(function() {
                b.$9.bumpCounter("protocol.error.connect.timeout"), b.$11(q.CONNECT_TIMEOUT)
            }, o * 1e3);
            ...
            this.$6.onmessage = function(a) {
                ...
                try {
                    a = new Uint8Array(a);
                    b.$10 != null && (a = m(b.$10, a), b.$9.bumpCounter("protocol.debug.usingMessagesBuffer"), delete b.$10, b.$10 = null);
                    a = k(a);
                    var c = a.messages;
                    b.$10 = a.remaining;
                    for (var a = 0; a < c.length; a++) b.handleMessage(c[a])
                } catch (a) {
                    b.$10 = null, b.$9.logError(a, q.SOCKET_MESSAGE.errorMessage), b.$9.bumpCounter("protocol.error.onmessage.parse"), b.$11(q.SOCKET_MESSAGE)
                }
            };
            ...
            this.$8 = new l(a.keepAliveInterval, this.$12.bind(this, new i.Ping("PINGREQ")), this.$11.bind(this, q.PING_TIMEOUT))
        };
        b.$13 = function() {
            this.setConnected(!1), this.$8 != null && this.$8.cancel(), this.$7 != null && (g.clearTimeout(this.$7), this.$7 = null), this.$6 != null && (this.$6.onopen = function(a) {}, this.$6.onmessage = function(a) {}, this.$6.onerror = function(a) {}, this.$6.onclose = function(a) {}, this.$6.readyState === this.$6.OPEN && this.$6.close(), delete this.$6, this.$6 = null), this.$2.onConnectSuccess = function() {}, this.$2.onConnectFailure = function(a) {}, this.$2.onConnection = function() {}, this.$2.onConnectionError = function(a) {}, this.$2.onConnectionLost = function(a) {}, this.$2.onMessageArrived = function(a, b) {}, this.$2.onMessageDelivered = function(a, b) {}
        };
...
__d("PolarisMqttUserName", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function() {
        function a(a, b, c, d, e, f, g) {
            this.$1 = a, this.$2 = b, this.$3 = c, this.$4 = d, this.$5 = e, this.$6 = f, this.$8 = g, this.$7 = typeof document === "object" && document && document.hasFocus()
        }
        var b = a.prototype;
...
__d("PolarisMqttConnection", ["PolarisMqttConnectionHookCollection", "PolarisMqttEnv", "PolarisMqttProtocolClient", "PolarisMqttTypes", "PolarisMqttUserName", "PolarisMqttUtils", "PolarisODS", "Promise"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 10,
        i = "publish",
        j = "subscribe",
    ...
    a = function() {
        function a(a, b) {
            ...
            this.$38 = function(a, b) {
                try {
                    ...
                    c("PolarisODS").incr("web.mqtt.js_error_in_error_logging"), d.$10.logError(a, "JS error while trying to log previous error")
                }
            };
            this.$8 = !1;
        ...
        d.shutdown = function() {
            this.$22(), this.$23("shutdown"), this.$8 = !1, this.$10.debugTrace("shutdown", "Shutdown")
        };
        ...
        d.publish = function(a, c, d) {
            ...
            if (!g) h = "connection_not_connected", e.reject(new Error("Client disconnected"));
            else {
                c = this.$25(a, c, d, e);
        ...
        d.ensureConnected = function(a) {
            if (!this.$8) {
                this.$10.debugTrace("ensureConnected", "Mqtt connection: " + a + " called when not running");
                return !1
            }
            if (this.$7 == null) {
                this.$10.debugTrace("ensureConnected", "Mqtt connection: " + a + " called when not connected, ignored");
                return !1
            }
            var b = this.$7.isConnected();
            if (!b) {
                this.$10.debugTrace("ensureConnected", "Mqtt connection: " + a + " called with client not connected");
                return !1
            }
            return !0
        };
        ...
        d.$20 = function() {
            var a = this;
            c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_send_unload_event) && typeof window !== "undefined" && window.addEventListener("unload", function(b) {
                return a.$27(b)
            })
        };
        d.$27 = function(a) {
        ...
        d.$22 = function() {
            this.$8 && this.$7 != null && (this.$28("Disconnected"), this.$7 != null && this.$7.disconnect(), this.$7 = null)
        };
        d.$28 = function(a) {
        ...
        d.$21 = function() {
            ...
            try {
                ...
                }), c("PolarisODS").incr("web.mqtt.protocol.connectattempt"), this.$19.onConnectAttempt())
            } catch (a) {
                c("PolarisODS").incr("web.mqtt.js_error_in_init_exception"), this.$28("Disconnected"), this.$37(!1, b, d, [], 14, a.message), a && this.$10.logErrorWarn(a, "ws_js_error"), this.$19.onWSFatal(), this.$38(new(c("PolarisMqttTypes").MqttChannelError)(!1, "ws_js_error", a), "client_init")
            }
        };
        d.$29 = function() {
            var a = this.$4(),
        ...
        d.$24 = function(a) {
            try {
                ...
                this.$10.logError(a, "Exception subscribing"), c("PolarisODS").incr("web.mqtt.subscribe_exception"), c("PolarisODS").incr("web.mqtt.protocol.subscribe.error")
            }
            return !1
        };
        d.$26 = function(a) {
            try {
                ...
                this.$10.logError(a, "Exception unsubscribing"), c("PolarisODS").incr("web.mqtt.unsubscribe_exception"), c("PolarisODS").incr("web.mqtt.protocol.unsubscribe.error")
            }
            return !1
        };
        d.$25 = function(a, b, d, e) {
            if (this.$7 != null) try {
                ...
                var f = b != null ? b : "null";
                this.$10.debugTrace("_doPublish", "publish " + a + " with messageId:" + f + " qos:" + d);
                this.$19.onPublish(a);
        ...
        d.$39 = function(a) {
            ...
            this.$9 = -1;
            this.$13 = 0;
            a = a != null ? a : Math.pow(2, Math.min(this.$12, 6)) * (1e3 + c("PolarisMqttEnv").Env.random() * 200);
        ...
        d.$40 = function() {
            if (!c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_ws_reconnect_reset)) return;
            var a = Date.now() - this.$13,
                b = this.$13 !== 0 && a > n,
                d = this.$12 > o;
            (b || d) && (this.$12 = 0);
            this.$13 !== 0 && a <= n && c("PolarisODS").incr("web.mqtt.short_lived_session");
            d && c("PolarisODS").incr("web.mqtt.connection_attempt_limit")
        };
        d.$37 = function(a, b, c, d, e, f) {
            a === !0 ? this.$18++ : this.$17++, this.$10.eventLogConnect({
                sessionID: this.$9,
                connectionStatus: a,
                duration: Date.now() - b,
                hostname: this.$5,
        ...
        d.$31 = function(a, b, d) {
            c("PolarisODS").incr("web.mqtt.protocol.onconnectsuccess"), this.$10.debugTrace("connect", "Connect success"), this.$19.onConnectSuccess(), this.$37(!0, a, b, d), this.$28("Connected"), this.$41(b), c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_ws_reconnect_reset) || (this.$12 = 0), this.$13 = Date.now()
        };
        d.$34 = function(a) {
            c("PolarisODS").incr("web.mqtt.protocol.onconnectionlost"), a.errorCode && this.$10.eventLogDisconnect({
                sessionID: this.$9,
                errorCode: a.errorCode,
                errorMessage: a.errorMessage,
                duration: Date.now() - this.$13
            }), this.$10.debugTrace("connect", "connection lost"), this.$19.onConnectionLost(), this.$39()
        };
        d.$33 = function(a) {};
        d.$35 = function(a, b) {
            ...
            try {
                ...
                this.$10.logError(a, "Listener threw error"), c("PolarisODS").incr("web.mqtt.listener_error")
            }
        };
        d.$36 = function(a, b) {
...
__d("PolarisMqttChannel", ["PolarisChannelClientID", "PolarisIrisSubscribeChecker", "PolarisMqttAnalyticsHook", "PolarisMqttConnection", "PolarisMqttEnv", "PolarisMqttUserName", "PolarisMqttUtils", "PolarisODS", "Promise", "uuid"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 60 * 1e3;
    a = function() {
        function a(a) {
            ...
            this.$8.setAppId(d);
            this.$9 = new(c("PolarisMqttUserName"))(a, e, g, c("PolarisChannelClientID").getID(), d, f, j);
            this.$1 = i;
            this.$5 = "Disconnected";
            this.$2 = [l];
            this.$4 = new Set();
            ...
            this.$7.addHook(new(c("PolarisIrisSubscribeChecker"))(function() {
                return b.$4.size > 0
            }));
            this.$10 = !1;
            this.$12 = new Map();
        ...
        d.$14 = function(a) {
            ...
            if (c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_ws_polling_enabled))
                if (c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_ws_forced_polling_only)) {
                    this.$15("MqttChannel", "Websocket disabled, will do long polling only");
                    return
                } else if (!c("PolarisMqttUtils").hasWSSupport()) {
                this.$15("MqttChannel", "Websocket Unavailable, will do long polling only");
        ...
        d.$21 = function(a, d, e) {
            ...
            e.skipBuffer ? this.$7.connectionState() === "Connecting" ? this.$11.push(a) : this.$22(a) : (a.timeoutId = this.$23(h), this.$12.set(h, a), this.$24(a));
            return g
        };
        d.$22 = function(a) {
            c("PolarisMqttUtils").promiseDone(this.$7.publish(a.topic, a.payload, a.options.qos), function() {
                a.ack.resolve()
            }, function(b) {
                a.ack.reject(b)
            })
        ...
        d.$26 = function(a) {
            var b = this.$12.get(a);
            b != null && b.timeoutId != null && c("PolarisMqttEnv").Env.clearTimeout(b.timeoutId);
            this.$12["delete"](a)
        };
        d.$23 = function(a) {
            var b = this;
            a = c("PolarisMqttEnv").Env.setTimeout(function(a) {
                var d = b.$12.get(a);
                if (!d) return;
                var e = d.topic;
                c("PolarisODS").incr("web.mqtt.publish_timeout");
                b.$8.debugTrace("publish_timeout", "Timeout publishing topic: " + e + " publishToken: " + a);
                b.$26(a);
        ...
        d.$25 = function(a) {
            ...
            this.$26(b);
            a.ack.resolve();
            this.$8.debugTrace("publish_success", "Topic: " + a.topic + " publishToken: " + a.publishToken);
            c("PolarisODS").incr("web.mqtt.publish_success")
        };
        d.$18 = function(a, b) {
            var d = this.$6.get(a);
            if (!d) this.$8.debugTrace("_onMessageReceived", a + " being dropped, no listeners");
            else
                for (var a = d, d = Array.isArray(a), e = 0, a = d ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                    var f;
                    if (d) {
                        if (e >= a.length) break;
                        f = a[e++]
                    ...
                    try {
                        ...
                        this.$8.logError(a, "Listener exception"), c("PolarisODS").incr("web.mqtt.listener_error")
                    }
                }
        };
        d.$17 = function(a) {
            if (c("PolarisMqttEnv").Env.genGk(c("PolarisMqttEnv").MqttGkNames.mqtt_ws_polling_enabled)) {
                a.isRecoverable ? c("PolarisODS").incr("web.mqtt.recoverable_error_skipped") : c("PolarisODS").incr("web.mqtt.unrecoverable_error_skipped");
                return
            }
            a.isRecoverable ? c("PolarisODS").incr("web.mqtt.recoverable_error_not_skipped") : c("PolarisODS").incr("web.mqtt.unrecoverable_error_not_skipped");
        ...
        d.$16 = function(a) {
            var b = this;
            a === "Connecting" ? (this.$11.forEach(function(a) {
                a.ack.reject(new Error("Client Reconnecting"))
            }), this.$11 = []) : a === "TransportConnected" && (this.$11.forEach(function(a) {
                b.$22(a)
            }), this.$11 = [], this.$12.forEach(function(a, c, d) {
                b.$24(a)
            }));
            this.$5 = this.$28(a);
        ...
        d.$19 = function() {
            ...
            this.$4.forEach(function(d) {
                try {
                    ...
                    a.$8.logError(b, "ConnectPayload provider exception"), c("PolarisODS").incr("web.mqtt.connectPayloadProvider_error")
                }
            });
            return b
        };
...
__d("PolarisMqttLogger", ["PolarisChannelClientID", "PolarisDirectLogger", "PolarisMqttEnv", "PolarisODS"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = "mqtt_client";
    var h = null,
        i = new(d("PolarisDirectLogger").DirectLogger)(a, c("PolarisChannelClientID").getID()),
        j = {
    ...
    b = function() {
        ...
        function a() {
            this.$1 = 0, this.$2 = Date.now(), this.$3 = c("PolarisChannelClientID").getID()
        }
        var b = a.prototype;
        b.setAppId = function(a) {
            this.$1 === 0 && (this.$1 = a)
        ...
        b.eventLogConnect = function(a) {
            ...
            a.failTotal;
            a.successTotal;
            var h = a.subscribedTopics,
                i = a.publishes,
                k = a.errorCode;
            a = a.errorMessage;
            d ? c("PolarisODS").incr("web.mqtt.mqtt_client_connect.success") : c("PolarisODS").incr("web.mqtt.mqtt_client_connect.failed");
            b = {
                device_id: this.$3,
                session_id: b,
        ...
        b.$4 = function(a, b) {
            var d = this;
            c("PolarisMqttEnv").Env.scheduleLoggingCallback(function() {
                b.event_type = a, b.app_id = d.$1, b.online = d.$5(), i.logDirectEvent(a, b)
            })
        };
        b.$5 = function() {
...
__d("PolarisMqttEnvInitializer", ["PolarisConfig", "PolarisMqttEnv", "PolarisMqttLogger", "PolarisWebStorage", "PolarissetTimeoutAcrossTransitions"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = "mqtt:";
    a = {
        initialize: function() {
            d("PolarisMqttEnv").Env.initialize(null, d("PolarisConfig").isLoggedIn, null, c("PolarissetTimeoutAcrossTransitions"), function() {
                return c("PolarisMqttLogger").getInstance()
            }, null, null, null, null, function(a, b) {
...
__d("PolarisDirectMQTT", ["PolarisBaseGraphQLEventHandler", "PolarisCallGatingHelpers", "PolarisConfig", "PolarisDeviceOrMachineId", "PolarisDirectConstants", "PolarisDirectDeltaHandlers", "PolarisDirectGraphQLSubscription", "PolarisDirectIrisSubscription", "PolarisDirectLogger", "PolarisDirectSkywalkerSubscription", "PolarisLiveDeltaHandler", "PolarisMqttChannel", "PolarisMqttEnvInitializer", "PolarisODS", "PolarisarraySplitChunks", "PolarisdeveloperSettings", "PolarisforEachAsync", "PolarisgenerateOfflineThreadingId", "nullthrows", "randomInt", "react-redux-wwwig"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 20;
    a = function() {
        function a(a, b) {
            ...
            this.$14 = function(a) {
                ...
                if (a.type === 4 && a.conferenceName.includes("ROOM")) {
                    var d, f;
                    d = ((d = b.payload.body) == null ? void 0 : (d = d.ringRequest) == null ? void 0 : d.ringType) % 2 === 1;
                    f = (f = b.payload.body) == null ? void 0 : (f = f.ringRequest) == null ? void 0 : (f = f.appMessages) == null ? void 0 : f.find(function(a) {
                    ...
                    var g = "",
                        ...
                        j = [];
                    if (f) {
                        f = JSON.parse(f == null ? void 0 : (f = f.body) == null ? void 0 : (f = f.genericMessage) == null ? void 0 : f.data);
                    ...
                    e.$15(a.conferenceName, a.sequenceNumber, a.serverInfoData, a.transactionId, a.type, a.conferenceType)
                } else a.type === 5 && a.conferenceName.includes("ROOM") ? (e.$6(a.type, a.serverInfoData, "", !1, "", [], ""), c("PolarisODS").incr("web.rtc.ack_dismiss_message"), e.$15(a.conferenceName, a.sequenceNumber, a.serverInfoData, a.transactionId, a.type, a.conferenceType)) : c("PolarisODS").incr("web.rtc.rtc_message_ignored")
            };
            this.$15 = function(a, b, d, f, g, h) {
                ...
                c("nullthrows")(e.$5).publish("/rtc_multi", JSON.stringify(i))["catch"](function(a) {
                    var b;
                    g === 4 ? c("PolarisODS").incr("web.rtc.ack_ring_message_failed") : g === 5 ? c("PolarisODS").incr("web.rtc.ack_dismiss_message_failed") : c("PolarisODS").incr("web.rtc.ack_message_failed");
                    b = (b = (b = e.$5) == null ? void 0 : b.getConnectionState()) != null ? b : "Unknown";
            ...
            this.$16 = function(a) {
                ...
                c("PolarisforEachAsync")(c("PolarisarraySplitChunks")(f, h), function(a) {
                    d("react-redux-wwwig").batch(function() {
                        for (var c = a, d = Array.isArray(c), f = 0, c = d ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                            var g;
                            if (d) {
                                if (f >= c.length) break;
                                g = c[f++]
                            ...
                            if (i !== "patch") {
                                e.$4.debugTrace("skipped_message", {
                                    event: i
                                });
                                return
                            }
                            ...
                            for (var i = h, h = Array.isArray(i), k = 0, i = h ? i : i[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                                var l;
                                if (h) {
                                    if (k >= i.length) break;
                                    l = i[k++]
            ...
            this.$17 = function(a) {
                try {
                    ...
                    if (a.status === "ok") {
                        var b;
                        (a == null ? void 0 : (b = a.payload) == null ? void 0 : b.activity_status) == null ? e.$4.logDirectEvent("send_message_response_success") : e.$4.logDirectEvent("send_activity_response_success")
                    } else {
                        (a == null ? void 0 : (b = a.payload) == null ? void 0 : b.activity_status) == null ? e.$4.logError("send_message_response_failed") : e.$4.logDirectEvent("send_activity_response_failed")
                    }
                } catch (a) {
            ...
            this.$18 = function(a) {
                ...
                if (a === "Connected") {
                    ...
                    d("PolarisCallGatingHelpers").isIncomingCallEnabled() && !d("PolarisCallGatingHelpers").isZenonIncomingRingEnabled() && f.subscribe("/pubsub", e.$14);
                    e.$3 || (e.$3 = new(d("PolarisDirectIrisSubscription").DirectIrisSubscription)(b, e.$2, f, e.$4.getDebugId()));
                    e.$3.subscribe();
                    e.$10 || (e.$10 = new(d("PolarisDirectGraphQLSubscription").DirectGraphQLSubscription)(b, f, e.$4.getDebugId()));
                    e.$2.subscription_type === "message" ? (e.$9 || (e.$9 = new(d("PolarisDirectSkywalkerSubscription").DirectSkywalkerSubscription)(b, f, e.$4.getDebugId())), e.$9.subscribe(), e.$10 && e.$10.enableOrDisableEventHandlerByType(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE, !0)) : (e.$4.debugTrace("skip_skywalker", e.$2), e.$10 && e.$10.enableOrDisableEventHandlerByType(d("PolarisBaseGraphQLEventHandler").GRAPH_QL_EVENT_TYPES.PRESENCE, !1));
                    e.$10 && e.$10.subscribe()
                    ...
                    f = e.$5;
                    f && (f.unsubscribe("/ig_message_sync"), f.unsubscribe("/ig_send_message_response"), d("PolarisCallGatingHelpers").isIncomingCallEnabled() && !d("PolarisCallGatingHelpers").isZenonIncomingRingEnabled() && f.unsubscribe("/pubsub"))
                }
            ...
            this.$19 = function(a) {
                ...
                return c("nullthrows")(e.$5).publish("/ig_send_message", JSON.stringify(babelHelpers["extends"]({
        ...
        b.sendRtcHangupRequest = function(a) {
            ...
            return c("nullthrows")(this.$5).publish("/rtc_multi", JSON.stringify(a))["catch"](function(a) {
