!(function (t, n, e) {
  ...
  for (
    var i = "function" == typeof __nr_require && __nr_require, o = 0;
    o < e.length;
    o++
  )
    r(e[o]);
...
})(
  {
      ...
      function (t, n, e) {
        ...
        n.exports = function (t, n) {
          return "addEventListener" in window
            ? window.addEventListener(t, n, r(!1))
    ...
    2: [
      function (t, n, e) {
        ...
        function c(t, n) {
          return n
            ? (n.c || (n = f(n.t)),
              (n.min = Math.min(t.min, n.min)),
              (n.max = Math.max(t.max, n.max)),
              (n.t += t.t),
              (n.sos += t.sos),
              (n.c += t.c),
              n)
        ...
        function d(t, n, e, r) {
          ...
          var i = g[t][n];
          return (
            i || ((i = g[t][n] = { params: e || {} }), r && (i.custom = r)), i
          );
        }
        function l(t, n) {
        ...
        function h(t) {
          for (var n = {}, e = "", r = !1, i = 0; i < t.length; i++)
            (e = t[i]), (n[e] = p(g[e])), n[e].length && (r = !0), delete g[e];
          return r ? n : null;
        }
        function p(t) {
        ...
        var v = t(52),
          g = {};
        n.exports = { store: i, storeMetric: r, take: h, get: l, merge: u };
      },
      {},
    ],
    3: [
      function (t, n, e) {
        ...
        function o(t, n, e) {
          "string" == typeof n &&
            ("/" !== n.charAt(0) && (n = "/" + n),
            (g.customTransaction = (e || "http://custom.transaction") + n));
        }
        function a(t, n) {
          var e = n ? n - g.offset : t;
          w.recordCustom("finished", { time: e }),
            s(t, { name: "finished", start: e + g.offset, origin: "nr" }),
        ...
        l.on("jserrors", function () {
          return { body: h.take(["cm", "sm"]) };
        }),
          d("storeMetric", r, "api"),
          d("storeEventMetrics", i, "api");
        var E = {
          finished: p(a),
          setPageViewName: o,
          setErrorHandler: c,
        ...
        function o() {
          function t(t) {
            return "undefined" == typeof t || "" === t
              ? ""
              : ((t = String(t)),
                f.shouldObfuscate() && (t = f.obfuscateString(t)),
                d.call(n, t) ? i(n[t], !0) : ((n[t] = e++), s(t)));
          }
      ...
      function (t, n, e) {
        ...
        function i(t) {
          return null === t || void 0 === t
            ? "null"
            : encodeURIComponent(t).replace(l, r);
        }
        function o(t, n) {
    ...
    9: [
      function (t, n, e) {
        ...
        var i = t(10),
          o = t(25);
        (n.exports = r),
          (r.prototype.startTimer = function (t, n) {
            (this.interval = t),
              (this.started = !0),
              this.scheduleHarvest(null != n ? n : this.interval);
          }),
            ...
            if (this.opts.getPayload) {
              ...
              if (s) {
                ...
                for (var u = 0; u < s.length; u++)
                  i.send(this.endpoint, this.loader, s[u], t, r, n);
              }
          ...
          (r.prototype.onHarvestFinished = function (t, n) {
            if (
              (this.opts.onFinished && this.opts.onFinished(n),
              n.sent && n.retry)
            ) {
              ...
              this.started && e
                ? (clearTimeout(this.timeoutHandle),
                  (this.timeoutHandle = null),
                  this.scheduleHarvest(e, t))
                : !this.started && e && this.scheduleHarvest(e, t);
            }
          });
      },
      {},
    ...
    10: [
      function (t, n, e) {
        function r(t) {
          if (t.info.beacon) {
            t.info.queueTime &&
              S.store("measures", "qt", { value: t.info.queueTime }),
              t.info.applicationTime &&
                S.store("measures", "ap", { value: t.info.applicationTime }),
              j.measure("be", "starttime", "firstbyte"),
              j.measure("fe", "firstbyte", "onload"),
              j.measure("dc", "firstbyte", "domContent");
            var n = S.get("measures"),
              e = y(n, function (t, n) {
            ...
            if (e) {
              ...
              if (
                (i.push(e),
                i.push(w.param("tt", t.info.ttGuid)),
                i.push(w.param("us", t.info.user)),
                i.push(w.param("ac", t.info.account)),
                i.push(w.param("pr", t.info.product)),
                i.push(
                  w.param(
                    "af",
                    y(t.features, function (t) {
                      return t;
                    }).join(",")
                  )
                ),
                ...
                a &&
                  ...
                  a.forEach(function (t) {
                    !t.startTime ||
                      t.startTime <= 0 ||
                      ("first-paint" === t.name
                        ? i.push(w.param("fp", String(Math.floor(t.startTime))))
                        : "first-contentful-paint" === t.name &&
                          i.push(
                            w.param("fcp", String(Math.floor(t.startTime)))
                          ),
                      q(t.name, Math.floor(t.startTime)));
                  });
              }
              i.push(w.param("xx", t.info.extra)),
                i.push(w.param("ua", t.info.userAttributes)),
                i.push(w.param("at", t.info.atts));
              var s = b(t.info.jsAttributes);
              i.push(w.param("ja", "{}" === s ? null : s));
              var u = w.fromArray(i, t.maxBytes);
              T.jsonp(
                I +
                  "://" +
                  t.info.beacon +
        ...
        function s(t, n, e, r) {
          var i = d(t, e);
          if (!i) return !1;
          var o = { retry: i.method === T.xhr };
          return R.shouldObfuscate()
            ? c(t, n, a(t, o), e, i, r)
            : f(t, n, a(t, o), e, i, r);
        }
        function u(t, n, e, r, i, o) {
          ...
          var u = { body: a(), qs: s() },
            d = R.shouldObfuscate() ? c : f;
          return d(t, n, u, r, i, o);
        }
        function c(t, n, e, r, i, o) {
          return N(e, R.obfuscateString, "string", ["e"]), f(t, n, e, r, i, o);
        }
        function f(t, n, e, r, i, o) {
          ...
          var a =
            ...
            n.info.licenseKey +
            m(n);
          e.qs && (a += w.obj(e.qs, n.maxBytes)), i || (i = d(t, r));
          var s,
            u = i.method,
            c = i.useBody,
            f = a;
          ...
          return (
            l ||
              u !== T.beacon ||
              ((u = T.img), (l = u(a + w.obj(e.body, n.maxBytes)))),
            l
          );
        }
        function d(t, n) {
          ...
          if (n.needResponse) {
            if (!_) return !1;
            (r = !0), (e = T.xhr);
          } else if (n.unload) (r = P), (e = P ? T.beacon : T.img);
          else if (_) (r = !0), (e = T.xhr);
          else {
        ...
        function l(t) {
          return t.info.transactionName
            ? w.param("to", t.info.transactionName)
            : w.param("t", t.info.tNamePlain || "Unnamed Transaction");
        }
        function h(t, n) {
          var e = O[t] || (O[t] = []);
          e.push(n);
        ...
        function m(t) {
          ...
          var e = A(k.getLocation()),
            r = R.shouldObfuscate() ? R.obfuscateString(e) : e;
          return [
            "?a=" + t.info.applicationID,
            w.param("sa", t.info.sa ? "" + t.info.sa : ""),
            w.param("v", M),
            l(t),
            w.param("ct", t.customTransaction),
            "&rst=" + t.now(),
            "&ck=" + (n ? "1" : "0"),
            w.param("ref", r),
            w.param("ptid", t.ptid ? "" + t.ptid : ""),
          ].join("");
        }
        function v() {
          var t = {},
        ...
        var g = t(21),
          ...
          A = t(5),
          R = t(16),
          N = t(27).applyFnToProps,
          M = "1216.487a282",
          U = "NREUM.setToken",
          O = {},
          P = !!navigator.sendBeacon,
          F = C.getConfiguration("harvest.tooManyRequestsDelay") || 60,
          I = C.getConfiguration("ssl") === !1 ? "http" : "https",
          L = t(11),
          _ = L > 9 || 0 === L,
          q = t(17).addMetric,
          H = t(46);
    ...
    11: [
      function (t, n, e) {
        ...
        var i,
          o = r.getElementsByTagName("div").length;
        (i = 4 === o ? 6 : 3 === o ? 7 : 2 === o ? 8 : 1 === o ? 9 : 0),
          (n.exports = i);
      },
      {},
    ],
    12: [
      function (t, n, e) {
        ...
        var i = t(23),
          ...
          h = t(48),
          p = t(49);
        t(3), t(26).init(c, l.getConfiguration("page_view_timing"));
        var m =
          "undefined" == typeof window.NREUM.autorun || window.NREUM.autorun;
        (window.NREUM.setToken = u),
          6 === t(11) ? (c.maxBytes = 2e3) : (c.maxBytes = 3e4),
          (c.releaseIds = {}),
          o(r),
          s("mark", i.mark, "api"),
          i.mark("done"),
          ...
          setTimeout(function () {
            for (var t = 0; t < h.length; t++)
              p.recordSupportability("Framework/" + h[t] + "/Detected");
          }, 0);
      },
      {},
    ],
    ...
    16: [
      function (t, n, e) {
        ...
        function i() {
          var t = [],
            n = s.getConfiguration("obfuscate") || [];
          return (t = t.concat(n)), c.isFileProtocol() && t.push(f), t;
        }
        function o(t) {
          for (var n = !1, e = !1, r = 0; r < t.length; r++) {
            "regex" in t[r]
              ? "string" != typeof t[r].regex &&
                t[r].regex.constructor !== RegExp &&
                (console &&
                  console.warn &&
                  console.warn(
        ...
        var s = t(45),
          u = t(49),
          c = t(18),
          f = { regex: /^file:\/\/(.*)/, replacement: "file://OBFUSCATED" };
        r() && u.recordSupportability("Generic/Obfuscate/Detected"),
          r() && !o(i()) && u.recordSupportability("Generic/Obfuscate/Invalid"),
          (n.exports = {
            obfuscateString: a,
            shouldObfuscate: r,
            getRules: i,
    ...
    18: [
      function (t, n, e) {
        ...
        var i = t(29).getWindow,
          o = t(49),
          a = { isFileProtocol: r, supportabilityMetricSent: !1 };
        (n.exports = a),
          r() &&
            (o.recordSupportability("Generic/FileProtocol/Detected"),
            (a.supportabilityMetricSent = !0));
      },
      {},
    ],
    19: [
            ...
            if (0 === t[n].indexOf("NREUM=")) {
              for (
                var e,
                  ...
                  i,
                  o,
                  s = t[n].substring("NREUM=".length).split("&"),
                  u = 0;
                u < s.length;
                u++
              )
      ...
      function (t, n, e) {
        ...
        (r.jsonp = function i(t, i) {
          ...
          (r.xhr = function (t, n, e) {
            ...
            return (
              r.setRequestHeader("content-type", "text/plain"), r.send(n), r
            );
          }),
      ...
      function (t, n, e) {
        function r(t, n) {
          if (v(n)) {
            ...
            var c = new j(E, "events", { onFinished: d, getPayload: p });
            k("timing", f),
              k("lcp", o),
              k("cls", a),
              k("pageHide", s),
        ...
        function i() {
          if (!U && null !== O) {
            ...
            e &&
              (e["net-type"] && (r["net-type"] = e["net-type"]),
              e["net-etype"] && (r["net-etype"] = e["net-etype"]),
              e["net-rtt"] && (r["net-rtt"] = e["net-rtt"]),
              e["net-dlink"] && (r["net-dlink"] = e["net-dlink"])),
              t.url && (r.elUrl = A(t.url)),
              t.element && t.element.tagName && (r.elTag = t.element.tagName),
              (n > 0 || P) && (r.cls = n),
              c("lcp", Math.floor(t.startTime), r, !1),
              (U = !0);
          }
        }
        function o(t, n) {
        ...
        function a(t) {
          (t.startTime - I.lastEntryTime > 1e3 ||
            t.startTime - I.firstEntryTime > 5e3) &&
            (I = {
              value: 0,
            ...
            (I.value += t.value),
            (I.lastEntryTime = Math.max(I.lastEntryTime, t.startTime)),
            F < I.value && (F = I.value);
        }
        function s(t) {
          L || (c("pageHide", t, null, !0), (L = !0));
        }
        function u() {
        ...
        function p(t) {
          if (0 !== N.length) {
            var n = m(N);
            if (t.retry) for (var e = 0; e < N.length; e++) M.push(N[e]);
            return (N = []), { body: { e: n } };
          }
        }
        function m(t) {
          for (var n = x(), e = "bel.6;", r = 0; r < t.length; r++) {
            ...
            (e += "e,"),
              ...
              h(i);
            var o = w(i.attrs, n);
            o && o.length > 0 && (e += y(o.length) + ";" + o.join(";")),
              r + 1 < t.length && (e += ";");
          }
          return e;
        }
        ...
        var g = t(4).nullable,
          ...
          P = !1,
          F = 0,
          I = { value: 0, firstEntryTime: 0, lastEntryTime: 0 },
          L = !1;
        n.exports = {
          addTiming: c,
          getPayload: m,
    ...
    29: [
      function (t, n, e) {
        ...
        var a = window,
          s = a;
        n.exports = { getWindow: r, setWindow: i, resetWindow: o };
      },
      {},
    ],
    30: [
    ...
    31: [
      function (t, n, e) {
        ...
        function o(t, n) {
          var e = a(n);
          return e
            ? (f(e.func) ? (t.wrapperSeen = !0) : t.stackLines.push(n),
              t.wrapperSeen || t.frames.push(e),
              t)
            : (t.stackLines.push(n), t);
        }
        function a(t) {
          var n = t.match(v);
          return (
        ...
        function s(t) {
          ...
          var e = n + ": " + t.message + "\n    at " + t.sourceURL;
          return (
            t.line && ((e += ":" + t.line), t.column && (e += ":" + t.column)),
            {
              mode: "sourceline",
              name: n,
              message: t.message,
    ...
    33: [
      function (t, n, e) {
        function r(t) {
          ...
          return (
            "{}" !== r && (e.qs.ri = r),
            n && n.err && n.err.length && !M && ((e.qs.pve = "1"), (M = !0)),
            e
          );
        }
        function i(t) {
        ...
        function c(t) {
          for (var n = p(g.origin), e = 0; e < t.frames.length; e++) {
            ...
            o &&
              o !== r.url &&
              ((r.url = o), (t.stackString = t.stackString.split(i).join(o)));
          }
          return t;
        }
        function f(t, n, e, r) {
          ...
          if (((n = n || g.now()), e || !g.onerror || !g.onerror(t))) {
            ...
            a.message && (f.message = "" + a.message),
              x[f.stackHash]
                ...
                : ((x[f.stackHash] = !0), (f.stack_trace = R(a.stackString))),
              (f.releaseIds = S(g.releaseIds));
            var d = o(f);
            w[d] || ((f.pageview = 1), (w[d] = !0));
            var h = e ? "ierr" : "err",
              p = { time: n };
            if ((j("errorAgg", [h, d, f, p]), null != f._interactionId))
              (N[f._interactionId] = N[f._interactionId] || []),
                N[f._interactionId].push([h, d, f, p, b, r]);
            else {
              var y = {},
      ...
      function (t, n, e) {
        function r(t) {
          ...
          for (var r = 0; r < t.length; r++)
            (n = t.charCodeAt(r)), (e = (e << 5) - e + n), (e = 0 | e);
          return e;
        }
        n.exports = r;
      },
    ...
    35: [
      function (t, n, e) {
        ...
        function o(t, n, e) {
          ...
          if (!(b.length >= w)) {
            ...
            "undefined" != typeof window &&
              ...
              ((i = window.document.documentElement.clientWidth),
        ...
        document.referrer && (s = v(document.referrer)),
          h("api-setCustomAttribute", a, "api"),
          ...
          (l.finish = function () {
            ...
            if (!n.end) {
              ...
              this.onFinished && this.onFinished(this),
                o(a.info.jsAttributes, function (t, n) {
                  t in s || (s[t] = n);
                }),
                (n.end = e),
                i.emit("interaction", [this]);
            }
          });
      },
      {},
      ...
      function (t, n, e) {
        ...
        (a.child = function (t, n, e, o) {
          ...
          (a.callback = function (t, n) {
            var e = this;
            (e.jsTime += t),
              n > e.jsEnd && ((e.jsEnd = n), (e.interaction.lastCb = n));
          }),
          (a.cancel = function () {
            this.cancelled = !0;
    ...
    38: [
      function (t, n, e) {
        ...
        function i() {
          this.resolved || ((this.resolved = !0), (this[G] = it));
        }
        function o() {
          return it;
        }
        function a(t) {
          ut || t || !st || (t = st.root),
            it && it[$].checkFinish(tt, nt),
            (ot = it),
            (it = t && !t[$].root.end ? t : null);
        }
        function s(t) {
          t === st && (st = null);
          var n = t.root,
        ...
        function d(t) {
          return t.ignored || (!t.save && !t.routeChange)
            ? void w.emit("interactionDiscarded", [t])
            : ((t.root.attrs.id = U.generateUuid()),
              "initialPageLoad" === t.root.attrs.trigger &&
                ((t.root.attrs.firstPaint = O["first-paint"]),
                (t.root.attrs.firstContentfulPaint =
                  O["first-contentful-paint"])),
              w.emit("interactionSaved", [t]),
              lt.push(t),
              void pt.scheduleHarvest(0));
        }
        function l() {
          var t = F.getConfiguration("spa");
          return !t || t.enabled !== !1;
        }
        var h = t(19),
          p = t(44),
          m = t(42).shouldCollectEvent,
          v = t(10),
          g = t(9),
          y = t(39),
          x = t("loader"),
        ...
        (n.exports = function () {
          ...
          w.on("feat-spa", function () {
            ...
            function n() {
              ...
              (ct = this.ct + t),
                it &&
                  (it.callback(n, this[H]),
                  this.isTraced && (it.attrs.tracedTime = n)),
                (this.jsTime = it ? 0 : n),
                a(this.prevNode),
                (this.prevNode = null),
                (rt = _);
            ...
            if (l()) {
              (st = new P("initialPageLoad", 0, tt, nt, s)),
                (st.save = !0),
                (it = st.root),
                st[D]++,
                h.on(w, q, t),
              ...
              h("spa-register", function (t) {
                ...
                h.on(S, q, function (t, n) {
                  ...
                  else if (!it && L.indexOf(r) !== -1) {
                    var o = new P(r, this[q], tt, nt, s);
                    if ((a(o.root), "click" === r)) {
                      var u = f(e.target);
                ...
                h.on(j, "setTimeout-end", function (t, n, e) {
                  !it ||
                    rt - this.timerDuration < 0 ||
                    ((!t || t[0] instanceof Function) &&
                      (it[$][D]++,
                      (this.timerId = e),
                      (et[e] = it),
                      (this.timerBudget = rt - 50)));
                }),
                ...
                h.on(A, "new-xhr", function () {
                  it && (this[G] = it.child("ajax", null, null, !0));
                }),
                ...
                h.on(w, "xhr-resolved", function () {
                  ...
                  if (t) {
                    ...
                    (n.params = this.params),
                      ...
                      t.finish(this.endTime);
                  }
                }),
                h.on(C, "new-jsonp", function (t) {
                  if (it) {
                    var n = (this[V] = it.child("ajax", this[J]));
                ...
                h.on(C, K, function () {
                  ...
                  if (t) {
                    ...
                    (e.method = "GET"),
                      ...
                      (n.metrics = { txSize: 0, rxSize: 0 }),
                      (n.isJSONP = !0),
                      (t.jsEnd = this[K]),
                      (t.jsTime = this[B] ? this[K] - this[B] : 0),
                      t.finish(t.jsEnd);
                  }
                }),
                h.on(k, J, function (t, n) {
                  it &&
                    t &&
                    ((this[G] = it.child("ajax", this[J])),
                    n && this[G] && (this[G].dt = n));
                }),
                h.on(k, X + "start", function (t) {
                  it && ((this[G] = it), it[$][D]++);
                }),
                h.on(k, X + "end", function (t, n, e) {
                  var r = this[G];
                  r && r[$][D]--;
                }),
                h.on(k, W, function (t, n) {
                  var e = this[G];
                  if (e) {
                ...
                h.on(E, "newURL", function (t, n) {
                  it && (tt !== t && (it[$].routeChange = !0), n && (at = it)),
                    (tt = t);
                }),
                C.on("dom-start", function (t) {
                  ...
                  if (it) {
                    ...
                    i &&
                      (o[D]++,
                      r.addEventListener("load", n, I(!1)),
                      r.addEventListener("error", e, I(!1)));
                  }
                }),
                h.on(b, q, function () {
                  a(ot);
                }),
                h.on(T, "resolve-start", i),
                h.on(T, "executor-err", i),
                h.on(T, "propagate", r),
                h.on(T, B, function () {
                ...
                h(z + "get", function (t) {
                  var n = (this.ixn = it ? it[$] : new P("api", t, tt, nt, s));
                ...
                h(z + "tracer", function (t, n, e) {
                  var r = this.ixn,
                    ...
                    o = w.context(e);
                  return n
                    ? void (o[G] = i.child("customTracer", t, n))
                    : ((o.inc = ++r[D]), (o[G] = i));
                }),
                h.on(R, q, e),
                h.on(R, "no-" + q, e),
                h(z + "getContext", function (t, n) {
        ...
        var dt = F.getConfiguration("spa.harvestTimeSeconds") || 10,
          lt = [],
          ht = [],
          pt = new g(x, "events", { onFinished: c, retryDelay: dt });
        v.on("events", u),
          w.on("errorAgg", function (t, n, e, r) {
            it &&
              ((e._interactionId = it.interaction.id),
              it.type &&
                "interaction" !== it.type &&
                (e._interactionNodeId = it.id));
          }),
          w.on("interaction", d);
      },
      {},
      ...
      function (t, n, e) {
        ...
        function o(t, n, e, r, i) {
          function o(t, v) {
            ...
            switch (y) {
                ...
                (N[2] = f(t.jsEnd - d)),
                  N.push(
                    ...
                    c(h && A, f, !0) +
                      ...
                      i(j.id),
                    i(t.id),
                    c(j.firstPaint, f, !0) + c(j.firstContentfulPaint, f, !1)
                  );
                var M = l(j.custom, i);
                (S = S.concat(M)),
                  (b = M.length),
              ...
              case 2:
                N.push(
                  ...
                  f(k.txSize),
                  f(k.rxSize),
                  j.isFetch ? 1 : j.isJSONP ? 2 : "",
                  i(t.id),
                  c(t.dt && t.dt.spanId, i, !0) +
                    c(t.dt && t.dt.traceId, i, !0) +
                    c(t.dt && t.dt.timestamp, f, !1)
                );
                break;
              case 4:
                var U = j.tracedTime;
            ...
            for (var O = 0; O < t.children.length; O++) o(t.children[O], S);
            if (
              (N.unshift(f(y), f((w += b))),
              v.push(N),
              w && v.push(S.join(";")),
          ...
          n = n || 0;
          var d,
            h = "initialPageLoad" === t.attrs.trigger,
      ...
      function (t, n, e) {
        function r(t, n, e) {
          ...
          (r[t] = n),
            i(r, !0),
            w(t, e) &&
              a({ type: "fid", target: "document" }, "document", n, n + e.fid);
        }
        function i(t, n) {
          var e,
            r,
          ...
          for (e in t)
            (r = t[e]),
              "number" == typeof r &&
                r > 0 &&
                r < o &&
                ((i = n ? t[e] : t[e] - E.offset),
                h({ n: e, s: i, e: i, o: "document", t: "timing" }));
        }
        function o(t, n, e, r) {
          var i = "timer";
        ...
        function a(t, n, e, r) {
          if (T(t, n)) return !1;
          var i = { n: s(t.type), s: e, e: r, t: "event" };
          try {
            i.o = u(t.target, n);
          } catch (o) {
            i.o = u(null, n);
        ...
        function u(t, n) {
          ...
          if (t && t instanceof XMLHttpRequest) {
            ...
            t &&
              ...
              t.id && (e += "#" + t.id),
              t.className && (e += "." + N(t.classList).join(".")));
          return (
            "unknown" === e &&
              ("string" == typeof n
                ? (e = n)
                ...
                : n === window
                ? (e = "window")
                : n instanceof FileReader && (e = "FileReader")),
            e
          );
        }
        function c(t, n, e) {
            ...
            (t.forEach(function (t) {
              var n = M(t.name),
                e = {
                  ...
                  e: 0 | t.responseEnd,
                  o:
                    n.protocol + "://" + n.hostname + ":" + n.port + n.pathname,
                  t: t.entryType,
                };
              e.s <= $ || h(e);
            }),
        ...
        function m(t) {
          ...
          var n = A(
            C(_, function (t, n) {
              return t in I ? A(C(A(n.sort(v), g(t), {}), y), x, []) : n;
            }),
            x,
            []
          );
          ...
          t && (H = _), (_ = {}), (q = 0);
          var e = { qs: { st: "" + E.offset }, body: { res: n } };
          if (!P) {
        ...
        function g(t) {
          ...
          return function (i, o) {
            ...
            return (
              "scrolling" !== t || b(o)
                ? s && o.s - s.s < e && s.e > o.s - n
                  ? (s.e = o.e)
                  : ((r[o.o] = o), a.push(o))
                : ((r[o.o] = null), (o.n = "scroll"), a.push(o)),
              i
            );
          };
        }
        ...
        function T(t, n) {
          var e = u(t.target, n);
          return t.type in F.global || !!(F[e] && t.type in F[e]);
        }
        var E = t("loader"),
          S = t(19),
          j = t(10),
        ...
        if (j.xhrUsable && E.xhrWrappable) {
          var P = "",
            F = {
              global: { mouseup: !0, mousedown: !0 },
              window: { load: !0, pagehide: !0 },
            },
            I = {
              typing: [1e3, 2e3],
              scrolling: [100, 1e3],
            ...
            q = 0,
            H = null,
            B = O.getConfiguration("stn.harvestTimeSeconds") || 10,
            z = O.getConfiguration("stn.maxNodesPerHarvest") || 1e3,
            D = t("ee");
          if (((n.exports = { _takeSTNs: m }), t(22), E.features.stn)) {
            D.on("feat-stn", function () {
              function t(t) {
                t.sent &&
                  t.responseText &&
                  !P &&
                  ((P = t.responseText), (E.ptid = P), e.startTimer(B)),
                  t.sent &&
                    t.retry &&
                    H &&
                    (C(H, function (t, n) {
              ...
              function n(t) {
                ...
                if (!(P && q <= 30)) return m(t.retry);
              }
              i(window.performance.timing), j.on("resources", n);
              var e = new k(E, "resources", { onFinished: t, retryDelay: B });
      ...
      function (t, n, e) {
        function r(t) {
          ...
          for (var n = 0; n < s.length; n++) {
            ...
            if (o(e.hostname, t.hostname) && a(e.pathname, t.pathname))
              return !1;
          }
          return !0;
        }
        function i(t) {
          if (((s = []), t && t.length))
            for (var n = 0; n < t.length; n++) {
              ...
              0 === e.indexOf("http://")
                ? (e = e.substring(7))
                : 0 === e.indexOf("https://") && (e = e.substring(8));
              var r = e.indexOf("/");
              r > 0
                ? s.push({
    ...
    43: [
      function (t, n, e) {
        function r() {
          return { ajaxEvents: N, spaAjaxEvents: M };
        }
        function i(t, n, e, r, i) {
          n.time = e;
          var o;
          if (
            ((o = v(
              t.cat ? [t.status, t.cat] : [t.status, t.host, t.pathname]
            )),
            E("bstXhrAgg", ["xhr", o, t, n]),
            h.store("xhr", o, t, n),
            d())
          ) {
            if (!C(t))
              return void R(
                t.hostname === b.info.errorBeacon
            ...
            if (
              (a.dt &&
                ((s.spanId = a.dt.spanId),
                (s.traceId = a.dt.traceId),
                (s.spanTimestamp = a.dt.timestamp)),
              this.spaNode)
            ) {
        ...
        function o(t) {
          ...
          for (
            var n = a(N, t.maxPayloadSize || P), e = [], r = 0;
            r < n.length;
            r++
          )
            e.push({ body: { e: n[r] } });
        ...
        function a(t, n, e) {
          e = e || 1;
          for (
            var r = [], i = t.length / e, o = c(t, i), s = !1, u = 0;
            u < o.length;
            u++
          ) {
            var f = o[u];
        ...
        function u() {
          l.runHarvest({ unload: !0 });
        }
        function c(t, n) {
          n = n || t.length;
          for (var e = [], r = 0, i = t.length; r < i; r += n)
            e.push(new f(t.slice(r, r + n)));
          return e;
        }
        function f(t) {
          ...
          for (var n = 0; n < this.events.length; n++) {
            var e = this.events[n],
              r = [
                y(e.startTime),
                y(e.endTime - e.startTime),
                y(0),
                y(0),
                this.addString(e.method),
                y(e.status),
                this.addString(e.domain),
                this.addString(e.path),
                y(e.requestSize),
                y(e.responseSize),
                "fetch" === e.type ? 1 : "",
                this.addString(0),
                g(e.spanId, this.addString, !0) +
                  g(e.traceId, this.addString, !0) +
                  g(e.spanTimestamp, y, !1),
              ],
              i = "2,",
              o = w(b.info.jsAttributes || {}, this.addString);
            r.unshift(y(o.length)),
              (i += r.join(",")),
              o && o.length > 0 && (i += ";" + o.join(";")),
              n + 1 < this.events.length && (i += ";"),
              (this.payload += i);
          }
          this.tooBig = function (t) {
            return (t = t || P), 2 * this.payload.length > t;
          };
        }
        function d() {
        ...
        var l,
          ...
          j = t(9),
          k = t(42).setDenyList,
          C = t(42).shouldCollectEvent,
          A = t(28),
          R = t(49).recordSupportability,
          N = [],
          M = {},
          U = [];
        if (b.features.xhr) {
          var O = S.getConfiguration("ajax.harvestTimeSeconds") || 60,
            P = S.getConfiguration("ajax.maxPayloadSize") || 1e6;
          d() && k(S.getConfiguration("ajax.deny_list")),
            T.on("feat-err", function () {
              p("xhr", i),
                m.on("jserrors", function () {
                  return { body: h.take(["xhr"]) };
                }),
                d() &&
                  ((l = new j(b, "events", { onFinished: s, getPayload: o })),
                  l.startTimer(O),
                  A(u));
            }),
            (n.exports = i),
            (n.exports.prepareHarvest = o),
            (n.exports.getStoredEvents = r),
            (n.exports.shouldCollectEvent = C),
            (n.exports.setDenyList = k),
            T.on("interactionSaved", function (t) {
              M[t.id] && delete M[t.id];
            }),
            T.on("interactionDiscarded", function (t) {
              M[t.id] &&
                d() &&
                (M[t.id].forEach(function (t) {
                  N.push(t);
                }),
                delete M[t.id]);
            });
    ...
    45: [
      function (t, n, e) {
        function r(t) {
          if (NREUM.init) {
            for (
              var n = NREUM.init, e = t.split("."), r = 0;
              r < e.length - 1;
              r++
            )
    ...
    48: [
      function (t, n, e) {
        function r() {
          ...
          try {
            i() && t.push(s.REACT),
              o() && t.push(s.ANGULARJS),
              a() && t.push(s.ANGULAR),
              window.Backbone && t.push(s.BACKBONE),
              window.Ember && t.push(s.EMBER),
              window.Vue && t.push(s.VUE),
              window.Meteor && t.push(s.METEOR),
              window.Zepto && t.push(s.ZEPTO),
              window.jQuery && t.push(s.JQUERY);
          } catch (n) {}
          return t;
        }
        function i() {
          try {
            ...
            if (document.querySelector("[data-reactroot], [data-reactid]"))
              return !0;
            for (
              var t = document.querySelectorAll("body > div"), n = 0;
              n < t.length;
              n++
            )
              if (Object.keys(t[n]).indexOf("_reactRootContainer") >= 0)
                return !0;
            return !1;
          } catch (e) {
            return !1;
    ...
    51: [
      function (t, n, e) {
        function r() {
          ...
          for (
            var i, o = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx", a = "", s = 0;
            s < o.length;
            s++
          )
            (i = o[s]),
        ...
        function a(t) {
          ...
          i &&
            i.getRandomValues &&
            Uint8Array &&
            (e = i.getRandomValues(new Uint8Array(t)));
    ...
    55: [
      function (t, n, e) {
        function r(t, n, e) {
          var r = 0;
          for (
            "undefined" == typeof e && ((e = t[0]), (r = 1)), r;
            r < t.length;
            r++
          )
            e = n(e, t[r]);
