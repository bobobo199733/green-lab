  ...
  [935],
  {
    ...
    7790: function (e, t, n) {
      ...
      function k(e, t) {
        ...
        if ((void 0 === t && (t = !1), y(e))) n = new c(e.data);
          ...
          var k = new p(e.name, e.data);
          null != e["x-name"] &&
            ((k["x-name"] = e["x-name"]),
            (k["x-publicId"] = e["x-publicId"]),
            (k["x-systemId"] = e["x-systemId"])),
            (n = k);
        }
        return (
    ...
    8276: function (e, t, n) {
      ...
      if (document.implementation) {
        ...
        c = function (e, t) {
          return t
            ? ((f.documentElement.getElementsByTagName(t)[0].innerHTML = e), f)
      ...
      m.content &&
        ...
        (e.exports = function (e) {
          ...
          switch ((f && f[1] && (t = f[1].toLowerCase()), t)) {
            ...
            case o:
              return (
                (d = c(e).getElementsByTagName(t)),
                s.test(e) && l.test(e) ? d[0].parentNode.childNodes : d
              );
            default:
              return h ? h(e) : c(e, o).getElementsByTagName(o)[0].childNodes;
          }
        });
    },
    4152: function (e, t, n) {
      ...
      e.exports = {
        ...
        formatDOM: function e(t, n, r) {
          ...
          for (var i = [], o = 0, a = t.length; o < a; o++) {
            ...
            switch (d.nodeType) {
              case 1:
                (p = new s(m(d.nodeName), h(d.attributes))).children = e(
                  d.childNodes,
                  p
                );
                break;
        ...
        for (t in e)
          if (((a = e[t]), r.isCustomAttribute(t))) c[t] = a;
            ...
            switch (
              ...
              ("checked" !== l && "value" !== l) || u || (l = o("default" + n)),
              (c[l] = a),
              s && s.type)
            ) {
              case r.BOOLEAN:
          ...
          else i.PRESERVE_CUSTOM_ATTRIBUTES && (c[t] = a);
    ...
    3670: function (e, t, n) {
      ...
      e.exports = function e(t, n) {
        for (
          ...
          if (((o = t[b]), v && g((u = n.replace(o)))))
            k > 1 && (u = h(u, { key: u.key || b })), y.push(u);
          else if ("text" !== o.type) {
            switch (
              ((p = o.attribs),
              s(o) ? a(p.style, p) : p && (p = i(p)),
              (d = null),
              o.type)
            ) {
              case "script":
              case "style":
                o.children[0] &&
                  (p.dangerouslySetInnerHTML = { __html: o.children[0].data });
                break;
              case "tag":
                "textarea" === o.name && o.children[0]
                  ? (p.defaultValue = o.children[0].data)
                  : o.children && o.children.length && (d = e(o.children, n));
                break;
              default:
                continue;
            }
            k > 1 && (p.key = b), y.push(m(o.name, p, d));
          } else {
            if ((c = !o.data.trim().length) && o.parent && !l(o.parent))
              continue;
            if (x && c) continue;
            y.push(o.data);
          }
      ...
      e.exports = function (e, s) {
        ...
        function w() {
          var e = h(),
            n = v(i);
          if (n) {
            if ((k(), !v(o))) return y("property missing ':'");
            var r = v(a),
              s = e({
                type: "declaration",
    ...
    7848: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        for (
          var o, a, l = r(e), s = "function" === typeof t, c = 0, u = l.length;
          c < u;
          c++
        )
          (o = (n = l[c]).property),
            (a = n.value),
            s ? t(o, a, n) : a && (i || (i = {}), (i[o] = a));
        return i;
      };
    },
    5935: function (e, t, n) {
