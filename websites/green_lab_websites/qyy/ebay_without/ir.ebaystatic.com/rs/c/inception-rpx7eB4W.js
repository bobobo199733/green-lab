(function() {
    function i(c, d) {
        var a = Error('Cannot find module "' + c + '"' + (d ? ' from "' + d + '"' : ""));
        a.code = "MODULE_NOT_FOUND";
        return a
    }

    function o(c) {
        this.id = this.filename = c;
        this.loaded = !1;
        this.exports = void 0
    }

    function p(c, d) {
        for (var a = c.length, b = a, e = 0, g;
            "." === (g = d[e]);)
            if (e++, "." === d[e] && (e++, b && (b = c.lastIndexOf("/", b - 1), -1 === b && (b = 0))), "/" === (g = d[e])) e++;
            else break;
        return g ? b ? c.slice(0, b) + "/" + d.slice(e) : d.slice(e) : b ? b === a ? c : c.slice(0, b) : "/" === c[0] ? "/" : "."
    }
    ...
    function j(c, d) {
        ...
        if ("/" === c[0]) a = c;
            ...
            if (b = u[a]) a = b;
                ...
                e = b.indexOf("/");
                "@" === b[1] && (e = b.indexOf("/", e + 1));
                var e = -1 === e ? b.length : e,
                    e = [b.substring(0, e), b.substring(e)][0],
                    g = a.indexOf("/");
                0 > g ? (b = a, a = "") : ("@" === a[0] && (g = a.indexOf("/", g + 1)), b = a.substring(0, g), a = a.substring(g));
                (e = v[e + "/" + b]) ? (b = "/" + b + "$" + e, a && (b += a), a = b) : a = void 0
            }
        }
        if (a) {
            b = w[a];
            void 0 !== b && (a = p(a, b || "index"));
            (b = x[a]) && (a = b);
            if (void 0 ===
                h[a]) {
                var b = a.lastIndexOf("."),
                    f;
                a = -1 === b || -1 !== (f = a.lastIndexOf("/")) && f > b ? void 0 : a.substring(0, b);
                void 0 !== a && void 0 === h[a] && (a = void 0)
            }
            return a
        }
    }
    ...
    function y(c, d) {
        ...
        var b = k[a];
        void 0 === b && (b = k[a] = new o(a), b.load(h[a]));
        return b
    }

    function r(c, d) {
        return y(c, d).exports
    }
    ...
    s.load = function(c) {
        ...
        if ("function" === typeof c) {
            ...
            b.resolve = function(b) {
                if (!b) throw i("");
                var c = j(b, a);
                if (void 0 === c) throw i(b, a);
                return c
            };
            b.cache = k;
            b.runtime = n;
            this.exports = {};
            c(b, this.exports, this, d, a)
        } else this.exports = c;
        this.loaded = !0
    };
    var t = 0,
    ...
    s.__runtime = n = {
        def: function(c, d, a) {
            ...
            h[c] = d;
            if (a)
                for (var d = f || global, c = r(c, "/"), b = 0; b < a.length; b++) d[a[b]] = c
        },
        installed: function(c, d, a) {
            v[c + "/" + d] = a
        },
        run: z,
        main: function(c, d) {
        ...
        builtin: function(c, d) {
            u[c] = d
        },
        require: r,
        resolve: function(c, d) {
            var a = j(c, d);
            if (void 0 !== a) return [a, h[a]]
        },
        join: p,
        ready: A,
    ...
    f ? f.$_mod = n : module.exports = n
})();
$_mod.def("/@ebay/skin$14.2.1/global", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/utility", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/core", function(a) {
    a("/@ebay/skin$14.2.1/global");
    a("/@ebay/skin$14.2.1/utility")
});
$_mod.def("/@ebay/skin$14.2.1/lightbox-dialog", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/button", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/checkbox", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/field", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/radio", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/select", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/switch", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/textbox", function() {
    void 0
});
$_mod.def("/@ebay/skin$14.2.1/form", function(a) {
    a("/@ebay/skin$14.2.1/button");
    a("/@ebay/skin$14.2.1/checkbox");
    a("/@ebay/skin$14.2.1/field");
    a("/@ebay/skin$14.2.1/radio");
    a("/@ebay/skin$14.2.1/select");
    a("/@ebay/skin$14.2.1/switch");
    a("/@ebay/skin$14.2.1/textbox")
});
$_mod.def("/@ebay/skin$14.2.1/progress-spinner", function() {
    void 0
});
$_mod.def("/ebay-font$1.2.3/font/marketsans/fontloader", function() {
    function d() {
        try {
...
$_mod.def("/@ebay/skin$14.2.1/marketsans", function() {
    void 0
});
$_mod.installed("@ebay/ebayui-inception$13.0.0", "@ebay/cookies-browser", "0.0.3");
$_mod.main("/@ebay/cookies-browser$0.0.3", "");
$_mod.def("/@ebay/cookies-browser$0.0.3/index", function(g, i, l) {
    var k = {
            COOKIELET_DELIMITER: "^",
    ...
    window["@ebay/cookies-browser"] = j;
    window["cookies-browser"] = j;
    l.exports = j
});
$_mod.run("/@ebay/cookies-browser$0.0.3/index");
$_mod.installed("@ebay/site-speed-ebay$5.5.0", "@ebay/cookies-browser", "0.0.3");
$_mod.installed("@ebay/site-speed-ebay$5.5.0", "core-site-speed-ebay", "1.0.14");
        ...
        var i = n.create(p.sUrl),
            ...
            m = new function(f) {
                ...
                this.sendBeacon = function(b, d, e) {
                    ...
                    if (!("undefined" == typeof a || 1 == a.sent)) {
                        ...
                        if (d) {
                            ...
                            if (a.bf) c.add("ex1", "1");
                            else if (c.add("ct21", a.ct21), a.iLoadST && c.add("ctb", a.iLoadST - a.iST), a.st1a && c.add("st1a", a.st1a), a.aChunktimes && a.aChunktimes.length) {
                ...
                beacon: {
                    ...
                    getUrl: function() {
                        for (var f in i.params)
                            if (Array.isArray(i.params[f])) {
                ...
                metrics: {
                    getEntries: function() {
                        ...
                        if ("undefined" != typeof g)
                            for (var i in g) g.hasOwnProperty(i) &&
                                f.push({
                                    key: i,
                                    value: g[i]
                                });
...
$_mod.def("/@ebay/site-speed-ebay$5.5.0/client/uri", function(d, f, m) {
        ...
        f = {
            ...
            decodeParams: function(a) {
                for (var a = a ? a.split("&") : [], c = 0; c < a.length; c++) {
                    var b = a[c].split("="),
                        e = l(b[0]),
                        b = 1 < b.length ? l(b[1].replace(/\+/g, "%20")) : "";
            ...
            encodeParams: function(a) {
                ...
                for (b in a)
                    if (a.hasOwnProperty(b))
                        if ("object" !== h(a[b])) c.push(this.encodeParam(b, a[b]));
                        else
                            for (var e = a[b], e = "undefined" !== typeof e ? e.length :
    ...
    d || (d = {});
    if (f)
        for (var j in f) f.hasOwnProperty(j) && (d[j] = f[j]);
    g.create =
        function(a) {
            return new g(a)
        };
...
$_mod.def("/@ebay/site-speed-ebay$5.5.0/client/metrics", function(e, f, d) {
    d.exports = function() {
        var c = {};
...
$_mod.def("/@ebay/site-speed-ebay$5.5.0/client/sitespeed", function(a) {
    window.$ssg = function(b) {
        var c = a("/@ebay/site-speed-ebay$5.5.0/client/metrics")(),
            d = a("/@ebay/site-speed-ebay$5.5.0/client/uri"),
            e = a("/@ebay/cookies-browser$0.0.3/index");
        return a("/core-site-speed-ebay$1.0.14/SiteSpeed")(b, d, e, c)
    }
});
$_mod.run("/@ebay/site-speed-ebay$5.5.0/client/sitespeed");