...
BigInteger.small = [BigInteger.ZERO, BigInteger.ONE, new BigInteger([2], 1), new BigInteger([3], 1), new BigInteger([4], 1), new BigInteger([5], 1), new BigInteger([6], 1), new BigInteger([7], 1), new BigInteger([8], 1), new BigInteger([9], 1), new BigInteger([0, 1], 1), new BigInteger([1, 1], 1), new BigInteger([2, 1], 1), new BigInteger([3, 1], 1), new BigInteger([4, 1], 1), new BigInteger([5, 1], 1), new BigInteger([6, 1], 1), new BigInteger([7, 1], 1), new BigInteger([8, 1], 1), new BigInteger([9, 1], 1), new BigInteger([0, 2], 1), new BigInteger([1,
    2
], 1), new BigInteger([2, 2], 1), new BigInteger([3, 2], 1), new BigInteger([4, 2], 1), new BigInteger([5, 2], 1), new BigInteger([6, 2], 1), new BigInteger([7, 2], 1), new BigInteger([8, 2], 1), new BigInteger([9, 2], 1), new BigInteger([0, 3], 1), new BigInteger([1, 3], 1), new BigInteger([2, 3], 1), new BigInteger([3, 3], 1), new BigInteger([4, 3], 1), new BigInteger([5, 3], 1), new BigInteger([6, 3], 1)];
...
BigInteger.parse = function(a, b) {
    ...
    if (e) {
        ...
        var g = e[2] || "",
            e = e[3] ||
            "";
        if ("undefined" === typeof b) "0" === g ? 0 === e.length ? (b = 10, e = "0") : b = 8 : b = "0x" === g || "0X" === g ? 16 : "0b" === g || "0B" === g ? 2 : 10;
        else if (2 > b || 36 < b) throw Error("Illegal radix " + b + ".");
        b = +b;
...
BigInteger.prototype.subtract = function(a) {
    ...
    var b = this;
    if (0 > this._s) var d = b,
        b = new BigInteger(a._d, 1),
        a = new BigInteger(d._d, 1);
...
BigInteger.prototype.divRem = function(a) {
    ...
    var b = this._s * a._s,
        ...
        j = new BigInteger([], 1);
    for (j._s = 1; g.length;)
        if (j._d.unshift(g.pop()), j = new BigInteger(j._d,
                1), 0 > j.compareAbs(a)) f.push(0);
        else {
            var c = 0 === j._s ? 0 : 9;
            do {
...
var _PlsrCookieUtil = {
    ...
    CGuidHash = {
        ...
        isInSampling: function(a) {
            if (100 == a) return !0;
            var b = CGuidHash.getMod1000(),
                a = Math.floor(parseFloat(10 * a));
            return 0 > b || b >= a ? !1 : !0
        }
    },
    JSON = JSON || {};
...
function PlsUBTURLTemplate(a, b, d) {
    var e = "";
    if (null != a.serverUrl) e = a.serverUrl;
    else {
        var g, f = "qa" == a.env || -1 < b.indexOf(".qa."),
            j = "preprod" == a.env || -1 < b.indexOf(".pp.");
        if (f || j) {
            var c = null;
...
function getBrowserNameAndVersion() {
    ...
    if ("Chrome" === d[1] && (b = a.match(/\bOPR|Edge\/(\d+)/), null != b)) return {
        name: "Opera",
        version: b[1]
    };
