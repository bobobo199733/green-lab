...
! function(a, b) {
    ...
    function d(a, b, c, d, e) {
        ...
        if (b) {
            ...
            if (g.data) return;
            e && (g.requested = !0, !g.dependencies && c.length && (g.dependencies = c))
        }
    ...
    var n = /^([^~^=<]+)(([~^=<])([0-9]+(\.[0-9]+){0,2}))?$/,
        ...
        t = 0;
    (new Date).getTime();
    if (a.Rmodules && a.Rmodules.version) return void(a.console && ("1.27.3" === a.Rmodules.version ? a.console.log("WARNING: Rmodules-1.27.3 is being included more than once.") : a.console.log("WARNING: Rmodules-1.27.3 is being included at the same time than Rmodules-" + a.Rmodules.version + ". Use only the newest one.")));
    a.Rmodules = {
        version: "1.27.3",
        baseUrl: a.Rmodules && a.Rmodules.baseUrl || "",
        config: c,
        define: d,
        get: e,
        debug: !1
...
function(a, b) {
    "use strict";
    b.baseUrl || (b.baseUrl = "https://r.r10s.jp/com/js/d"), b.config({
        jQuery: [{
            version: "1.12.2",
        ...
        "jQuery.ui": [{
            version: "1.12.1",
            path: "/Rmodules/modules/rmod-jquery-ui-1.12.1.min.js",
            dependencies: ["jQuery"]
        }],
        loadImage: [{
            version: "2.6.1",
        ...
        R: [{
            ...
            version: "1.7.0",
            path: "/R/1.7/R-1.7.0.min.js",
            dependencies: ["jQuery"]
        }, {
            version: "1.7.1",
            path: "/R/1.7/R-1.7.1.min.js",
            dependencies: ["jQuery"]
        }],
        "R.ui": [{
            version: "1.0.0",
        ...
        "R.api": [{
            ...
            version: "1.10.2",
            path: "/RApi/1.10/R.api-1.10.2.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.11.0",
            path: "/RApi/1.11/R.api-1.11.0.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.11.1",
            path: "/RApi/1.11/R.api-1.11.1.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.12.0",
            path: "/RApi/1.12/R.api-1.12.0.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.14.0",
            path: "/RApi/1.14/R.api-1.14.0.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.14.1",
            path: "/RApi/1.14/R.api-1.14.1.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.15.0",
            path: "/RApi/1.15/R.api-1.15.0.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.15.1",
            path: "/RApi/1.15/R.api-1.15.1.min.js",
            dependencies: ["R^1"]
        }, {
            version: "1.15.2",
            path: "/RApi/1.15/R.api-1.15.2.min.js",
            dependencies: ["R^1"]
        }],
        "R.api.top": [{
            version: "1.0.0",
            ...
            version: "1.7.0",
            path: "/RApiTop/1.7/R.api.top-1.7.0.min.js",
            dependencies: ["R.api^1"]
        }],
        "R.api.item": [{
            version: "1.0.0",
            ...
            version: "1.3.0",
            path: "/RApiItem/1.3/R.api.item-1.3.0.min.js",
            dependencies: ["R.api^1"]
        }]
    }), delete b.config
