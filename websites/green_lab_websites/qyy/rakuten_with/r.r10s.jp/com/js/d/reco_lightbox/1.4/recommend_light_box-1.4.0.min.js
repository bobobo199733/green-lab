/*
 recommend_light_box-1.4.0.js
 Copyright (c) 2020 Rakuten.Inc
 Date: 2020-06-14 19:46:10
*/
! function(a, b, c) {
    "use strict";
    if (b !== c) {
        ...
        d.extend({
            recommend_light_box: {
                ...
                settings: {
                    ...
                    recommend_layer_url: ["https://rp.rakuten.co.jp/v2/ichiba/recommend/top_lightbox_pc", "Str", "^^(https?:)?//(?:[a-zA-Z0-9_\\-]+\\.)+rakuten\\.co\\.jp\\/[a-zA-Z0-9_&=\\?\\-\\.%:\\/]+$"],
                ...
                openRecoPopLightBox: function(b, c, e, f, g, h) {
                    b.lightBoxModal.fadeIn(100), d.recommend_light_box.alignLightBox(), d.recommend_light_box.itemClicked = "", d.recommend_light_box.clickCount = 0, b.prototypeErrorLightBox.hide(), d.recommend_light_box.disable(b), a.SC && "function" == typeof a.SC.sendSTL && "1" == d.recommend_light_box.settings.sc_displayed_flag && a.SC.sendSTL({
                ...
                getRecommendDataLayer: function(a, b, e, f, g, h, i, j) {
                    function k(a, f, g, h, i, j, k) {
                        ...
                        if (clearTimeout(l), f.status === c || f.reco_count === c) return d.recommend_light_box.displayErrorMessage(a), !1;
                        if ("Success" != f.status && "NotFound" != f.status) return d.recommend_light_box.displayErrorMessage(a), !1;
                        if (g && 0 === m.length) return d.recommend_light_box.updateLinkAreaOnError(a, h), d.recommend_light_box.updateItemURL(a), !1;
                        for (var n = [], o = d.recommend_light_box.props.recommendLayer.items[0], p = 0; p < m.length; p++) n.push({
                            itemname: d.recommend_light_box.editItemnameLightBox(d.recommend_light_box, m[p].item_name),
                            itemurl: "1" == d.recommend_light_box.settings.sid_clickcount_flag ? d.recommend_light_box.editItemurl(m[p].item_url, d.recommend_light_box.settings.recommend_sid + "_" + d.recommend_light_box.clickCount) : d.recommend_light_box.editItemurl(m[p].item_url, d.recommend_light_box.settings.recommend_sid),
                            itemprice: d.recommend_light_box.editItemprice(m[p].item_price),
                            imageele: "",
                            imageurl: d.recommend_light_box.editImageurl(m[p].small_image_url, d.recommend_light_box.settings.lightbox_imgsize),
                            imagealt: d.recommend_light_box.editItemnameLightBox(d.recommend_light_box, m[p].item_name),
                            imagetitle: d.recommend_light_box.editItemnameLightBox(d.recommend_light_box, m[p].item_name),
                            shopid: m[p].shop_id,
                            itemid: m[p].item_id
                        });
                        return o != c && g && (o = o[h], n.length >= d.recommend_light_box.settings.recommend_items_number && (h < n.length ? n.splice(h, 0, o) : n[h] = o)),
                            d.recommend_light_box.props.recommendLayer.items[0] = n, n.length < d.recommend_light_box.settings.recommend_items_number ? g ? d.recommend_light_box.getShopRecommendData(a, m.length, g, e, b, h, o) : d.recommend_light_box.getRankingDataLayer(a, m.length, g, i, j, k) : d.recommend_light_box.prepareRecommendItems(a, n, g, h), !0
                    }
                    var l, m = [],
                        n = 0;
                    if (d.recommend_light_box.status.isTimeout = !1, i) {
                        if (d.recommend_light_box.itemClicked = j, m = d.recommend_light_box.props.recommendLayer.items[0], m[j] == c) return d.recommend_light_box.displayErrorMessage(a), !1;
                ...
                getShopRecommendData: function(a, b, e, f, g, h, i) {
                    function j(a, b, e, f, g) {
                        if (d.recommend_light_box.status.isTimeout) return !1;
                        if (clearTimeout(k), b.num === c) return 0 == e && d.recommend_light_box.updateLinkAreaOnError(a, g), !1;
                ...
                getRankingDataLayer: function(a, b, e, f, g, h) {
                    function i(a, b, e, f, g, h) {
                        ...
                        if (a.prototypeErrorLightBox.hide(), 0 == b.num) return 0 == e && d.recommend_light_box.displayErrorMessage(a), !1;
