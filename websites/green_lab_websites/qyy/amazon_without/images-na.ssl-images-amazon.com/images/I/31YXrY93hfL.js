(function(f, m) {
    ...
    function x(a, h) {
        ...
        h.adb && (e.adb = h.adb);
        if (k = h.attribution) e.attribution =
            "" + k;
        if (!b) {
            ...
            if ((b = a.stack || (a.err ? a.err.stack : "")) && b.split)
                for (e.csm += " stack", k = b.split("\n"); l < k.length && e.s.length < F;)(b = k[l++]) && e.s.push(y(b));
            else {
                e.csm += " callee";
                var m = z(a.args || arguments, "callee");
                for (k = l = 0; m && l < F;) {
                    var w = G;
                    m.skipTrace || (b = m.toString()) && b.substr &&
                        (w = 0 === k ? 4 * G : w, w = 1 == k ? 2 * G : w, e.s.push(b.substr(0, w)), k++);
                    m = z(m, "caller");
                    l++
                }
            }
...
(function(f, m) {
    function y(r) {
        for (var a = {}, c, d, n = 0; n < r.length; n++) d = r[n], d.r = d.r || b.rid, d.s = d.s || f.ue_sid, c = d.r + d.s + d.m, d.c && (a[c] || (a[c] = []), a[c].push(r[n]));
        return a
    }
    ...
    (function() {
            ...
            switch (typeof g) {
                ...
                case "object":
                    ...
                    if (k && "object" === typeof k)
                        for (d = k.length, a = 0; a < d; a += 1) "string" === typeof k[a] && (e = k[a], (h = c(e, g)) && r.push(b(e) + (n ? ": " : ":") + h));
                    else
                        for (e in g) Object.prototype.hasOwnProperty.call(g, e) && (h = c(e, g)) && r.push(b(e) + (n ? ": " : ":") + h);
                    h = 0 === r.length ? "{}" : n ? "{\n" + n + r.join(",\n" + n) + "\n" + t + "}" : "{" + r.join(",") + "}";
                    n = t;
                    return h
            }
        ...
        var d = /[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            ...
            k;
        "function" !== typeof D.stringify && (D.stringify = function(a,
            b, d) {
            var g;
            f = n = "";
            if ("number" === typeof d)
    ...
    var H = function() {
        ...
        b = f.ue || {};
    H = f.uet || v;
    (f.uet || v)("bb", "ue_frst_v2", {
        wb: 1
    });
    var e =
        "//" + f.ue_furl + "/1/batch/1/OE/",
        k = [],
        l = [],
        q = [],
        w = !1,
        p, P, Q = void 0 === f.ue_hpfi ? 1E3 : f.ue_hpfi,
                ...
                send: function(k) {
                    for (var r in k)
                        if (k.hasOwnProperty(r)) {
                            for (var c = k[r], d = c, n = {}, g, l = 0; l < d.length; l++) g = d[l].c, n[g] || (n[g] = []), n[g].push(d[l]);
                            c = c[0] || {};
                            d = c.sn || f.ue_sn;
                            ...
                            for (p = 0; p < n.length;) {
                                ...
                                g = q + (w + g + ":" + u.t);
                                if (u.l) g += ":" + u.p++ + "_", d.push(g), g = c, m = "$", l = 0;
                                else if (p++, 1 != u.p)
                                    for (g += ":" + u.p + "_" + u.p, q = 0; q < u.p - 1; q++) d[d.length - q - 1] += u.p
                            }
                            d.push(g);
                            c = d;
    ...
    b._lpn = b._lpn || {};
    try {
        m.amznJQ && m.amznJQ.declareAvailable && m.amznJQ.declareAvailable("forester-client"), m.P && m.P.register && m.P.register("forester-client", v)
    } catch (r) {
        f.ueLogError(r, {
            logLevel: "WARN"
        })
    }(function() {
        b.log && b.log.isStub && (b.log.replay(function(a,
            b, c) {
            var d = a[2] || {};
            d.t = b;
            d.r = c;
