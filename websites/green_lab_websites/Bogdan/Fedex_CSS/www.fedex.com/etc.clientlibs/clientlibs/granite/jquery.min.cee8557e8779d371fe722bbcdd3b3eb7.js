...
(function(p, ba) {
    ...
    function ib() {
        n.addEventListener ? (n.removeEventListener("DOMContentLoaded", C), p.removeEventListener("load", C)) : (n.detachEvent("onreadystatechange", C), p.detachEvent("onload",
            C))
    }

    function C() {
        if (n.addEventListener || "load" === p.event.type || "complete" === n.readyState) ib(), c.ready()
    }

    function jb(a, b, d) {
        if (void 0 === d && 1 === a.nodeType)
            if (d = "data-" + b.replace(gc, "-$1").toLowerCase(), d = a.getAttribute(d), "string" === typeof d) {
                try {
    ...
    function kb(a, b, d, e) {
        if (pa(a)) {
            ...
            if (l && h[l] && (e || h[l].data) || void 0 !== d || "string" !== typeof b) {
                ...
                if ("object" === typeof b || "function" === typeof b) e ? h[l] = c.extend(h[l], b) : h[l].data = c.extend(h[l].data, b);
                a = h[l];
        ...
        if (pa(a)) {
            ...
            if (h[l]) {
                if (b && (e = d ? h[l] : h[l].data)) {
                    ...
                    if (d ? !La(e) : !c.isEmptyObject(e)) return
                }
                if (!d && (delete h[l].data, !La(h[l]))) return;
    ...
    function mb(a, b, d, e) {
        var f = 1,
            ...
            m =
            (c.cssNumber[b] || "px" !== k && +l) && Ma.exec(c.css(a, b));
        if (m && m[3] !== k) {
            k = k || m[3];
            d = d || [];
            m = +l || 1;
    ...
    function y(a, b) {
        ...
        if (!g)
            for (g = [], d = a.childNodes || a; null != (e = d[f]); f++) !b || c.nodeName(e, b) ? g.push(e) : c.merge(g, y(e, b));
    ...
    function ob(a, b, d, e, f) {
        for (var g, h, l, k, m, r, t = a.length, I = nb(b), p = [], n = 0; n < t; n++)
            ...
            if (!q.tbody)
                for (g = (h = "table" !==
                        k || qb.test(h) ? "\x3ctable\x3e" !== r[1] || qb.test(h) ? 0 : l : l.firstChild) && h.childNodes.length; g--;) c.nodeName(m = h.childNodes[g], "tbody") && !m.childNodes.length && h.removeChild(m);
        ...
        for (n = 0; h = p[n++];)
            ...
            else if (a = c.contains(h.ownerDocument, h), l = y(I.appendChild(h), "script"), a && Na(l),
            d)
    ...
    function ea(a, b, d, e) {
        ...
        var f, g = 0,
            ...
            k = b[0],
            m = c.isFunction(k);
        if (m || 1 < h && "string" === typeof k && !q.checkClone && lc.test(k)) return a.each(function(c) {
            var f = a.eq(c);
        ...
        if (h) {
            ...
            if (t ||
                ...
                for (f = p.length; g < h; g++) t = r, g !== l && (t = c.clone(t, !0, !0), f && c.merge(p, y(t, "script"))), d.call(a[g], t, g);
                if (f)
                    for (r = p[p.length - 1].ownerDocument, c.map(p, vb), g = 0; g < f; g++) t = p[g], rb.test(t.type || "") && !c._data(t, "globalEval") && c.contains(r, t) && (t.src ? c._evalUrl && c._evalUrl(t.src) : c.globalEval((t.text || t.textContent || t.innerHTML || "").replace(mc, "")));
                r = t = null
            }
        }
        return a
    ...
    function yb(a, b, d) {
        for (var e = b ? c.filter(b, a) : a, f = 0; null != (b = e[f]); f++) d || 1 !== b.nodeType || c.cleanData(y(b)),
            b.parentNode && (d && c.contains(b.ownerDocument, b) && Na(y(b, "script")), b.parentNode.removeChild(b));
        return a
    }
    ...
    function za(a) {
        var b = n,
            d = Ab[a];
        d || (d = zb(a, b), "none" !== d && d || (wa = (wa || c("\x3ciframe frameborder\x3d'0' width\x3d'0' height\x3d'0'/\x3e")).appendTo(b.documentElement), b = (wa[0].contentWindow || wa[0].contentDocument).document, b.write(), b.close(), d = zb(a, b), wa.detach()), Ab[a] = d);
        return d
    }
    ...
    function Eb(a, b) {
        for (var d, e, f, g = [], h = 0, l = a.length; h < l; h++) e = a[h], e.style && (g[h] = c._data(e, "olddisplay"), d = e.style.display, b ? (g[h] || "none" !== d || (e.style.display = ""), "" === e.style.display && fa(e) && (g[h] = c._data(e, "olddisplay", za(e.nodeName)))) : (f = fa(e), (d && "none" !== d || !f) && c._data(e,
            "olddisplay", f ? d : c.css(e, "display"))));
    ...
    function Gb(a, b, d, e, f) {
        ...
        for (var g = 0; 4 > b; b += 2) "margin" === d && (g += c.css(a, d + T[b], !0, f)), e ? ("content" === d && (g -= c.css(a, "padding" + T[b], !0, f)), "margin" !== d && (g -= c.css(a, "border" + T[b] + "Width", !0, f))) : (g += c.css(a, "padding" +
            T[b], !0, f), "padding" !== d && (g += c.css(a, "border" + T[b] + "Width", !0, f)));
        return g
    }
    ...
    function oc(a, b) {
        ...
        for (d in a) {
            ...
            if ((e = c.cssHooks[f]) && "expand" in e)
                for (d in h = e.expand(h), delete a[f],
                    h) d in a || (a[d] = h[d], b[d] = g);
            else b[f] = g
        }
    }
    ...
    function S(a, b, d) {
        var e, f = 0,
            ...
            l = function() {
                ...
                for (var c = 1 - (b / k.duration || 0), d = 0, f = k.tweens.length; d < f; d++) k.tweens[d].run(c);
        ...
        for (oc(d, k.opts.specialEasing); f < g; f++)
            if (b = S.prefilters[f].call(k, a, d, k.opts)) return c.isFunction(b.stop) && (c._queueHooks(k.elem, k.opts.queue).stop =
                c.proxy(b.stop, b)), b;
        c.map(d, Jb, k);
    ...
    function Kb(a) {
        return function(b, d) {
            ...
            if (c.isFunction(d))
                for (; b = f[e++];) "+" === b.charAt(0) ? (b = b.slice(1) || "*", (a[b] = a[b] || []).unshift(d)) :
                    (a[b] = a[b] || []).push(d)
        }
    }
    ...
    function pc(a) {
        if (!c.contains(a.ownerDocument || n, a)) return !0;
        for (; a && 1 === a.nodeType;) {
            if ("none" ===
        ...
        for (; f < g; f++)
            if (null != (d = arguments[f]))
                for (b in d) {
                    var l = e[b];
                    var k = d[b];
                    "__proto__" !== b && e !== k && (h && k && (c.isPlainObject(k) || (a = c.isArray(k))) ? (a ? (a = !1, l = l && c.isArray(l) ? l : []) : l = l && c.isPlainObject(l) ? l : {}, e[b] = c.extend(h, l, k)) : void 0 !== k && (e[b] = k))
                }
        return e
    };
    c.extend({
    ...
    var sa = function(a) {
        function b(a, b, c, d) {
            var e, f, g, u, h = b && b.ownerDocument,
                ...
                9;
            c = c || [];
            if ("string" !== typeof a || !a || 1 !== v && 9 !== v && 11 !== v) return c;
            if (!d && ((b ? b.ownerDocument || b : A) !== w && xa(b), b = b || w, Y)) {
                if (11 !== v && (u = ta.exec(a)))
                    if (e = u[1])
                        if (9 === v)
                    ...
                    if (h && (f = h.getElementById(e)) && Aa(b, f) && f.id === e) return c.push(f), c
                } else {
                    if (u[2]) return C.apply(c, b.getElementsByTagName(a)), c;
                    if ((e = u[3]) && F.getElementsByClassName && b.getElementsByClassName) return C.apply(c, b.getElementsByClassName(e)), c
                }
                if (!(!F.qsa || M[a + " "] ||
                        O && O.test(a))) {
                    if (1 !== v) {
                        ...
                        u = ca(a);
                        e = u.length;
                        for (f = ha.test(g) ? "#" + g : "[id\x3d'" + g + "']"; e--;) u[e] = f + " " + p(u[e]);
                        l = u.join(",");
                        h = da.test(a) && r(b.parentNode) || b
                    }
                    if (l) try {
                        return C.apply(c, h.querySelectorAll(l)), c
                    } catch (ad) {} finally {
                    ...
                    for (; b = b[d];) {
                        ...
                        for (; b = b[d];)
                            if (1 === b.nodeType || e) {
                                ...
                                if ((h = v[d]) && h[0] === ka && h[1] === f) return u[2] = h[2];
                                v[d] = u;
        ...
        function y(a, b, c, d, e) {
            for (var f,
                    g = [], h = 0, u = a.length, v = null != b; h < u; h++)
                if (f = a[h])
        ...
        function D(a, c, d, f, g, h) {
            ...
            return e(function(e, h, u, v) {
                ...
                if (!(L = e)) {
                    L = c || "*";
                    for (var r = u.nodeType ? [u] : u, t = [], p = 0, q = r.length; p < q; p++) b(L, r[p], t);
                    L = t
                }
                ...
                if (e) {
                    if (g || a) {
                        ...
                        for (u = r.length; u--;)(l = r[u]) && -1 < (n = g ? E(e, l) : k[u]) && (e[n] = !(h[n] = l))
                    }
                } else r = y(r === h ? r.splice(U, r.length) : r), g ? g(null, h, r, v) : C.apply(h, r)
            })
        }
        ...
        function P(a) {
            ...
            for (var g = e ? 1 : 0, h = q(function(a) {
                ...
                if (f = B.relative[a[g].type]) l = [q(n(l), f)];
                else {
                    f = B.filter[a[g].type].apply(null,
                        a[g].matches);
                    if (f[z]) {
        ...
        var x, N, K, Q, w, Z, Y, O, ya, Ea, Aa, z = "sizzle" + 1 * new Date,
            A = a.document,
            ka = 0,
            S = 0,
            G = c(),
        ...
        try {
            C.apply(la = X.call(A.childNodes), A.childNodes), la[A.childNodes.length].nodeType
        } catch (u) {
            C = {
        ...
        var xa = b.setDocument = function(a) {
            ...
            }) : (delete B.find.ID, B.filter.ID = function(a) {
                var b = a.replace(ma, na);
                return function(a) {
                    return (a =
            ...
            ya = [];
            O = [];
            if (F.qsa = V.test(w.querySelectorAll)) f(function(a) {
            ...
            R = b ? function(a, b) {
                ...
                var c = 0,
                    ...
                    f = [a],
                    g = [b];
                if (!d || !e) return a === w ? -1 : b === w ? 1 : d ? -1 : e ? 1 : K ? E(K, a) - E(K, b) : 0;
                if (d === e) return h(a, b);
        ...
        b.matchesSelector = function(a, c) {
            ...
            if (!(!F.matchesSelector || !Y || M[c + " "] || ya && ya.test(c) || O && O.test(c))) try {
                var d = Ea.call(a, c);
        ...
        var fa = b.getText = function(a) {
            ...
            if (!d)
                ...
                for (a = a.firstChild; a; a = a.nextSibling) b += fa(a)
        ...
        var B = b.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    ...
                    a[3] ? a[2] = a[4] || a[5] || "" : c && qa.test(c) && (b = ca(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] =
                    ...
                    return 1 === d && 0 === e ? function(a) {
                        ...
                        if (u) {
                            if (f) {
                                for (; c;) {
                                    for (k = b; k = k[c];)
                                        if (h ? k.nodeName.toLowerCase() === r : 1 === k.nodeType) return !1;
                            ...
                            if (g && l) {
                                ...
                                for (k = m && u.childNodes[m]; k = ++m && k && k[c] || (t = m = 0) || p.pop();)
                                    ...
                                    (k[z] = {}), v = v[k.uniqueID] || (v[k.uniqueID] = {}), t = v[a] || [], t = m = t[0] === ka && t[1]), !1 === t)
                                for (;
                                    (k = ++m && k && k[c] || (t = m = 0) || p.pop()) && ((h ? k.nodeName.toLowerCase() !== r : 1 !== k.nodeType) || !++t || (l && (v = k[z] || (k[z] = {}), v = v[k.uniqueID] || (v[k.uniqueID] = {}), v[a] = [ka, t]), k !== b)););
                            t -= e;
                ...
                PSEUDO: function(a, c) {
                    ...
                    if (1 < d.length) {
                        ...
                        return B.setFilters.hasOwnProperty(a.toLowerCase()) ?
                            e(function(a, b) {
                                for (var e, f = d(a, c), g = f.length; g--;) e = E(a, f[g]), a[e] = !(b[e] = f[g])
                            }) : function(a) {
                                return d(a, 0, f)
                            }
                    }
        ...
        var ca = b.tokenize = function(a, c) {
            var d, e, f, g, h;
            if (g = J[a + " "]) return c ? 0 : g.slice(0);
            g = a;
            var l = [];
            for (h = B.preFilter; g;) {
                if (!k || (d = ia.exec(g))) d &&
                    (g = g.slice(d[0].length) || g), l.push(e = []);
                var k = !1;
                if (d = ja.exec(g)) k = d.shift(), e.push({
                    value: k,
                    type: d[0].replace(T, " ")
                }), g = g.slice(k.length);
                for (f in B.filter) !(d = W[f].exec(g)) || h[f] && !(d = h[f](d)) || (k = d.shift(), e.push({
                    value: k,
                    type: f,
                    matches: d
                }), g = g.slice(k.length));
            ...
            b.select = function(a, b, c, d) {
                ...
                if (1 === l.length) {
                    ...
                    for (e = W.needsContext.test(a) ? 0 : k.length; e--;) {
                        ...
                        if (g = B.find[g])
                            if (d = g(f.matches[0].replace(ma, na), da.test(k[0].type) &&
                                    r(b.parentNode) || b)) {
                                k.splice(e, 1);
                                a = d.length && p(k);
                                if (!a) return C.apply(c, d), c;
                                break
                            }
                    }
    ...
    (c.fn.init = function(a, b, d) {
        ...
        if ("string" === typeof a) {
            ...
            if (e[1]) {
                if (b = b instanceof c ? b[0] : b, c.merge(this, c.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : n, !0)), Rb.test(e[1]) && c.isPlainObject(b))
                    for (e in b)
        ...
        closest: function(a, b) {
            for (var d, e = 0, f = this.length, g = [], h = Qb.test(a) || "string" !== typeof a ? c(a, b || this.context) : 0; e < f; e++)
                for (d = this[e]; d && d !== b; d = d.parentNode)
                    if (11 >
                        d.nodeType && (h ? -1 < h.index(d) : 1 === d.nodeType && c.find.matchesSelector(d, a))) {
                        g.push(d);
                        break
                    }
    ...
    c.each({
        ...
        siblings: function(a) {
            return Pb((a.parentNode || {}).firstChild,
                a)
        },
        children: function(a) {
        ...
        c.fn[a] = function(d, e) {
            ...
            1 < this.length && (yc[a] || (f = c.uniqueSort(f)), xc.test(a) && (f = f.reverse()));
    ...
    c.Callbacks = function(a) {
        ...
        var b, d, e, f, g = [],
            ...
            m = {
                add: function() {
                    g && (d && !b && (l = g.length - 1, h.push(d)), function I(b) {
                ...
                remove: function() {
                    c.each(arguments, function(a, b) {
                        for (var d; - 1 < (d = c.inArray(b, g, d));) g.splice(d, 1), d <= l &&
                            l--
                    });
                    return this
                },
    ...
    c.extend({
        Deferred: function(a) {
            var b = [
                    ["resolve",
                        "done", c.Callbacks("once memory"), "resolved"
                    ],
        ...
        when: function(a) {
            ...
            if (1 < e) {
                var k = Array(e);
                var m = Array(e);
                for (l = Array(e); b < e; b++) d[b] && c.isFunction(d[b].promise) ? d[b].promise().progress(h(b, m, k)).done(h(b, l, d)).fail(g.reject) : --f
            }
            f || g.resolveWith(l, d);
            return g.promise()
        }
    ...
    c.extend({
        ...
        ready: function(a) {
            (!0 === a ? --c.readyWait : c.isReady) || (c.isReady = !0, !0 !== a && 0 < --c.readyWait || (Fa.resolveWith(n, [c]), c.fn.triggerHandler && (c(n).triggerHandler("ready"), c(n).off("ready"))))
        }
    });
    c.ready.promise = function(a) {
        if (!Fa)
            if (Fa = c.Deferred(), "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll) p.setTimeout(c.ready);
            else if (n.addEventListener) n.addEventListener("DOMContentLoaded", C), p.addEventListener("load", C);
        else {
    ...
    c(function() {
        ...
        if ((a = n.getElementsByTagName("body")[0]) && a.style) {
            ...
            "undefined" !== typeof b.style.zoom && (b.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", q.inlineBlockNeedsLayout = b = 3 === b.offsetWidth) && (a.style.zoom = 1);
            a.removeChild(c)
        }
    });
    (function() {
                ...
                if (this.length) {
                    ...
                    if (1 === e.nodeType &&
                        ...
                        for (d = f.length; d--;)
                            if (f[d]) {
                                var h = f[d].name;
                                0 === h.indexOf("data-") && (h = c.camelCase(h.slice(5)), jb(e, h, g[h]))
                            }
    ...
    c.fn.extend({
        ...
        promise: function(a, b) {
            ...
            for (a =
                a || "fx"; h--;)(d = c._data(g[h], a + "queueHooks")) && d.empty && (e++, d.empty.add(l));
            l();
            return f.promise(b)
        }
    });
        ...
        q.shrinkWrapBlocks = function() {
            ...
            if ((b = n.getElementsByTagName("body")[0]) && b.style) {
                ...
                "undefined" !== typeof c.style.zoom && (c.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
                    c.appendChild(n.createElement("div")).style.width = "5px", a = 3 !== c.offsetWidth);
                b.removeChild(e);
                return a
            }
        }
    ...
    var Ya = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        E = function(a, b, d, e, f, g, h) {
            var l = 0,
                ...
                m = null == d;
            if ("object" === c.type(d))
                for (l in f = !0, d) E(a, b, l, d[l], !0, g, h);
    ...
    (function() {
        ...
        for (a in {
            ...
            var c = "on" + a;
            (q[a] = c in p) || (b.setAttribute(c, "t"), q[a] = !1 === b.attributes[c].expando)
        }
    })();
    ...
    c.event = {
        ...
        add: function(a, b, d, e, f) {
            ...
            if (h = c._data(a)) {
                ...
                (l = h.handle) || (l = h.handle = function(a) {
                    return "undefined" ===
                        typeof c || a && c.event.triggered === a.type ? void 0 : c.event.dispatch.apply(l.elem, arguments)
                }, l.elem = a);
                b = (b || "").match(J) || [""];
                for (h = b.length; h--;) {
                    var p = Ub.exec(b[h]) || [];
                    ...
                    n && (p = c.event.special[n] || {}, n = (f ? p.delegateType : p.bindType) || n, p = c.event.special[n] || {}, k = c.extend({
                        type: n,
                        origType: k,
                        data: e,
                        handler: d,
                        ...
                        namespace: q.join(".")
                    }, r), (m = g[n]) || (m = g[n] = [], m.delegateCount = 0, p.setup && !1 !==
                        p.setup.call(a, e, q, l) || (a.addEventListener ? a.addEventListener(n, l, !1) : a.attachEvent && a.attachEvent("on" + n, l))), p.add && (p.add.call(a, k), k.handler.guid || (k.handler.guid = d.guid)), f ? m.splice(m.delegateCount++, 0, k) : m.push(k), c.event.global[n] = !0)
                }
                a = null
            }
        },
            ...
            if (r && (k = r.events)) {
                ...
                for (l = b.length; l--;) {
                    ...
                    if (n) {
                        ...
                        for (h = g = D.length; g--;) {
                            var C = D[g];
                            !f && m !== C.origType || d && d.guid !== C.guid || p && !p.test(C.namespace) || e && e !== C.selector && ("**" !== e || !C.selector) || (D.splice(g, 1), C.selector && D.delegateCount--, y.remove && y.remove.call(a, C))
                        }
                        h && !D.length && (y.teardown && !1 !== y.teardown.call(a, q, r.handle) || c.removeEvent(a, n, r.handle), delete k[n])
                    } else
                        for (n in k) c.event.remove(a, n + b[l], d, e, !0)
                }
        ...
        trigger: function(a, b, d, e) {
            ...
            if (3 !== d.nodeType && 8 !== d.nodeType && !Tb.test(l + c.event.triggered)) {
                ...
                a.isTrigger = e ? 2 : 3;
                a.namespace = k.join(".");
                a.rnamespace = a.namespace ? new RegExp("(^|\\.)" + k.join("\\.(?:.*\\.|)") + "(\\.|$)") :
                    null;
                a.result = void 0;
                a.target || (a.target = d);
                ...
                if (e || !k.trigger || !1 !== k.trigger.apply(d, b)) {
                    ...
                    for (g = 0;
                        (m = h[g++]) && !a.isPropagationStopped();) a.type = 1 < g ? q : k.bindType || l, (f = (c._data(m, "events") || {})[a.type] && c._data(m, "handle")) && f.apply(m, b), (f = r && m[r]) &&
                        f.apply && pa(m) && (a.result = f.apply(m, b), !1 === a.result && a.preventDefault());
                    a.type = l;
        ...
        dispatch: function(a) {
            ...
            if (!h.preDispatch ||
                !1 !== h.preDispatch.call(this, a)) {
                var l = c.event.handlers.call(this, a, g);
                for (g = 0;
                    (e = l[g++]) && !a.isPropagationStopped();)
    ...
    c.Event = function(a, b) {
        ...
        a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? va : qa) : this.type = a;
        b && c.extend(this, b);
        ...
        setup: function() {
            ...
            c.event.add(this, "click._submit keypress._submit", function(a) {
                ...
                (a = c.nodeName(a, "input") || c.nodeName(a,
                    "button") ? c.prop(a, "form") : void 0) && !c._data(a, "submit") && (c.event.add(a, "submit._submit", function(a) {
                    a._submitBubble = !0
                }), c._data(a, "submit", !0))
            })
        },
    ...
    c.extend({
        ...
        clone: function(a, b, d) {
            ...
            if (q.html5Clone || c.isXMLDoc(a) || !Vb.test("\x3c" + a.nodeName + "\x3e")) var h = a.cloneNode(!0);
            else $a.innerHTML = a.outerHTML, $a.removeChild(h = $a.firstChild);
            if (!(q.noCloneEvent && q.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType ||
                    c.isXMLDoc(a))) {
                var l = y(h);
                var k = y(a);
                for (f = 0; null != (e = k[f]); ++f)
                    if (l[f]) {
                        ...
                        if (1 === n.nodeType) {
                            ...
                            if ("script" === I && n.text !== p.text) ub(n).text = p.text, vb(n);
                            else if ("object" === I) n.parentNode && (n.outerHTML = p.outerHTML), q.html5Clone && p.innerHTML && !c.trim(n.innerHTML) && (n.innerHTML = p.innerHTML);
                            else if ("input" === I && Oa.test(p.type)) n.defaultChecked =
                                n.checked = p.checked, n.value !== p.value && (n.value = p.value);
                            else if ("option" === I) n.defaultSelected = n.selected = p.defaultSelected;
                            else if ("input" === I || "textarea" === I) n.defaultValue = p.defaultValue
                        }
                    }
            }
            if (b)
                if (d)
                    for (k = k || y(a), l = l || y(h), f = 0; null != (e = k[f]); f++) wb(e, l[f]);
                else wb(a, h);
            l = y(h, "script");
        ...
        cleanData: function(a, b) {
            for (var d, e, f, g, h = 0, l = c.expando, k = c.cache, m = q.attributes, p = c.event.special; null != (d = a[h]); h++)
                if (b || pa(d))
                    if (g = (f = d[l]) && k[f]) {
                        if (g.events)
                            for (e in g.events) p[e] ?
                                c.event.remove(d, e) : c.removeEvent(d, e, g.handle);
                        k[f] && (delete k[f], m || "undefined" === typeof d.removeAttribute ? d[l] = void 0 : d.removeAttribute(l), R.push(f))
                    }
        }
    });
    c.fn.extend({
        ...
        append: function() {
            return ea(this, arguments, function(a) {
                1 !== this.nodeType &&
                    11 !== this.nodeType && 9 !== this.nodeType || tb(this, a).appendChild(a)
            })
        },
        prepend: function() {
            return ea(this, arguments, function(a) {
        ...
        html: function(a) {
            return E(this, function(a) {
                var b = this[0] || {},
                    e = 0,
                    f = this.length;
                if (void 0 === a) return 1 === b.nodeType ? b.innerHTML.replace(Cc, "") : void 0;
                if (!("string" !== typeof a || Dc.test(a) || !q.htmlSerialize && Vb.test(a) || !q.leadingWhitespace &&
                        Pa.test(a) || H[(pb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = c.htmlPrefilter(a);
                    try {
                        for (; e < f; e++) b = this[e] || {}, 1 === b.nodeType && (c.cleanData(y(b, !1)), b.innerHTML = a);
                        b = 0
                    } catch (g) {}
                }
        ...
        replaceWith: function() {
            ...
            return ea(this, arguments, function(b) {
                ...
                0 > c.inArray(this, a) && (c.cleanData(y(this)), d && d.replaceChild(b, this))
            }, a)
        }
    });
    c.each({
        ...
        function(a, b) {
            c.fn[a] = function(a) {
                for (var d = 0, f = [], g = c(a), h = g.length - 1; d <= h; d++) a = d === h ? this : this.clone(!0), c(g[d])[b](a), Wa.apply(f, a.get());
                return this.pushStack(f)
            }
        });
    var wa, Ab = {
    ...
    (function() {
        function a() {
            ...
            if (f = 0 === k.getClientRects().length)
                if (k.style.display = "", k.innerHTML = "\x3ctable\x3e\x3ctr\x3e\x3ctd\x3e\x3c/td\x3e\x3ctd\x3et\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e", k.childNodes[0].style.borderCollapse = "separate", c = k.getElementsByTagName("td"), c[0].style.cssText = "margin:0;border:0;padding:0;display:none", f = 0 === c[0].offsetHeight) c[0].style.display = "", c[1].style.display = "none", f = 0 === c[0].offsetHeight;
            a.removeChild(l)
        }
        var b, d, e, f, g, h, l = n.createElement("div"),
            k = n.createElement("div");
        k.style && (k.style.cssText = "float:left;opacity:.5", q.opacity = "0.5" === k.style.opacity, q.cssFloat = !!k.style.cssFloat, k.style.backgroundClip = "content-box", k.cloneNode(!0).style.backgroundClip = "", q.clearCloneStyle = "content-box" === k.style.backgroundClip, l = n.createElement("div"), l.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", k.innerHTML = "", l.appendChild(k), q.boxSizing = "" === k.style.boxSizing || "" === k.style.MozBoxSizing ||
            "" === k.style.WebkitBoxSizing, c.extend(q, {
    ...
    } else Xb.currentStyle && (ha = function(a) {
        ...
        style: function(a, b, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (void 0 !== d) {
                    var k = typeof d;
                    "string" ===
                    k && (f = Ma.exec(d)) && f[1] && (d = mb(a, b, f), k = "number");
                    if (null != d && d === d && ("number" === k && (d += f && f[3] || (c.cssNumber[g] ? "" : "px")), q.clearCloneStyle || "" !== d || 0 !== b.indexOf("background") || (h[b] = "inherit"), !(l && "set" in l) || void 0 !== (d = l.set(a, d, e)))) try {
                        h[b] = d
                    } catch (m) {}
    ...
    c.each(["height", "width"], function(a, b) {
        c.cssHooks[b] = {
            get: function(a, e, f) {
                if (e) return Gc.test(c.css(a, "display")) && 0 === a.offsetWidth ? ab(a, Hc, function() {
                    return Hb(a, b, f)
                }) : Hb(a, b, f)
            },
            set: function(a, e, f) {
    ...
    q.opacity || (c.cssHooks.opacity = {
        get: function(a, b) {
            return Fc.test((b && a.currentStyle ? a.currentStyle.filter :
        ...
        set: function(a, b) {
            ...
            d.zoom = 1;
            if ((1 <= b || "" === b) && "" === c.trim(f.replace(bb, "")) && d.removeAttribute && (d.removeAttribute("filter"), "" === b || a && !a.filter)) return;
    ...
    c.cssHooks.marginLeft = Ra(q.reliableMarginLeft, function(a, b) {
        if (b) return (parseFloat(ia(a, "marginLeft")) || (c.contains(a.ownerDocument, a) ? a.getBoundingClientRect().left - ab(a, {
            marginLeft: 0
        }, function() {
    ...
    c.Animation = c.extend(S, {
        ...
        tweener: function(a, b) {
            c.isFunction(a) ? (b = a, a = ["*"]) : a = a.match(J);
            for (var d, e = 0, f = a.length; e < f; e++) d = a[e], S.tweeners[d] =
                S.tweeners[d] || [], S.tweeners[d].unshift(b)
        },
        prefilters: [function(a, b, d) {
            ...
            d.overflow && (h.overflow = "hidden", q.shrinkWrapBlocks() || f.always(function() {
            ...
            for (e in b)
                if (y = b[e], Ic.exec(y)) {
                    ...
                    var C = C || "toggle" === y;
                    if (y === (l ? "hide" : "show"))
                        if ("show" === y && k && void 0 !== k[e]) l = !0;
                        else continue;
                    g[e] = k && k[e] || c.style(a,
                        e)
                } else n = void 0;
            if (c.isEmptyObject(g)) "inline" === ("none" === n ? za(a.nodeName) : n) && (h.display = n);
            else
                for (e in k ? "hidden" in k && (l = k.hidden) : k = c._data(a, "fxshow", {}), C && (k.hidden = !l), l ? c(a).show() : f.done(function() {
                        c(a).hide()
                    }), f.done(function() {
                        var b;
                        c._removeData(a, "fxshow");
                        for (b in g) c.style(a, b, g[b])
                    }), g) b = Jb(l ? k[e] : 0, e, f), e in k || (k[e] = b.start, l && (b.end = b.start, b.start = "width" === e || "height" === e ? 1 : 0))
        }],
    ...
    c.fn.extend({
        ...
        stop: function(a, b, d) {
            ...
            return this.each(function() {
                ...
                if (g) l[g] && l[g].stop && e(l[g]);
                    ...
                    for (g in l) l[g] && l[g].stop && Jc.test(g) && e(l[g]);
        ...
        finish: function(a) {
            ...
            return this.each(function() {
                ...
                for (e = f.length; e--;) f[e].elem === this && f[e].queue === a && (f[e].anim.stop(!0),
                    f.splice(e, 1));
            ...
            select: {
                get: function(a) {
                    for (var b, d = a.options, e = a.selectedIndex, f = (a = "select-one" === a.type || 0 > e) ? null : [], g = a ? e + 1 : d.length, h = 0 > e ? g : a ? e : 0; h < g; h++)
                        if (b = d[h], !(!b.selected && h !== e || (q.optDisabled ? b.disabled : null !== b.getAttribute("disabled")) || b.parentNode.disabled && c.nodeName(b.parentNode, "optgroup"))) {
                            b = c(b).val();
                            if (a) return b;
                            f.push(b)
                        }
    ...
    c.extend({
        attr: function(a, b, d) {
            ...
            if (3 !== f && 8 !== f && 2 !== f) {
                ...
                if (void 0 !== d) {
                    ...
                    if (g &&
                        "set" in g && void 0 !== (e = g.set(a, d, b))) return e;
                    a.setAttribute(b, d + "");
                    return d
                }
        ...
        removeAttr: function(a, b) {
            ...
            if (e && 1 === a.nodeType)
                for (; b = e[d++];) {
                    var f = c.propFix[b] || b;
                    c.expr.match.bool.test(b) ? Ha && oa || !cb.test(b) ? a[f] = !1 : a[c.camelCase("default-" +
                        b)] = a[f] = !1 : c.attr(a, b, "");
    ...
    c.each(c.expr.match.bool.source.match(/\w+/g), function(a, b) {
        ...
        Ha && oa || !cb.test(b) ? aa[b] = function(a, b, c) {
            ...
            if (!d) return a[c.camelCase("default-" + b)] ? b.toLowerCase() :
                null
        }
    });
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" === typeof b && "string" === d ? b ? this.addClass(a) : this.removeClass(a) : c.isFunction(a) ? this.each(function(d) {
                ...
                if ("string" === d) {
                    var g = 0;
                    var h = c(this);
                    for (f = a.match(J) || []; b = f[g++];) h.hasClass(b) ? h.removeClass(b) : h.addClass(b)
                } else if (void 0 === a || "boolean" === d)(b = ja(this)) && c._data(this, "__className__", b), c.attr(this, "class", b || !1 === a ? "" : c._data(this, "__className__") || "")
            })
        },
        hasClass: function(a) {
            var b, c = 0;
            for (a = " " + a + " "; b = this[c++];)
                if (1 === b.nodeType && -1 < (" " + ja(b) + " ").replace(db, " ").indexOf(a)) return !0;
            return !1
        }
    });
    ...
    c.parseXML = function(a) {
        ...
        try {
            ...
            } else d = new p.ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(a)
        } catch (e) {
            d = void 0
        }
        ...
        ajax: function(a, b) {
            function d(a, b, d, e) {
                ...
                if (2 !== P) {
                    ...
                    if (d) {
                        var r = m;
                        for (var t = x, w, K, z, A, Q = r.contents, E = r.dataTypes;
                            "*" === E[0];) E.shift(), void 0 === K && (K = r.mimeType || t.getResponseHeader("Content-Type"));
                        if (K)
                            for (A in Q)
                                if (Q[A] && Q[A].test(K)) {
                                    E.unshift(A);
                        ...
                        z ? (z !== E[0] && E.unshift(z), r = d[z]) : r = void 0
                    }
                    a: {
                        d = m;w = r;K = x;z = e;
                        var H;t = {};Q = d.dataTypes.slice();
                        if (Q[1])
                            for (M in d.converters) t[M.toLowerCase()] =
                                d.converters[M];
                        for (A = Q.shift(); A;) {
                            ...
                            if (A = Q.shift())
                                ...
                                if (!M)
                                    for (H in t)
                                        if (r = H.split(" "), r[1] === A && (M = t[G + " " + r[0]] || t["* " + r[0]])) {
                                            !0 === M ? M = t[H] : !0 !== t[H] && (A = r[0], Q.unshift(r[1]));
                                            break
                                        }
                                if (!0 !== M)
                                    if (M && d["throws"]) w = M(w);
                    ...
                    if (e)
                        if (m.ifModified && ((k = x.getResponseHeader("Last-Modified")) && (c.lastModified[N] = k), (k = x.getResponseHeader("etag")) && (c.etag[N] = k)), 204 === a || "HEAD" === m.type) k = "nocontent";
                        ...
                        var J = r.error;
                        e = !J
                    } else if (J = k, a || !k) k = "error", 0 > a && (a = 0);
                    x.status = a;
                    x.statusText = (b || k) + "";
                    ...
                    C.fireWith(n, [x, k]);
                    h && (q.trigger("ajaxComplete", [x, m]), --c.active || c.event.trigger("ajaxStop"))
                }
            }
            ...
            var e, f, g, h, l, k, m = c.ajaxSetup({}, b),
                n = m.context || m,
                q = m.context && (n.nodeType || n.jquery) ? c(n) : c.event,
                y = c.Deferred(),
                ...
                x = {
                    ...
                    getResponseHeader: function(a) {
                        ...
                        if (2 === P) {
                            if (!k)
                                for (k = {}; b = Sc.exec(f);) k[b[1].toLowerCase()] = b[2];
                            b = k[a.toLowerCase()]
                        }
            ...
            m.dataTypes =
                c.trim(m.dataType || "*").toLowerCase().match(J) || [""];
            null == m.crossDomain && (a = $b.exec(m.url.toLowerCase()), m.crossDomain = !(!a || a[1] === ta[1] && a[2] === ta[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (ta[3] || ("http:" === ta[1] ? "80" : "443"))));
            ...
            var N = m.url;
            m.hasContent ||
                (m.data && (N = m.url += (fb.test(N) ? "\x26" : "?") + m.data, delete m.data), !1 === m.cache && (m.url = Zb.test(N) ? N.replace(Zb, "$1_\x3d" + eb++) : N + (fb.test(N) ? "\x26" : "?") + "_\x3d" + eb++));
            m.ifModified && (c.lastModified[N] && x.setRequestHeader("If-Modified-Since", c.lastModified[N]), c.etag[N] && x.setRequestHeader("If-None-Match", c.etag[N]));
            (m.data && m.hasContent && !1 !== m.contentType || b.contentType) && x.setRequestHeader("Content-Type", m.contentType);
            x.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] +
                ("*" !== m.dataTypes[0] ? ", " + bc + "; q\x3d0.01" : "") : m.accepts["*"]);
            for (e in m.headers) x.setRequestHeader(e, m.headers[e]);
            if (m.beforeSend && (!1 === m.beforeSend.call(n, x, m) || 2 === P)) return x.abort();
            G = "abort";
            for (e in {
                    success: 1,
                    error: 1,
    ...
    c.ajaxSettings.xhr = void 0 !== p.ActiveXObject ? function() {
        return this.isLocal ? Mb() : 8 < n.documentMode ? Va() : /^(get|post|head|put|delete|options)$/i.test(this.type) &&
            Va() || Mb()
    } : Va;
    var Yc = 0,
        Ia = {},
                ...
                send: function(d, e) {
                    ...
                    b = function(d, f) {
                        if (b && (f || 4 === g.readyState))
                            if (delete Ia[h], b = void 0, g.onreadystatechange = c.noop, f) 4 !== g.readyState && g.abort();
                            else {
                                var k = {};
                                var l = g.status;
                    ...
                    a.async ? 4 === g.readyState ?
                        p.setTimeout(b) : g.onreadystatechange = Ia[h] = b : b()
                },
                abort: function() {
                    b && b(void 0, !0)
                }
    ...
    c.ajaxPrefilter("json jsonp", function(a, b, d) {
        ...
        if (f || "jsonp" === a.dataTypes[0]) {
            ...
            f ? a[f] = a[f].replace(hb,
                "$1" + g) : !1 !== a.jsonp && (a.url += (fb.test(a.url) ? "\x26" : "?") + a.jsonp + "\x3d" + g);
    ...
    c.fn.load = function(a, b, d) {
        ...
        0 < g.length && c.ajax({
            ...
            f = arguments;
            g.html(l ? c("\x3cdiv\x3e").append(c.parseHTML(a)).find(l) :
                a)
    ...
    c.offset = {
        setOffset: function(a, b, d) {
            ...
            var k =
                c.css(a, "left");
            ("absolute" === e || "fixed" === e) && -1 < c.inArray("auto", [l, k]) ? (k = f.position(), l = k.top, k = k.left) : (l = parseFloat(l) || 0, k = parseFloat(k) || 0);
    ...
    c.each({
        ...
        c.fn[a] = function(e) {
            return E(this, function(a, e, h) {
                var f = Nb(a);
                if (void 0 === h) return f ? b in f ? f[b] : f.document.documentElement[e] :
                    a[e];
    ...
    c.each(["top", "left"], function(a, b) {
        c.cssHooks[b] = Ra(q.pixelPosition, function(a, e) {
            if (e) return e = ia(a, b), Ba.test(e) ? c(a).position()[b] + "px" : e
        })
    });
    c.each({
        Height: "height",
        ...
        c.each({
            ...
            c.fn[e] = function(e, g) {
                ...
                return E(this, function(b, d,
                    e) {
                    return c.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType ? (d = b.documentElement, Math.max(b.body["scroll" + a], d["scroll" + a], b.body["offset" + a], d["offset" + a], d["client" + a])) : void 0 === e ? c.css(b, d, l) : c.style(b, d, e, l)
                }, b, f ? e : void 0, f, null)
            }
        })
    });
