(function(window) {
    ...
    window.MDIGITAL.version = '2.47.3';
})(window);
window.KAMPYLE_CONSTANT = {
    PLACEHOLDERS: {
        URL_PREFIX: 'https://resources.digital-cloud-gov.medallia.com/',
    ...
    SRC: {
        OPEN_SANS: 'resources/form/FormBuilder/vendor/fonts-googleapis/css/open-sans-v14.css',
        COOLADATA: 'resources/onsite/js/cool-2.1.15.min.js',
        OOPS: 'resources/onsite/images/oops.svg'
    },
    FORM_HEIGHT: '450',
    FORM_WIDTH: '450',
    ...
    ANALYTICS_EVENT_FORBIDDEN_PROPERTIES: {
        sourceWindow: true,
        content: true,
        feedbackCorrelationUUID: true
    },
    FORM_TRIGGER_TYPES_MAP: {
        embedded: 'Embedded',
        invitation: 'Intercept',
        button: 'AlwaysOn',
        code: 'TriggeredByCode',
    },
    EXPOSED_FEEDBACK_KEYS: {
        FORM_ID_LABEL: 'Form_ID',
        FORM_TYPE_LABEL: 'Form_Type',
        FEEDBACK_UUID_LABEL: 'Feedback_UUID',
        FEEDBACK_CONTENT_LABEL: 'Content',
        FORM_LANGUAGE_LABEL: 'Form_Language',
    },
    ...
    IFRAME_SETTINGS: {
        EMBEDDED: {
            IFRAME_ID_PREFIX: "embeddedIframe"
        },
        LIGHTBOX: {
            IFRAME_ID_PREFIX: "kampyleForm",
            CONTAINER_ID_PREFIX: "kampyleFormModal",
            WRAPPER_ID: "MDigitalLightboxWrapper"
        },
        ANIMATION: {
            CONTAINER_ID: 'KampyleAnimationContainer',
            IFRAME_ID: 'kampyleFormAnimation',
            WRAPPER_ID: 'MDigitalAnimationWrapper'
        },
        INVITATION: {
            IFRAME_ID: 'kampyleInvite',
            CONTAINER_ID: 'kampyleInviteModal',
            IFRAME_TITLE: 'Invitation to provide feedback',
            WRAPPER_ID: 'MDigitalInvitationWrapper'
        },
        OOPS: {
            CONTAINER_ID_PREFIX: 'mdigital-no-json-modal_',
            CLOSE_BUTTON_ID: 'close-no-json-modal'
        },
        IFRAME_TITLE: "Feedback Survey",
    },
    PROPERTY_SETTINGS: {
        MANUALLY_INVITE_TARGETING: 'MANUALLY_INVITE_TARGETING',
        CUSTOM_CSS_UPLOAD: 'CUSTOM_CSS_UPLOAD'
    },
    EVENTS: {
    ...
    TARGETING_PHASES: {
        ...
        QUARANTINE_TARGETING: "quarantineTargeting"
    },
    TARGETING_RULES: {
        INVITE_IF_ANY_SURVEY_ALREADY_SUBMITTED_PER_SESSION: 'InviteAnySurveyAlreadySubmittedPerSession',
        INVITE_IF_ANY_INVITE_ALREADY_SHOWN_PER_SESSION: 'InvitePerSession'
    },
    REGIONS: {
        DEV: 'dev',
        QA: 'qa',
        COLO_QA: 'digital-cloud-qa',
        COLO_US: 'digital-cloud-us',
    },
    MEMORY_DATA_FIELDS: {
    ...
    SESSION_DATA_FIELDS: {
        IS_SURVEY_SUBMITTED_IN_SESSION: 'md_isSurveySubmittedInSession'
    },
    TIMEOUT_HANDLERS: {
        FORM_APP_STATUS: 'formAppStatus',
        EMBEDDED_STATUS: 'embeddedFormStatus',
    },
    CSS_FONT_RULE: 'CSSFontFaceRule',
    NETWORK: {
        RETRY_TIMEOUT: 1000,
        REQUEST_TIMEOUT: 5000,
        TIME_FOR_FORM_TO_LOAD_MS: 60000,
        NUM_OF_RETRIES: 3
    },
    ERROR_CODE: {
        SECURITY_ERROR: 18
    ...
    URLS: {
        KMA_UDC: 'https://nginx-log-post.kampyle.com/?data='
    },
    TEXTS: {
        DEFAULT_JSON_ERROR_MESSAGES: {
            title: 'Oops...',
            body: 'We can’t collect your feedback at the moment.<br/>Refresh your page and try again',
            close: 'Close this modal',
        },
        SCREEN_CAPTURE: {
            DEFAULT_DESCRIPTION: 'Click "Capture Image" button or drag the cursor to highlight a specific area'
        }
    },
    FORM_LOADING_FAILURE_CAUSE: {
    ...
    SCREEN_CAPTURE: {
        ...
        DOM_SELECTION_VALUE: "domSelector",
        AREA_SELECTION_VALUE: "highlight",
    },
    COOLADATA_HTTP_EVENTS_BY_METHOD: {
        BEFORE: {
            POST: 'neb_beforeHttpPostRequest'
        },
        AFTER: {
            GET: 'neb_afterHttpGetRequest',
            POST: 'neb_afterHttpPostRequest'
        },
        TIMEOUT: {
            GET: 'neb_afterHttpGetRequestOnTimeout',
            POST: 'neb_afterHttpPostRequestOnTimeout'
        },
        ERROR: {
            GET: 'neb_afterHttpGetRequestOnError',
            POST: 'neb_afterHttpPostRequestOnError'
        },
        ERROR_STATUS_CODE: {
            GET: 'neb_afterHttpGetRequestOnErrorStatusCode',
            POST: 'neb_afterHttpPostRequestOnErrorStatusCode'
        }
    },
    HTTP_METHODS: {
        GET: 'GET',
    ...
    COLORS: {
        USERSNAP_V4_SELECTION_COLOR: "#fb585b",
        USERSNAP_ONPREM_SELECTION_COLOR: "#004CCB",
    },
    VIEW: {
        FEEDBACK_BUTTON_ID: 'nebula_div_btn',
        FEEDBACK_BUTTON_CONTAINER_ID: 'kampyleButtonContainer',
    },
    CLOSE_FORM_PARAM_VALUES: {
        ALL: 'all',
        EMBEDDED: 'embedded',
        MODAL: 'modal'
    },
    SPINNER_SETTINGS: {
        ID: 'MDigital_spinnerCircle',
        CONTAINER_ID: 'MDigital_spinnerContainer',
        SIZE: {
            LARGE: "large",
            SMALL: "small"
        }
    ...
    CSS_SETTINGS: {
        STYLE_SHEET_ANIMATION_NAME: 'MDigital_animationStyle',
        ANIMATION_RULE_SPIN_NAME: 'MDigital_spin'
    }
};
window.MDIGITAL.CONFIGURATION = (function(window, document) {
    ...
    function getOnsiteConfiguration() {
        ...
        return {
            "provisions": {
                ...
                "chtmlLogs": null,
                "disableFormReloadOnClose": true,
                "customEventsBroadcast": true,
                "sharePropertyBetweenSubdomains": null,
                "googleAnalyticsClientEventsEnabled": null,
                "spaUrlPolling": null,
                "20dcr4_MPC2802_enable_backendGeneratedUUID": null,
                "21dcr2_MPC2743_enable_newLiveForm": null,
                ...
                "adobeAnalytics": null,
                "eventIncludeFeedbackContent": null,
                "userSnapV4": null,
                "dynamicModalSizeInCustomHtml": null,
                ...
                "serverBasedTargeting": null,
                "CSPRemoveInlineStyling": null,
                "21dcr6_MPC4144_enable_SelfServiceV2Migration": null,
                "enableOverflow": null,
                "doNotSurveyOnUBTNetworkFail": null,
                "mobileInvitationLayout": null,
                ...
                "mobileWebDynamicFormSizeInFormBuilder": true,
                ...
                "formTemplatesWCAG": true,
                "formSpacing": null,
                "21dcr1_MPC_3283_enable_RTL": null,
                ...
                "targetingRuleIdleTime": null,
                "22dcr2_MPC4277_useDecibelTriggers": null,
                "21dcr6_MPC4143_enable_HideAlternativeOptions": null,
                "21dcr6_MPC4296_enable_UBTIdentifierHash": null,
                "onPremHybrid": null,
                "responsiveRatingComponent": null,
                "localizedForms": true,
                "21dcr3_MPC3281_enable_newModalDialogs": true,
                "UBTExtraEvents": null,
                "21dcr2_MPC3296_enable_usersnapOnpremCSP": null,
                "adobeAnalyticsObjectName": null,
                "mobileWebDynamicFormSize": null,
                ...
                "cooladataIntegration": false,
                "cooladataCreateSessionEvent": null,
                "21DCR1_MPC3199_enable_RatingLabelAlign": null,
                "21DCR2_MPC3662_EnableEventsForCEDebug": null,
                "parallelTabSolution": null
            },
            "sbtServerDomain": "NOT_SET",
            "sbtEnvPrefix": "wdcgov_",
            "endUserIdentifier": {},
            "formNodes": [{
                "formId": "259",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/259/form1662486911776.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/259/formData1662486911849_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/259/formData1662486911849_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/259/formDataV2_1662486911849_###LANGUAGE_CODE###.json",
                "inviteJsonRelativePath": "wdcgov/2/forms/259/invitationData1662486893147_###LANGUAGE_CODE###.json",
                "availableLanguages": ["en", "es", "zh"],
                "triggerAvailableLanguages": ["zh", "es", "en"],
                "functionFileUrl": "",
                "customParams": "[{\"id\":\"6033\",\"unique_name\":\"Tracking Code\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcode\",\"is_identifier\":\"false\"}, {\"id\":\"5984\",\"unique_name\":\"Product Name\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaPname\",\"is_identifier\":\"false\"}, {\"id\":\"5983\",\"unique_name\":\"Domain Language\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaSurveyLanguage\",\"is_identifier\":\"false\"}, {\"id\":\"4\",\"unique_name\":\"_gid\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_gid\",\"is_identifier\":\"false\"}, {\"id\":\"7\",\"unique_name\":\"_ga\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_ga\",\"is_identifier\":\"false\"}, {\"id\":\"5973\",\"unique_name\":\"Tracking Category 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcat\",\"is_identifier\":\"false\"}, {\"id\":\"5975\",\"unique_name\":\"Tracking ID 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTid\",\"is_identifier\":\"false\"}, {\"id\":\"5974\",\"unique_name\":\"Tracking Name 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTname\",\"is_identifier\":\"false\"}, {\"id\":\"6\",\"unique_name\":\"Number Randomizer\",\"type\":\"Number\",\"source\":\"Cookie\",\"source_name\":\"mab_usps\",\"is_identifier\":\"false\"}, {\"id\":\"5\",\"unique_name\":\"Cart Count\",\"type\":\"Number\",\"source\":\"Var\",\"source_name\":\"cart_count\",\"is_identifier\":\"false\"}]",
                "formType": "invitation",
                "formDisplay": {
                ...
                "onSiteData": {
                    ...
                    "kampyleInvitePerSession": {
                        "inviteOncePerSession": "false"
                    },
                    "kampyleTimeInSession": {
                        "time": "5"
                    },
                    "declined": {
                        "days": "30"
                    ...
                    "genericRule": "{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"20\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"greaterThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"},{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"31\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"smallerThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"}]}]}"
                }
            }, {
                "formId": "254",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/254/form1662486916145.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/254/formData1662486916221_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                "isFullWidthEmbedded": "null",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/254/formData1662486916221_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/254/formDataV2_1662486916221_###LANGUAGE_CODE###.json",
                "inviteJsonRelativePath": "wdcgov/2/forms/254/invitationData1662486917866_###LANGUAGE_CODE###.json",
                "availableLanguages": ["en", "es", "zh"],
                ...
                "onSiteData": {
                    ...
                    "genericRule": "{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"5\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"greaterThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"},{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"11\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"smallerThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"}]}]}"
                }
            }, {
                "formId": "245",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/245/form1662486880500.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/245/formData1662486880579_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                "isFullWidthEmbedded": "null",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/245/formData1662486880579_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/245/formDataV2_1662486880579_###LANGUAGE_CODE###.json",
                "inviteJsonRelativePath": "wdcgov/2/forms/245/invitationData1662486917821_###LANGUAGE_CODE###.json",
                "availableLanguages": ["en", "es"],
                "triggerAvailableLanguages": ["es", "en"],
                "functionFileUrl": "",
                "customParams": "[{\"id\":\"6033\",\"unique_name\":\"Tracking Code\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcode\",\"is_identifier\":\"false\"}, {\"id\":\"5984\",\"unique_name\":\"Product Name\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaPname\",\"is_identifier\":\"false\"}, {\"id\":\"5983\",\"unique_name\":\"Domain Language\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaSurveyLanguage\",\"is_identifier\":\"false\"}, {\"id\":\"4\",\"unique_name\":\"_gid\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_gid\",\"is_identifier\":\"false\"}, {\"id\":\"7\",\"unique_name\":\"_ga\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_ga\",\"is_identifier\":\"false\"}, {\"id\":\"5977\",\"unique_name\":\"Tracking Features\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"window.dataLayer.0.ecommerce.impressions.0.dimension149\",\"is_identifier\":\"false\"}, {\"id\":\"5973\",\"unique_name\":\"Tracking Category 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcat\",\"is_identifier\":\"false\"}, {\"id\":\"5975\",\"unique_name\":\"Tracking ID 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTid\",\"is_identifier\":\"false\"}, {\"id\":\"5974\",\"unique_name\":\"Tracking Name 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTname\",\"is_identifier\":\"false\"}, {\"id\":\"6\",\"unique_name\":\"Number Randomizer\",\"type\":\"Number\",\"source\":\"Cookie\",\"source_name\":\"mab_usps\",\"is_identifier\":\"false\"}, {\"id\":\"5\",\"unique_name\":\"Cart Count\",\"type\":\"Number\",\"source\":\"Var\",\"source_name\":\"cart_count\",\"is_identifier\":\"false\"}]",
                "formType": "invitation",
                "formDisplay": {
                ...
                "onSiteData": {
                    ...
                    "genericRule": "{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"6\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"smallerThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"}]}"
                }
            }, {
                "formId": "11",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/11/form1662486898990.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/11/formData1662486899093_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                "isFullWidthEmbedded": "null",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/11/formData1662486899093_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/11/formDataV2_1662486899093_###LANGUAGE_CODE###.json",
                "inviteJsonRelativePath": "wdcgov/2/forms/11/invitationData1662486899563_###LANGUAGE_CODE###.json",
                "availableLanguages": ["en", "es", "zh"],
                "triggerAvailableLanguages": ["es", "zh", "en"],
                "functionFileUrl": "",
                "customParams": "[{\"id\":\"6033\",\"unique_name\":\"Tracking Code\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcode\",\"is_identifier\":\"false\"}, {\"id\":\"5984\",\"unique_name\":\"Product Name\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaPname\",\"is_identifier\":\"false\"}, {\"id\":\"5983\",\"unique_name\":\"Domain Language\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaSurveyLanguage\",\"is_identifier\":\"false\"}, {\"id\":\"4\",\"unique_name\":\"_gid\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_gid\",\"is_identifier\":\"false\"}, {\"id\":\"7\",\"unique_name\":\"_ga\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_ga\",\"is_identifier\":\"false\"}, {\"id\":\"5977\",\"unique_name\":\"Tracking Features\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"window.dataLayer.0.ecommerce.impressions.0.dimension149\",\"is_identifier\":\"false\"}, {\"id\":\"5973\",\"unique_name\":\"Tracking Category 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcat\",\"is_identifier\":\"false\"}, {\"id\":\"5975\",\"unique_name\":\"Tracking ID 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTid\",\"is_identifier\":\"false\"}, {\"id\":\"5974\",\"unique_name\":\"Tracking Name 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTname\",\"is_identifier\":\"false\"}, {\"id\":\"6\",\"unique_name\":\"Number Randomizer\",\"type\":\"Number\",\"source\":\"Cookie\",\"source_name\":\"mab_usps\",\"is_identifier\":\"false\"}, {\"id\":\"5\",\"unique_name\":\"Cart Count\",\"type\":\"Number\",\"source\":\"Var\",\"source_name\":\"cart_count\",\"is_identifier\":\"false\"}]",
                "formType": "invitation",
                "formDisplay": {
                ...
                "inviteData": {
                    "inviteUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/11/invitation1662486899530.html",
                    "inviteHeight": "400",
                    "inviteWidth": "700",
                    "skipInvitation": "true",
                    "invitationPosition": "top",
                    "inviteDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/11/invitationData1662486899563_###LANGUAGE_CODE###.json"
                },
                "urlRules": {
                    "exclusionUrl": {
                        "rule": "https://tools.usps.com/go/TrackConfirmAction_input;https://www.uspsdelivers.com/;https://stage-store.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://stage-store.usps.com/;https://ecom-cat.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://ecom-cat.usps.com/;https://special.usps.com;https://testkits.store.usps.com;https://deliver.usps.com;https://store10.usps.com/;https://testkits-store.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://testkits-store.usps.com/;https://delivery.usps.com"
                    },
                    "inclusionUrl": {
                        "rule": "https://tools.usps.com/go/TrackConfirmAction?tLabels=;https://tools.usps.com/go/TrackConfirmAction?tRef=;https://tools.usps.com/go/TrackConfirmAction?qtc_tLabels1=;https://tools.usps.com/go/TrackConfirmAction"
                    }
                },
                "onSiteData": {
                    "devicetypes": ["desktop", "mobile", "tablet"],
                    ...
                    "kampyleInvitePerSession": {
                        "inviteOncePerSession": "true"
                    },
                    "submitted": {
                        "days": "60"
                    },
                    "genericRule": "{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"10\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"greaterThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"},{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"16\",\"formId\":-1,\"fieldId\":6,\"formName\":\"All Forms\",\"uniqueId\":\"customParam6\",\"condition\":\"smallerThan\",\"fieldName\":\"Number Randomizer\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"}]}]}"
                }
            }, {
                "formId": "7",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/7/form1662486898601.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/7/formData1662486898687_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                "isFullWidthEmbedded": "null",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/7/formData1662486898687_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/7/formDataV2_1662486898687_###LANGUAGE_CODE###.json",
                "inviteJsonRelativePath": "wdcgov/2/forms/7/invitationData1662486923549_###LANGUAGE_CODE###.json",
                "availableLanguages": ["es", "zh", "en"],
                "triggerAvailableLanguages": ["zh", "es", "en"],
                "functionFileUrl": "",
                "customParams": "[{\"id\":\"6033\",\"unique_name\":\"Tracking Code\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcode\",\"is_identifier\":\"false\"}, {\"id\":\"5984\",\"unique_name\":\"Product Name\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaPname\",\"is_identifier\":\"false\"}, {\"id\":\"5983\",\"unique_name\":\"Domain Language\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaSurveyLanguage\",\"is_identifier\":\"false\"}, {\"id\":\"4\",\"unique_name\":\"_gid\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_gid\",\"is_identifier\":\"false\"}, {\"id\":\"7\",\"unique_name\":\"_ga\",\"type\":\"Text\",\"source\":\"Cookie\",\"source_name\":\"_ga\",\"is_identifier\":\"false\"}, {\"id\":\"5973\",\"unique_name\":\"Tracking Category 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTcat\",\"is_identifier\":\"false\"}, {\"id\":\"5975\",\"unique_name\":\"Tracking ID 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTid\",\"is_identifier\":\"false\"}, {\"id\":\"5974\",\"unique_name\":\"Tracking Name 2.0\",\"type\":\"Text\",\"source\":\"Var\",\"source_name\":\"medalliaTname\",\"is_identifier\":\"false\"}, {\"id\":\"6\",\"unique_name\":\"Number Randomizer\",\"type\":\"Number\",\"source\":\"Cookie\",\"source_name\":\"mab_usps\",\"is_identifier\":\"false\"}, {\"id\":\"5\",\"unique_name\":\"Cart Count\",\"type\":\"Number\",\"source\":\"Var\",\"source_name\":\"cart_count\",\"is_identifier\":\"false\"}]",
                "formType": "invitation",
                ...
                "inviteData": {
                    "inviteUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/7/invitation1662486923518.html",
                    "inviteHeight": "400",
                    "inviteWidth": "700",
                    "skipInvitation": "true",
                    "invitationPosition": "top",
                    "inviteDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/7/invitationData1662486923549_###LANGUAGE_CODE###.json"
                },
                "urlRules": {
                    "exclusionUrl": {
                        "rule": "/mobile-cart.jsp;/checkout/login.jsp;/checkout/shipping.jsp;/checkout/;/payment/MCheckout_input;/store/checkout/confirm.jsp;https://pay.usps.com/;https://catpx-pay.usps.com/;https://sitpx-pay.usps.com/;/pse-form-enter.action;/store/pse/pse-configure.jsp;/pfs/;/schedule-pickup-steps.htm;https://ecom-cat.usps.com/store/checkout/shipping.jsp;https://ecom-sit.usps.com/store/checkout/shipping.jsp;https://store.usps.com/store/checkout/shipping.jsp;https://postalpro.usps.com/;https://gateway.usps.com/;https://prodpx-promotool.usps.com/promoreg/campaignView.do;https://about.usps.com/;https://pe.usps.com/;http://pe.usps.com/;https://delivercheer.com/;https://dbcalc-cat.usps.com/CalculatorSetPage.aspx;https://dbcalc.usps.com/CalculatorSetPage.aspx;https://special.usps.com;https://testkits.store.usps.com;https://deliver.usps.com;https://store10.usps.com/;https://testkits-store.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://testkits-store.usps.com/;https://stage-store.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://stage-store.usps.com/;https://ecom-cat.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://ecom-cat.usps.com/;https://testkits-store.usps.com/store/product/shipping-supplies/white-house-project-P_TKIT22;https://testkits-store.usps.com/;https://delivery.usps.com"
                    },
                    "inclusionUrl": {
                        "rule": "https://ecom-sit.usps.com;https://ecom-cat.usps.com;https://store.usps.com"
                    }
                },
                "onSiteData": {
                    "kampyleInvitePercentageUsers": {
                    ...
                    "genericRule": "{\"type\":\"criteriaGroup\",\"conjunction\":\"AND\",\"childrenCriterias\":[{\"type\":\"criteria\",\"value\":\"0\",\"formId\":7,\"fieldId\":5,\"formName\":\"Store Abandonment\",\"uniqueId\":\"customParam5\",\"condition\":\"greaterThan\",\"fieldName\":\"Cart Count\",\"fieldType\":\"Number\",\"fieldOrigin\":\"customParam\"}]}"
                }
            }, {
                "formId": "244",
                "isCustomHtmlEnabled": "false",
                "formVersion": "2",
                "formHtmlUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/244/form1662486911836.html",
                "formDataUrl": "https://resources.digital-cloud-gov.medallia.com/wdcgov/2/forms/244/formData1662486911936_###LANGUAGE_CODE###.json",
                "formWidth": "450",
                "formHeight": "450",
                "isFixedSize": "false",
                "isFullWidthEmbedded": "null",
                ...
                "formJsonRelativePath": "wdcgov/2/forms/244/formData1662486911936_###LANGUAGE_CODE###.json",
                "formJsonV2RelativePath": "wdcgov/2/forms/244/formDataV2_1662486911936_###LANGUAGE_CODE###.json",
                "availableLanguages": ["en", "es", "zh"],
                "triggerAvailableLanguages": ["en", "es", "zh"],
                "buttonData": {
                    "textLocalization": {
                        "en": "Feedback",
                        "es": "Comentarios",
            ...
            "usersnapEnvId": "NOT_SET",
            "usersnapOnpremWidgetLoaderPath": null,
            "propertyMessages": null,
            "globalResourcesUrl": "https://resources.digital-cloud-gov.medallia.com/liveApp/resources",
            "submitUrlPrefix": "https://feedback.digital-cloud-gov.medallia.com/",
            "submitUrlSuffix": "feedback/api/feedback/submit",
            "submitUrlWithBackendUUID": "https://feedback.digital-cloud-gov.medallia.com/feedback/api/v2/feedback/submit",
            "region": "digital-cloud-gov",
            "websiteId": 2,
            "accountId": 1,
            "packageVersion": null,
            "adobeSdkName": null,
            "sharedSubdomain": null,
            "customCssUpload": false,
            ...
            "screenCaptureSelectionTool": "AREA_SELECTION",
            "isSpa": false
        };
    }
    ...
    function onsiteDataFailed(error) {
        var eventData = {
            errorMessage: KAMPYLE_CONSTANT.LOG_MESSAGES.ERROR_DYNAMIC_ONSITE_INITIALIZATION,
...
window.KAMPYLE_FUNC = (function() {
    function init() {
        ...
        var context = KAMPYLE_UTILS.getUrlParam('nebContext') || 'live';
    ...
    function handleInviteApplicationUpdated(eventName, data) {
        ...
        if (shouldShowInvite && MDIGITAL.FORM_STATE.isInviteLoaded(data.formId) && isJsonDataLoaded(data.formId, true) && !isAnyOtherFormAlreadyShown()) {
            ...
            KAMPYLE_DATA.setFormState(data.formId, {
                inviteShown: false
            });
        }
    }
    ...
    function subscribeToCustomEvents() {
        var eventMapping = {
            neb_inviteDeclined: ['neb_displayClosed'],
            neb_formClosed: ['neb_displayClosed'],
        };
        KAMPYLE_EVENT_DISPATCHER.subscribeMany(eventMapping);
    }
    ...
    function isFormAlreadyShown(formId) {
        ...
        if (shouldSkipShowingForm) {
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_formReady', {
                formId: formId
            });
            KAMPYLE_DATA.setFormState(formId, {
                shouldBeShown: false
            });
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_skipShowingForm', {
                formId: formId
            });
        }
        return shouldSkipShowingForm;
    }
    ...
    function isFormLoaded(formId) {
        ...
        var displayType = KAMPYLE_DATA.getDisplayType(formData);
        return MDIGITAL.FORM_STATE.isFormLoaded(formId) || displayType === KAMPYLE_CONSTANT.DISPLAY_TYPES.POPUP;
    }
    ...
    function shouldRenderForm(data) {
        ...
        return isFormLoadedSuccessfully && shouldShowForm;
    }
    ...
    function onJsonFetchingFailed(data, isInvite, error) {
        ...
        if (!isInvite) {
            KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.NEB_FORM_LOADING_HAS_FAILED, {
                formId: data.formId,
                failureCause: KAMPYLE_CONSTANT.FORM_LOADING_FAILURE_CAUSE.JSON_FAILED
            });
        }
        var eventData = {
            errorData: {
    ...
    function handleFormStateUpdated(data) {
        if (shouldRenderForm(data)) {
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_showForm', {
                formId: data.formId
            });
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_formReady', {
                formId: data.formId
    ...
    function getTriggerTypeByEvent(eventName) {
        var eventTriggerMapping = {
            neb_buttonClicked: 'Button',
            neb_sdkShowForm: 'ByCode',
            neb_routeToForm: 'ByCode',
            neb_skipInvitation: 'Invitation',
            neb_inviteAccepted: 'Invitation',
        };
    ...
    function handleShowForm(eventName, data) {
        ...
        KAMPYLE_DATA.saveFormExtraData(data.formId, {
    ...
    function createSession() {
        ...
        try {
            ...
            var data = {
                ...
                errorStack: e.stack,
                additionalInfo: "createSession- failed to access document.referrer, probably CORS problem when the customer's iframe is hosted in a website with different domain."
            };
    ...
    function handleFormLoading(eventName, data) {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_form_loaded', {
            formId: data.formId
        });
    }
    ...
    function sendInviteInitialData(eventName, data) {
        ...
        KAMPYLE_UTILS.sendMessageToIframe('kampyleInvite', {
            action: 'inviteShown',
        });
        var messageData = {
        ...
        if (hostWidth > formWidth && hostHeight > formHeight) {
            if (KAMPYLE_DATA.isCustomHtmlAndFixedSizeForm(currentFormId)) {
                iframeStyleObject = {
                    position: 'absolute',
                    top: '50%',
                    'margin-top': -formHeight / 2 + 'px',
                    left: '50%',
                    'margin-left': -formWidth / 2 + 'px',
                    height: formHeight + 'px',
                    width: formWidth + 'px',
                };
            } else {
    ...
    function getUserIdentifierVal() {
        ...
        var userIdentifierVal = MDIGITAL.CUSTOM_PARAMETERS.getCustomParamValue({
            name: identifierCustomParam.source_name,
            type: identifierCustomParam.type,
            source: identifierCustomParam.source,
        });
    ...
    function updateIdentifierDataIntegerIfNecessary(identifierDataValue, userStateString) {
        ...
        var identifierDataToSync = {
            identifierDataState: userStateString,
            identifierValOnLocalStorage: localStorageDate
        };
        var identifierDataValues = {
            identifierDataState: userStateString,
            identifierValOnSbt: identifierDataValue,
            identifierValOnLocalStorage: localStorageDate
        };
    ...
    function startCheckingTargeting() {
        ...
        if (window.KAMPYLE_ONSITE_STATE !== 'manual') {
            ...
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_targetingInit', {
                skipInviteTargeting: shouldSkipInviteTargeting
            });
        }
    }
    ...
    function setQuarantineDeclinedDate(eventName) {
        ...
        if (checkProvision(KAMPYLE_CONSTANT.PROVISIONS.SERVER_BASED_TARGETING)) {
            KAMPYLE_EVENT_DISPATCHER.trigger(eventName, {
                declinedDate: date
            });
        }
    ...
    function handleFormClosed(eventName, data) {
        ...
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.NEW_MODAL_DIALOGS)) {
            ...
            KAMPYLE_UTILS.triggerCustomEvent('neb_formClosed', {
                formId: data.formId
            });
            if (KAMPYLE_DATA.getMemoryData('context') === 'preview') {
                window.close();
    ...
    function finishFormClosed(formId) {
        ...
        if (buttonFormId) {
            setTimeout(function() {
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_showButton', {
                    formId: buttonFormId,
                    formClosed: true
                });
    ...
    function triggerFormClosedEvents(formId) {
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_afterFormClosed', {
            formId: formId
        });
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.NEW_MODAL_DIALOGS)) {
            KAMPYLE_UTILS.triggerCustomEvent('neb_formClosed', {
    ...
    function setQuarantineSubmittedDate() {
        ...
        if (!!KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.SERVER_BASED_TARGETING)) {
            KAMPYLE_EVENT_DISPATCHER.trigger('MDigital_updateTargetingWithSubmittedDate', {
                submittedDate: date
            });
        }
    ...
    function handleScreenCaptureApiLoaded(eventName, data) {
        ...
        KAMPYLE_UTILS.sendMessageToIframe(iframeId, {
            action: 'screenCaptureLoaded'
        });
    }
    ...
    function checkDevice() {
        if (!KAMPYLE_DATA.getMemoryData('kampyleDevice')) {
            KAMPYLE_DATA.setMemoryData('kampyleDevice', KAMPYLE_UTILS.getDeviceTypeByUserAgent(navigator.userAgent));
        }
    ...
    function addScreenCaptureData(messageData) {
        ...
        if (version === 1) {
            messageData.screenCapture = {
                isTaken: false
            };
        } else {
            messageData.integrations.screenCapture = {
                isTaken: false
            };
        }
        return messageData;
    ...
    function sendFormExtraData(eventName, data) {
        ...
        if (targetWindow && targetWindow.postMessage) {
            ...
            messageData.customCssUpload = KAMPYLE_DATA.isFeatureEnabled(KAMPYLE_CONSTANT.PROPERTY_SETTINGS.CUSTOM_CSS_UPLOAD), messageData.displayType = KAMPYLE_DATA.getDisplayType(formData);
            var onsiteConfiguration = MDIGITAL.CONFIGURATION.getOnsiteConfiguration();
            ...
            if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.SERVER_BASED_TARGETING)) {
                ...
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_initUserIdentifierOnExtraData', {
                    hasIdentifierValue: messageData.endUserIdentifier !== null
                });
            }
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_formShown', {
            formId: data.formId,
            feedbackCorrelationUUID: data.feedbackCorrelationUUID,
        });
    }
    ...
    function isAnyOtherFormAlreadyShown(currentFormId, shouldIgnoreSkipInvitation) {
        ...
        for (var formId in allFormStates) {
            if (allFormStates.hasOwnProperty(formId)) {
                var shouldIgnoreForm = !MDIGITAL.FORM_STATE.isFormAlreadyShown(formId) && ((currentFormId && currentFormId == formId) || shouldIgnoreSkipInvitation && KAMPYLE_DATA.isSkipInvitation(formId))
    ...
    function kampyleButtonClicked(formData) {
        formData = formData || {};
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_buttonClicked', {
            formId: formData.formId,
        });
    }
    ...
    function isContentPayloadEnabled() {
        return KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.EVENT_INCLUDE_FEEDBACK_CONTENT) || KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.EXPOSE_SELECTION_QUESTIONS) || KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.EXPOSE_VERBATIM_QUESTIONS)
    }
    return {
...
window.KAMPYLE_DATA = (function() {
    var dataJson;
    var _memory;
    var TargetingMapping = {
        abandon: 'abandon',
        percentage: 'kampyleInvitePercentageUsers',
        timeInSession: 'kampyleTimeInSession',
        timeOnPage: 'kampyleTimeOnPage',
        deviceTypes: 'devicetypes',
        pageEvents: 'pageElementEvent',
    };
    var featureToPathMapping = {
        'GTM': 'isGoogleAnalyticsClientGTM',
        'WCAG': 'isWCAG',
        'SPA': 'isSpa',
        'MANUALLY_INVITE_TARGETING': 'isManuallyInviteTargeting',
        'CUSTOM_CSS_UPLOAD': 'customCssUpload'
    };
    ...
    function getUserIdentifier() {
        ...
        for (var i = 0; i < formNodes.length; i++) {
            var identifierCp = (formNodes[i].customParams || []).find(function(cp) {
    ...
    function fetchFormJsonData(obj, isSecondCall) {
        ...
        KAMPYLE_UTILS.httpRequest(KAMPYLE_CONSTANT.HTTP_METHODS.GET, url, null, function(data) {
            if (isSecondCall) {
                var warnMessage = 'second http request have been made to the url: ' + url;
                KAMPYLE_EVENT_DISPATCHER.trigger('MDigital_warning', {
                    message: warnMessage
                });
            }
            if (!data) {
...
window.KAMPYLE_TARGETING = (function(window, document) {
    var QUARANTINE_DEFAULT_TEXTS = {
        DECLINED_DATE: 'The user did not decline',
        SUBMITTED_DATE: 'The user did not submit'
    };

    function init() {
        var eventMapping = {
            neb_targetingInit: [initTargeting],
            MDigital_manuallyInviteTargeting: [handleFormsTargeting],
    ...
    function handleButton(eventName, data) {
        ...
        if (kampyleDevice === KAMPYLE_CONSTANT.DEVICES.MOBILE || kampyleDevice === KAMPYLE_CONSTANT.DEVICES.TABLET) {
            if (KAMPYLE_FUNC.isPreloadConfigured()) {
                KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.NEB_LOAD_FORM, {
                    formId: data.formId
                });
            }
        }
    ...
    function isUbtFailed(formData) {
        var isUbtCheckFailed = KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.SERVER_BASED_TARGETING) && KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.DO_NOT_SURVEY_ON_UBT_NETWORK_FAIL) && !KAMPYLE_DATA.getMemoryData('isGuest') && !KAMPYLE_DATA.getMemoryData('isSyncedIdentifierData');
        if (isUbtCheckFailed) {
            KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
                formId: formData.formId,
    ...
    function handleSkippedInvitaion(formData) {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_skipInvitation', {
            formId: formData.formId
        });
    }
    ...
    function isAlreadySubmitted(formData) {
        ...
        submittedDays && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
            formId: formData.formId,
    ...
    function isAlreadyDeclined(formData) {
        ...
        declinedDays && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
            formId: formData.formId,
    ...
    function handleNotSkippedInvitaion(formData) {
        if (KAMPYLE_DATA.getDisplayType(formData) === KAMPYLE_CONSTANT.DISPLAY_TYPES.POPUP) {
            KAMPYLE_DATA.setFormState(formData.formId, {
                inviteShown: true
            });
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_showInvitation', {
                formId: formData.formId
            });
        } else {
    ...
    function initTargetingObject() {
        ...
        targetingState.kampyleIdleTime = false;
    ...
    function validateCommonTargetingOnForm(form) {
        ...
        if (canShow === true) {
            ...
            KAMPYLE_UTILS.getNestedPropertyValue(form, 'urlRules.exclusionUrl.rule') && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
                formId: form.formId,
        ...
        if (canShow === true) {
            ...
            (KAMPYLE_UTILS.getNestedPropertyValue(form, 'urlRules.inclusionUrl.rule') && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
                formId: form.formId,
                formTriggerType: KAMPYLE_DATA.getFormTriggerType(form.formId),
        ...
        if (canShow === true) {
            ...
            (KAMPYLE_UTILS.getNestedPropertyValue(form, 'onSiteData.genericRule') && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
                formId: form.formId,
        ...
        if (canShow === true) {
            ...
            (KAMPYLE_UTILS.getNestedPropertyValue(form, 'onSiteData.devicetypes') && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
                formId: form.formId,
            ...
            switch (criteria.fieldOrigin) {
                case 'customParam':
                    ...
                    if (customParamObj && customParamObj.source_name) {
                        paramValue = MDIGITAL.CUSTOM_PARAMETERS.getCustomParamValue({
                            type: customParamObj.type,
                            name: customParamObj.source_name,
                            source: customParamObj.source
                        });
                        secondParamValue = MDIGITAL.CUSTOM_PARAMETERS.getCustomParamValue({
                            type: customParamObj.type,
                            name: customParamObj.source_name,
                            source: customParamObj.source,
    ...
    function isNumSessions(data) {
        ...
        numberOfRepeats && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
            formId: data.formId,
    ...
    function sendTimeOnPageEventData(formData) {
        ...
        timeOnPage && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
            formId: formData.formId,
    ...
    function idleTime(timeSpan) {
        if (timeSpan === null) {
            return KAMPYLE_DATA.setMemoryData('targetingState.kampyleIdleTime', true);
        }
        var idleSince = KAMPYLE_UTILS.getCurrentTimestamp();
        var resetIdleTime = function() {
            idleSince = KAMPYLE_UTILS.getCurrentTimestamp();
        };
        var addListeners = function() {
            addEventListener('click', resetIdleTime);
            addEventListener('mousemove', resetIdleTime);
            addEventListener('keydown', resetIdleTime);
        };
        var removeListeners = function() {
            removeEventListener('click', resetIdleTime);
            removeEventListener('mousemove', resetIdleTime);
            removeEventListener('keydown', resetIdleTime);
        };
        var interval = setInterval(function() {
            if (KAMPYLE_UTILS.getCurrentTimestamp() - idleSince >= timeSpan * 1000) {
                KAMPYLE_DATA.setMemoryData('targetingState.kampyleIdleTime', true);
                isShowInvite();
                removeListeners();
    ...
    function initDynamicTargeting(formData) {
        ...
        if (KAMPYLE_FUNC.checkProvision('targetingRuleIdleTime') && formData.onSiteData.kampyleIdleTime !== undefined) {
            idleTime(formData.onSiteData.kampyleIdleTime.timeSpan);
        } else {
            targetingState.kampyleIdleTime = true;
        }
        KAMPYLE_DATA.setMemoryData('targetingState', targetingState);
    ...
    function initUserIdentifier() {
        ...
        if (!!KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.SERVER_BASED_TARGETING)) {
            ...
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_initUserIdentifier', {
                hasIdentifierValue: hasIdentifierValue
            });
        }
        return userIdentifierVal;
    }
    ...
    function handleIdentifierData(userIdentifierVal, eventName, data) {
        if (KAMPYLE_FUNC.shouldSyncIdentifier(userIdentifierVal)) {
            KAMPYLE_EVENT_DISPATCHER.trigger('MDigital_settingIdentifierValueOnMemory', {
                hasIdentifierValue: userIdentifierVal !== null
            });
    ...
    function initFormsTargeting(eventName, data) {
        ...
        for (var i = allForms.length - 1; i >= 0; i--) {
            if (allForms[i].formType === KAMPYLE_CONSTANT.FORM_TYPES.BUTTON && !data.skipButtonTargeting && KAMPYLE_DATA.getMemoryData('isButtonShown') === false) {
                canShow = KAMPYLE_TARGETING.validateCommonTargetingOnForm(allForms[i]);
                if (canShow === true) {
                    KAMPYLE_EVENT_DISPATCHER.trigger('neb_initButton', {
                        formId: allForms[i].formId
                    });
                }
    ...
    function shouldCheckInvite(form, targetingSettings) {
        return (form.formType === KAMPYLE_CONSTANT.FORM_TYPES.INVITATION && KAMPYLE_UTILS.kampyleIsCookieEnabled() && !targetingSettings.skipInviteTargeting && KAMPYLE_DATA.getMemoryData('isInviteActivated') === false && !KAMPYLE_TARGETING.isUbtFailed(form))
    }
    ...
    function validateCommonSessionTargeting(formId) {
        ...
        (KAMPYLE_UTILS.getNestedPropertyValue(data, 'onSiteData.numberOfPagesViewed.numberOfRepeats') && KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED, {
            formId: data.formId,
        ...
        if (isInvite) {
            if (KAMPYLE_UTILS.isTrue(data.inviteData.skipInvitation)) {
                ...
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_loadInvitation', {
                    formId: formId
                });
            }
        }
...
window.KAMPYLE_ANIMATION = (function() {
    var DEFAULTS = {
        ANIMATION_DIRECTION: 'centerRight',
    };
    ...
    function animateIn(eventName, data) {
        ...
        var v2IframeStyle = {
            display: 'block',
            boxShadow: '-4px 0px 18px -1px rgba(0,0,0,0.37)'
        };
        var displayDirection = getDisplayDirection(formData);
        switch (displayDirection) {
            case 'centerRight':
                KAMPYLE_UTILS.setElementStyle(animationContainer, {
                    right: 0,
                });
    ...
    function refreshFormIframe(eventName, data) {
        setTimeout(function() {
            ...
            if (!!currIframe) {
                if (KAMPYLE_FUNC.checkProvision("disableFormReloadOnClose")) {
                    currIframe.remove();
                    KAMPYLE_DATA.initOnsiteDefaultState();
                } else {
                    currIframe.src = currIframe.src;
    ...
    function setAnimationContainerInitialPosition(formData, animationContainer) {
        ...
        switch (getDisplayDirection(formData)) {
            case 'centerRight':
                KAMPYLE_UTILS.setElementStyle(animationContainer, {
                    top: getMiddleHeight(animationContainer.style.height),
                    right: '-' + formData.formWidth + 'px',
                    bottom: null,
                    left: null,
    ...
    function hideFormAnimationContainer(eventName, data) {
        ...
        if (isAnimationForm(formData)) {
            var formIframe = document.getElementById(KAMPYLE_CONSTANT.IFRAME_SETTINGS.ANIMATION.IFRAME_ID + data.formId);
            if (formIframe) {
                KAMPYLE_UTILS.setElementStyle(formIframe, {
                    display: 'none',
                });
            }
        }
    ...
    function getOrCreateAnimationContainer() {
        ...
        if (!container) {
            var formSpanPlacer = Object.assign(document.createElement('span'), {
                id: KAMPYLE_CONSTANT.IFRAME_SETTINGS.ANIMATION.WRAPPER_ID
            });
            container = document.createElement('div');
            KAMPYLE_UTILS.addAttributesOnElement(container, {
                id: KAMPYLE_CONSTANT.IFRAME_SETTINGS.ANIMATION.CONTAINER_ID
            });
            container.style.zIndex = '2147483000';
            formSpanPlacer.appendChild(container);
            document.body.appendChild(formSpanPlacer);
            KAMPYLE_UTILS.setElementStyle(container, {
                border: 0,
                position: 'fixed',
                display: 'block',
                zIndex: '2147483000',
    ...
    function handleAnimationIframe(eventName, data) {
        ...
        var formIframe = document.getElementById(KAMPYLE_CONSTANT.IFRAME_SETTINGS.ANIMATION.IFRAME_ID + data.formId);
        if (!formIframe) {
            var animationIframeStyle = {
                border: 0,
                height: formData.formHeight + 'px',
                width: formData.formWidth + 'px',
                display: 'none',
            }
...
window.KAMPYLE_VIEW = (function(window, document) {
    ...
    var BUTTON_FUNCTION_ENUM = {
        vertical: 'getVerticalButton',
        triangular: 'getTriangularButton',
    ...
    function handleInviteReady(eventName, data) {
        ...
        if (newMobileInvite()) {
            restoreHostingDOM();
            if (inviteContainer) {
                KAMPYLE_UTILS.setElementStyle(inviteContainer, {
                    top: '',
                    bottom: '',
                    left: '',
                    right: '',
            ...
            if (iframe) {
                KAMPYLE_UTILS.setElementStyle(iframe, {
                    visibility: 'visible',
                }, true);
            }
        }
    ...
    function showInviteIfNeeded(eventName, params) {
        ...
        if (shouldShowInvite) {
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_invitation_loaded', {
    ...
    function handleInvitationSkippedForms(eventName, data) {
        ...
        KAMPYLE_UTILS.setElementStyle(document.getElementById('kampyleFormContainer'), {
            visibility: 'visible',
        }, true);
    ...
    function toggleSpinner(isShow) {
        ...
        if (spinners && spinners.length) {
            for (var i = spinners.length - 1; i >= 0; i--) {
                KAMPYLE_UTILS.setElementStyle(spinners[i], {
                    display: display
                });
            }
        }
    ...
    function showVisibility(eventName, data) {
        ...
        if (!!formContainer && !!formIframe) {
            KAMPYLE_UTILS.setElementStyle(formContainer, {
                display: 'block',
                visibility: 'visible',
            }, true);
        }
    ...
    function hideForm(eventName, data) {
        ...
        if (document.getElementById('kampyleFormContainer') !== null) {
            ...
            if (!!currIframe) {
                if (!KAMPYLE_FUNC.checkProvision("disableFormReloadOnClose")) {
                    currIframe.src = currIframe.src;
                    KAMPYLE_EVENT_DISPATCHER.trigger('neb_load_form_form_reload', {
                        formId: data.formId
                    });
                } else {
                    KAMPYLE_DATA.initOnsiteDefaultState();
                ...
                KAMPYLE_UTILS.setElementStyle(currIframe, {
                    display: 'none',
                }, true);
                if (currIframe.removeAttribute) {
                    currIframe.removeAttribute('origin');
        ...
        if (!KAMPYLE_FUNC.checkProvision("disableFormReloadOnClose") || KAMPYLE_DATA.isPopupDisplayType(currentFormId)) {
    ...
    function formatTriangularStyle(formData) {
        ...
        var triangularStyle = ['button#nebula_div_btn { height: auto !important }', '.kampyle_feedback-button{', 'background-color:transparent !important;font-family:"Open Sans",sans-serif;cursor:pointer;position:fixed;z-index:99999990', '}', '.kampyle_feedback-button .kampyle_triangle{position:absolute;width:0;height:0;z-index:-1}', '.kampyle_feedback-button .kampyle_button-text{', 'height:81px;width:81px;text-align:center;z-index:1000;color:' + buttonData.textColor + ';font-size:14px;font-weight:normal !important;', '}', '.kampyle_feedback-button .kampyle_bottom{', 'line-height:108px !important;', '}', '.kampyle_feedback-button .kampyle_top {', 'line-height:53px !important;', '}', '.kampyle_feedback-button.kampyle_top-right{', 'top:0;right:0;', '}', '.kampyle_feedback-button.kampyle_top-left .kampyle_triangle, .kampyle_feedback-button.kampyle_top-right .kampyle_triangle {', 'top:0;border-top:81px solid;', '}', '.kampyle_feedback-button.kampyle_bottom-left .kampyle_triangle, .kampyle_feedback-button.kampyle_bottom-right .kampyle_triangle {', 'bottom:0;border-bottom:81px solid;', '}', '.kampyle_feedback-button.kampyle_bottom-right .kampyle_triangle, .kampyle_feedback-button.kampyle_top-right .kampyle_triangle {', 'right:0;border-left:81px solid transparent;', '}', '.kampyle_feedback-button.kampyle_bottom-left .kampyle_triangle, .kampyle_feedback-button.kampyle_top-left .kampyle_triangle {', 'left:0;border-right:81px solid transparent;', '}', '#nebula_div_btn .kampyle_triangle {', 'border-bottom-color: ' + buttonData.backgroundColor + ';', 'border-top-color: ' + buttonData.backgroundColor + ';', '}', '.kampyle_feedback-button.kampyle_top-right .kampyle_button-text, .kampyle_feedback-button.kampyle_bottom-left .kampyle_button-text {', '-ms-transform:rotate(45deg);-webkit-transform:rotate(45deg);transform:rotate(45deg);', '}', '.kampyle_feedback-button.kampyle_top-left .kampyle_button-text, .kampyle_feedback-button.kampyle_bottom-right .kampyle_button-text {', '-ms-transform:rotate(-45deg);-webkit-transform:rotate(-45deg);transform:rotate(-45deg);', '}', '.kampyle_feedback-button.kampyle_top-left {', 'top:0;left:0;', '}', '.kampyle_feedback-button.kampyle_bottom-right {', 'bottom:0;right:0;', '}', '.kampyle_feedback-button.kampyle_bottom-left {', 'bottom:0;left:0;', '}', '.kampyle_feedback-button.kampyle_bottom-left, .kampyle_feedback-button.kampyle_bottom-right, .kampyle_feedback-button.kampyle_top-left, .kampyle_feedback-button.kampyle_top-right {', 'padding: 0 !important;', '}'].join(' ');
    ...
    function formatVerticalStyle(formData) {
        ...
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.ADDITIONAL_BUTTON_STYLES)) {
            verticalStyle += ['.kampyle_vertical_button:hover .kampyle_button-text {', 'color:' + buttonData.textHoverColor + ';', '}', '.kampyle_vertical_button:hover .kampyle_button {', 'background-color:' + buttonData.backgroundHoverColor + ';', '}', ].join(' ');
        }
    ...
    function getTriangleButtonStyle(formData) {
        ...
        return '<button id="nebula_div_btn" style="border: none; background: none" alt="' + buttonText + '" tabindex="0" class="kampyle_feedback-button ' + classDirection.leftright + ' ' + getWCAGClass() + '"><div class="kampyle_triangle"></div><div data-aut="feedback" class="kampyle_button-text ' + classDirection.topbottom + '">' + buttonText + '</div></button>';
    }
    ...
    function displayGenericFormBtn(formData) {
        var btnBuilders = ({
            vertical: {
                html: getVerticalButtonStyle,
                style: formatVerticalStyle
            },
            triangular: {
                html: getTriangleButtonStyle,
                style: formatTriangularStyle
            }
        })[formData.buttonData.type];
        if (!btnBuilders) {
    ...
    function showIframeContainers(formId) {
        ...
        if (kampyleFormContainer) {
            ...
            KAMPYLE_UTILS.setElementStyle(kampyleFormContainer, {
                display: 'block',
                visibility: 'visible',
            }, true);
        }
    ...
    function onErrModalClose(formId) {
        ...
        showButton("", {
            formId: KAMPYLE_DATA.getMemoryData('buttonFormId')
        });
        KAMPYLE_UTILS.triggerCustomEvent(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_NO_JSON_MODAL_CLOSED, {
            formId: formId
        });
        KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_NO_JSON_MODAL_CLOSED, {
            formId: formId
        });
    }
    ...
    function resetFormState(formId) {
        ...
        KAMPYLE_DATA.setMemoryData(KAMPYLE_CONSTANT.MEMORY_DATA_FIELDS.IS_BUTTON_CONTAINER_CREATED, false)
        KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.NEB_RESET_FORM_STATE, {
            formId: formId
        });
    }
    ...
    function getClassDirectonByPosition(position) {
        var classDirection = {
            topbottom: 'kampyle_bottom',
            leftright: 'kampyle_bottom-left'
        };
        switch (position) {
            case 'bottomLeft':
    ...
    function showFormCouldNotFechtedErrorMsg(eventName, data) {
        ...
        KAMPYLE_UTILS.triggerCustomEvent(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_NO_JSON_MODAL_SHOWN, {
            formId: data.formId
        });
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_NO_JSON_MODAL_SHOWN, {
    ...
    function hideFeedbackButtonVisually() {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(button, {
            tabindex: -1,
            'aria-hidden': true
        })
    }
    ...
    function showButton(eventName, data) {
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.NEW_MODAL_DIALOGS) && document.getElementById(KAMPYLE_CONSTANT.VIEW.FEEDBACK_BUTTON_CONTAINER_ID) != null && document.getElementById(KAMPYLE_CONSTANT.VIEW.FEEDBACK_BUTTON_ID) != null) {
    ...
    function pickElementStyleProperties(button, properties) {
        ...
        return (buttonStyle != null && properties != null && properties.length) ? properties.reduce(function(acc, key) {
    ...
    function createButton(eventName, data) {
        ...
        if (isDesktop) {
            ...
            var buttonProximityFunc = function(event) {
                ...
                if (isNear) {
                    KAMPYLE_EVENT_DISPATCHER.trigger('neb_load_form_preload_proximity', {
                        formId: data.formId
                    });
                    KAMPYLE_EVENT_DISPATCHER.trigger('neb_loadForm', {
                        formId: data.formId
    ...
    function updateDynamicIframeStyle(formData) {
        ...
        var modal = document.getElementById('kampyleFormModal');
        if (modal) {
            KAMPYLE_UTILS.setElementStyle(modal, {
                top: 0,
                margin: 0,
                width: '100%',
            }, true);
    ...
    function openPopup(formUrl, formId, formWidth, formHeight, eventName) {
        ...
        setTimeout(function() {
            if (isPopupBlocked) {
                ...
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_popupBlocked', {
                    formId: formId
                });
            }
        }, 25);
    ...
    function handlePopupShow(formUrl, formId, formWidth, formHeight, eventName) {
        if (KAMPYLE_FUNC.shouldRenderForm({
                formId: formId
            })) {
    ...
    function showForm(eventName, data) {
        ...
        if (displayType === 'lightbox') {
            ...
            if (kampyleFormContainer) {
                ...
                KAMPYLE_UTILS.setElementStyle(kampyleFormContainer, {
                    display: 'block',
                    visibility: shouldOptimizeSkipInvitation ? 'hidden' : 'visible',
                }, true);
            } else {
    ...
    function changeInviteHeight(eventName, data) {
        ...
        if (document.activeElement.tagName === 'INPUT' || document.activeElement.tagName === 'TEXTAREA') {
            KAMPYLE_UTILS.hideInvite();
            KAMPYLE_UTILS.setEventHandler(document.activeElement, 'blur', (function(elm) {
    ...
    function showInvite(eventName, data) {
        ...
        if (inviteContainer && KAMPYLE_DATA.getMemoryData('formIsShown') === false) {
            ...
            prepareHostingDOM();
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_invitation_ready', {
                formId: data.formId
            });
            var inviteModal = document.getElementById('kampyleInviteModal');
            if (inviteModal) {
                KAMPYLE_UTILS.setElementStyle(inviteModal, {
                    top: inviteTop,
            ...
            var inviteIframe = document.getElementById('kampyleInvite');
            if (inviteIframe) {
                KAMPYLE_UTILS.setElementStyle(inviteIframe, {
                    width: inviteData.inviteWidth + 'px',
                    'max-width': inviteData.inviteWidth + 'px',
                    height: inviteData.inviteHeight + 'px',
                    'max-height': inviteData.inviteHeight + 'px',
    ...
    function createFormContainer() {
        if (!KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.CSP_RULES)) {
            var formSpanPlacer = Object.assign(document.createElement('span'), {
                id: KAMPYLE_CONSTANT.IFRAME_SETTINGS.LIGHTBOX.WRAPPER_ID
            });
            var html = '';
            html += '<div id="kampyleFormContainer" style="top:0 !important;left:0 !important;width: 100% !important;height: 100% !important;position: fixed !important;visibility:hidden !important;display:table !important;background-color: rgba(102,102,102,0.4) !important;z-index:99999999 !important;-webkit-overflow-scrolling: touch !important; ">';
    ...
    function applyMobileDynamicStyles(eventName, data) {
        ...
        KAMPYLE_UTILS.setElementStyle(kFormContainer, {
            height: KAMPYLE_UTILS.getDocumentSize().height + 'px',
            position: 'absolute',
        }, true);
    }
    ...
    function manipulateAriaHiddens() {
        ...
        for (var i = 0; i < bodyChilds.length; i++) {
            ariaHiddenValues.push({
                element: bodyChilds[i],
                prevAriaHiddenValue: bodyChilds[i].getAttribute('aria-hidden'),
            });
    ...
    function createInviteIframe(eventName, eventData) {
        ...
        var inviteSpanPlacer = Object.assign(document.createElement('span'), {
            id: KAMPYLE_CONSTANT.IFRAME_SETTINGS.INVITATION.WRAPPER_ID
        });
        if (!KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.CSP_RULES)) {
            ...
            inviteSpanPlacer.innerHTML = '<div id="kampyleInviteContainer" style="' + inviteContainerStyles + '">' + '<div id="kampyleInviteModal" style="overflow: hidden;margin: 0 auto;height:' + data.inviteData.inviteHeight + ';width:' + data.inviteData.inviteWidth + ';position:relative;z-index:99999999;top: 25%;-webkit-box-shadow:0 0 10px rgba(0,0,0,0.4);-moz-box-shadow:0 0 10px rgba(0,0,0,0.4); box-shadow:0 0 10px rgba(0,0,0,0.4);"></div></div>';
            var spinnerContainer = MDIGITAL_ELEMENT_BUILDER.createSpinnerElement();
        ...
        if (KAMPYLE_DATA.isNewMobileInvitation()) {
            ...
            KAMPYLE_UTILS.setElementStyle(spinner, {
                display: 'none',
            }, true);
            KAMPYLE_UTILS.setElementStyle(inviteSpanPlacer, {
                'z-index': 99999998,
            }, true);
            var inviteContainer = document.getElementById('kampyleInviteContainer');
            if (inviteContainer) {
...
window.KAMPYLE_MESSAGE = (function() {
    ...
    function handleMessage(e) {
        ...
        switch (data.action) {
            case 'inviteAccepted':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_inviteAccepted', {
                    'formId': data.formId
                });
                break;
            case 'inviteDeclined':
            case 'inviteDefered':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_inviteDeclined', {
                    'formId': data.formId
                });
                break;
            case 'inviteHeightChanged':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_inviteHeightChanged', {
                    formId: data.formId,
                    newHeight: data.newHeight,
                });
                break;
            case 'formLoaded':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_formLoaded', {
                    'formId': data.formId,
                    origin: e.origin,
                    isScreenCaptureEnabled: data.isScreenCaptureEnabled,
                });
                break;
            case 'formSubmitPending':
            case 'formHide':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_formHide', {
                    'formId': data.formId
                });
                break;
            case 'formSubmitted':
            ...
            case 'screenCaptureRetake':
                ...
                break;
            case 'scrollToForm':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_scrollToForm', {
                    formId: data.formId
                });
                break;
            case 'iFrameHeightChanged':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_iFrameHeightChanged', {
                    formId: data.formId,
                    newHeight: data.newHeight,
                });
                break;
            case 'scrollToTop':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_scrollToTop', {
                    formId: data.formId,
                });
                break;
            case 'scrollFromTop':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_scrollFromTop', {
                    formId: data.formId,
                    numberOfPixels: data.numberOfPixels
                });
                break;
            case 'inviteLoaded':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_inviteLoaded', {
                    formId: data.formId,
            ...
            case 'loadMultipleForms':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_loadMultipileForms', {
                    formId: data.formId,
                    formIds: data.formIds,
                });
                break;
            case 'routeToForm':
                KAMPYLE_EVENT_DISPATCHER.trigger('neb_routeToForm', {
                    formId: data.destinationForm,
                    sourceFormId: data.formId,
                }, null, {
                    isStrictMode: true
                });
                break;
            ...
            case 'MDigital_Invalid_Origin':
                KAMPYLE_EVENT_DISPATCHER.trigger('MDigital_Invalid_Origin', {
                    formId: data.formId
                });
                break;
            default:
    ...
    return {
        ...
        validateMessageEvent: validateMessageEvent
    };
})();
window.KAMPYLE_UTILS = {
    ...
    httpRequest: function(method, url, jsonData, onSuccess, onError, config) {
        ...
        function makeRequest() {
            ...
            if (jsonData) {
                ...
                beforeRequestData = Object.assign({}, beforeRequestData, {
                    postData: postData
                })
            }
            if (method === 'POST') {
                KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.COOLADATA_HTTP_EVENTS_BY_METHOD.BEFORE.POST, {
                    httpRequestData: beforeRequestData
                });
            }
            ...
            xhr.onerror = function(error) {
                ...
                var onErrorData = {
                    ...
                    error: error,
                    requestTotalTimeInSeconds: onErrorRequestTotalTime
                };
                handleError(onErrorData, KAMPYLE_CONSTANT.COOLADATA_HTTP_EVENTS_BY_METHOD.ERROR[method], {
                    httpRequestData: onErrorData
                });
            };
            xhr.ontimeout = function(error) {
                ...
                handleError(onTimeoutData, KAMPYLE_CONSTANT.COOLADATA_HTTP_EVENTS_BY_METHOD.TIMEOUT[method], {
                    httpRequestData: onTimeoutData
                });
            };
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    var onSuccessEventData = {
                        requestUrl: url,
                        attemptNumber: counter,
                        requestTotalTimeInSeconds: onloadRequestTotalTime
                    };
                    KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.COOLADATA_HTTP_EVENTS_BY_METHOD.AFTER[method], {
                        httpRequestData: onSuccessEventData
                    });
                    if (typeof onSuccess === 'function') {
                        onSuccess(responseData);
                    }
                } else {
                    var afterRequestData = {
                        requestUrl: url,
                        responseStatus: xhr.status,
                    ...
                    handleError(afterRequestData, KAMPYLE_CONSTANT.COOLADATA_HTTP_EVENTS_BY_METHOD.ERROR_STATUS_CODE[method], {
                        httpRequestData: afterRequestData
                    });
                }
            };
    ...
    getDeviceTypeByUserAgent: function(agent) {
        ...
        var arrays = [
            ...
            [/(archos)\s(gamepad2?)/i, /(hp).+(touchpad)/i, /(hp).+(tablet)/i, /(kindle)\/([\w\.]+)/i, /\s(nook)[\w\s]+build\/(\w+)/i, /(dell)\s(strea[kpr\s\d]*[\dko])/i, /SHIELD Tablet/, /A500/, /LG-V410\/V41020c/, /Puffin/, /^(?!.*Mobile).*Android.*$/],
    ...
    addWcagStyleOnFocus: function(element) {
        if (KAMPYLE_DATA.isFeatureEnabled(KAMPYLE_CONSTANT.FEATURE_FLAGS.WCAG)) {
            element.addEventListener("focusin", function() {
                KAMPYLE_UTILS.setElementStyle(element, {
    ...
    setCurrentScrollPosition: function() {
        ...
        KAMPYLE_DATA.setMemoryData('scrollPosition', {
            x: position.x,
            y: position.y
        });
    },
    ...
    sha512: function(str) {
        ...
        if (typeof digest.then === 'function' && typeof digest.catch === 'function') {
            return digest.then(function(hash) {
    ...
    setSpinnerStyle: function(spinnerContainerElement, spinnerSize, iframe) {
        ...
        KAMPYLE_UTILS.setElementStyle(spinner, {
            'border': spinerSizes[spinnerSize]['border'] + ' solid #f3f3f3',
            'border-radius': '50%',
            'width': spinerSizes[spinnerSize]['widthHeight'],
            'height': spinerSizes[spinnerSize]['widthHeight'],
            'border-top': spinerSizes[spinnerSize]['border'] + ' solid #4050C6',
            'margin-top': '5px',
            'margin-right': '5px',
            'top': 'calc(50% - ' + spinerSizes[spinnerSize]['widthHeight'] + ')',
            'left': 'calc(50% - ' + spinerSizes[spinnerSize]['widthHeight'] + ')',
            'position': 'relative',
...
window.KAMPYLE_EVENT_DISPATCHER = (function(window, document) {
    ...
    function getTriggerMessage(settings) {
        ...
        messageTemplate = messageTemplate.replace("{{EVENT_NAME}}", settings.eventName).replace("{{DATA}}", KAMPYLE_UTILS.getStrigifiedData(settings.data)).replace("{{CONTEXT}}", KAMPYLE_UTILS.getStrigifiedData(settings.context)).replace("{{OPTIONS}}", KAMPYLE_UTILS.getStrigifiedData(settings.options));
            ...
            if (typeof subscribers[i] === 'string') {
                ...
                try {
                    ...
                    if (MDIGITAL.LOGGER.getLoggerStatus()) {
                        MDIGITAL.LOGGER.debug(getTriggerMessage({
                            eventName: eventName,
                            data: data,
                            context: context,
                            options: options,
                    ...
                    if (MDIGITAL.LOGGER.getLoggerStatus()) {
                        MDIGITAL.LOGGER.error(getTriggerMessage({
                            eventName: eventName,
                            data: data,
                            context: context,
                            options: options,
...
window.KAMPYLE_GA = (function(window, document) {
    ...
    var gaEvents = {
        'neb_formShown': {
            ...
            label: formIdPlaceHolder
        },
        'neb_showInvitation': {
            category: 'NebulaCX',
            action: 'Invite_Triggered',
            label: formIdPlaceHolder
        },
        'neb_inviteDeclined': {
            category: 'NebulaCX',
        ...
        'neb_formTriggerdByCode': {
            category: 'NebulaCX',
            action: 'Form_Triggered_By_Code',
            label: formIdPlaceHolder
        },
        'neb_buttonClicked': {
            category: 'NebulaCX',
        ...
        'neb_formPageShown': {
            category: 'NebulaCX',
            action: 'Form_Page_Displayed',
            label: formIdPlaceHolder
        },
        'neb_captureInit': {
            category: 'NebulaCX',
            action: 'Screen_Capture_Init',
            label: formIdPlaceHolder
        },
        ...
        'MDigital_Capture_Cancelled': {
            category: 'NebulaCX',
            action: 'Cancel_Capture_Click',
            label: formIdPlaceHolder
        },
        screenCaptureDelete: {
            category: 'NebulaCX',
            action: 'Screen_Capture_Delete',
            label: formIdPlaceHolder
        },
        screenCaptureRetake: {
            category: 'NebulaCX',
            action: 'Screen_Capture_Retake',
            label: formIdPlaceHolder
        },
        'MDigital_Form_Close_No_Submit': {
            category: 'NebulaCX',
            action: 'Form_Close_No_Submit',
            label: formIdPlaceHolder
        },
        'MDigital_Form_Next_Page': {
            category: 'NebulaCX',
            action: 'Form_Next_Page',
            label: formIdPlaceHolder
        },
        'MDigital_Form_Back_Page': {
            category: 'NebulaCX',
            action: 'Form_Back_Page',
            label: formIdPlaceHolder
        },
        'MDigital_ThankYou_Displayed': {
            category: 'NebulaCX',
            action: 'ThankYou_Displayed',
            label: formIdPlaceHolder
        },
        'MDigital_ThankYou_Close': {
            category: 'NebulaCX',
            action: 'ThankYou_Close',
            label: formIdPlaceHolder
        }
    };
...
window.MDIGITAL.ON_PREM = (function() {
    ...
    return {
        replaceOnPremPrefixes: replaceOnPremPrefixes,
        getPackageVersion: getPackageVersion,
        getPackageRoot: getPackageRoot,
        replaceFormNodeUrls: replaceFormNodeUrls
    };
})();
window.MDIGITAL = window.MDIGITAL || {};
window.MDIGITAL.LOCALIZATION = (function() {
    ...
    function getLangaugeFallback(formNode, languageCode) {
        ...
        var foundFallback = availableLanguages.find(function(lang) {
    ...
    function detectUsableLanguageCode(formNode) {
        ...
        return (formNode.availableLanguages.find(function(lang) {
    ...
    function getLanguageCodeByForm(formNode) {
        return MDIGITAL.LOCALIZATION.detectUsableLanguageCode({
            availableLanguages: formNode.availableLanguages,
            formLocalizationSettings: formNode.formLocalizationSettings,
            formId: formNode.formId
        });
    }
...
window.MDIGITAL.EMBEDDED = (function(window, document) {
    ...
    function setIframeScrolling(iframe, enableScroll) {
        if (!enableScroll) {
            KAMPYLE_UTILS.addAttributesOnElement(iframe, {
                scrolling: "no"
            });
        } else {
    ...
    function calculateFormSize(event, data) {
        ...
        var iframeStyle = {
            height: newHeightSettings.iframeHeight + 'px',
            width: isEmbeddedFullWidth(data.formId) ? '100%' : newWidth + 'px'
        }
        ...
        var messageData = {
            height: newHeightSettings.formHeight,
            width: newWidth,
            shouldBeStatic: newHeightSettings.shouldBeStatic
        };
        KAMPYLE_UTILS.sendMessageToIframe(KAMPYLE_CONSTANT.IFRAME_SETTINGS.EMBEDDED.IFRAME_ID_PREFIX + data.formId, {
            action: 'setFormStyle',
            data: messageData,
        });
        return messageData;
...
window.MDIGITAL.FORM_STATE = (function(window, document) {
    function init() {
        var eventMapping = {
            neb_formLoadingHasFailed: [onFormLoadingFailed]
        };
        KAMPYLE_EVENT_DISPATCHER.subscribeMany(eventMapping);
    }
    ...
    return {
        ...
        isFormAlreadyShown: isFormAlreadyShown,
...
window.MDIGITAL_ELEMENT_BUILDER = (function() {
    function createFormContainer() {
        ...
        var divContainer = Object.assign(document.createElement('div'), {
            id: 'kampyleFormContainer'
        });
        var containerStyle = {
            top: 0,
            left: 0,
        ...
        KAMPYLE_UTILS.setElementStyle(divElem2, {
            zIndex: '99999999',
            webkitOverflowScrolling: 'touch'
        }, true);
    ...
    function createInviteIframeContainer(data) {
        ...
        var divContainer = Object.assign(document.createElement('div'), {
            id: 'kampyleInviteContainer'
        });
        KAMPYLE_UTILS.setElementStyle(divContainer, {
            top: '0',
            left: '0',
            width: '100%',
            height: '100%',
    ...
    function getErrorModal(noJsonModalId, errorModalLang, errorMessageTitle, errorMessageBody, errorMessageClose) {
        ...
        var errorModalAttributes = KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.NEW_MODAL_DIALOGS) ? {
            ...
            role: "alertdialog",
            'aria-modal': true,
            'aria-labelledby': 'title-no-json-modal',
            'aria-describedby': 'description-no-json-modal',
            lang: errorModal
        }
    ...
    function getVerticalButton(formData) {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(buttonElement, {
            id: 'nebula_div_btn',
            alt: buttonText,
            tabIndex: "0",
            class: 'kampyle_vertical_button ' + direction + ' ' + KAMPYLE_VIEW.getWCAGClass()
        });
        ...
        KAMPYLE_UTILS.setElementStyle(divElement, {
            width: '125px',
            minWidth: '125px',
            maxWidth: '125px',
            minHeight: '35px',
        ...
        KAMPYLE_UTILS.setElementStyle(divElement, {
            height: '35px',
            background: formData.buttonData.backgroundColor,
            color: formData.buttonData.textColor,
            position: 'absolute',
            top: 0,
            left: 0,
            zIndex: '-1'
        ...
        KAMPYLE_UTILS.addAttributesOnElement(divElement2, {
            'data-aut': 'feedback',
            class: 'kampyle_button-text'
        });
        KAMPYLE_UTILS.setElementStyle(divElement2, {
            fontWeight: 'normal'
        }, true);
        KAMPYLE_UTILS.setElementStyle(divElement2, {
            color: formData.buttonData.textColor,
        ...
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.ADDITIONAL_BUTTON_STYLES)) {
            ...
            addHoverStyleToFeedbackButton(buttonElement, {
                bgElementStyle: {
                    backgroundColor: formData.buttonData.backgroundColor
                },
                textElementStyle: {
                    color: formData.buttonData.textColor
                }
                ...
                bgElementStyle: {
                    backgroundColor: formData.buttonData.backgroundHoverColor || defaultBackgroundHoverColor
                },
                textElementStyle: {
                    color: formData.buttonData.textHoverColor || defaultTextHoverColor
                }
            });
        }
        ...
        return {
            topRight: {
                ...
                div1Style: {
                    top: 0,
                    right: 0,
                    borderTop: '81px solid ' + formData.buttonData.backgroundColor,
                    borderLeft: '81px solid transparent'
                },
                div2Style: {
            ...
            topLeft: {
                ...
                div1Style: {
                    ...
                    left: 0,
                    borderTop: '81px solid ' + formData.buttonData.backgroundColor,
                    borderRight: '81px solid transparent'
                },
                div2Style: {
                    '-ms-transform': 'rotate(-45deg)',
                    '-webkit-transform': 'rotate(-45deg)',
            ...
            bottomRight: {
                ...
                div1Style: {
                    bottom: 0,
                    right: 0,
                    borderBottom: '81px solid ' + formData.buttonData.backgroundColor,
                    borderLeft: '81px solid transparent'
                },
                div2Style: {
                    '-ms-transform': 'rotate(-45deg)',
    ...
    function getTriangularButton(formData) {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(buttonElement, {
            ...
            alt: buttonText,
            tabindex: 0,
            class: 'kampyle_feedback-button ' + classDirection.leftright + ' ' + KAMPYLE_VIEW.getWCAGClass(),
        });
        KAMPYLE_UTILS.setElementStyle(buttonElement, {
            backgroundColor: 'transparent',
            height: 'auto',
        ...
        KAMPYLE_UTILS.setElementStyle(buttonElement, Object.assign({
            fontFamily: 'Open Sans, sans-serif',
            cursor: 'pointer',
            position: 'fixed',
            border: 'none',
        ...
        KAMPYLE_UTILS.setElementStyle(divElem1, Object.assign({
            position: 'absolute',
            width: 0,
            height: 0,
            zIndex: -1
        ...
        var divElem2 = document.createElement('div');
        KAMPYLE_UTILS.addAttributesOnElement(divElem2, {
            'data-aut': 'feedback',
            class: 'kampyle_button-text ' + classDirection.topbottom,
        });
        KAMPYLE_UTILS.setElementStyle(divElem2, {
            fontWeight: 'normal',
            lineHeight: (position === 'bottomLeft' || position === 'bottomRight') ? '108px' : '53px'
        }, true);
        KAMPYLE_UTILS.setElementStyle(divElem2, Object.assign({
            height: '81px',
            width: '81px',
            textAlign: 'center',
            zIndex: '1000',
    ...
    function getCustomButton(formData) {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(buttonElement, {
            id: 'nebula_div_btn',
            tabindex: 0,
            class: 'nebula_image_button ' + KAMPYLE_VIEW.getWCAGClass(),
        });
        KAMPYLE_UTILS.setElementStyle(buttonElement, {
            zIndex: '99999990',
            position: 'fixed',
        ...
        KAMPYLE_UTILS.addAttributesOnElement(imgElem, {
            alt: buttonText,
            src: formData.buttonData.buttonUrl
        });
    ...
    function getErrorModalCloseButton(text, langCode) {
        ...
        KAMPYLE_UTILS.setElementStyle(closeButton, {
            cursor: 'pointer',
            position: 'absolute',
            top: '3px',
            right: '12px',
        ...
        if (KAMPYLE_UTILS.isDesktop()) {
            KAMPYLE_UTILS.addHoverEffectOnElement(closeButton, {
                opacity: 0.7
            }, {
                opacity: 1
            });
    ...
    function getErrorModalTitle(text) {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(title, {
            id: "title-no-json-modal"
        });
        KAMPYLE_UTILS.setElementStyle(title, {
            fontWeight: 'bold',
            margin: '40px 0 16px',
            fontSize: '24px'
        })
    ...
    function getErrorModalBackgroundImage() {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(backgroundImage, {
            src: KAMPYLE_COMMON.getUrlPrefix() + KAMPYLE_CONSTANT.SRC.OOPS
        });
        KAMPYLE_UTILS.setElementStyle(backgroundImage, {
            marginLeft: '-1px'
        });
    ...
    function createSpinnerElement() {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(spinnerContainer, {
            class: 'neb-loading-spinner'
        });
...
window.MDIGITAL.PROPERTY_MESSAGES = (function() {
    ...
    function getLanguageCodeByCustomParam() {
        ...
        return MDIGITAL.CUSTOM_PARAMETERS.getCustomParamValue({
            type: customParamObject.type,
            name: customParamObject.source_name,
            source: customParamObject.source
        }) || getDefaultLanguageFromPropertyData();
    }
    ...
    var init = function() {
        if (!window.cooladata) {
            ...
            ! function() {
                    ...
                    c = h.each = function(t, n, o) {
                        if (null != t)
                            ...
                            for (var i = 0, a = t.length; i < a; i++)
                                if (i in t && n.call(o, t[i], i, t) === r) return
                        } else
                            for (var c in t)
                                if (s.call(t, c) && n.call(o, t[c], c, t) === r) return
                    };
                h.extend = function(e) {
                ...
                var t = {
                    ...
                    encode: function(e) {
                        var n, o, r, i, a, s, c, u = "",
                            f = 0;
                        for (e = t._utf8_encode(e); f < e.length;) i = (n = e.charCodeAt(f++)) >> 2, a = (3 & n) << 4 | (o = e.charCodeAt(f++)) >> 4, s = (15 & o) << 2 | (r = e.charCodeAt(f++)) >> 6, c = 63 & r, isNaN(o) ? s = c = 64 : isNaN(r) && (c = 64), u = u + this._keyStr.charAt(i) + this._keyStr.charAt(a) + this._keyStr.charAt(s) + this._keyStr.charAt(c);
                        return u
                    },
                ...
                var n, o, r = [];
                return void 0 === t && (t = "&"), h.each(e, function(e, t) {
                ...
                return t() + "-" + Math.random().toString(16).replace(".", "") + "-" + function(e) {
                    var t, n, o = d,
                        r = [],
                        i = 0;
            ...
            if (w.prototype.init = function(t, n, o) {
                    ...
                    this.__loaded = !0, this.__SV = !0, this.config = {}, this.eventsArray = [], this.set_config(h.extend({}, g, {
                        token: e.app_key,
                    ...
                    this.storeUid(r), this.set_config({
                        user_id: r
                    }), this.__dom_loaded_queue = [], this.__request_queue = [], e.custom_event_handler && (this.__customEventHandler = e.custom_event_handler)
                    ...
                    }, this), h.each(this.__request_queue, function(e) {
                ...
                }, w.prototype._onError = function(e, t) {}, w.prototype._send_request = function(e, t) {
                    if (_) this.__request_queue.push(arguments);
                        ...
                        if (o || !n() && !this.get_config("img"))
                            if (p) {
                                var a = null;
                                this.get_config("http_post") || o ? a = "data=" + encodeURIComponent(e) : (e = {
                                    data: h.base64Encode(e)
                                }, i += "?" + h.HTTPBuildQuery(e));
                                var s = new XMLHttpRequest;
                                this.get_config("http_post") || o ? (s.open("POST", i, !0), s.setRequestHeader("Content-type", "application/x-www-form-urlencoded")) : s.open("GET", i, !0), s.withCredentials = !0, s.onreadystatechange = function(e) {
                                    if (4 === s.readyState)
                                        if (200 === s.status) t && t();
                                        else {
                    ...
                    var t, n = [],
                        ...
                        r = [];
                    h.each(e, function(e) {
                        e && (t = e[0], "function" == typeof e ? e.call(this) : h.isArray(e) && "alias" === t ? n.push(e) : !h.isArray(e) || -1 == t.indexOf("track") && -1 == t.indexOf("flush") || "function" != typeof this[t] ? o.push(e) : r.push(e))
                    }, this);
                    var i = function(e, t) {
                        h.each(e, function(e) {
                    ...
                    if (void 0 !== e) {
                        ...
                        r[this.get_config("user_identifier_property")] = this.get_config("user_id"), r = {
                            events: [r = h.extend(r, t)]
                        };
                ...
                }, h.toArray = h.toArray, h.isObject = h.isObject, h.JSONEncode = h.JSONEncode, h.info = h.info, w.prototype.init = w.prototype.init, w.prototype.track_event = w.prototype.trackEvent, w.prototype.track_event_later = w.prototype.trackEventLater, w.prototype.flush = w.prototype.flush, w.prototype.track_pageload = w.prototype.track_pageload, w.prototype.set_config = w.prototype.set_config, w.prototype.get_config = w.prototype.get_config, w.prototype.toString = w.prototype.toString, h.isUndefined(e)) y("'cooladata' object not initialized. Ensure you are using the latest version of the Cooladata JS Library along with the snippet we provide.");
                ...
                if (e.init = function(t, n, o) {
                        if (o) e[o] || (e[o] = S[o] = m(t, n, o), e[o]._loaded());
                        else {
                            var r = e;
                            S.cooladata ? r = S.cooladata : t && (r = m(t, n, "cooladata")) && r._loaded(), window.cooladata = e = r, h.each(S, function(t, n) {
                                "cooladata" !== n && (e[n] = t)
                            }), e._ = h
                        }
                    }, e.init(), h.each(S, function(e) {
                        e._loaded()
                    }), f.addEventListener) "complete" == f.readyState ? C() : f.addEventListener("DOMContentLoaded", C, !1);
            ...
            function C() {
                C.done || (C.done = !0, v = !0, _ = !1, h.each(S, function(e) {
                    e._dom_loaded()
                }))
            }
        }(window.cooladata);
...
window.KAMPYLE_COOLADATA = (function(window, document) {
    var COOLADATA_CONFIGURATION = {
        API_GATEWAY_ENDPOINT: 'uwbhzazjt4.execute-api.eu-west-1.amazonaws.com/Production',
        COOLADATA_APP_KEY: {
            PROD: 'qceuv8449dzg58ptt1bhda9g8ue19c7s',
            QA: 'lf5shxz66ckwmizs7kowapgs2rkoejcl'
        }
    };
    ...
    var cooladataEvents = {
        neb_pageView: {
            eventId: 'nebula_page_view',
        },
        neb_inviteAccepted: {
            eventId: 'nebula_invite_accepted',
        },
        neb_inviteDeclined: {
            eventId: 'nebula_invite_declined',
        },
        neb_showInvitation: {
            eventId: 'nebula_invitation_show',
            memoryDataKey: 'invitationTriggeringData',
        },
        neb_feedbackSubmitted: {
            eventId: 'nebula_form_submitted',
        },
        neb_formShown: {
            eventId: 'nebula_form_show',
        },
        neb_buttonClicked: {
            eventId: 'nebula_button_clicked',
        },
        neb_sdkShowForm: {
            eventId: 'nebula_code_trigger_form',
        },
        neb_routeToForm: {
            eventId: 'nebula_route_to_form',
        },
        neb_formClosed: {
            eventId: 'nebula_form_closed',
        },
        neb_popupBlocked: {
            eventId: 'nebula_popup_blocked',
        },
        neb_skipInvitation: {
            eventId: 'nebula_invitation_skipped',
        },
        neb_formPageShown: {
            eventId: 'nebula_form_page_displayed',
        },
        neb_captureInit: {
            eventId: 'nebula_capture_init',
        },
        neb_captureImageClicked: {
            eventId: 'nebula_capture_image_clicked',
        },
        MDigital_Capture_Cancelled: {
            eventId: 'nebula_cancel_capture_clicked',
        },
        neb_load_form_preload_proximity: {
            eventId: 'nebula_load_form_preload_proximity',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_cancel_capture_clicked: {
            eventId: 'nebula_cancel_capture_clicked',
        },
        neb_load_form_form_reload: {
            eventId: 'nebula_load_form_form_reload',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_button_displayed: {
            eventId: 'nebula_button_displayed',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_invitation_loaded: {
            eventId: 'nebula_invitation_loaded',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_invitation_ready: {
            eventId: 'nebula_invitation_ready',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_form_loaded: {
            eventId: 'nebula_form_loaded',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_formReady: {
            eventId: 'nebula_form_ready',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents,
        },
        neb_sdkSurveyDisplayed: {
            eventId: 'nebula_code_survey_displayed',
        },
        neb_afterHttpGetRequestOnError: {
            eventId: 'nebula_after_http_get_request_on_error',
            eventDataKey: 'httpRequestData',
        },
        neb_afterHttpGetRequestOnErrorStatusCode: {
            eventId: 'nebula_after_http_get_request_on_error_status_code',
            eventDataKey: 'httpRequestData',
        },
        ...
        neb_afterHttpGetRequest: {
            eventId: 'nebula_after_http_get_request',
            eventDataKey: 'httpRequestData',
        },
        MDigital_updatingSbtServer: {
            eventId: 'MDigital_updating_sbt_server',
            eventDataKey: 'dataObjForSbt',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        MDigital_settingIdentifierValueOnMemory: {
            eventId: 'MDigital_setting_identifier_value_on_memory',
            eventDataKey: 'hasIdentifierValue',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        MDigital_shouldNotSyncIdentifier: {
            eventId: 'MDigital_should_not_sync_identifier',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_beforeHttpPostRequest: {
            eventId: 'nebula_before_http_post_request',
            eventDataKey: 'httpRequestData',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_afterHttpPostRequestOnError: {
            eventId: 'nebula_after_http_post_request_on_error',
            eventDataKey: 'httpRequestData',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_afterHttpPostRequest: {
            eventId: 'nebula_after_http_post_request',
            eventDataKey: 'httpRequestData',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_afterHttpPostRequestOnErrorStatusCode: {
            eventId: 'nebula_after_http_post_request_on_error_status_code',
            eventDataKey: 'httpRequestData',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_afterHttpPostRequestOnTimeout: {
            eventId: 'nebula_after_http_post_request_on_timeout',
            eventDataKey: 'httpRequestData',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        MDigital_updateTargetingWithDeclinedDateInviteDeclined: {
            eventId: 'MDigital_update_targeting_with_declined_date_invite_declined',
            eventDataKey: 'declinedDate',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        MDigital_updateTargetingWithSubmittedDate: {
            eventId: 'MDigital_update_targeting_with_submitted_date',
            eventDataKey: 'submittedDate',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        MDigital_updateTargetingWithDeclinedDateFormClosed: {
            eventId: 'MDigital_update_targeting_with_declined_date_form_closed',
            eventDataKey: 'declinedDate',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_initUserIdentifier: {
            eventId: 'nebula_init_user_identifier',
            eventDataKey: 'hasIdentifierValue',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_initUserIdentifierOnExtraData: {
            eventId: 'nebula_init_user_identifier_on_extra_data',
            eventDataKey: 'hasIdentifierValue',
            provision: KAMPYLE_CONSTANT.PROVISIONS.UBT_EXTRA_EVENTS,
        },
        neb_eventDispatcherError: {
            eventId: 'nebula_eventDispatcherError',
            eventDataKeys: ['errorMessage', 'errorStack', 'additionalInfo']
        },
        neb_feedbackUUIDisNull: {
            eventId: 'nebula_feedbackUuidIsNull'
        },
        neb_submitFeedbackFailed: {
            eventId: 'nebula_submitFeedbackFailed',
            eventDataKeys: ['uuid', 'errorMessage', 'errorStack']
        },
        MDigital_Form_Next_Page: {
            eventId: 'MDigital_Form_Next_Page',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents
        },
        MDigital_Form_Back_Page: {
            eventId: 'MDigital_Form_Back_Page',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents
        },
        MDigital_Form_Close_No_Submit: {
            eventId: 'MDigital_Form_Close_No_Submit',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents
        },
        MDigital_ThankYou_Displayed: {
            eventId: 'MDigital_ThankYou_Displayed',
            provision: KAMPYLE_CONSTANT.PROVISIONS.cooladataNewEvents
        },
        MDigital_ThankYou_Close: {
        ...
        MDigital_warning: {
            eventId: 'MDigital_warning',
            eventDataKey: 'message'
        },
        MDigital_couldNotFetchData: {
            eventId: 'MDigital_couldNotFetchData',
            eventDataKey: 'errorData'
        },
        MDigital_couldNotLoadFormApplication: {
            eventId: 'MDigital_couldNotLoadFormApplication',
            eventDataKey: 'errorData'
        },
        MDigital_Invalid_Origin: {
            eventId: 'MDigital_Invalid_Origin'
        },
        MDigital_DynamicOnsiteInitializedSuccessfully: {
            eventId: KAMPYLE_CONSTANT.EVENTS.MDIGITAL_DYNAMIC_ONSITE_INITIALIZED_SUCCESSFULLY,
            provision: KAMPYLE_CONSTANT.PROVISIONS.DYNAMIC_ONSITE_EVENTS,
        },
        MDigital_noJsonModalShown: {
            eventId: 'mdigital_noDataMessageDisplayed',
            eventDataKey: 'additionalInfo'
        },
        screenCaptureRetake: {
            eventId: KAMPYLE_CONSTANT.EVENTS.SCREEN_CAPTURE_RETAKE
        },
        screenCaptureDelete: {
            eventId: KAMPYLE_CONSTANT.EVENTS.SCREEN_CAPTURE_DELETE
        },
    };
    ...
    function init() {
        try {
            COMMON_FIELDS = {
                userid: KAMPYLE_UTILS.kampyleGetUserId(),
            };
            var config = {
...
window.KAMPYLE_COMMON = (function(window, document) {
    ...
    function getDomainsListRelativePath(url) {
        var configurationPath = '/resources/config';
        if (KAMPYLE_DATA.getMemoryData('context') === 'preview') {
...
window.KAMPYLE_THERMO_TEALEAF_FUNC = (function() {
    ...
    function getTealeafData() {
        if (KAMPYLE_THERMO_TEALEAF_FUNC.isTealeafEnabled()) {
            return {
                sid: KAMPYLE_UTILS.kampyleGetCookie(TEALEAF_COOKIE_SESSION_ID),
            };
        }
        return null;
    }
    return {
        isTealeafEnabled: isTealeafEnabled,
        getTealeafData: getTealeafData,
    };
})();
window.KAMPYLE_ADOBE_ANALYTICS = (function(window, document) {
    ...
    var COMMON_FIELDS = {
        CONTEXT_NAME: 'NebulaCX_Activity'
    };
    var events = {
        'neb_formShown': {
            action: 'form_displayed'
    ...
    var sendAAEvent = function(eventName, data) {
        ...
        if (!!window[adobeSdkName] && !!window[adobeSdkName].tl) {
            ...
            if (isAdobeLinkTrackVarsProvisionOn) {
                window[adobeSdkName].linkTrackVars = window[adobeSdkName].linkTrackVars && isAdobeConcatLinkTrackVarsProvisionOn ? window[adobeSdkName].linkTrackVars.split(',').concat(window[adobeSdkName].linkTrackVars.indexOf(contextEventName) < 0 ? [contextEventName] : []) : [contextEventName];
            }
            ...
            for (var i = 0; i < queueLen; i++) {
                try {
                    ...
                    var error = {
                        errorMessage: e.message,
                        errorStack: e.stack,
                        additionalInfo: 'KAMPYLE_ADOBE_ANALYTICS'
                    };
    ...
    return {
        init: init,
        triggerEvent: triggerEvent,
        getAdobeSdkName: getAdobeSdkName,
        sendAAEvent: sendAAEvent,
        processDataForAA: processDataForAA
    };
})(window, document);
window.KAMPYLE_CLICKTALE_FUNC = (function() {
    function isClicktaleEnabled() {
        return (!!window.ClickTale && !!window.ClickTale.KampyleLink);
    };

    function getClicktaleData() {
        if (KAMPYLE_CLICKTALE_FUNC.isClicktaleEnabled()) {
            if (window.ClickTale.KampyleLink !== KAMPYLE_CONSTANT.NOT_RECORDING) {
                var clicktaleData = {
                    recordingUrl: window.ClickTale.KampyleLink
                };
                return clicktaleData;
            }
        }
        return null;
    }
    return {
        isClicktaleEnabled: isClicktaleEnabled,
        getClicktaleData: getClicktaleData
    };
})();
window.KAMPYLE_SESSIONCAM = {
    isSessionCamEnabled: function() {
        return (!!window.sessionCamRecorder);
    },
    getSessionCamData: function() {
        if (KAMPYLE_SESSIONCAM.isSessionCamEnabled()) {
            var sessionId = window.sessionCamRecorder.sessionId();
            if (!!sessionId) {
                var sessionCamData = {
                    recordingUrl: "https://console.sessioncam.com/Console/Recordings/PlaybackSession?sessionId=" + sessionId
                };
                return sessionCamData;
            }
        }
        return null;
    },
    sendCustomParam: function(key, value) {
    ...
    init: function() {
        KAMPYLE_EVENT_DISPATCHER.subscribe("neb_feedbackSubmitted", this.sessionCamFormSubmittedCallback);
    },
    sessionCamFormSubmittedCallback: function(eventName, oData) {
        if (eventName !== 'neb_feedbackSubmitted') {
            return;
        }
        KAMPYLE_SESSIONCAM.sendCustomParam("nebula_feedback_uuid", oData.feedbackUUID);
    }
};
window.KAMPYLE_SCREEN_CAPTURE = (function(window, document) {
    ...
    var SCREEN_CAPTURE_DEFAULT_TEXTS = {
        ...
        instructionsScreenCapture: '<h2 class="scTitle" style="font-size: 1.5em;">Screen Capture</h2><p class="scParagraph" style="font-size: 1em; margin-top: 10px;">Drag the cursor around the area you want to highlight.<br>Press Capture Image to take the snapshot and return to your feedback</p>',
    ...
    var screenCaptureWidgetTemplate = ["<html>", "<head>", '<link rel="stylesheet" type="text/css" href="' +
    ...
    var UserSnapModel = function() {
        ...
        this.getUrl = function() {
            ...
            if (this._widgetVersion === V4_WIDGET_VERSION) {
                url += KAMPYLE_UTILS.buildQueryParams({
                    onload: ON_LOAD_ONPREM_AND_V4_CALLBACK_NAME,
                    apiaccess: 'extended',
                    cdn: KAMPYLE_CONSTANT.PLACEHOLDERS.USERSNAP_V4_HOST_PREFIX + '/classic/frontend'
                });
            }
            return url;
        }
    ...
    function beforeSend(obj) {
        ...
        obj.addInfo = {
            uuid: formData.feedbackCorrelationUUID,
    ...
    function afterSend(id) {
        ...
        if (formData && !formData.canceledClicked) {
            ...
            var eventExtraData = {
                formId: formData.formId,
                feedbackCorrelationUUID: formData.feedbackCorrelationUUID
            }
            KAMPYLE_EVENT_DISPATCHER.trigger('neb_captureImageClicked', eventExtraData);
            KAMPYLE_UTILS.sendMessageToIframe(KAMPYLE_DATA.getFormIframeId(formData.formId), {
                action: 'takenScreenCapture',
                data: eventExtraData
            });
        }
        if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.USER_SNAP_ONPREM)) {
    ...
    function getConfiguration() {
        return function(api) {
            ...
            var initParams = {
                ...
                tools: {
                    keys: ["highlight"],
                    colors: [KAMPYLE_CONSTANT.COLORS.USERSNAP_V4_SELECTION_COLOR],
                },
                thankYou: {
                    isHidden: true,
                },
    ...
    function init(callback) {
        ...
        KAMPYLE_EVENT_DISPATCHER.subscribeMany({
            neb_captureInit: [initScreenCaptureWidget],
            neb_cancelCaptureClicked: [cancelCaptureClicked]
        });
    }
    ...
    function beforeOpen() {
        ...
        if (scIframe) {
            KAMPYLE_UTILS.setElementStyle(scIframe, {
                display: 'block',
            }, true);
        }
    ...
    function handleCaptureCancellation() {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('MDigital_Capture_Cancelled', {
            formId: formId,
            feedbackCorrelationUUID: KAMPYLE_DATA.getMemoryData(KAMPYLE_CONSTANT.MEMORY_DATA_FIELDS.FEEDBACK_CORRELATION_UUID),
        });
        var formData = KAMPYLE_DATA.getFormData(formId);
        KAMPYLE_UTILS.sendMessageToIframe(KAMPYLE_DATA.getFormIframeId(formId), {
            action: 'cancelScreenCapture',
            data: formData
        });
    }
    ...
    function appendScreenCaptureScript() {
        ...
        Object.assign(scriptElem, {
            id: id,
            type: 'text/javascript',
            src: userSnapInstance.getUrl()
        });
...
window.KAMPYLE_ONSITE_SDK = (function(window, document) {
    function triggerSdkError(method) {
        var eventData = {
            errorMessage: KAMPYLE_CONSTANT.LOG_MESSAGES.ERROR_ONSITE_SDK_CONFIGURATION_MISSING.replace('{{METHOD}}', method)
        };
        KAMPYLE_EVENT_DISPATCHER.triggerError(eventData);
    ...
    function showForm(formId, options) {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_sdkShowForm', {
            formId: formId,
    ...
    function closeFormById(formId) {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger('neb_formClosed', {
            formId: formId,
    ...
    function startInviteTargeting() {
        ...
        KAMPYLE_EVENT_DISPATCHER.trigger(KAMPYLE_CONSTANT.EVENTS.MDIGITAL_MANUALLY_INVITE_TARGETING, {
            skipButtonTargeting: true,
            skipInviteTargeting: false
        });
    }
...
window.KAMPYLE_INTEGRATION = (function() {
    var INTEGRATION_CONTEXT = {
        sessionCam: 'sessionCamRecorder',
        quantumMetrics: 'QuantumMetricAPI',
    };
    ...
    function isEnabled(integrationData) {
        ...
        for (var i = 0; i < isEnabledArray.length; i++) {
            ...
            valueBySource = getParameterBySource({
                source: isEnabledArray[i].source,
                param: isEnabledCurrName,
                context: integrationContext,
                predefinedArgs: isEnabledArray[i].predefinedArguments
            });
            if (paramValue === null) {
    ...
    function prepareIntegrationData(integrationData) {
        ...
        for (var i = 0; i < parametersArray.length; i++) {
            var paramValue = getParameterBySource({
                source: parametersArray[i].source,
                param: parametersArray[i].param,
                context: integrationContext,
                predefinedArgs: parametersArray[i].predefinedArguments
            });
    ...
    return {
        isEnabled: isEnabled,
        prepareIntegrationData: prepareIntegrationData,
        getParameterBySource: getParameterBySource,
...
window.MDIGITAL.CUSTOM_EVENTS = (function() {
    ...
    var customEvents = {
        MDigital_Form_Close_Submitted: {
            customEventId: 'MDigital_Form_Close_Submitted',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        neb_formReady: {
            customEventId: 'MDigital_Form_Displayed',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        neb_pageView: {
            customEventId: 'MDigital_Page_View',
            payload: [],
        },
        MDigital_Form_Next_Page: {
            customEventId: 'MDigital_Form_Next_Page',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        MDigital_Form_Back_Page: {
            customEventId: 'MDigital_Form_Back_Page',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        MDigital_Form_Close_No_Submit: {
            customEventId: 'MDigital_Form_Close_No_Submit',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        MDigital_ThankYou_Displayed: {
            customEventId: 'MDigital_ThankYou_Displayed',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        MDigital_ThankYou_Close: {
        ...
        neb_feedbackSubmitted: {
            ...
            payload: [FORM_ID, FORM_TRIGGER_TYPE].concat(!KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.BACKEND_GENERATED_UUID) ? FEEDBACK_CORRELATION_UUID : FEEDBACK_UUID).concat(isExposeFormLanguageAllowed() ? FORM_LANGUAGE : []).concat(KAMPYLE_FUNC.isContentPayloadEnabled() ? FEEDBACK_CONTENT : [])
        },
        neb_inviteAccepted: {
            customEventId: 'MDigital_Invite_Accepted',
            payload: [FORM_ID]
        },
        neb_showInvitation: {
            customEventId: 'MDigital_Invite_Displayed',
            payload: [FORM_ID]
        },
        neb_inviteDeclined: {
            customEventId: 'MDigital_Invite_Declined',
            payload: [FORM_ID]
        },
        neb_skipInvitation: {
            customEventId: 'MDigital_invite_Skipped',
            payload: [FORM_ID]
        },
        neb_buttonClicked: {
            customEventId: 'MDigital_Feedback_Button_Clicked',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        neb_captureInit: {
            customEventId: 'MDigital_CaptureButton_Clicked',
        ...
        neb_sdkShowForm: {
            customEventId: 'MDigital_ShowForm_Called',
            payload: [FORM_ID, FORM_TRIGGER_TYPE]
        },
        MDigital_targetingRuleEvaluated: {
            customEventId: KAMPYLE_CONSTANT.EVENTS.MDIGITAL_TARGETING_RULE_EVALUATED,
            payload: [FORM_ID, IS_PASSED, TARGETING_RULE, EXPECTED, ACTUAL, FORM_TRIGGER_TYPE],
        },
    };
    var dataToSendMapping = {
        formId: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FORM_ID_LABEL,
            manipulateValueMethod: null
        },
        formTriggerType: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FORM_TYPE_LABEL,
            manipulateValueMethod: manipulateTriggerTypeValue
        },
        feedbackCorrelationUUID: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FEEDBACK_UUID_LABEL
        },
        feedbackUUID: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FEEDBACK_UUID_LABEL,
            manipulateValueMethod: null
        ...
        content: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FEEDBACK_CONTENT_LABEL,
            manipulateValueMethod: null,
        },
        formLanguage: {
            exposedProperty: KAMPYLE_CONSTANT.EXPOSED_FEEDBACK_KEYS.FORM_LANGUAGE_LABEL,
            manipulateValueMethod: null,
        }
    }
    ...
    function triggerCustomEvent(eventName, eventDispatcherData) {
        ...
        if (customEventData) {
            ...
            if (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.ENABLE_EVENTS_FOR_CE_DEBUG)) {
                KAMPYLE_COOLADATA.triggerCooladataEvent(KAMPYLE_CONSTANT.EVENTS.CUSTOM_EVENTS_DEBUG_MESSAGE, {
    ...
    function isExposeFormLanguageAllowed() {
        return KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.LOCALIZED_FORMS) && (KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.EXPOSE_SELECTION_QUESTIONS) || KAMPYLE_FUNC.checkProvision(KAMPYLE_CONSTANT.PROVISIONS.EXPOSE_VERBATIM_QUESTIONS))
    }
    return {
        init: init,
        triggerCustomEvent: triggerCustomEvent,
        getCustomEventDataToSend: getCustomEventDataToSend,
        isExposeFormLanguageAllowed: isExposeFormLanguageAllowed
    };
})();
window.MDIGITAL = window.MDIGITAL || {};
window.MDIGITAL.CUSTOM_PARAMETERS = (function(window, document) {
    ...
    function getCustomParamById(fieldId, formData) {
        if (fieldId !== undefined && formData && formData.customParams && formData.customParams.length) {
            return formData.customParams.find(function(cp) {
    ...
    function appendValueToCPObject(cp) {
        cp = cp || {};
        var cpValue = MDIGITAL.CUSTOM_PARAMETERS.getCustomParamValue({
            name: cp.source_name,
            type: cp.type,
            source: cp.source,
        });
...
window.MDIGITAL.INIT = (function(window, document) {
    ...
    return {
        init: init,
        initOnsite: initOnsite,
        reportInitComplete: reportInitComplete
    };
})(window, document);
window.MDIGITAL = window.MDIGITAL || {};
window.MDIGITAL.WCAG = (function() {
    ...
    function onFormShown(eventName, payload) {
        if (KAMPYLE_UTILS.isModalFormType(payload.formId)) {
            setModalState({
                ...
                targetModalId: KAMPYLE_DATA.getFormIframeId(payload.formId)
            });
    ...
    function onInviteReady(eventName, payload) {
        setModalState({
            targetModalId: KAMPYLE_CONSTANT.IFRAME_SETTINGS.INVITATION.IFRAME_ID
        });
    }

    function onNoJsonModalShown(eventName, payload) {
        setModalState({
            targetModalId: KAMPYLE_CONSTANT.IFRAME_SETTINGS.OOPS.CONTAINER_ID_PREFIX + payload.formId,
        });
    }
...
window.MDIGITAL.MODAL_DIALOGS = (function() {
    ...
    function setDialogAriaAttributesOnForm(formId) {
        var ariaAttrs = {
            role: "dialog",
            'aria-modal': true,
            'aria-label': getFormAnnouncement(formId),
        }
        var langCode = getFormLanguageCode(formId);
        removeDialogAriaAttributesLightBox();
        setDialogAriaAttributesLightBox(langCode != null ? Object.assign(ariaAttrs, {
            lang: langCode
        }) : ariaAttrs);
    }
    ...
    function setDialogAriaAttributesOnInvite(formId) {
        var ariaAttrs = {
            role: "dialog",
            'aria-modal': true,
            'aria-label': getInviteAnnoucement(formId),
        }
        var langCode = getFormLanguageCode(formId);
        removeDialogAriaAttributesInvite();
        setDialogAriaAttributesInvite(langCode != null ? Object.assign(ariaAttrs, {
            lang: langCode
        }) : ariaAttrs);
    }
    ...
    function enforceFocusOnBody() {
        ...
        KAMPYLE_UTILS.addAttributesOnElement(tempFocusHolder, {
            tabindex: "-1",
            "aria-hidden": true
        });
...
window.MDIGITAL.DECIBEL = (function() {
    ...
    return {
        init: init,
        listenToBehaviouralEvent: listenToBehaviouralEvent,
        listenToScoreEvent: listenToScoreEvent,
