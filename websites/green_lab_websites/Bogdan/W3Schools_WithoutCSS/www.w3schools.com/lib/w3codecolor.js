...
function w3CodeColorize(x, lang) {
    ...
    function jsMode(txt) {
        ...
        while (y == 1) {
            ...
            if (Math.max(numpos[0], regexppos[0], sfnuttpos[0], dfnuttpos[0], bfnuttpos[0], compos[0], comlinepos[0], keywordpos[0], dotpos[0]) == -1) {
                break;
            }
    ...
    function pythonMode(txt) {
        ...
        while (y == 1) {
            ...
            if (Math.max(numpos[0], sfnuttpos[0], dfnuttpos[0], compos[0], comhashpos[0], keywordpos[0]) == -1) {
                break;
            }
