(function(d, w, _RB) {
    ...
    var init = function() {
        ...
        var Integrations = {
            integrations: {
                ...
                "branch": {
                    ...
                    getId: function() {
                        ...
                        if (branch_id) {
                            ...
                            return {
                                "branch_id": branch_id,
                                "branch_browser_id": branch_browser_id
                            }
                        }
                        return false
                    },
                ...
                "_sva": {
                    ...
                    getId: function() {
                        ...
                        var obj = {
                            "survicate_visitor_id": survicate_visitor_id
                        };
                    ...
                    external: function() {
                        getUID.all(function(obj) {
                            var uid = obj["uid"];
                            if (w._sva && w._sva.setVisitorTraits) w._sva.setVisitorTraits({
                                rockerbox_uid: uid
                            });
                        });
                    },
                ...
                "juapp": {
                    ...
                    getId: function() {
                        ...
                        var obj = {
                            "justuno_session_id": justuno_session_id
                        };
                ...
                "pintrk": {
                    ...
                    getId: function() {
                        ...
                        if (pinterest_id_encoded) {
                            ...
                            return {
                                "pinterest_view_id": pinterest_view_id
                            }
                        }
                        return false
                    },
                ...
                "_st": {
                    ...
                    getId: function() {
                        ...
                        if (dialogtech_session_id) {
                            ...
                            return {
                                "dialogtech_session_id": dialogtech_session_id
                            }
                        }
                        return false
                    },
                ...
                "trackable": {
                    ...
                    getId: function() {
                        ...
                        if (chartable_user_id) {
                            ...
                            return {
                                "chartable_user_id": chartable_user_id
                            }
                        }
                        return false
                    },
                ...
                "pdst": {
                    ...
                    getId: function() {
                        ...
                        if (podsights_session_id) {
                            ...
                            return {
                                "podsights_session_id": podsights_session_id
                            }
                        }
                        return false
                    },
            ...
            supportedIds: ["segment_anonymous_id", "invoca_id", "branch_id", "branch_browser_id", "tatari_session_id", "tatari_user_id", "survicate_visitor_id", "privy_uuid", "justuno_session_id", "pinterest_view_id", "amplitude_device_id", "dialogtech_session_id", "chartable_user_id", "hotjar_user_id", "facebook_pixel_id", "podsights_session_id"],
            ids: {},
            ...
            integrations: {
                ...
                "survicate": {
                    ...
                    generateAdder: function() {
                        return w._sva && w._sva.addEventListener
                    },
        ...
        RB.queue.map(function(args) {
            RB.track(args[0], args[1])
        });
        RB.queue = [];
        RB.loaded = true;
