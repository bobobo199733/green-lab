    ...
    a = function() {
        function a(a, b, e) {
            ...
            this.$21 = function(a) {
                ...
                d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(b, f.$3, "drm_create_media_keys", function() {}, f.$24);
                return b
            };
            this.$22 = function(a) {
                ...
                d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(a, f.$3, "drm_set_media_keys", function() {}, f.$24);
                return a
            };
            this.$23 = function(a) {
                var b = a.mediaKeys,
                ...
                d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(a, f.$3, "drm_request_license", function() {}, f.$24);
                return a
            };
            this.$5 = b;
            this.$1 = e;
        ...
        b.$18 = function() {
            try {
                ...
                var a = b;
                this.$16(new(c("oz-player/utils/OzError"))({
                    type: "OZ_DRM_MANAGER",
        ...
        b.startEME = function(a, b, d, e) {
            ...
            h.then(this.$21).then(this.$22).then(this.$23).then(function() {
                return i.log()
            }, function(a) {
                a = a != null ? f.$15(a, "keypromisechain") : new(c("oz-player/utils/OzError"))({
                    type: "OZ_DRM_MANAGER",
        ...
        b.$19 = function(a, b, c, d) {
            ...
            b.forEach(function(b) {
                ...
                f != null && f.forEach(function(a) {
                    ...
                    d === "audio" && !e.audioCapabilities.has(g) && e.audioCapabilities.set(g, {
                        contentType: g,
                        robustness: a.getAudioRobustness()
                    });
                    d === "video" && !e.videoCapabilities.has(g) && e.videoCapabilities.set(g, {
                        contentType: g,
...
__d("oz-player/loggings/OzMultiDestinationPerfLogger", ["oz-player/loggings/OzOperationLoggerBase", "oz-player/loggings/OzPerfLoggerProviderBase"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        var c = b.prototype;
        c.createOperationLogger = function(a) {
            var b = new h(a, this.$OzMultiDestinationPerfLoggerProvider1.map(function(b) {
...
__d("oz-player/shims/www/OzNetworkDiagnosticsWWW", [], function(a, b, c, d, e, f) {
    "use strict";
...
__d("oz-player/manifests/OzDynamicVideoLibrary", ["oz-player/shims/OzNetworkDiagnostics"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.updateWithResponse = function(a, b, d, e) {
            ...
            this.$10(a, d);
            (this.$2 != null && this.$3.getBool("dvl_update_interval_reset_on_err") || this.$2 === "200") && (this.$4 = b)
        };
        b.$10 = function(a, b) {
            a = this.$6.exec(a);
            if (a != null) {
...
__d("oz-player/manifests/OzRepresentationBase", ["oz-player/shims/ozvariant", "oz-player/utils/OzError"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a(a, b, c, d, e, f, g, h, i) {
            this.$1 = a, this.$7 = b, this.$2 = c, this.$3 = d, this.$4 = e, this.$5 = f, this.$6 = g, this.$8 = h, this.$9 = i
        }
        var b = a.prototype;
        b.getID = function() {
            return this.$7
        ...
        b.getCustomField = function(a) {
            if (this.$9 == null || !this.$9[a]) throw new(c("oz-player/utils/OzError"))({
        ...
        b.updateWith = function(b) {
            b instanceof a || c("oz-player/shims/ozvariant")(0, 229), this.$5.updateWith(b.$5)
        };
...
__d("oz-player/shims/interfaces/IOzWorkerClient", [], function(a, b, c, d, e, f) {
    "use strict";
    a = function(a) {
...
__d("oz-player/utils/maybeConvertReadableStreamToOzReadableStream", ["oz-player/shims/OzStreams", "regeneratorRuntime"], function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("oz-player/networks/OzFetchRequestImplementation", ["oz-player/networks/FetchWithTimeout", "oz-player/shims/interfaces/IOzWorkerClient", "oz-player/utils/processFetchResponse"], function(a, b, c, d, e, f, g) {
    "use strict";

    function a(a, b, e, f, g, h, i, j, k) {
        e = e ? e.networkTimeoutMs : null;
        var l;
        h == null || g == null ? l = c("oz-player/networks/FetchWithTimeout")(a, b.credentials, e).then(function(a) {
            return new(d("oz-player/shims/interfaces/IOzWorkerClient").ResponseAndMetadata)({
                response: a
            })
        ...
        return l.then(function(a) {
            var b = a.response,
                ...
                g = b.status,
                h = b.headers;
            return f != null && !e && typeof b.text === "function" ? b.text().then(function(a) {
                a = {
                    ok: e,
                    status: g,
                    headers: h,
...
__d("oz-player/networks/withRetries", ["Promise", "oz-player/shims/ozSetTimeoutAcrossTransitions", "regeneratorRuntime"], function(a, b, c, d, e, f, g) {
    "use strict";
                ...
                return b("regeneratorRuntime").async(function(k) {
                    while (1) switch (k.prev = k.next) {
                        ...
                        case 4:
                            ...
                            break;
                        case 8:
                            k.prev = 8, k.t2 = k["catch"](0), i > 0 ? (j = typeof e === "function" ? e(d - i) : e, c("oz-player/shims/ozSetTimeoutAcrossTransitions")(function() {
                                h(i - 1)
                            }, j)) : g(k.t2);
                        case 11:
                        case "end":
...
__d("oz-player/networks/OzFetchWithCache", ["oz-player/networks/OzFetchRequestImplementation", "oz-player/networks/withRetries", "oz-player/shims/OzMaybeNativePromise", "oz-player/utils/OzError", "oz-player/utils/arrayBuffer2OzReadableStream", "oz-player/utils/processFetchResponse"], function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        ...
        if (h) a = !0, h = h.then(function(a) {
            ...
            var o;
            o = (o = g == null ? void 0 : g.retryAttempts_SIDX_USE_ONLY) != null ? o : 0;
            if (o > 0) {
                var p;
                p = (p = g == null ? void 0 : g.retryTimeoutMs_SIDX_USE_ONLY) != null ? p : 100;
    ...
    a = function() {
        ...
        b.startStream = function(a) {
            ...
            return e.then(function(d) {
                ...
                h = f;
                for (var a = 0; a < d.length; a++) h = h.pipeThrough(d[a]);
                return h
            }, function(a) {
                var d = [];
                for (var e = 0; e < b.$9.length; e++) try {
                ...
                if (a instanceof TypeError) {
                    ...
                    for (var f = 0; f < d.length; f++) e = e.pipeThrough(d[f]);
                    return e
                }
                throw a
            })["catch"](function(a) {
...
__d("oz-player/networks/OzNetworkManager", ["oz-player/loggings/OzLoggingUtils", "oz-player/networks/OzNetworkRequestStream", "oz-player/networks/OzPausableRangeStream", "oz-player/networks/RequestParamCreator", "oz-player/networks/getOzSegmentStreamableRange", "oz-player/shims/OzStreams", "oz-player/shims/OzURI", "oz-player/shims/ozvariant", "oz-player/utils/OzNetworkRequestLoggingUtils"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.$15 = function(a, b, c, e, f) {
            ...
            a = h.startStream();
            var i = this.$17(a);
            e && d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(i, e, "fetch_stream", function() {}, function(a) {
    ...
    b = function() {
        function b(b) {
            ...
            this.$23 = function() {
                ...
                c && d.$13(c.responseStart - c.requestStart);
        ...
        e.onTimeToFirstByteMsSample = function(a) {
            this.$13 = a
        };
        ...
        e.$25 = function() {
            ...
            this.$20 = !0;
            var b = c("oz-player/shims/OzNetworkDiagnostics").getBandwidthMeanEstimate(a),
                d = c("oz-player/shims/OzNetworkDiagnostics").getBandwidthStandardDeviationEstimate(a);
            a = c("oz-player/shims/OzNetworkDiagnostics").getTimeToFirstByteMsEstimate(a);
    ...
    function a(a, b, d, e, f) {
        return {
            startStream: function(g) {
                ...
                i.onTimeToFirstByteMsSample(function(b) {
                    var c = a.getNumber("time_to_first_byte_ignore_above_threshold_ms", 0);
                    (c === 0 || b <= c) && e.addTimeToFirstByteMsSample(b)
                });
    ...
    var t = function() {
        ...
        u = function() {
            ...
            b.$4 = function() {
                ...
                c = new Uint8Array(b);
                c[0] = a;
                for (var a = 1; a < b; a++) c[a] = this.$2.readUint8();
                return c
            };
            a.$6 = function(a) {
...
__d("oz-player/parsers/OzSidxSegmentsParser", ["oz-player/loggings/OzLoggingUtils", "oz-player/manifests/OzSegmentOptions", "oz-player/manifests/OzZeroTimeRangeSegment", "oz-player/networks/getOzBandwidthEstimatorPipeThroughReporter", "oz-player/parsers/OzMp4SidxParser", "oz-player/parsers/OzSidxSegmentsContainer", "oz-player/parsers/OzWebmSidxParser", "oz-player/shims/OzEventEmitter", "oz-player/shims/OzMaybeNativePromise", "oz-player/shims/OzURI", "oz-player/utils/OzErrorEmitter", "oz-player/utils/OzReadableStreamUtils"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.parseInitializationSegment = function() {
            ...
            b = this.$10.getBool("sidx_parser_memory_optimization") ? new(c("oz-player/manifests/OzZeroTimeRangeSegment"))(this.$2, d.startByte, d.endByte) : {
                getData: function() {
                    return null
                },
                getURI: function() {
        ...
        b.parseSegmentsContainer = function() {
            ...
            b = new(c("oz-player/parsers/OzSidxSegmentsContainer"))(function() {
                return a.$7
            }, this.$9);
            return b
        };
    ...
    a = function() {
        ...
        b.$15 = function() {
            ...
            if (this.$1.SegmentBase) {
                ...
                b = new(c("oz-player/parsers/OzSidxSegmentsParser"))(this.$11, e, f, d("oz-player/parsers/OzVideoContainerType").parse(this.$1.$.mimeType), d("oz-player/utils/OzMimeUtil").getMimeType(this.$1.$.mimeType), this.$7, this.$8);
                b.onError(function(b) {
                    var c;
                    if ((c = a.$14) == null ? void 0 : c.handleError(a.parseID(), b)) return;
                    return a.$6.emitError(b)
                })
            } else if (this.$1.SegmentTemplate) b = this.$16(this.$1.SegmentTemplate[0], {
                isShared: !1
            });
            else if (this.$2) b = this.$16(this.$2[0], {
                isShared: !0
            });
            else {
        ...
        b.$16 = function(a, b) {
            ...
            d = (d = this.$10.customRepresentationParsers) == null ? void 0 : d.initializationBinary;
            d = d ? d(this.$1) : null;
            return new(c("oz-player/parsers/OzSegmentTemplateParser"))(this.$11, a, {
                baseUrl: e,
                mpdUrl: b,
        ...
        b.parseCustomFieldFirstSegment = function() {
            var a = this.$10.customRepresentationParsers ? this.$10.customRepresentationParsers.firstSegmentParser : null;
            return a ? a(this.$1) : null
        };
        b.parse = function() {
            return new(c("oz-player/manifests/OzRepresentationBase"))(this.$1, this.parseID(), this.parseMimeCodecs(), this.parseLang(), this.parseInitSegment(), this.parseSegmentsContainer(), this.parseBandwidth(), this.parseCustomFieldFirstSegment(), this.$10.customRepresentationParsers)
        };
        return a
    }();
    g["default"] = a
...
__d("oz-player/parsers/OzApplicationRepresentationParser", ["oz-player/manifests/OzApplicationRepresentation", "oz-player/parsers/OzRepresentationParserBase"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        var d = b.prototype;
        d.parse = function() {
            var a = this.$OzApplicationRepresentationParser2.customRepresentationParsers;
            return new(c("oz-player/manifests/OzApplicationRepresentation"))(this.$OzApplicationRepresentationParser1, this.parseID(), this.parseMimeCodecs(), this.parseLang(), this.parseInitSegment(), this.parseSegmentsContainer(), this.parseBandwidth(), this.parseCustomFieldFirstSegment(), a)
        };
        return b
...
__d("oz-player/parsers/OzAudioRepresentationParser", ["oz-player/manifests/OzAudioRepresentation", "oz-player/parsers/OzRepresentationParserBase"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        d.parse = function() {
            ...
            return new(c("oz-player/manifests/OzAudioRepresentation"))(this.$OzAudioRepresentationParser1, this.parseID(), this.parseMimeCodecs(), this.parseLang(), this.parseInitSegment(), this.parseSegmentsContainer(), this.parseBandwidth(), this.parseCustomFieldFirstSegment(), a)
        };
        return b
    }(c("oz-player/parsers/OzRepresentationParserBase"));
    g["default"] = a
...
__d("oz-player/parsers/OzVideoRepresentationParser", ["oz-player/manifests/OzVideoRepresentation", "oz-player/parsers/OzRepresentationParserBase"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        d.parse = function() {
            ...
            return new(c("oz-player/manifests/OzVideoRepresentation"))(this.$OzVideoRepresentationParser1, this.parseID(), this.parseMimeCodecs(), this.parseLang(), this.parseInitSegment(), this.parseSegmentsContainer(), this.parseBandwidth(), this.parseCustomFieldFirstSegment(), d, b, a)
        };
        return b
    }(c("oz-player/parsers/OzRepresentationParserBase"));
    g["default"] = a
}, 98);
__d("oz-player/parsers/OzMpdParser", ["oz-player/manifests/Mpd", "oz-player/parsers/OzApplicationRepresentationParser", "oz-player/parsers/OzAudioRepresentationParser", "oz-player/parsers/OzVideoRepresentationParser", "oz-player/utils/OzErrorEmitter"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a(a, b, d, e, f, g, h) {
            g === void 0 && (g = []), h === void 0 && (h = null), this.$2 = new(c("oz-player/utils/OzErrorEmitter"))(), this.$5 = a, this.$1 = d, this.$3 = e, this.$4 = b, this.$6 = f, this.$7 = g, this.$8 = h
        }
        var b = a.prototype;
        b.onError = function(a) {
        ...
        b.parse = function(a) {
            ...
            var f = this.$11(a, "video"),
                g = this.$5.getBool("mpd_parse_all_adaptation_sets") ? this.$12(this.$13(a, "video"), c("oz-player/parsers/OzVideoRepresentationParser"), {
                    manifestType: e,
            ...
            if (this.$5.getBool("vtt_caption_representation")) {
                ...
                j = this.$14(a[0], c("oz-player/parsers/OzApplicationRepresentationParser"), {
                    manifestType: e,
                    manifestIsTemplated: d
                })
            }
            a = this.$4.mpdUrl;
            d = new(c("oz-player/manifests/Mpd"))(b, g, i, j, a, this.$15(b), this.$4.customParsers || new Map(), e === "static");
            if (this.$6) {
                j = this.$6;
                j.startEME(f, g, h, i)
            }
        ...
        b.$14 = function(a, b, c) {
            ...
            return !a ? [] : a.Representation.map(function(e) {
                e = new b(d.$5, e, d.$4, d.$1, d.$3, c, a.SegmentTemplate, a.$.mimeType, a.$.codecs, a.$.lang, d.$7, d.$8);
        ...
        b.$12 = function(a, b, c) {
            var d = this,
                e = [],
                f = 0;
            a.filter(Boolean).forEach(function(a, g, h) {
                g = g === h.length - 1;
                h = f;
                for (var i = a.Representation, j = Array.isArray(i), k = 0, i = j ? i : i[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                    var l, m;
                    if (j) {
                        if (k >= i.length) break;
                        m = i[k++]
                    ...
                    m = m;
                    var n = parseInt(m.$.height, 10);
                    if (n <= f) continue;
                    if (((l = m.$.FBAbrPolicyTags) == null ? void 0 : l.includes("avoid_on_abr")) && !g) continue;
                    l = new b(d.$5, m, d.$4, d.$1, d.$3, c, a.SegmentTemplate, a.$.mimeType, a.$.codecs, a.$.lang, d.$7, d.$8);
                    l.onError(d.$2.emitError);
                    m = l.parse();
                    if (!MediaSource.isTypeSupported(m.getMimeCodecs())) continue;
                    e.push(m);
                    h = Math.max(n, h)
                }
                f = h
...
__d("oz-player/utils/OzMpdUtils", [], function(a, b, c, d, e, f) {
    ...
    function a(a, b) {
        var c = [];
        c.push.apply(c, a.getVideoRepresentations().concat(a.getAudioRepresentations()));
        if (c.length)
            if (b.getBool("get_mpd_least_last_time_range")) {
                a = c.map(function(a) {
                ...
                b = c[0].getEndingSegment();
                if (b) return b.getTimeRange()
            }
        return null
    }
        ...
        function b(b, e, f, g, h, i, j, k) {
            ...
            l.$OzMpdUpdater25 = function() {
                ...
                l.$OzMpdUpdater27(b).then(function(a) {
                    ...
                    h = new(c("oz-player/parsers/OzMpdParser"))(l.$OzMpdUpdater6, h, l.$OzMpdUpdater1, l.$OzMpdUpdater5, l.$OzMpdUpdater14);
                    ...
                    h = l.$OzMpdUpdater6.getBool("log_extra_events") ? {
                    ...
                    if (a instanceof c("oz-player/utils/OzError")) e = a;
                        ...
                        if (l.$OzMpdUpdater6.getBool("fix_manifest_fetch_mixed_promise_catch")) {
                            if (a != null)
...
__d("oz-player/parsers/OzXmlParserImplDOMParser", ["oz-player/utils/OzError"], function(a, b, c, d, e, f, g) {
    function h() {
        return {
            $: {}
        }
    ...
    function i(a) {
        ...
        for (var e = a.childNodes, c = 0; c < e.length; ++c) {
            d = e[c];
        ...
        b.parse = function(a) {
            try {
                ...
                if (e) {
                    ...
                    throw new(c("oz-player/utils/OzError"))({
                        type: "OZ_XML_PARSER",
                        description: e + "; truncated xml (" + f + "/" + a.length + "): " + a.substring(0, f),
                        extra: {}
                    })
                }
                e = d.documentElement;
                ...
                if (b instanceof c("oz-player/utils/OzError")) throw b;
                    ...
                    throw new(c("oz-player/utils/OzError"))({
                        type: "OZ_XML_PARSER",
                        description: b.message + "; truncated xml (" + f + "/" + a.length + "): " + a.substring(0, f) + "\n\n" + b.stack,
                        extra: {
                            originalError: b
                        }
                    })
...
__d("oz-player/playback_controls/OzSteadyStateManager", ["invariant"], function(a, b, c, d, e, f, g, h) {
    "use strict";
    a = function() {
        function a(a, b) {
...
__d("oz-player/playback_controls/OzLiveLatencyManager", ["oz-player/playback_controls/OzSteadyStateManager", "oz-player/shims/OzDOMEventListener", "oz-player/shims/OzSubscriptionsHandler", "oz-player/shims/ozThrottle", "oz-player/utils/OzSourceBufferUtil"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a) {
            ...
            this.$4 = h;
            this.$5 = a;
            this.$16() && this.$8.addSubscriptions(c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$4, "timeupdate", c("oz-player/shims/ozThrottle")(function() {
                b.$17(), b.$18()
            }, this.$1.getNumber("playhead_manager_timeupdate_throttle_ms"))), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$4, "waiting", function() {
                b.$17()
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$4, "durationchange", function() {
                b.$17()
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$4, "seeking", function() {
                var a;
                b.$14 = Date.now();
                b.$12 = null;
                (a = b.$7) == null ? void 0 : a.reset()
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$4, "playing", function() {
                b.$14 = Date.now(), b.$12 = null
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(h, "pause", function() {
                var a;
        ...
        b.$22 = function() {
            return this.$2.getRefreshDate() == null && this.$1.getBool("latencymanager_stalempd_edgelatency_sec_on")
        };
        b.getInitialPlayHeadPosition = function() {
            return this.$22() ? this.getLiveHeadTimeSec() - this.$23(this.$1.getNumber("latencymanager_stalempd_edgelatency_sec")) : this.getLiveHeadTimeSec() - this.getPreferredLiveHeadLatencySec()
        };
        ...
        b.$26 = function(a, b) {
            ...
            if (this.$4.playbackRate === 0) {
                ...
                this.$6 = null
            } else if (this.$15 && this.$11 && a < d && (g > 0 || h > 0) && b === 0 && (c === 0 || this.$14 != null && this.$14 + c * 1e3 < Date.now())) {
                j = h > 0 ? 1 - h : this.$25(g, d, a);
                !this.$1.getBool("playback_speed_latency_adjustment_user_rate_disable") && this.$10 == null && (this.$10 = this.$4.playbackRate);
                this.$6 == null && this.$1.getBool("log_extra_events") && (this.$6 = this.$5.getOperationLogger("latency_manager").start().setInitiator("speed_adjustment").setReason("slow").setUserInfo({
                    newPlaybackRate: String(j),
                    oldPlaybackRate: String(this.$4.playbackRate)
                }));
                this.$27(j)
            } else if (this.$15 && this.$11 && (this.$19() || this.$20()) && i > 0 && b === 0 && (this.$13 == null || this.$13 + f * 1e3 < Date.now()) && (c === 0 || this.$14 != null && this.$14 + c * 1e3 < Date.now())) {
                !this.$1.getBool("playback_speed_latency_adjustment_user_rate_disable") && this.$10 == null && (this.$10 = this.$4.playbackRate);
                h = 1 + i;
                this.$6 == null && this.$1.getBool("log_extra_events") && (this.$6 = this.$5.getOperationLogger("latency_manager").start().setInitiator("speed_adjustment").setReason("fast").setUserInfo({
                    newPlaybackRate: String(h),
                    oldPlaybackRate: String(this.$4.playbackRate)
                }));
                this.$27(h)
            } else if (this.$15 === !1 || this.$12 == null || this.$12 + e * 1e3 < Date.now()) {
                g = this.$4.playbackRate;
                this.$1.getBool("playback_speed_latency_adjustment_user_rate_disable") ? this.$4.playbackRate = 1 : this.$10 != null && (this.$4.playbackRate = this.$10, this.$10 = null);
    ...
    a = function() {
        ...
        b.$18 = function(a) {
            ...
            if (b && this.$1.getNumber("pdash_download_cursor_catchup_threshold_sec") === 0 && e !== 0 && c !== 0 && a - this.$2.currentTime > c) {
                b = [];
                for (var c = 0; c < this.$2.buffered.length; c++) b.push({
                ...
                this.$1.getBool("log_extra_events") && this.$16.getOperationLogger("latency_manager").setInitiator("time_range_manager").setReason("blocked_range").setLength(b.endTime - b.startTime).setUserInfo({
...
__d("oz-player/playback_controls/OzPlayheadManager", ["oz-player/shims/OzDOMEventListener", "oz-player/shims/OzEventEmitter", "oz-player/shims/OzSubscriptionsHandler", "oz-player/shims/ozThrottle", "oz-player/shims/ozvariant", "oz-player/strategies/LiveheadSeekaheadStrategy", "oz-player/utils/OzNumericalRangeUtil", "oz-player/utils/OzSourceBufferUtil", "oz-player/utils/OzTimelineGapUtil"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        function b(b) {
            var d;
            d = a.call(this) || this;
            d.$OzPlayheadManager2 = new(c("oz-player/shims/OzSubscriptionsHandler"))();
            d.$OzPlayheadManager3 = new(c("oz-player/shims/OzSubscriptionsHandler"))();
            ...
            d.$OzPlayheadManager15 = !1;
            d.$OzPlayheadManager16 = !0;
            d.$OzPlayheadManager17 = !1;
            var e = b.video,
                f = b.mpd,
                g = b.playheadCatchup,
                j = b.playbackState,
                k = b.config,
                l = b.perfLoggerProvider,
                m = b.seekHandler,
                n = b.initialPlaybackPosition,
                o = b.canSupportSkipVideobufferGaps,
                p = b.liveLatencyManager;
            b = b.dynamicVideoLibrary;
            d.$OzPlayheadManager1 = e;
            d.$OzPlayheadManager6 = k;
            d.$OzPlayheadManager7 = j;
            d.$OzPlayheadManager8 = f;
            d.$OzPlayheadManager9 = g;
            d.$OzPlayheadManager11 = l;
            m && (d.$OzPlayheadManager12 = m);
            d.$OzPlayheadManager17 = o;
            d.$OzPlayheadManager20 = p;
            d.$OzPlayheadManager13 = n;
            d.$OzPlayheadManager21 = b;
            d.$OzPlayheadManager6.getBool("log_extra_events") && (d.$OzPlayheadManager18 = new i({
                video: e,
                perfLoggerProvider: l
            }), d.$OzPlayheadManager19 = new h({
                video: e,
                perfLoggerProvider: l,
                config: k
            }));
            d.$OzPlayheadManager2.addSubscriptions(c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "durationchange", function() {
                d.setPlaybackPositionOnFirstDurationChange("durationchange", d.$OzPlayheadManager1.duration), d.$OzPlayheadManager23("durationchange"), d.$OzPlayheadManager24("durationchange")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "pause", function() {
                d.$OzPlayheadManager23("pause")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "play", function() {
                d.$OzPlayheadManager23("play")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "playing", function() {
                d.$OzPlayheadManager23("playing")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "waiting", function() {
                d.$OzPlayheadManager6.getBool("playhead_manager_handle_time_range_update_on_waiting") ? d.$OzPlayheadManager23("waiting") : d.$OzPlayheadManager23.bind(babelHelpers.assertThisInitialized(d), "waiting"), d.$OzPlayheadManager24("waiting")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "timeupdate", c("oz-player/shims/ozThrottle")(function() {
                d.$OzPlayheadManager23("timeupdate"), d.$OzPlayheadManager6.getBool("playhead_manager_buffered_timerange_update_on_timeupdate") && d.$OzPlayheadManager24("timeupdate")
            }, d.$OzPlayheadManager6.getNumber("playhead_manager_timeupdate_throttle_ms"))), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "ratechange", function() {
                d.$OzPlayheadManager25() && d.$OzPlayheadManager6.getBool("handle_buffered_timerange_update_on_ratechange") && d.$OzPlayheadManager24("ratechange")
            }), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d.$OzPlayheadManager1, "seeking", function() {
                d.$OzPlayheadManager22 = Date.now()
            }));
            return d
        }
        var e = b.prototype;
        ...
        e.$OzPlayheadManager23 = function(a, b) {
            b === void 0 && (b = null);
            if (this.$OzPlayheadManager20 != null ? !this.$OzPlayheadManager20.shouldEnableManifestTimeRangeCatchup() : !this.$OzPlayheadManager6.getBool("skip_timerange_gaps")) return;
            var c = this.$OzPlayheadManager9;
            if (c && c.isEnabled(this.$OzPlayheadManager1, this.$OzPlayheadManager8)) {
                c = c.computeNewPlayheadPosition(this.$OzPlayheadManager1, this.$OzPlayheadManager8);
                if (typeof c === "number") {
                    this.$OzPlayheadManager27(c, "live_catch_up_strategy", a, b);
                    return
                }
            }
            c = this.$OzPlayheadManager6.getNumber("auto_seek_playhead_slack");
            if (c === 0) return;
            ...
            var f = this.$OzPlayheadManager7.getCurrentTime(),
                ...
                h = d("oz-player/utils/OzNumericalRangeUtil").findNextRangeIndex(f, g);
            if ((d("oz-player/utils/OzTimelineGapUtil").isNearGap(f, e.getTimeRanges(), this.$OzPlayheadManager6) || d("oz-player/utils/OzTimelineGapUtil").isInGap(f, e.getTimeRanges(), this.$OzPlayheadManager6)) && h !== -1) {
                f = g[h];
                this.$OzPlayheadManager27(f.rangeStart + c, "jump_over_timeline_gap", a, b)
            }
        };
        e.$OzPlayheadManager24 = function(a) {
            ...
            this.$OzPlayheadManager19 && this.$OzPlayheadManager6.getBool("log_extra_events") && this.$OzPlayheadManager19.markState(a, this.$OzPlayheadManager7);
            ...
            var q = c >= 0 ? i[c] : null,
                r = function(b) {
                    ...
                    !c && b != null && e.$OzPlayheadManager6.getBool("log_extra_events") && e.$OzPlayheadManager11.getOperationLogger("playhead_adjustment").setError("ignore_before_seek_main_" + b).setResult("failed").setInitiator(a).setUserInfo({
            ...
            if (o != null && this.$OzPlayheadManager25() && this.$OzPlayheadManager16 == !1 && r("buf")) {
                if (this.$OzPlayheadManager6.getBool("playhead_manager_buffer_gaps_skip_reverse") && o < g && q != null && q.rangeStart <= o && q.rangeEnd != null && q.rangeEnd > o) {
            ...
            if ((d("oz-player/utils/OzTimelineGapUtil").isNearGap(g, h, this.$OzPlayheadManager6, n, m) || d("oz-player/utils/OzTimelineGapUtil").isInGap(g, h, this.$OzPlayheadManager6, n)) && j !== -1 && (l === 0 || i[j].rangeStart - g < l) && (!this.$OzPlayheadManager6.getBool("playheadman_dont_skip_ahead_past_last_fetched") || o != null && i[j].rangeStart + f < o) && (this.$OzPlayheadManager16 == !0 || r("main"))) {
                c = i[j];
                this.$OzPlayheadManager27(c.rangeStart + f, "jump_over_buffer_gap", a, null, {
                    lastSegmentStartPTS: String(b),
                    last200RequestedUrlDecisionMinTime: String(p),
                    lastSeekTime: String(this.$OzPlayheadManager22)
                });
            ...
            this.$OzPlayheadManager18 && this.$OzPlayheadManager6.getBool("log_extra_events") && this.$OzPlayheadManager18.markState(a, {
        ...
        e.$OzPlayheadManager27 = function(a, b, c, d, e) {
            if (this.$OzPlayheadManager6.getBool("skip_playhead_adjustment_before_initial_playback_position") && (this.$OzPlayheadManager13 !== 0 && b !== "initial_playback_position" && !this.$OzPlayheadManager14)) return;
            var f = a - this.$OzPlayheadManager1.currentTime,
                g = this.$OzPlayheadManager6.getNumber("seek_ahead_epsilon");
            if (g > 0 && (this.$OzPlayheadManager6.getBool("playhead_manager_buffer_gaps_skip_reverse") ? Math.abs(f) : f) <= g) return;
...
__d("oz-player/media_source/OzMSESourceBufferImpl", ["oz-player/shims/OzDOMEventListener"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a(a) {
            this.$1 = a
...
__d("oz-player/workers/OzProxyVideoNode", ["oz-player/utils/OzFakeEventTarget"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function(a) {
        babelHelpers.inheritsLoose(b, a);
        ...
        function b(b, c, d) {
            ...
            e.$OzProxyVideoNode7 = null;
            e.$OzProxyVideoNode8 = null;
            e.$OzProxyVideoNode9 = b;
            e.$OzProxyVideoNode10 = c;
            e.$OzProxyVideoNode11 = d;
            Object.defineProperty(babelHelpers.assertThisInitialized(e), "currentTime", {
                get: function() {
                    return e.$OzProxyVideoNode1
                },
                set: function(a) {
                    e.$OzProxyVideoNode11(a)
                },
                configurable: !0,
                enumerable: !0
            });
            Object.defineProperty(babelHelpers.assertThisInitialized(e), "duration", {
                get: function() {
            ...
            Object.defineProperty(babelHelpers.assertThisInitialized(e), "seeking", {
                get: function() {
            ...
            Object.defineProperty(babelHelpers.assertThisInitialized(e), "playbackRate", {
                get: function() {
        ...
        c.setMediaSource = function(a) {
            this.$OzProxyVideoNode8 != null && URL.revokeObjectURL(this.$OzProxyVideoNode8), this.$OzProxyVideoNode7 = a, a && (this.$OzProxyVideoNode8 = URL.createObjectURL(a)), this.$OzProxyVideoNode9(this.$OzProxyVideoNode8)
        };
        c.play = function() {
            this.$OzProxyVideoNode10()
        };
        c.setState = function(a) {
...
__d("oz-player/media_source/SourceBufferManager", ["Promise", "oz-player/loggings/OzLoggingUtils", "oz-player/media_source/SourceBufferManagerUtils", "oz-player/shims/OzDOMEventListener", "oz-player/shims/OzDeferred", "oz-player/shims/OzMaybeNativePromise", "oz-player/shims/OzStreams", "oz-player/shims/OzSubscriptionsHandler", "oz-player/states/OzObservedSourceBufferState", "oz-player/utils/OzCustomErrorCode", "oz-player/utils/OzError", "oz-player/utils/ozConcatUint8Arrays", "oz-player/workers/OzProxyVideoNode"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
            ...
            this.$27 = function() {
                if (h.$9.hasError()) {
                    ...
                    var d = h.$9.getVideoNode(),
                        e = h.$27;
                    d instanceof c("oz-player/workers/OzProxyVideoNode") ? (d.addEventListener("error", e), b = {
                        remove: function() {
                            d.removeEventListener("error", e)
                        }
                    }) : b = c("oz-player/shims/OzDOMEventListener").listenDOMEvent(d, "error", e);
        ...
        e.setSourceBuffer = function(a) {
            this.cancelOperationAndCleanQueue(), this.$2 = a, this.$16(), this.$8.setSourceBuffer(a)
        };
        e.queueData = function(a, b, d) {
            b === void 0 && (b = null);
            d === void 0 && (d = 0);
            var e = new(c("oz-player/shims/OzDeferred"))(c("oz-player/shims/OzMaybeNativePromise"));
            this.$7.push({
                data: a,
                deferred: e,
                loggerProvider: b,
        ...
        e.$24 = function(a, b, e) {
            var f = this,
                g = function() {
                    var g = f.$3 = new(c("oz-player/shims/OzDeferred"))(c("oz-player/shims/OzMaybeNativePromise")),
                        h = !1,
                        i = !0;
                    try {
                        i = !!f.$2.getBuffered()
                    ...
                    k = g.getPromise();
                    b && d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(k, b, "append", function(b) {
                        var c;
            ...
            if (this.$2.getIsUpdating()) return this.$23(b).then(g)["catch"](function(a) {
                throw a
            });
        ...
        e.$19 = function() {
            ...
            b = b.appendTarget;
            this.$6 = !0;
            e = e instanceof d("oz-player/shims/OzStreams").OzReadableStream ? this.$26(e, g, b) : this.$24(e, g, {
                appendTarget: b
            });
            var h = d("oz-player/media_source/SourceBufferManagerUtils").startMeasuringAppendedBuffer(this.$10, this.$2, this.$8);
        ...
        e.$26 = function(a, b, d) {
            var e = this,
                ...
                h = a.getReader();
            a = function a() {
                var i = new(c("oz-player/shims/OzDeferred"))(c("oz-player/shims/OzMaybeNativePromise"));
                e.$5 = i;
                ...
                return i.getPromise().then(function(h) {
                    if (h.done) {
                        ...
                        f.length = 0;
                        g = 0;
                        return i.byteLength > 0 ? e.$24(i, b, {
                            appendTarget: d
                    ...
                    return h && h.byteLength >= d ? e.$24(h, b, {
                        appendTarget: d
                    }).then(function() {
                        return a()
                    }) : a()
...
__d("oz-player/shims/www/getOzVTTSourceBufferImplWWW", ["cr:3142"], function(a, b, c, d, e, f, g) {
    "use strict";
    g["default"] = b("cr:3142")
}, 98);
...
__d("oz-player/workers/mirroring/OzMediaSourceMirroring", ["oz-player/shims/OzDOMEventListener"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    function a(a, b) {
        ...
        d.forEach(function(d) {
            c("oz-player/shims/OzDOMEventListener").listenDOMEvent(a, d, function(c) {
                b(d, h(a))
            })
        });
        return h(a)
...
__d("oz-player/media_source/MediaSourceManager", ["oz-player/loggings/OzLoggingUtils", "oz-player/loggings/OzMultiDestinationPerfLogger", "oz-player/media_source/OzMSESourceBufferImpl", "oz-player/media_source/OzMediaErrorProvider", "oz-player/media_source/SourceBufferManager", "oz-player/shims/OzDOMEventListener", "oz-player/shims/OzDeferred", "oz-player/shims/OzMaybeNativePromise", "oz-player/shims/OzSubscriptionsHandler", "oz-player/shims/getOzVTTSourceBufferImpl", "oz-player/shims/ozClearTimeout", "oz-player/shims/ozSetTimeoutAcrossTransitions", "oz-player/shims/ozThrottle", "oz-player/utils/OzCustomErrorCode", "oz-player/utils/OzError", "oz-player/utils/OzErrorEmitter", "oz-player/utils/OzMimeUtil", "oz-player/utils/ozGetErrorNameFromMediaErrorCode", "oz-player/workers/OzProxyVideoNode", "oz-player/workers/mirroring/OzMediaSourceMirroring"], function(a, b, c, d, e, f, g) {
    ...
    function h(a, b, d) {
        if (a instanceof EventTarget) return c("oz-player/shims/OzDOMEventListener").listenDOMEvent(a, b, d);
        else {
    ...
    a = function() {
        function a(a) {
            ...
            this.$3.addSubscriptions(h(this.$1, "error", function() {
                var a;
                b.$5.getOperationLogger("media_element_error").setError((a = b.$9.getMediaErrorName()) != null ? a : void 0).setCode(b.$9.getErrorCode()).setResult("failed").log();
                b.$8 = [];
                b.$6 = [];
                b.$4.release();
                ...
                if (b.$20 != null) {
                    b.$5.getOperationLogger("media_element_error").setError(a).setCode(d).setReason("mitigation_failed").setResult("failed").log();
                    b.$21.emitError(e);
                    return
                }
                b.$20 = b.$1.currentTime;
                b.$19 == null && (b.$19 = c("oz-player/shims/ozSetTimeoutAcrossTransitions")(function() {
                    b.$19 = null, b.$11.getBool("retry_video_element_error") && (b.$17 != null && b.$17(e), b.$23())
                }, 0))
            ...
            this.$18 && c("oz-player/workers/mirroring/OzMediaSourceMirroring")(this.$2, this.$18);
            this.$24(this.$2);
            d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(this.$25(), this.$5, "media_source_open")
        }
        var b = a.prototype;
        b.$24 = function(a) {
            var b = this.$1;
            if (b instanceof c("oz-player/workers/OzProxyVideoNode")) b.setMediaSource(a);
            else {
                var d = b.src;
                d !== "" && URL.revokeObjectURL(d);
                if (a)
                    if (this.$11.getBool("use_src_object_for_media_source") && "srcObject" in b) try {
                        b.srcObject = a
                    } catch (c) {
        ...
        b.$23 = function() {
            ...
            if (this.$11.getBool("abort_clear_video_node_on_detach") && this.$12) return;
            this.$2 = new MediaSource();
            this.$18 && c("oz-player/workers/mirroring/OzMediaSourceMirroring")(this.$2, this.$18);
            this.$24(this.$2);
            var b = this.$25().then(function() {
                ...
                a.$7.forEach(function(c, d) {
                    var e = a.$26(d).then(function(b) {
                        c.setSourceBuffer(b), a.$27(b, c, d)
                    });
                    b.push(e)
                });
            ...
            b.then(function() {
                if (a.$11.getBool("abort_clear_video_node_on_detach") && a.$12) return;
                a.$16 && a.$16();
        ...
        b.$25 = function() {
            ...
            this.$3.addSubscriptions(h(this.$2, "sourceopen", function() {
                b.resolve(), a.$28()
            }));
            return b.getPromise()
        };
        b.$26 = function(a) {
            ...
            try {
                a.includes("vtt") ? e = this.$29(a) : e = this.$25().then(function() {
                    return new(c("oz-player/media_source/OzMSESourceBufferImpl"))(b.$2.addSourceBuffer(a))
                });
        ...
        b.$27 = function(a, b, c) {
            var e = this;
            d("oz-player/utils/OzMimeUtil").getMimeType(c);
        ...
        b.createSourceBufferManager = function(a, b, e) {
            ...
            return c("oz-player/shims/OzMaybeNativePromise").all([this.$25(), this.$26(a)]).then(function(b) {
                ...
                var e = new(c("oz-player/media_source/SourceBufferManager"))(b, f.$11, f.$9, function(a) {
                    return f.$2.readyState !== "closed" && (f.$11.getBool("should_check_that_source_buffer_attached") ? f.$30(a) : !0)
                }, function() {
                ...
                if (a instanceof c("oz-player/utils/OzError")) throw a;
                    ...
                    a = new(c("oz-player/utils/OzError"))({
                        type: "OZ_SOURCE_BUFFER",
                        description: "Failed to create SBM: " + (a.message || String(a)) + ", support AAC-LC=" + (MediaSource.isTypeSupported("audio/mp4; codecs=mp4a.40.2") ? "true" : "false"),
                        extra: {
                            originalError: a,
        ...
        b.notifyEndOfStream = function(a, b) {
            ...
            this.$3.addSubscriptions(h(this.$2, "sourceended", function() {
                e.resolve()
            }));
            this.$8.push(function(c) {
                if (d.$11.getBool("check_mediasource_readystate_before_end_of_stream")) {
                    ...
                    e = d.$5.getOperationLogger("end_of_stream");
                    e.setInitiator(a).setReason(b);
                    e.log();
                    c.endOfStream()
                }
        ...
        b.updateDuration = function(a, b) {
            var c = this.$2.duration;
            if (Number.isFinite(c) && (!b || c >= a)) return !1;
        ...
        b.detach = function() {
            this.$19 && (c("oz-player/shims/ozClearTimeout")(this.$19), this.$19 = null);
        ...
        b.$32 = function() {
            return !this.$31() && this.$2.readyState === "open" && !this.$10 && !this.$12
        };
        b.$31 = function() {
...
__d("oz-player/workers/OzMainThreadFallbackClient", ["oz-player/media_source/MediaSourceManager", "oz-player/networks/FetchWithTimeout", "oz-player/shims/interfaces/IOzWorkerClient"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a(a) {
            var b = a.videoNode,
        ...
        b.fetchAndMaybeAppend = function(a, b, e, f) {
            return c("oz-player/networks/FetchWithTimeout")(a, b, e).then(function(a) {
                return new(d("oz-player/shims/interfaces/IOzWorkerClient").ResponseAndMetadata)({
                    response: a
                })
            })
...
__d("oz-player/shims/www/OzCreateWorkerClientWWW", ["cr:1514", "oz-player/workers/OzMainThreadFallbackClient"], function(a, b, c, d, e, f, g) {
    "use strict";

    function a(a) {
        if (b("cr:1514") !== null && b("cr:1514").isSupported()) return new(b("cr:1514"))(a);
        else return new(c("oz-player/workers/OzMainThreadFallbackClient"))(a)
    }
    g.createWorkerClient = a
}, 98);
__d("oz-player/shims/OzCreateWorkerClient", ["oz-player/shims/www/OzCreateWorkerClientWWW"], function(a, b, c, d, e, f) {
    "use strict";
    Object.keys(importNamespace("oz-player/shims/www/OzCreateWorkerClientWWW")).forEach(function(a) {
...
__d("oz-player/states/OzObservedPlaybackState", ["oz-player/loggings/OzMultiDestinationPerfLogger", "oz-player/shims/OzDOMEventListener", "oz-player/shims/OzSubscriptionsHandler"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b, e) {
            ...
            this.$3 = new(c("oz-player/shims/OzSubscriptionsHandler"))();
            this.$5 = function() {
                f.$4.getOperationLogger("pause").setState("paused").log()
            };
            this.$6 = function() {
                f.$4.getOperationLogger("playing").setState("playing").log()
            };
            this.$2 = b;
            this.$4 = e;
            this.$3.addSubscriptions(c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$2, "pause", this.$5), c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$2, "playing", this.$6))
        }
        var b = a.prototype;
        b.isPlaying = function() {
            return !this.$2.paused
        };
        b.getCurrentTime = function() {
            return this.$2.currentTime
        };
        b.getCurrentTimeUpdateTime = function() {
            return Date.now()
        };
        b.getDuration = function() {
            return this.$2.duration
        };
        b.addEventListener = function(a, b) {
            return c("oz-player/shims/OzDOMEventListener").listenDOMEvent(this.$2, a, b)
        };
        b.destroy = function() {
            this.$3.release()
        };
...
__d("oz-player/strategies/OzAudioIBRManager", ["oz-player/networks/OzBandwidthEstimator"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function() {
        function a(a, b) {
            this.$1 = a, this.$2 = b
        ...
        b.getInitialAudioRepresentation = function(a) {
            var b = c("oz-player/networks/OzBandwidthEstimator").getAdjustedBandwidth(this.$1.getLegacyConfig());
            a = a.slice(0);
            a.sort(function(a, b) {
                return a.getBandwidth() - b.getBandwidth()
            });
            ...
            for (var e = a.length - 1; e >= 0; e--)
                if (a[e].getBandwidth() <= d) {
                    this.$2.getOperationLogger("audio_ibr_success").setRepresentationID(a[e].getID()).setReason(b.toString()).log();
                    return a[e]
                }
            this.$2.getOperationLogger("audio_ibr_no_op").setReason(b.toString()).log();
            return null
        };
        return a
    }();
...
__d("oz-player/strategies/OzBufferTargetCalculator", [], function(a, b, c, d, e, f) {
    ...
    a = function() {
        ...
        b.computeBufferTarget = function() {
            ...
            for (var e = this.$3, d = Array.isArray(e), c = 0, e = d ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                if (d) {
                    if (c >= e.length) break;
                    b = e[c++]
                } else {
...
__d("oz-player/streams/OzEndOfStreamWatcher", ["oz-player/shims/OzEventEmitter", "oz-player/shims/ozvariant"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        d.notifyRepresentationSwitched = function(a) {
            this.$OzEndOfStreamWatcher1.has(a) || c("oz-player/shims/ozvariant")(0, 5192), this.$OzEndOfStreamWatcher4("end_of_stream_watcher", "representation_switched")
        };
        d.notifyMediaStreamEnded = function(a) {
            this.$OzEndOfStreamWatcher1.has(a) || c("oz-player/shims/ozvariant")(0, 5192), this.$OzEndOfStreamWatcher1.set(a, !0), this.$OzEndOfStreamWatcher4("end_of_stream_watcher", "media_stream_ended")
        };
        d.$OzEndOfStreamWatcher4 = function(a, b) {
            var c = this,
                d = this.$OzEndOfStreamWatcher2.getReadyState();
            d === "open" && this.$OzEndOfStreamWatcher5() && this.$OzEndOfStreamWatcher2.notifyEndOfStream(a, b).then(function() {
                c.emit("streamEnd")
            })["catch"](function() {
                c.emit("streamEnd")
            })
        ...
        b.$10 = function(a) {
            ...
            a.then(function() {
                if (e) {
                    ...
                    h && d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(k, h, "fetch_stream", function() {}, function(c) {
                        if (i) {
                            d("oz-player/utils/OzNetworkRequestLoggingUtils").setFetchStreamLoggingAttributes(c, i.getRequestUrl(), i.isPrefetch(), i.segments, f - j, a.getBytesStreamed(), i.getResponse());
                            var e = b.$9;
                ...
                b.$4 = null, b.$3.reject(a), b.$8.getBool("streaming_task_reject_current_stream_deferred") && k.reject(a), f.reject(a)
            })
        };
        b.$11 = function(a) {
            return a.then(function(a) {
...
__d("oz-player/streams/OzSegmentLocator", ["oz-player/utils/OzNumericalRangeUtil", "oz-player/utils/OzRangeUtils"], function(a, b, c, d, e, f, g) {
    ...
    var h = function(a, b) {
            a = a.getCurrentTime();
            a = b ? d("oz-player/utils/OzRangeUtils").getRangeForTime(a, b.getBufferedRanges()) : null;
            return a
        },
        i = function(a, b, c) {
            b = h(a, b);
    ...
    b = function(a, b, c, e, f, g, j, k) {
        k = a.getPredictedSegmentAfter(g);
        if (k && b.isPlaying()) return k;
        h(b, e);
        k = i(b, e, g);
        e = f.getTimeRanges();
        g = d("oz-player/utils/OzNumericalRangeUtil").findDiffCoveredByRanges(b.getCurrentTime(), k, e.map(function(a) {
            return {
                rangeStart: a.startTime,
                rangeEnd: a.endTime
            }
        ...
        if (g > c) return null;
        f = a.getSegment(0);
        (j.getNumber("auto_seek_playhead_slack") === 0 || j.getBool("fix_initial_segment_non_zero_start_time")) && f && f.getTimeRange().startTime > k && (k = f.getTimeRange().startTime);
        return a.getSegmentByTime(k)
    };
    ...
    a = function(a) {
        ...
        function b(b) {
            ...
            e.$OzMediaStream5.then(function(a) {
                e.$OzMediaStream6 = a, e.$OzMediaStream16 && e.$OzMediaStream16.setSourceBuffer(a), e.$OzMediaStream27.setSourceBufferState(a.getSourceBufferState()), e.$OzMediaStream46()
            });
            e.$OzMediaStream12 = h;
            e.$OzMediaStream7 = i;
            e.$OzMediaStream14 = j;
            ...
            e.$OzMediaStream17.addSubscriptions(e.$OzMediaStream7.addEventListener("seeking", function() {
                var a = i.getCurrentTime(),
                    b = null;
                e.$OzMediaStream1.getBool("ignore_reset_after_seek_if_bufferahead") && e.$OzMediaStream8.canPredict() && (e.$OzMediaStream1.getBool("ignore_reset_after_seek_if_bufferahead_liverewind") || e.$OzMediaStream35) && (e.$OzMediaStream6 ? d("oz-player/utils/OzBufferingUtils").getBufferAheadFromCurrentTime(a, e.$OzMediaStream6.getSourceBufferState().getBufferedRanges()) > 0 : !1) ? b = "no_reset_anchor" : (b = "reset_anchor", e.$OzMediaStream41 = Date.now(), e.$OzMediaStream9 != null && (e.$OzMediaStream47(), e.$OzMediaStream31 = !1, e.$OzMediaStream24 && e.$OzMediaStream24.resolve(), e.$OzMediaStream1.getBool("media_stream_tracker_cancel_on_seek") && (e.$OzMediaStream13 && e.$OzMediaStream13.cancel())));
                if (e.$OzMediaStream1.getBool("log_extra_events")) {
        ...
        e.updateRunTimeConfigs = function(a) {
            ...
            a === !0 && this.$OzMediaStream8.canApproximateId() && (this.$OzMediaStream47(), this.$OzMediaStream10 = null)
        };
        e.$OzMediaStream49 = function(a, b) {
            var d, e = this;
            b === void 0 && (b = "internal");
            b === "user" && this.$OzMediaStream47();
            (d = this.$OzMediaStream20) == null ? void 0 : d.remove();
            this.$OzMediaStream20 = null;
            d = this.$OzMediaStream18.cloneContext().setType(this.$OzMediaStream21 + ";init");
            var f = d.cloneContext().setRepresentationID(a.getID()),
                g = a.getInitSegment(),
                h = g.getData(),
                i = d.getOperationLogger("stream_switch").setPreviousRepresentationID(this.$OzMediaStream8 ? this.$OzMediaStream8.getID() : null).setInitiator(b).setRepresentationID(a.getID()).setReason(b === "internal" ? this.$OzMediaStream16 && this.$OzMediaStream16.getLastEvaluationReason() : b).start();
            ...
            d = function() {
                ...
                e.emit("initAppended");
                (a = e.$OzMediaStream14) == null ? void 0 : a.notifyRepresentationSwitched(e)
            };
            var j = function(b) {
                var c;
                i.setError(b).log();
                e.$OzMediaStream50(b);
                (c = e.$OzMediaStream40) == null ? void 0 : c.handleError(a.getID(), b);
                if (e.$OzMediaStream1.getBool("proceed_on_representation_change_in_init_append_fail") && a.getID() !== e.$OzMediaStream8.getID()) {
                    (c = e.$OzMediaStream24) == null ? void 0 : c.resolve()
                }
            };
            if (h == null) {
                g = this.$OzMediaStream12.request([g], [c("oz-player/networks/getOzBandwidthEstimatorPipeThroughReporter")(this.$OzMediaStream21)], f, null, this.$OzMediaStream44, d, j);
                h = g.getStream()
            }
            this.emit("switchRepresentation", b, a);
            this.$OzMediaStream51({
                data: h,
        ...
        e.$OzMediaStream54 = function(a) {
            ...
            if (this.$OzMediaStream1.getBool("null_segment_for_no_buffer_target") && c <= 0) return null;
            var e = null;
        ...
        e.$OzMediaStream57 = function(a, b) {
            var e;
            ...
            if (e) f = [a];
                ...
                if (!b) {
                    e = this.$OzMediaStream53(f);
                    if (e) {
                        this.$OzMediaStream49(e);
                        a = this.$OzMediaStream54(!1);
                        if (!a) return [];
                        else return this.$OzMediaStream57(a, {
        ...
        e.$OzMediaStream59 = function(a, b) {
            b = this.$OzMediaStream54(a);
            if (b == null) return [];
            else return this.$OzMediaStream57(b, {
                fetchSingleSegment: a
            })
        };
        e.$OzMediaStream52 = function() {
            var a = this,
            ...
            var e = this.$OzMediaStream56(),
                f = this.$OzMediaStream54(e);
            if (this.$OzMediaStream8.canPredict() && this.$OzMediaStream11 != null && d("oz-player/manifests/IOzSegment").isSequenceNumberGreaterOrEqual(f, this.$OzMediaStream11)) {
                this.$OzMediaStream1.getBool("log_extra_events") && this.$OzMediaStream18.cloneContext().getOperationLogger("media_loop_end").setInitiator("segment_end").setRepresentationID(this.$OzMediaStream8.getID()).log();
                return
            }
            ...
            if (!f || this.$OzMediaStream31) {
                ...
                return this.$OzMediaStream58()
            }
            this.$OzMediaStream22 = 0;
            var j = this.$OzMediaStream57(f, {
            ...
            var n = k.getTimeRange().endTime,
                ...
                p = function(b) {
                    v.setAppendedBufferMs(Math.round(b.appendedSec * 1e3)), v.log(), a.$OzMediaStream26.handleEvent("append_succeeded"), j.forEach(function(b) {
                        a.emit("SegmentAppended", a.$OzMediaStream60(b, o))
                    }), m() && a.endStream(), a.$OzMediaStream61(o, b)
                },
                q = function(b) {
                    v.setError(b).log();
                    var c = t || s;
            ...
            !e ? (t = this.$OzMediaStream30.startStreamDeferred({
                segments: this.$OzMediaStream59(e, j),
            ...
            }), this.$OzMediaStream1.getBool("media_stream_tracker_cancel_on_seek") ? this.$OzMediaStream13 = t : this.$OzMediaStream13 = s) : (s = this.$OzMediaStream12.request(j, [c("oz-player/networks/getOzBandwidthEstimatorPipeThroughReporter")(this.$OzMediaStream21)], r.cloneContext(), null, this.$OzMediaStream44, p, q), this.$OzMediaStream13 = s);
            this.$OzMediaStream31 = !0;
            var u = this.$OzMediaStream62(g, k, j.length),
            ...
            }), x = t.getStatusChangePromise()) : s && (w(s.getStream()), x = s.getStatusChangePromise());
            !x && c("oz-player/shims/ozvariant")(0, 51928);
            f = x.then(function(b) {
                a.$OzMediaStream63(b, k);
                return a.$OzMediaStream64()
            }).then(function() {
                a.$OzMediaStream2 = 0
            });
            return f["catch"](function(b) {
                ...
                return a.$OzMediaStream66(b, k, d)
            })
        };
        ...
        e.$OzMediaStream66 = function(a, b, e) {
            var f = this;
            ...
            var g = new(c("oz-player/shims/OzDeferred"))(c("oz-player/shims/OzMaybeNativePromise")),
                ...
                l = function(b) {
                    f.$OzMediaStream2++;
                    f.$OzMediaStream1.getBool("log_extra_events") && f.$OzMediaStream18.getOperationLogger("media_stream").setInitiator("fetch_stream_" + (b.behavior != null ? b.behavior : "default")).setLength(b.timeoutMs).setReason("" + k.getDescription()).setError(k).setCode(j.length > 0 ? Number.parseInt(j, 10) : null).setType(f.$OzMediaStream21).log();
            ...
            i = {
                ...
                endStream: function() {
                    m(), f.$OzMediaStream10 = b, f.$OzMediaStream1.getBool("segment_end_410_response") && (f.$OzMediaStream11 = b), f.endStream(), g.resolve()
                },
                error: k,
                isInitialRequest: !1,
                retry: function(a) {
        ...
        e.$OzMediaStream65 = function(a) {
            this.$OzMediaStream47();
        ...
        e.$OzMediaStream63 = function(a, b) {
            if (a === "done") {
                a = (a = this.$OzMediaStream42) == null ? void 0 : a.getLast200RequestedUrlDecisionTimeByMimeType(this.$OzMediaStream21);
                if (this.$OzMediaStream1.getBool("media_stream_buffer_gaps_ignore_before_seek") && this.$OzMediaStream8.canPredict() && this.$OzMediaStream35 == !1 && this.$OzMediaStream9 == null && this.$OzMediaStream41 != null && a != null && this.$OzMediaStream41 >= a) return;
                this.$OzMediaStream9 = b
            }
        };
        e.$OzMediaStream64 = function() {
            this.$OzMediaStream31 = !1
        };
        e.$OzMediaStream51 = function(a) {
            this.$OzMediaStream19.push(a), this.$OzMediaStream6 && this.$OzMediaStream46()
        };
        ...
        e.$OzMediaStream46 = function() {
            ...
            this.$OzMediaStream19.forEach(function(b) {
                ...
                a.$OzMediaStream6 && a.$OzMediaStream6.queueData(d, g, b).then(function(a) {
                    if (!a) return;
                    e(a)
                })["catch"](function(a) {
                    f(a)
        ...
        e.$OzMediaStream68 = function(a) {
            return c("gkx")("3459") && (a instanceof c("oz-player/utils/OzError") && a.getType() === "OZ_ALLOCATION_FAILURE") ? !0 : !1
        };
        e.$OzMediaStream50 = function(a) {
            ...
            } else c("oz-player/shims/ozReportUnexpectedError")(a, "OzMediaStream append error callback", "warn"), this.$OzMediaStream68(a) && this.$OzMediaStream33.emitError(a)
        };
        e.$OzMediaStream62 = function(a, b, c) {
            var d = 0;
        ...
        e.cleanup = function() {
            var a = this.$OzMediaStream1.getBool("stop_loop_driver_immediately_on_cleanup");
            a && this.$OzMediaStream23.stop();
            ...
            this.$OzMediaStream20 && (this.$OzMediaStream20.remove(), this.$OzMediaStream20 = null);
            a || this.$OzMediaStream23.stop()
        };
        ...
        e.endStream = function() {
            var a;
            (a = this.$OzMediaStream14) == null ? void 0 : a.notifyMediaStreamEnded(this);
            this.$OzMediaStream69()
        };
        e.endStreamIfBufferedToEndTime = function() {
            ...
            if (a.length > 0) {
                ...
                if (this.$OzMediaStream6) {
                    ...
                    b.length > 0 && (Math.abs(b[b.length - 1].endTime - a) < i && this.endStream())
                }
            }
        };
        ...
        e.restartLoopBody = function() {
            this.$OzMediaStream45 && this.$OzMediaStream45.resetStream(this.$OzMediaStream44), this.$OzMediaStream47(), this.$OzMediaStream31 = !1, this.$OzMediaStream13 && this.$OzMediaStream13.cancel(), this.$OzMediaStream22 !== 0 && this.$OzMediaStream24 && this.$OzMediaStream24.resolve()
        };
        e.$OzMediaStream69 = function() {
            if (this.$OzMediaStream6) {
        ...
        e.$OzMediaStream48 = function(a) {
            this.$OzMediaStream8.getID() === a && this.$OzMediaStream16 != null && this.$OzMediaStream49(this.$OzMediaStream16.getBestRepresentation())
        };
        e.setEnableLiveheadCatchup = function(a) {
...
__d("oz-player/streams/OzPredictedSegmentLocator", ["oz-player/streams/OzSegmentLocator", "oz-player/streams/OzSegmentUtils", "oz-player/utils/OzSourceBufferUtil"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.getSegment = function(a, b, c, d, e, f, g, h, i) {
            ...
            g.getBool("log_extra_events") && j.segment === null && this.$3.getOperationLogger("segment_locator").setInitiator(j.initiator).setReason(j.reason).setType(i).setUserInfo(j.userInfo).log();
            b = this.$4;
            if (j.segment && b != null) {
        ...
        b.$6 = function(a, b, c, e, f, g, j, k, l) {
            var m, n = b.getCurrentTime(),
                ...
                p = j.getBool("pdash_download_cursor_nocatchup_use_currentbuffer") && !k;
            p = e != null ? j.getBool("pdash_download_cursor_use_totalbuffer") && !p ? d("oz-player/utils/OzSourceBufferUtil").getTotalBufferAheadOfPosition(e.getBufferedRanges(), b.getCurrentTime(), j) : d("oz-player/utils/OzSourceBufferUtil").getBufferAheadInBufferedRanges(e.getBufferedRanges(), b.getCurrentTime(), j) : {
                bufferAheadSec: 0,
                bufferedOffset: 0
            };
            var q = p.bufferAheadSec;
            p = p.bufferedOffset;
            var r = null,
                s = null,
            ...
            if (o && k && ((m = u) == null ? void 0 : m.getSequenceNumber()) != null && ((m = (m = u) == null ? void 0 : m.getSequenceNumber()) != null ? m : 0) <= ((m = v == null ? void 0 : v.getSequenceNumber()) != null ? m : 0)) {
                ...
                o = j.getNumber("pdash_download_cursor_between_catchups_seg") === 0 || ((v = v == null ? void 0 : v.getSequenceNumber()) != null ? v : 0) + j.getNumber("pdash_download_cursor_between_catchups_seg") < ((v = o == null ? void 0 : o.getSequenceNumber()) != null ? v : 0);
                if (o) {
                    if (((v = m == null ? void 0 : m.getSequenceNumber()) != null ? v : 0) > ((v = (o = u) == null ? void 0 : o.getSequenceNumber()) != null ? v : 0)) {
                        this.$5[l].lastSkippedToSegmentNumber = (o = m == null ? void 0 : m.getSequenceNumber()) != null ? o : 0;
                        if (j.getBool("log_extra_events")) {
                            this.$3.getOperationLogger("segment_locator").setInitiator("catchup").setUserInfo({
                                bufferAheadSec: String(q),
                                bufferedOffset: String(p)
                            }).setLength(((v = m == null ? void 0 : m.getSequenceNumber()) != null ? v : 0) - ((v = (o = u) == null ? void 0 : o.getSequenceNumber()) != null ? v : 0)).setType(l).log()
                        }
                    }
                    u = m;
                    r = "catchup";
                ...
                r = "1st_run";
                o = a.getTimeRanges();
                u === null && this.$2 != null && j.getBool("download_cursor_1st_run_2_fallback") && (u = a.getSegmentByTime(this.$2.getInitialPlayHeadPosition()), r = "1st_run_2");
                s = {
                    approx: String(a.canApproximateId()),
                    ranges: String(o.length),
                    mpdStartTime: o.length > 0 ? String(o[o.length - 1].startTime) : null,
                    mpdEndTime: o.length > 0 ? String(o[o.length - 1].endTime) : null
                };
                if (j.getBool("download_cursor_1st_run_set_skipped_segment_on")) {
                    this.$5[l].lastSkippedToSegmentNumber = (m = (v = u) == null ? void 0 : v.getSequenceNumber()) != null ? m : 0
                }
            }
            w && j.getBool("download_cursor_disable_buffer_ahead_rule_on") && (!j.getBool("download_cursor_disable_buffer_ahead_rule_lr_on") || k) && (w = t, x = "stream_state");
            if (w && q > c) {
            ...
            } else !w && q > c && (j.getBool("log_extra_events") && this.$3.getOperationLogger("segment_locator").setUserInfo({
                bufferAheadSec: String(q),
                bufferedOffset: String(p),
                computedBufferAheadTarget: String(c)
            ...
            if (u && g && f >= n) {
                o = d("oz-player/streams/OzSegmentLocator").getEndingSequenceNumber(a);
                return (o || 0) >= f ? {
                    segment: g
                } : {
                    segment: null,
            ...
            k = i(this.$5, l);
            t = Date.now();
            if (j.getNumber("download_cursor_total_buffer_max_sec") != 0 && j.getNumber("download_cursor_total_buffer_max_sec") < m || j.getNumber("download_cursor_buffer_ahead_time_max_sec") != 0 && k != null && j.getNumber("download_cursor_buffer_ahead_time_max_sec") < (t - k) / 1e3) {
                ...
                this.$3.getOperationLogger("segment_locator").setUserInfo({
                    ...
                    computedBufferAheadTarget: String(c),
                    inBufferAheadElapsedTime: String((t - ((n = k) != null ? n : 0)) / 1e3)
...
__d("oz-player/Player", ["Promise", "oz-player/configs/OzPlayerConfig", "oz-player/drm/OzDrmManager", "oz-player/loggings/OzDevConsolePerfLogger", "oz-player/loggings/OzLoggingUtils", "oz-player/loggings/OzMultiDestinationPerfLogger", "oz-player/loggings/OzOperationLoggerObserver", "oz-player/manifests/OzDynamicVideoLibrary", "oz-player/manifests/OzVideoRepresentation", "oz-player/media_source/OzMediaSeekableRangeManager", "oz-player/networks/OzClientClock", "oz-player/networks/OzNetworkManager", "oz-player/parsers/OzMpdParser", "oz-player/parsers/OzMpdUpdater", "oz-player/parsers/OzXmlParserImplDOMParser", "oz-player/playback_controls/OzClearSourceBufferOnSeekManager", "oz-player/playback_controls/OzLiveLatencyManager", "oz-player/playback_controls/OzPlaybackTimeRangeManager", "oz-player/playback_controls/OzPlayheadManager", "oz-player/shims/OzCreateWorkerClient", "oz-player/shims/OzEventEmitter", "oz-player/shims/OzMaybeNativePromise", "oz-player/shims/OzPerformance", "oz-player/shims/OzSubscriptionsHandler", "oz-player/shims/ozClearTimeout", "oz-player/shims/ozReportUnexpectedError", "oz-player/shims/ozSetTimeoutAcrossTransitions", "oz-player/shims/ozvariant", "oz-player/states/OzObservedPlaybackState", "oz-player/states/OzPositionToViewport", "oz-player/strategies/OzAbrManager", "oz-player/strategies/OzAudioIBRManager", "oz-player/strategies/OzBandwidthBoundaryStreamSegmentsCountStrategy", "oz-player/strategies/OzBlockedRepresentationsManager", "oz-player/strategies/OzBufferAheadPriorityStrategy", "oz-player/strategies/OzBufferAheadTargetStrategy", "oz-player/strategies/OzBufferEndLimitStrategy", "oz-player/strategies/OzBufferTargetBoundedStreamSegmentsCountStrategy", "oz-player/strategies/OzBufferTargetCalculator", "oz-player/strategies/OzBufferTargetCalculatorQuotaExceededConstraint", "oz-player/strategies/OzBufferingDetector", "oz-player/strategies/OzPausedStreamSegmentsCountStrategy", "oz-player/strategies/OzPlayheadAtInterruptionDetector", "oz-player/strategies/OzPlayingStatePriorityStrategy", "oz-player/strategies/OzPositionToViewportPriorityStrategy", "oz-player/strategies/OzPriorityCalculator", "oz-player/strategies/OzStaleManifestBufferTargetStrategy", "oz-player/strategies/OzStartupBufferTargetStrategy", "oz-player/strategies/OzStaticStreamSegmentsStrategy", "oz-player/strategies/OzStreamSegmentsCountCalculator", "oz-player/strategies/OzSupportedMimeCodecsRestriction", "oz-player/streams/OzEndOfStreamWatcher", "oz-player/streams/OzHandleUserRepresentationSwitch", "oz-player/streams/OzMediaStream", "oz-player/streams/OzPredictedSegmentLocator", "oz-player/utils/OzCustomErrorCode", "oz-player/utils/OzError", "oz-player/utils/OzErrorEmitter", "oz-player/utils/OzMpdUtils", "oz-player/utils/OzPlaybackRestrictionsUtils", "oz-player/utils/OzReadableStreamUtils", "oz-player/utils/getRepresentationInCache", "oz-player/workers/OzMainThreadFallbackClient"], function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        ...
        function e(b) {
            ...
            e.$Player16 = m || !1;
            e.$Player15 = new(d("oz-player/loggings/OzMultiDestinationPerfLogger").OzMultiDestinationPerfLoggerProvider)(e.$Player71().concat(n));
            e.$Player2 = f;
            ...
            e.$Player51 = p;
            e.$Player27 = w;
            e.$Player65 = new(c("oz-player/strategies/OzBlockedRepresentationsManager"))(e.$Player4);
            e.$Player10.addSubscriptions(e.$Player65.onRepresentationBlocked(function(a) {
                e.emit("representationBlocked", a)
            }));
            e.$Player30 = [e.$Player65, new(c("oz-player/strategies/OzSupportedMimeCodecsRestriction"))()].concat(x);
            e.$Player28 = z;
            e.$Player29 = y;
            e.$Player34 = A;
            e.$Player35 = B;
            ...
            e.$Player61 = I;
            e.$Player3 = h;
            e.$Player67 = d("oz-player/shims/OzCreateWorkerClient").createWorkerClient({
                videoNode: e.$Player3,
                config: e.$Player4,
            ...
            e.$Player62 = new(c("oz-player/playback_controls/OzClearSourceBufferOnSeekManager"))(e.$Player3, e.$Player4, e.$Player5, e.$Player15);
            e.$Player62.maybeOverwriteVideoCurrentTimeProperty();
            e.$Player23 = e.$Player67 instanceof c("oz-player/workers/OzMainThreadFallbackClient") ? o : null;
            f = e.$Player23 && e.$Player23.getCachedRepresentations();
            e.$Player24 = f || u;
            e.$Player10.addSubscriptions(e.$Player62.onError(e.$Player11.emitError));
            e.$Player4.getBool("enable_dvl") && (e.$Player63 = new(c("oz-player/manifests/OzDynamicVideoLibrary"))({
                config: e.$Player4
            }));
            e.$Player42 = q;
            e.$Player43 = s;
            ...
            e.$Player22 = new(c("oz-player/media_source/OzMediaSeekableRangeManager"))(e.$Player7, e.$Player4);
            e.$Player48 = (i = g) != null ? i : e.$Player74();
            e.$Player4.getNumber("pixels_below_viewport_to_observe") > 0 && (e.$Player59 = new(c("oz-player/states/OzPositionToViewport"))(e.$Player3, e.$Player4));
            return e
        }
        var f = e.prototype;
        f.$Player73 = function() {
        ...
        f.$Player75 = function(a) {
            var b = this;
            this.$Player76();
            try {
                var e = d("oz-player/loggings/OzLoggingUtils").executeOperationAndLog(this.$Player15.cloneContext().setInitiator(this.$Player47), "parse_manifest", function(e) {
                    var c = b.$Player77(a);
                    if (b.$Player4.getBool("log_extra_events")) {
                        var f, g;
        ...
        f.$Player78 = function(a) {
            ...
            if (this.$Player17 != null) {
                ...
                }), d.addListener("streamTransitionToStatic", this.$Player83), d.addListener("streamGone", this.$Player84));
                d.setupUpdateLoop();
                this.$Player20 = d
            }
            ...
            }), this.$Player36 = this.$Player39.getPreferredLiveHeadLatencySec() * -1) : this.$Player36 = this.$Player36 : this.$Player36 = a.isStaticMpd() ? this.$Player36 : this.$Player85(a);
            this.$Player18 = new(c("oz-player/playback_controls/OzPlayheadManager"))({
                ...
                canSupportSkipVideobufferGaps: this.$Player62.getCurrentTimePropertyOverwriteSuccess(),
            ...
            this.$Player86()["catch"](function(a) {
        ...
        f.load = function(a) {
            ...
            try {
                var d = this.$Player8;
                d != null ? this.$Player75(d) : a != null ? this.$Player87(a).then(function(a) {
                    if (b.$Player58) {
                        b.$Player58 = !1;
                        b.load(b.$Player17);
                        return
        ...
        f.$Player89 = function() {
            this.$Player53 != null && (c("oz-player/shims/ozClearTimeout")(this.$Player53), this.$Player53 = null)
        };
        f.$Player88 = function(a, b) {
            var d = this,
                e = !0,
                f = this.$Player52 - 1,
                g = a.getExtra().code;
            this.$Player54 !== g ? (this.$Player54 = g, this.$Player55 = 1) : this.$Player55++;
            var h = function() {
                e = !1
            };
            g = {
                endStream: function() {
                    if (d.$Player4.getBool("emit_stream_gone_on_end_stream_before_start")) h(), d.$Player49 = !0, d.emit("streamGoneBeforeStart");
                    else throw new(c("oz-player/utils/OzError"))({
                        type: "OZ_INITIALIZATION",
                ...
                isInitialRequest: !0,
                retry: function(a) {
                    h(), d.$Player89(), d.$Player53 = c("oz-player/shims/ozSetTimeoutAcrossTransitions")(function() {
                        d.$Player89(), d.load(b)
        ...
        f.updatePlayerRunTimeConfig = function(a) {
            ...
            b != null && b !== "" && this.$Player90(b)
        };
        f.$Player91 = function(a, b) {
            var c = this,
                e = a.getMimeCodecs();
            e = this.$Player7.createSourceBufferManager(e, b, a.getInitSegment().getData());
            this.$Player92(e, b, a);
            a = e.then(function(a) {
                c.$Player48 && b !== "caption" && c.$Player48.setSourceBufferState(b, a.getSourceBufferState());
                return a
            });
        ...
        f.$Player76 = function() {
            if (this.$Player45.length > 0) {
                var a = this.$Player46 = new(d("oz-player/drm/OzDrmManager").OzDrmManager)(this.$Player15, this.$Player3, {
                    maxStartEMEAttempts: this.$Player4.getNumber("max_start_eme_attempts"),
                    throwNoLicenseError: this.$Player4.getBool("throw_no_license_error")
                });
                a.onError(this.$Player11.emitError);
                this.$Player45 && this.$Player45.forEach(function(b) {
                    a.addProvider(b)
                });
                this.$Player28.drmProtections && this.$Player11.emitError(new(c("oz-player/utils/OzError"))({
                    type: "OZ_DRM_MANAGER",
        ...
        f.$Player92 = function(a, b, e) {
            var f = this,
                ...
                j = new(c("oz-player/streams/OzMediaStream"))({
                    ...
                    playbackState: this.$Player13,
                    endOfStreamWatcher: !this.$Player4.getBool("disable_end_of_stream_in_caption_stream") || b !== "caption" ? this.$Player14 : null,
                    bufferTargetCalculator: this.$Player95(b),
                    priorityCalculator: this.$Player96(),
                    streamSegmentsCountCalculator: this.$Player97(b),
                    abrManager: i,
                    representation: e,
                    ...
                    dynamicVideoLibrary: this.$Player63,
                    shouldAppendOncePerStream: this.$Player4.getBool("append_once_per_stream_in_caption_stream") && b === "caption",
                    mediaStreamType: b,
            ...
            this.$Player10.addSubscriptions(j.onError(this.$Player11.emitError), this.$Player22.listenToMediaStreamInitAppended(j));
            b === "video" && (this.$Player32 = new(c("oz-player/streams/OzHandleUserRepresentationSwitch"))(this.$Player4, this.$Player13, d("oz-player/utils/OzPlaybackRestrictionsUtils").applyVideoPlaybackRestrictions(this.$Player4, this.$Player30, this.$Player94(), g.getVideoRepresentations()), j, a, this.$Player70), this.$Player10.addSubscriptions(this.$Player32.onError(this.$Player11.emitError)));
            this.$Player5.set(b, j);
            this.$Player10.addSubscriptions(j.addListener("switchRepresentation", function() {
                var a = j.getCurrentRepresentation();
                f.$Player22.setTimeRangeProvider(a);
        ...
        f.$Player99 = function() {
            if (this.$Player64 != null) return [new(c("oz-player/strategies/OzBufferEndLimitStrategy"))(this.$Player3, this.$Player64)];
            else return [new(c("oz-player/strategies/OzStaleManifestBufferTargetStrategy"))(h(this.$Player9), this.$Player4), new(c("oz-player/strategies/OzStartupBufferTargetStrategy"))(this.$Player13, this.$Player4), new(c("oz-player/strategies/OzBufferAheadTargetStrategy"))(this.$Player4)]
        };
        f.$Player100 = function() {
            return this.$Player64 == null ? [new(c("oz-player/strategies/OzBufferTargetCalculatorQuotaExceededConstraint"))({
                config: this.$Player4,
        ...
        f.$Player79 = function() {
            return new(c("oz-player/strategies/OzBufferTargetCalculator"))(this.$Player99(), this.$Player100())
        };
        f.$Player80 = function() {
            return this.$Player1 != null ? new(c("oz-player/strategies/OzBufferTargetCalculator"))([].concat(this.$Player1, this.$Player99()), this.$Player101()) : this.$Player79()
        };
        f.$Player95 = function(a) {
            return a === "caption" ? this.$Player26 : this.$Player25
        };
        f.$Player82 = function(a) {
            var b = this;
        ...
        f.$Player96 = function() {
            var a = [new(c("oz-player/strategies/OzPlayingStatePriorityStrategy"))(this.$Player13), new(c("oz-player/strategies/OzBufferAheadPriorityStrategy"))(this.$Player4, this.$Player13)].concat(this.$Player4.getNumber("pixels_below_viewport_to_observe") > 0 && this.$Player59 != null ? new(c("oz-player/strategies/OzPositionToViewportPriorityStrategy"))(this.$Player59, this.$Player4) : []);
            return new(c("oz-player/strategies/OzPriorityCalculator"))(a)
        };
        f.$Player97 = function(a) {
            var b = [new(c("oz-player/strategies/OzStaticStreamSegmentsStrategy"))(this.$Player4), new(c("oz-player/strategies/OzBufferTargetBoundedStreamSegmentsCountStrategy"))(this.$Player95(a), this.$Player4)];
        ...
        f.getSelectedVideoQuality = function() {
            ...
            if (b instanceof c("oz-player/manifests/OzVideoRepresentation")) return b.getQualityLabel();
        ...
        f.getVideoQualities = function() {
            ...
            return !b ? [] : b.getVideoRepresentations().filter(function(b) {
                var c;
                return !((c = a.$Player65) == null ? void 0 : c.isBlocked(b.getID()))
            }).map(function(a) {
                return a.getQualityLabel()
            })
        };
        f.setEnableLiveheadCatchup = function(a) {
            this.$Player19 && (a ? this.$Player15.getOperationLogger("live_catchup_enabled").setIsLatencyCachupEnabled(!0).log() : this.$Player15.getOperationLogger("live_catchup_disabled").setIsLatencyCachupEnabled(!1).log(), this.$Player19.setTimelineBlockingEnabled(a)), this.$Player5.forEach(function(b) {
        ...
        f.$Player86 = function() {
            ...
            this.$Player60 = c && c.canPredict() && this.$Player4.getBool("pdash_use_pdash_segmentlocator") || c && c.canApproximateId() ? new(d("oz-player/streams/OzPredictedSegmentLocator").OzPredictedSegmentLocator)({
                videoNode: this.$Player3,
                liveLatencyManager: this.$Player39,
                loggerProvider: this.$Player15,
                dynamicVideoLibrary: this.$Player63
            }) : null;
            c = this.$Player2 ? [this.$Player102({
                liveConfigsFromAudioStream: !0
            }), this.$Player103()] : [this.$Player104(), this.$Player102({}), this.$Player103()];
            var e = [];
            return b("Promise").all(c).then(function() {
                ...
                e.forEach(function(b) {
                    a.$Player10.addSubscriptions(b.addUpdateListener(function() {
                        a.$Player98("SegmentIndexesUpdated", e)
                    }))
                });
                a.$Player98("InitialSegmentIndexes", e);
                a.$Player3 && a.$Player3.style && (a.$Player3.style.display = a.$Player2 ? "none" : "block")
            })
        };
        f.$Player105 = function(a) {
            if (a.getTimeRanges().length) {
                a = a.getTimeRanges()[a.getTimeRanges().length - 1].endTime;
                this.$Player7.updateDuration(a, !0)
            } else this.$Player4.getBool("log_extra_events") && this.$Player15.getOperationLogger("playhead_adjustment").setInitiator("setup_initial_duration").setResult("failed").log()
        };
        f.$Player106 = function(a) {
            this.$Player105(a), this.$Player22.setTimeRangeProvider(a), this.$Player18.setTimeRangeProvider(a), this.$Player19 != null && this.$Player19.setTimeRangeProvider(a)
        };
        f.$Player104 = function() {
            ...
            var b = d("oz-player/utils/OzPlaybackRestrictionsUtils").applyVideoPlaybackRestrictions(this.$Player4, this.$Player30, this.$Player94(), a);
            if (!b.length) {
                a = a.map(function(a) {
                    return a.getQualityLabel() + "@" + a.getWidth() + "x" + a.getHeight() + "(" + a.getMimeCodecs() + ")"
                });
                return c("oz-player/shims/OzMaybeNativePromise").reject(new Error("restricted all video representations: " + a.join(", ")))
            }
            this.$Player106(b[0]);
            a = this.$Player107(b);
            var e = this.$Player93(a || b[0]);
            this.$Player6.set("video", e);
            a || (a = e.getBestRepresentation());
            return this.$Player91(a || b[0], "video")
        };
        f.$Player102 = function(a) {
            a = a.liveConfigsFromAudioStream;
            a = a === void 0 ? !1 : a;
            var b = h(this.$Player9);
            b = b.getAudioRepresentations();
            a && this.$Player106(b[0]);
            return b.length ? this.$Player91(this.$Player108(b) || b[0], "audio") : c("oz-player/shims/OzMaybeNativePromise").resolve()
        };
        f.$Player103 = function() {
            var a = h(this.$Player9);
            a = a.getApplicationRepresentations();
            return a.length ? this.$Player91(this.$Player109(a) || a[0], "caption") : c("oz-player/shims/OzMaybeNativePromise").resolve()
        };
        f.getMpd = function() {
            return this.$Player9
        };
        f.destroy = function(a) {
            ...
            var d = b("Promise").resolve();
            this.$Player3.pause();
            this.$Player3.removeAttribute("src");
            this.$Player3.removeAttribute("srcObject");
            "function" === typeof this.$Player3.setMediaKeys && (d = this.$Player3.setMediaKeys(null));
            ...
            this.emit("destroyed");
            a = [d];
            return b("Promise").all(a).then(function() {
                c.$Player3.load()
            })
        };
        ...
        f.$Player108 = function(a) {
            ...
            e || (e = c("oz-player/utils/getRepresentationInCache")(a, this.$Player23));
            if (!e && !d.isStaticMpd() && a.length > 1 && this.$Player4.getBool("live_audio_ibr")) {
                d = new(c("oz-player/strategies/OzAudioIBRManager"))(this.$Player4, this.$Player15);
        ...
        f.$Player77 = function(a) {
            var b = new(c("oz-player/parsers/OzMpdParser"))(this.$Player4, {
                mpdUrl: this.$Player17,
                createXmlParser: this.$Player81,
                customParsers: this.$Player27,
                customRepresentationParsers: this.$Player28,
                customSegmentTimelineParser: this.$Player29
            }, this.$Player12, this.$Player15, this.$Player46, this.$Player24, this.$Player65);
        ...
        f.$Player94 = function() {
            var a = this.$Player50 ? this.$Player50() : {
        ...
        f.$Player90 = function(a) {
            ...
            if (!c) {
                ...
                c.updateLocation(a);
                this.$Player41 && (this.$Player10.releaseOne(this.$Player41), this.$Player41 = null);
                a = function() {
                    b.$Player41 && (b.$Player10.releaseOne(b.$Player41), b.$Player41 = null), b.$Player5.forEach(function(a, d) {
        ...
        f.getApproximateFBLSToPlayerDisplayLatency = function() {
            ...
            var c = this.$Player112(a, b);
            a = this.$Player113(a, b);
            return {
        ...
        f.$Player112 = function(a, b) {
            ...
            b = 0;
            this.$Player56 === a ? b = (c("oz-player/shims/OzPerformance").now() - Number(this.$Player57)) / 1e3 : (this.$Player57 = c("oz-player/shims/OzPerformance").now(), this.$Player56 = a);
            a = a / 1e3 + b - this.$Player13.getCurrentTime();
            return a
        };
        f.$Player113 = function(a, b) {
            var d;
