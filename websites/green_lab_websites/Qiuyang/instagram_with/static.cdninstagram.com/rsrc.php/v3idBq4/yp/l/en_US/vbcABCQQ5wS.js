...
__d("LSLogEventAnnotate.re", ["LSLogEventAnnotate.bs"], function(a, b, c, d, e, f) {
    a = b("LSLogEventAnnotate.bs").call;
    f.call = a
}, null);
__d("LSLogEventAnnotate.nop", ["LSLogEventAnnotate.re"], function(a, b, c, d, e, f, g) {
    "use strict";
    a = function(a, b, c, e, f, g) {
        return d("LSLogEventAnnotate.re").call(a, b, c, e, f, g)
    };
    g["default"] = a
}, 98);
...
__d("SwitcherButtonTappedFalcoEvent", ["FalcoLoggerInternal", "getFalcoLogPolicy_DO_NOT_USE"], function(a, b, c, d, e, f) {
    "use strict";
    a = b("getFalcoLogPolicy_DO_NOT_USE")("1968");
    c = b("FalcoLoggerInternal").create("switcher_button_tapped", a);
    e.exports = c
}, null);
...
__d("MqttProtocolClient", ["MqttEnv", "MqttProtocolCodec", "MqttProtocolUtils", "MqttTypes", "err", "qex"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 30,
        i = 6e4;
    a = function() {
        ...
        b.connect = function(a) {
            ...
            this.$7 = d("MqttEnv").Env.setTimeout(function() {
                e.$9.bumpCounter("protocol.error.connect.timeout"), e.$12(d("MqttTypes").MqttErrors.CONNECT_TIMEOUT)
            }, b * 1e3);
            this.$6 = d("MqttEnv").Env.createSocket(this.$3);
            this.$6.binaryType = "arraybuffer";
            this.$6.onopen = function() {
                e.setConnected(!0), e.$9.debugTrace("Socket-Open", "MQTTProtocolClient Socket Open"), e.$11 = e.$13(new(d("MqttProtocolCodec").WireMessage.Connect)(e.$1, a)), a.onConnection()
            };
            this.$6.onmessage = function(a) {
                ...
                try {
                    ...
                    e.$10 = null, e.$9.logError(a, d("MqttTypes").MqttErrors.SOCKET_MESSAGE.errorMessage), e.$9.bumpCounter("protocol.error.onmessage.parse"), e.$12(d("MqttTypes").MqttErrors.SOCKET_MESSAGE, a.message)
                }
            };
            this.$6.onerror = function(a) {
                e.$9.bumpCounter("protocol.error.socket"), e.$9.debugTrace("Socket-Error", "MQTTProtocolClient Socket Error"), e.$12(d("MqttTypes").MqttErrors.SOCKET_ERROR)
            };
            this.$6.onclose = function(a) {
                e.$9.bumpCounter("protocol.socket.close"), a.wasClean || e.$9.debugTrace("Socket-Unclean-Close", "MQTTProtocolClient error code: " + a.code + " reason: " + a.reason), e.$12(d("MqttTypes").MqttErrors.SOCKET_CLOSE, a.code + " : " + a.reason)
            };
            this.$8 != null && this.$8.cancel();
            this.$8 = new(d("MqttProtocolUtils").Pinger)(a.getKeepAliveIntervalSeconds, a.getKeepAliveTimeoutSeconds, this.$13.bind(this, new(d("MqttProtocolCodec").WireMessage.Ping)("PINGREQ")), function(a, b) {
...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "err", "qex"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 10,
        i = 1,
        j = 1,
    ...
    a = function() {
        ...
        e.shutdown = function(a) {
            this.$28(a), this.$29("shutdown"), this.$8 = !1, this.$10.debugTrace("shutdown", "Shutdown")
        };
        e.subscribe = function(a) {
            this.$17.add(a);
            this.ensureConnected(m) && this.$30(a);
            return !0
        };
        e.publish = function(a, e, f, g) {
            ...
            !j ? (g == null ? void 0 : g.onEvent(d("MqttPublishListener").MqttPublishEvent.NOT_CONNECTED), h.reject(c("err")("Client disconnected"))) : this.$31(a, e, f, h);
            return i
        };
        ...
        e.$28 = function(a) {
            this.$8 && this.$7 != null && (this.$33("Disconnected"), this.$7 != null && (this.$7.disconnect(a), this.$26.onConnectionDisconnect()), this.$7 = null)
        };
        e.$34 = function(a) {
        ...
        e.$33 = function(a) {
            a !== this.$11 && (this.$10.debugTrace("MQTTConnection-updateState", "State changed to: " + a), this.$34(a), this.$11 = a, this.$1(a))
        };
        e.$27 = function() {
            var a = this;
            if (!this.$8) return;
            ...
            try {
                ...
                this.$7 != null && (this.$13 += 1, this.$7.connect({
                    ...
                    onConnectFailure: function(c, d, g) {
                        return a.$38(d, b, a.$18, f, i, e, c, g)
                    },
                    onConnectSuccess: function(c) {
                        return a.$39(b, a.$18, f, i, e, c)
                    },
                    onConnection: function() {
                        return a.$40(h, f)
                    },
                ...
                }), this.$10.bumpCounter("protocol.connectattempt"), this.$6.getIsGuestAuthStringPresent() && this.$10.bumpCounter("guestAuthentication.connectattempt"), this.$26.onConnectAttempt())
            } catch (a) {
                this.$10.bumpCounter("js_error_in_init_exception"), this.$33("Disconnected"), this.$44(!1, !1, b, this.$18, f, [], e, null, 14, "init error - " + a.message), a && this.$10.logErrorWarn(a, "ws_js_error"), this.$26.onWSFatal(), this.$45(new(d("MqttTypes").MqttChannelError)(!1, "ws_js_error", a), "client_init")
            }
        };
        e.$35 = function() {
            var a = this.$4(),
        ...
        e.$46 = function(a) {
            ...
            a === void 0 && (a = null);
            if (!this.$8) return;
            this.$28(d("MqttTypes").MqttErrors.RECONNECT);
            this.$29("reconnect");
            this.$47();
            this.$9 = -1;
            this.$16 = 0;
        ...
        e.$44 = function(a, b, c, d, e, f, g, h, i, j) {
            a ? this.$14++ : this.$15++;
            var k = Date.now();
        ...
        e.$38 = function(a, b, c, d, e, f, g, h) {
            ...
            this.$44(!1, a.connAck !== -1, b, c, d, e, f, g, i.errorCode, h);
            if (a.connAck != null) {
        ...
        e.$39 = function(a, b, c, d, e, f) {
            this.$10.bumpCounter("protocol.onconnectsuccess"), this.$10.debugTrace("connect", "Connect success"), this.$6.getIsGuestAuthStringPresent() && this.$10.bumpCounter("guestAuthentication.onconnectsucess"), this.$26.onConnectSuccess(), this.$25 = !0, this.$33("Connected"), this.$44(!0, !0, a, b, c, d, e, f), this.$48(c), this.$16 = Date.now()
        };
        e.$41 = function(a, b) {
        ...
        e.$29 = function(a) {
            this.$10.bumpCounter("protocol.fail_all_unacked_publishes." + a), this.$23.forEach(function(b, e, f) {
...
__d("MqttChannel", ["ChannelClientID", "IrisSubscribeChecker", "MqttAnalyticsHook", "MqttConnection", "MqttEnv", "MqttPublishListener", "MqttPublishTimeoutConfig", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "Run", "err", "isFastRefreshEnabledForCurrentDomain", "promiseDone", "qex", "requireDeferred"], function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function() {
        ...
        e.publish = function(a, b, e) {
            ...
            var f;
            e.qos === 0 ? f = this.$26(a, b, e.listener) : f = this.$27(a, b, e);
        ...
        e.$29 = function(a) {
            a.attempt += 1, c("MqttUtils").promiseDone(this.$28(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt, a.startTime), function() {
                a.ack.resolve()
            }, function(b) {
                a.ack.reject(b)
            })
        ...
        e.$31 = function(a) {
            var b = this;
            a.attempt += 1;
            c("MqttUtils").promiseDone(this.$28(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt, a.startTime), function() {
                return b.$32(a)
            }, function(a) {})
        };
        ...
        e.$30 = function(a) {
            ...
            b = d("MqttEnv").Env.setTimeout(function(a) {
                ...
                e.$11.debugTrace("publish_timeout", "Timeout publishing topic: " + d + " publishToken: " + a);
                e.$33(a);
        ...
        e.$20 = function(a) {
            ...
            }), this.$14 = []) : a === "TransportConnected" && this.$36(), this.$19("_changeState", "Connection state = " + a), this.$37(a, this.$7)
        };
        e.$38 = function(a, b) {
            this.$13 && this.$13.canPublish() && this.$36(), this.$19("_changeLPStatus", "LP status = " + a + ", LP Request status = " + b), this.$37(this.$6, a)
        };
        e.$37 = function(a, b) {
            var c = this.$10.mqttStateFromConnectionState(a);
            this.$13 && this.$13.canPublish() && (c = "Connected");
            this.$6 = a;
            (c !== this.$5 || b != this.$7) && (this.$5 = c, this.$7 = b, this.$39(c))
        };
        e.$39 = function(a) {
            for (var b = this.$3, c = Array.isArray(b), d = 0, b = c ? b : b[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var e;
...
__d("MqttLogger", ["ChannelClientID", "FBLogger", "Log", "LogHistory", "MqttEnv", "MqttGlobalStreamCounter", "MqttUnifiedClientConnectFalcoEvent", "MqttUnifiedClientDisconnectFalcoEvent", "MqttUnifiedClientIncomingPublishFalcoEvent", "MqttUnifiedClientOutgoingPublishFalcoEvent", "MqttWsClientTypedLoggerLite", "NetworkStatus", "ODS", "Random", "gkx"], function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        function a() {
            this.$1 = d("LogHistory").getInstance(h), this.$2 = 0, this.$3 = c("gkx")("778292"), this.$4 = Date.now(), this.$5 = c("ChannelClientID").getID(), this.$7(), this.$6 = d("MqttGlobalStreamCounter").getInstance(), this.$6.isEnabled() || (this.$6 = null)
        }
        var b = a.prototype;
        b.setAppId = function(a) {
            this.$2 === 0 && (this.$2 = a)
        ...
        b.eventLogConnect = function(a) {
            ...
            var r = {
                ...
                os_connectivity: n,
                payload_size: a == null ? void 0 : a.toString(),
                extra_data: {
                    device_id: this.$5,
                    connect_success_rate: d.toString(),
                    hostname: i
                },
                ws_count: (o = this.$6) == null ? void 0 : o.getGlobalState().totalConnectionStreams.toString()
            };
            this.$8(function() {
        ...
        b.eventLogDisconnect = function(a) {
            ...
            var e = {
                ...
                ws_count: (a = this.$6) == null ? void 0 : a.getGlobalState().totalConnectionStreams.toString()
            };
            this.$8(function() {
