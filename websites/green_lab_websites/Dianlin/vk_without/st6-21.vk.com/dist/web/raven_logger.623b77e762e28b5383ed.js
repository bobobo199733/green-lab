(() => {
  var e,
    ...
    n = {
        ...
        (W.prototype = {
          ...
          config: function (e, t) {
            ...
            t &&
              ...
              (o.whitelistUrls =
                !!o.whitelistUrls.length && k(o.whitelistUrls)),
          ...
          _promiseRejectionHandler: function (e) {
            this._logDebug(
              ...
              this.captureException(e.reason, {
                extra: { unhandledPromiseRejection: !0 },
              });
          },
          ...
          captureException: function (e, t) {
            if (((t = y({ trimHeadFrames: 0 }, t || {})), c(e) && e.error))
              e = e.error;
            else {
              if (l(e) || u(e)) {
              ...
              if (
                ...
                if (this._globalOptions.stacktrace || (t && t.stacktrace)) {
                  (o.fingerprint = null == o.fingerprint ? e : o.fingerprint),
                    ((t = y({ trimHeadFrames: 0 }, t)).trimHeadFrames += 1);
                  var c = this._prepareFrames(i, t);
                  o.stacktrace = { frames: c.reverse() };
                }
                return (
                  o.fingerprint &&
                    (o.fingerprint = _(o.fingerprint)
                      ? o.fingerprint
                      : [o.fingerprint]),
                  this._send(o),
                  this
          ...
          _triggerEvent: function (e, t) {
            ...
            if (this._hasDocument) {
              ...
              q.createEvent
                ? (r = q.createEvent("HTMLEvents")).initEvent(e, !0, !0)
                : ((r = q.createEventObject()).eventType = e),
              t))
                w(t, n) && (r[n] = t[n]);
                  ...
                  function (t) {
                    return function (o, i, a, s) {
                      try {
                        i &&
                          i.handleEvent &&
                          (i.handleEvent = e.wrap(i.handleEvent));
                      } catch (e) {}
                      var c, l, u;
                      return (
                        n &&
                ...
                D(
                  ...
                  function (e) {
                    return function (t, r, n, o) {
                      try {
                        r =
                          r && (r.__raven_wrapper__ ? r.__raven_wrapper__ : r);
                      } catch (e) {}
                    ...
                    return function () {
                      ...
                      return (
                        "onreadystatechange" in r && g(r.onreadystatechange)
                          ? D(r, "onreadystatechange", function (t) {
                ...
                function (t) {
                  return function () {
                    ...
                    if (
                      ("string" == typeof i
                        ? (o = i)
                        : "Request" in A && i instanceof A.Request
          ...
          _processException: function (e, t, r, n, o, i) {
            ...
            if (
              ...
              (o && o.length
                ...
                : r &&
                  (a = { frames: [{ filename: r, lineno: n, in_app: !0 }] }),
              (!this._globalOptions.ignoreUrls.test ||
          ...
          _trimPacket: function (e) {
            ...
            return (
              n &&
                (n.url && (n.url = E(n.url, this._globalOptions.maxUrlLength)),
                n.Referer &&
                  (n.Referer = E(n.Referer, this._globalOptions.maxUrlLength))),
              e.breadcrumbs &&
              ...
              if (
                ...
                for (var a = 0; a < o.length; ++a)
                  (t = o[a]),
                    n.hasOwnProperty(t) &&
                      n[t] &&
                      (n[t] = E(n[t], this._globalOptions.maxUrlLength));
                e.values[i].data = n;
              }
          },
          ...
          _isRepeatData: function (e) {
            ...
            return (
              ...
              (e.stacktrace || t.stacktrace
                ...
                : (!e.exception && !t.exception) || C(e.exception, t.exception))
            );
          },
          ...
          _mergeContext: function (e, t) {
            d(t)
              ...
              : (this._globalContext[e] = y(this._globalContext[e] || {}, t));
          },
        }),
      ...
      236862: (e, t, r) => {
        ...
        function u(e, t) {
          var r, n;
          if (i(e.length)) for (r in e) h(e, r) && t.call(null, r, e[r]);
          else if ((n = e.length))
        ...
        e.exports = {
          ...
          serializeException: function e(t, r, o) {
            if (!a(t)) return t;
            o =
              "number" != typeof (r = "number" != typeof r ? 3 : r) ? 51200 : o;
            var i = b(t, r);
          ...
          function d(t, r, i, a, u) {
            ...
            if (h)
              o.computeStackTrace.augmentStackTraceWithInitialElement(
                ...
                g();
            else if (f && n.isError(f)) p(o.computeStackTrace(f), !0);
            else {
              var v,
                _ = { url: r, line: i, column: a },
                m = void 0;
              if ("[object String]" === {}.toString.call(d))
                (v = d.match(c)) && ((m = v[1]), (d = v[2]));
              (_.func = s),
                p({ name: m, message: d, url: l(), stack: [_] }, !0);
            }
          ...
          (o.computeStackTrace = (function () {
              ...
              if (void 0 !== e.stack && e.stack) {
                for (
                  ...
                  if (
                    ...
                    if (
                      (v.open("GET", n.url, !1), v.send(null), 200 === v.status)
                    ) {
                      var _ = v.responseText || "",
                        m = (_ = _.slice(-300)).match(
                          /\/\/# sourceMappingURL=(.*)$/
                        );
                      if (m) {
                        var b = m[1];
                ...
                return h.length
                  ? { name: e.name, message: e.message, url: l(), stack: h }
                  : null;
              }
            }
            function t(e, t, r, n) {
            ...
            function r(e, i) {
              for (
                ...
                if (d !== n && d !== o.report) {
                  if (
                    ((c = { url: null, func: s, line: null, column: null }),
                    d.name
                      ? (c.func = d.name)
                      : (a = u.exec(d.toString())) && (c.func = a[1]),
                    void 0 === c.func)
                  )
                    try {
              ...
              i && f.splice(0, i);
              var g = { name: e.name, message: e.message, url: l(), stack: f };
              return (
                t(
                  g,
            ...
            function n(t, n) {
              ...
              return { name: t.name, message: t.message, url: l() };
            }
            return (
      ...
      750705: (e) => {
        ...
        function s(e, r) {
          ...
          for (s = 0; s < e.length; s += 16)
            (c = h),
              ...
              (u = d),
              (f = g),
              (h = n(h, p, d, g, e[s], 7, -680876936)),
              (g = n(g, h, p, d, e[s + 1], 12, -389564586)),
              (d = n(d, g, h, p, e[s + 2], 17, 606105819)),
              (p = n(p, d, g, h, e[s + 3], 22, -1044525330)),
              (h = n(h, p, d, g, e[s + 4], 7, -176418897)),
              (g = n(g, h, p, d, e[s + 5], 12, 1200080426)),
              (d = n(d, g, h, p, e[s + 6], 17, -1473231341)),
              (p = n(p, d, g, h, e[s + 7], 22, -45705983)),
              (h = n(h, p, d, g, e[s + 8], 7, 1770035416)),
              (g = n(g, h, p, d, e[s + 9], 12, -1958414417)),
              (d = n(d, g, h, p, e[s + 10], 17, -42063)),
              (p = n(p, d, g, h, e[s + 11], 22, -1990404162)),
              (h = n(h, p, d, g, e[s + 12], 7, 1804603682)),
              (g = n(g, h, p, d, e[s + 13], 12, -40341101)),
              (d = n(d, g, h, p, e[s + 14], 17, -1502002290)),
              (h = o(
                h,
                (p = n(p, d, g, h, e[s + 15], 22, 1236535329)),
                d,
                g,
                e[s + 1],
                5,
              ...
              (g = o(g, h, p, d, e[s + 6], 9, -1069501632)),
              (d = o(d, g, h, p, e[s + 11], 14, 643717713)),
              (p = o(p, d, g, h, e[s], 20, -373897302)),
              (h = o(h, p, d, g, e[s + 5], 5, -701558691)),
              (g = o(g, h, p, d, e[s + 10], 9, 38016083)),
              (d = o(d, g, h, p, e[s + 15], 14, -660478335)),
              (p = o(p, d, g, h, e[s + 4], 20, -405537848)),
              (h = o(h, p, d, g, e[s + 9], 5, 568446438)),
              (g = o(g, h, p, d, e[s + 14], 9, -1019803690)),
              (d = o(d, g, h, p, e[s + 3], 14, -187363961)),
              (p = o(p, d, g, h, e[s + 8], 20, 1163531501)),
              (h = o(h, p, d, g, e[s + 13], 5, -1444681467)),
              (g = o(g, h, p, d, e[s + 2], 9, -51403784)),
              (d = o(d, g, h, p, e[s + 7], 14, 1735328473)),
              (h = i(
                h,
                (p = o(p, d, g, h, e[s + 12], 20, -1926607734)),
                d,
                g,
                e[s + 5],
                4,
              ...
              (g = i(g, h, p, d, e[s + 8], 11, -2022574463)),
              (d = i(d, g, h, p, e[s + 11], 16, 1839030562)),
              (p = i(p, d, g, h, e[s + 14], 23, -35309556)),
              (h = i(h, p, d, g, e[s + 1], 4, -1530992060)),
              (g = i(g, h, p, d, e[s + 4], 11, 1272893353)),
              (d = i(d, g, h, p, e[s + 7], 16, -155497632)),
              (p = i(p, d, g, h, e[s + 10], 23, -1094730640)),
              (h = i(h, p, d, g, e[s + 13], 4, 681279174)),
              (g = i(g, h, p, d, e[s], 11, -358537222)),
              (d = i(d, g, h, p, e[s + 3], 16, -722521979)),
              (p = i(p, d, g, h, e[s + 6], 23, 76029189)),
              (h = i(h, p, d, g, e[s + 9], 4, -640364487)),
              (g = i(g, h, p, d, e[s + 12], 11, -421815835)),
              (d = i(d, g, h, p, e[s + 15], 16, 530742520)),
              (h = a(
                h,
                (p = i(p, d, g, h, e[s + 2], 23, -995338651)),
                d,
                g,
                e[s],
                6,
              ...
              (g = a(g, h, p, d, e[s + 7], 10, 1126891415)),
              (d = a(d, g, h, p, e[s + 14], 15, -1416354905)),
              (p = a(p, d, g, h, e[s + 5], 21, -57434055)),
              (h = a(h, p, d, g, e[s + 12], 6, 1700485571)),
              (g = a(g, h, p, d, e[s + 3], 10, -1894986606)),
              (d = a(d, g, h, p, e[s + 10], 15, -1051523)),
              (p = a(p, d, g, h, e[s + 1], 21, -2054922799)),
              (h = a(h, p, d, g, e[s + 8], 6, 1873313359)),
              (g = a(g, h, p, d, e[s + 15], 10, -30611744)),
              (d = a(d, g, h, p, e[s + 6], 15, -1560198380)),
              (p = a(p, d, g, h, e[s + 13], 21, 1309151649)),
              (h = a(h, p, d, g, e[s + 4], 6, -145523070)),
              (g = a(g, h, p, d, e[s + 11], 10, -1120210379)),
              (d = a(d, g, h, p, e[s + 2], 15, 718787259)),
              (p = a(p, d, g, h, e[s + 9], 21, -343485551)),
              (h = t(h, c)),
              (p = t(p, l)),
              (d = t(d, u)),
              (g = t(g, f));
        ...
        function p(e, t) {
          return (function (e, t) {
            ...
            return (
              (n = s(i.concat(l(t)), 512 + 8 * t.length)),
              c(s(a.concat(n), 640))
            );
          })(f(e), f(t));
        }
        e.exports = function (e, t, r) {
          return t ? (r ? p(t, e) : u(p(t, e))) : r ? h(e) : u(h(e));
        };
      },
      837974: (e, t, r) => {
        "use strict";
        (0, r(415916).initLogger)(),
      ...
      415916: (e, t, r) => {
        ...
        function a(e, t, r) {
          ...
          var n = "nocur",
            o = (function (e) {
              var t = e.frames.some(function (e) {
                  return e.filename.includes(
                    "node_modules/@vkontakte/videoplayer"
                  );
                }),
                r = e.frames.some(function (e) {
                  return e.filename.includes("bundles/videoplayer");
                });
              if (t || r) return "videoplayer";
              if (
                e.frames.find(function (e) {
                  return e.filename.includes("bundles/fastchat_reforged");
                })
              )
                return "messenger";
              if (
                e.frames.find(function (e) {
                  return e.filename.includes("bundles/audioplayer");
                })
              )
                return "audioplayer";
              return !1;
          ...
          return (
            s ||
            (window.cur && (n = window.cur.module),
            e.includes("web/imn")
              ? (n = "im")
              : e.includes("web/stories")
              ? (n = "stories")
              : e.includes("web/notifier")
              ? (n = "notifier")
              : e.includes("web/videoplayer")
              ? (n = "videoplayer")
              : e.includes("web/article")
              ? (n = "articles")
              : e.includes("web/raven_logger")
              ? (n = "logger")
              : e.startsWith("http") &&
                !/^https:\/\/([a-z0-9]+\.)*vk\.(com|me|ru)/.test(e)
              ? (n = "external")
              : ((a = e),
                i.extensionPrefixes.some(function (e) {
                  return null == a ? void 0 : a.startsWith(e);
                })
                  ? (n = "extension")
                  : e.includes("web/market")
                  ? (n = "market")
                  : e.includes("web/calls") && (n = "calls")),
            n || (n = "unknown"),
            n)
          );
        }
        var s = function (e) {
          return (0, o.prepareError)(e, a);
        };
        function c() {
          var e = (0, o.getRavenXhrTransport)(s);
          n
            .config("http://fakeuser@dev.null/", {
              maxBreadcrumbs: 1,
              autoBreadcrumbs: {
                xhr: !0,
                console: !1,
      ...
      if (!r) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [r, n, o] = e[u], s = !0, c = 0; c < r.length; c++)
            (!1 & o || a >= o) && Object.keys(i.O).every((e) => i.O[e](r[c]))
              ? r.splice(c--, 1)
              : ((s = !1), o < a && (a = o));
          if (s) {
            e.splice(u--, 1);
  ...
  var a = i.O(void 0, [11216, 68592], () => i(837974));
  a = i.O(a);
})();
