...
const Head = ({
    ...
    return (
        <Helmet>
            ...
            <meta
                content={`${siteUrl}${previewImage}` || `${siteUrl}/social.png`}
                property="og:image"
            />
...
export const HeadWithQuery = ({ hrefs, head, noindex, noHrefLang, previewImage, lang }) => (
    <StaticQuery
        query={graphql`
            query MetaDataQuery {
                site {
