...
createChildClass("Selector", UiControl, {
  ...
  initOptions: function (input, data, options) {
    ...
    this.options = extend(
      ...
      this.defaultOptions,
      {
        ...
        customField: input["name"]
          ? input["name"] + "_custom"
          : "selectedItems_custom",
      },
    ...
    // Get selected value
    if (
      !isArray(this.options.selectedItems) &&
      isEmpty(this.options.selectedItems)
    ) {
    ...
    this.options.width =
      parseInt(this.options.width) > 0
        ? parseInt(this.options.width)
        : this.defaultOptions.width;
    this.options.height =
      parseInt(this.options.height) > 0
        ? parseInt(this.options.height)
        : this.defaultOptions.height;
    this.options.resultListWidth =
      parseInt(this.options.resultListWidth) > 0
        ? parseInt(this.options.resultListWidth)
        : this.options.width;
  ...
  initDOM: function (input, data) {
    ...
    this.container = ce(
      "div",
      {
        ...
        className:
          "selector_container" +
          (!self.options.autocomplete ? " dropdown_container" : "") +
          (self.options.big ? " big" : "") +
          (self.options.big_text ? " big_text" : "") +
          (self.options.withIcons ? " with_icons" : "") +
          (browser.mobile ? " mobile_selector_container" : "") +
          (self.options.noArr ? " dropdown_noarr" : "") +
          (self.options.listStyle ? " list_style" : "") +
          (self.options.limitedListHeight ? " limited_height" : ""),
  ...
  _containerHtml: function () {
    var dropDownBtn = this.options.dropdown
        ? '<td id="dropdown' +
          this.guid +
          '" class="selector_dropdown" role="button" aria-hidden="true">&nbsp;</td>'
        : "",
      scrollFaderTop = this.options.limitedListHeight
        ? '<div class="selected_items_wrap"><div class="scroll_fader_top"></div>'
        : "",
      scrollFaderBottom = this.options.limitedListHeight
        ? '<div class="scroll_fader_bottom"></div></div>'
        : "";
  ...
  initEvents: function () {
    ...
    function handleResListWheel(event) {
      if (
        event.deltaY > 0 &&
        self.resultList.scrollTop + self.resultList.offsetHeight >=
          self.resultList.childNodes[0].offsetHeight
      ) {
    ...
    if (this.options.limitedListHeight) {
      addEvent(
        ...
        "scroll",
        this.updateSelectedItemsScroll.bind(this)
      );
      ...
      addEvent(
        ...
        function () {
          addEvent(
            this.selectedItemsContainer,
            browserFeatures.wheelEvent,
            handleSelItemsContWheel.bind(this)
          );
        }.bind(this)
      );
    ...
    if (this.options.liteEventsBind) {
      addEvent(
        this.input,
        "paste keypress keydown focus blur",
      ...
      addEvent(
        this.input,
        "keydown keypress change paste cut drop input focus blur",
        this.handleKeyboardEvent,
        false,
        { self: this }
      );
  ...
  updateSelectedItemsScroll: function (event) {
    var showBottomFader =
      event.target.scrollTop + this.selectedItemsContainer.offsetHeight <
      this.selectedItemsContainer.scrollHeight;
    ...
    if (this.container.showTopFader !== showTopFader) {
      setTimeout(
        toggleClass.bind(this, this.container, "show_top_fader", showTopFader),
        0
      );
  ...
  afterInit: function () {
    ...
    if (this.options.selectedItems !== undefined) {
      if (isArray(this.options.selectedItems)) {
        ...
        each(
          (this.options.selectedItems + "").split(
            this.options.selectedItemsDelimiter
          ),
          function (i, x) {
    ...
    if (
      ...
      this.options.defaultItems.length
    ) {
  ...
  fadeButtonToColor: function () {
    ...
    var state = rtl
      ? { backgroundColor: "#E1E8ED", borderRightColor: "#D2DBE0" }
      : { backgroundColor: "#E1E8ED", borderLeftColor: "#D2DBE0" };
    var self = this;
    animate(this.dropdownButton, state, 200, function () {
      if (!self.mouseIsOver) {
        if (!self.select.isVisible()) {
          ...
          self.dropdownButton.style.backgroundColor = self.dropdownButton.style[
  ...
  fadeButtonToWhite: function () {
    ...
    animate(
      this.dropdownButton,
      rtl
        ? { backgroundColor: "#FFFFFF", borderRightColor: "#FFFFFF" }
        : { backgroundColor: "#FFFFFF", borderLeftColor: "#FFFFFF" },
      200,
      function () {
        self.dropdownButton.style.backgroundColor = self.dropdownButton.style[
          rtl ? "borderRightColor" : "borderLeftColor"
  ...
  destroy: function () {
    ...
    for (
      var el = this.selectedItemsContainer.firstChild;
      el;
      el = el.nextSibling
    ) {
    ...
    if (
      ...
      if (this._selectedItems.length) {
        if (rtl) {
          var offset =
            (this.input.offsetParent
              ? this.input.offsetParent.offsetWidth
              : this.selectorWidth) -
  ...
  updatePlaceholder: function () {
    ...
    var zeroPlaceholder =
      this.resultField.value == "0" && this.options.zeroPlaceholder;
    var placeholderTextNew =
      this.disabled && this.options.disabledText
        ? this.options.disabledText
        : this.options.placeholder;
    var placeholderVisibleNew = !(
      (this._selectedItems.length &&
        this.options.multiselect &&
        this.options.hidePlaceholderOnSelected) ||
      (this.input.value.length && !this.options.nativePlaceholder) ||
      zeroPlaceholder
    );
    ...
    if (this.options.nativePlaceholder || vk.a11y) {
      ...
      this.input.setAttribute(
        "placeholder",
        placeholderVisibleNew ? placeholderTextNew : ""
      );
    } else {
    ...
    switch (e.type) {
      ...
      case "keypress":
        if (
          e.which == KEY.RETURN &&
          browser.opera &&
          self.options.enableCustom &&
          (self.options.multiCustom ||
            self.select.selectedItem() === null ||
            self.select.selectedItem() === undefined)
        ) {
          self.select.hide();
          ...
          if ((self.readOnly || self.disabled) && vk.a11y) {
            // prevent keypress for disabled input in a11y mode.
            return;
          }
          clearTimeout(self.timeout);
          self.timeout = setTimeout(function () {
      ...
      case "keydown":
        if (
          self.options.addCustomTokenOnKeys &&
          inArray(e.which, self.options.addCustomTokenOnKeys)
        ) {
            ...
            if (self.input.value.length > 0) {
              ...
              if (self.selectedTokenId) {
                ...
                for (var i = self._selectedItems.length - 2; i >= 0; i--) {
                  if (
                    self._selectedItems[i][0] == self.selectedTokenId &&
                    self._selectedItems[i + 1]
                  ) {
                ...
                self.selectToken(
                  self._selectedItems[self._selectedItems.length - 1][0]
                );
              }
              cancelEvent(e);
            }
      ...
      case "focus":
        ...
        if ((self.disabled || self.readOnly) && !vk.a11y) {
          // For readers need focus on input
          self.input.blur();
          return true;
        }
      ...
      case "blur":
        if (
          isFunction(self.options.chooseFirst) &&
          self.options.chooseFirst(self.input.value)
        ) {
          // email field
          // todo
          self.select.active = 0;
          if (isFunction(self.select.options.onItemSelect)) {
            self.select.options.onItemSelect(
  ...
  updateCustom: function (forceVal) {
    ...
    if (
      self.options.enableCustom &&
      (self.input.value.length || (forceVal && forceVal.length))
    ) {
      ...
      if (self._selectedItems.length == 0 || self.options.multiCustom) {
        ...
        if (self.options.multiCustom) {
          ...
          if (custom_val.length > 1)
            multiValue = custom_val
              .slice(1)
              .join(self.options.selectedItemsDelimiter);
        ...
        if (valid) {
          ...
          if (self.options.valueIsCustom) {
            ...
            self._selectItem(
              [self.options.valueForCustom, custom_val],
              true,
              true
            );
            if (self.options.multiCustom) {
  ...
  handleKeyboardEventOutside: function (e) {
    ...
    if (
      this.disabled ||
      (this.input.value.length > 0 && this.hasFocus) ||
      (!this.hasFocus && this.selectedTokenId == 0)
    ) {
      return true;
    }
    switch (e.keyCode) {
      ...
      case KEY.LEFT:
        for (i = this._selectedItems.length - 1; i >= 0; i--) {
          if (
            ...
            (this._selectedItems[i][0] == this.selectedTokenId && i > 0)
          ) {
  ...
  showImage: function (itemValue, itemData) {
    ...
    if (itemData === undefined) {
      if (!itemValue) {
        // 0 or undefined
        itemValue = this.resultField.value.split(
          this.options.selectedItemsDelimiter
        )[0];
      }
  ...
  _selectItem: function (item, fireEvent, focusIfMultiselect) {
    ...
    if (item == -2e9) {
      data = [
        this.curTerm,
        this.curTerm,
        getLang("mail_enter_email_address"),
        "/images/pics/contact_info.png",
        0,
        "",
      ];
      ...
      var all_data = [];
      each(
        [this.dataItems, this.options.defaultItems, this.receivedData],
        function (i, items) {
          if (items && items.length) all_data = all_data.concat(items);
        }
      );
    ...
    if (this.options.multiselect) {
      ...
      if (this.dataURL) {
        ...
        if (this.options.hideSectionedChildren) {
          if (
            Selector.prototype.isClassEnabled(data[3] ? data[3] : "", "section")
          ) {
            ...
            for (i = curPosition + 1; i < this.dataItems.length; i++) {
              if (
                Selector.prototype.isClassEnabled(
                  this.dataItems[i][3],
                  "section"
                )
              ) {
      ...
      this.input.value =
        data[0] == "0" && data[1] == this.options.placeholder
          ? ""
          : winToUtf(stripHTML(data[1]));
      addClass(this.input, "selected");
      this.updatePlaceholder();
    }
  ...
  addTagData: function (data) {
    ...
    if (this.options.tokenPrefix) {
      tokenPrefix =
        '<span class="token_prefix">' + this.options.tokenPrefix + "</span>";
    } else {
      tokenPrefix = "<span></span>";
    }
    var tokenName = clean(stripHTML(data[1]));
    var removeLabel = clean(getLang("global_delete")) + " " + tokenName;
    var ariaRemoveBtnAttrs = vk.a11y
      ? ' tabindex="0" aria-label="' + removeLabel + '" '
      : "";
    var cancelIcon = UiControlsIcons.getIcon16Cancel().icon;
    token.innerHTML =
      tokenPrefix +
      '<span class="token_inner"><span class="x SelectorToken__x" role="button"' +
      ariaRemoveBtnAttrs +
      ">" +
      cancelIcon +
      '</span><span class="l"><span class="lc">' +
      tokenName +
      "</span>" +
      (data[5] ? data[5] : "") +
      "</span>";
    ...
    addEvent(token, "mouseout", function (event) {
      ...
      self.showImage(
        self.activeItemValue ? self.activeItemValue : self.selectedTokenId
      );
  ...
  onChange: function () {
    ...
    this.curTerm = term;
    var res =
      isFunction(this.options.customSearch) && this.options.customSearch(term);
    var data;
    if (res) {
  ...
  needsReverse: function () {
    ...
    var wh =
      (window.pageNode && window.browser.mozilla
        ? Math.min(getSize(pageNode)[1], window.lastWindowHeight)
        : window.lastWindowHeight) || getScroll()[3];
    ...
    if (list_ul && list_ul.firstChild) {
      ...
      listH = minListH
        ...
        ? this.currenDataItems.length * getSize(this.container)[1]
        : maxListH;
    }
    if (listH > maxListH) listH = maxListH;
    return (
      contY + contH + listH - scrollY > wh &&
      contY - listH - scrollY > 0 &&
      contY - listH > 40
    );
  },
  ...
  setSelectContent: function (text, items, query) {
    ...
    if (items.length) {
      ...
      var itemsToShow =
        this.options.autocomplete && query
          ? this.options.maxItemsShown(query.length)
          : items.length;
      var self = this;
  ...
  filterData: function (items) {
    ...
    each(items, function (i) {
      for (var j in self._selectedItems) {
        if (this[0] == self._selectedItems[j][0]) return;
      }
      ...
      if (!this.options.multiselect) {
        if (!this._selectedItems.length && this.options.defaultItems.length) {
          ...
          for (var i in this.options.defaultItems) {
            var item =
              this.options.defaultItems[i][0] || this.options.defaultItems[i];
            if (
              item == this._selectedItems[0][0] ||
              item == this._selectedItems[0][0]
            ) {
              exists = true;
              break;
  ...
  setOptions: function (new_options) {
    ...
    if ("maxItems" in new_options && this.options.maxItems >= 0) {
      for (
        var i = this._selectedItems.length - 1;
        i >= this.options.maxItems;
        i--
      ) {
    ...
    if ("width" in new_options) {
      this.container.style.width = this.resultList.style.width =
    ...
    if (
      ...
      "placeholder" in new_options ||
      "disabledText" in new_options
    ) {
      this.updateInput();
    }
  },
  val: function (value, fireEvent) {
    if (value !== undefined)
      this._selectItem(value, fireEvent === undefined ? false : fireEvent);
  ...
  customVal: function (value, fireEvent) {
    if (value !== undefined) {
      ...
      this.selectItem(
        [this.options.valueForCustom, value],
        fireEvent === undefined ? false : fireEvent
      );
    }
  ...
  _updateOptionsAriaSelected: function (updateNotSelected) {
    ...
    each(options, function () {
      if (~val.indexOf(this.getAttribute("val"))) {
        this.setAttribute(
          "aria-label",
          getLang("global_dropdown_aria_label_selected") +
            clean(this.textContent)
        );
...
createChildClass("Select", UiControl, {
  ...
  movePosition: function (step) {
    ...
    if (selected < 0) this.container.scrollTop = 0;
  ...
  highlight: function (i, el, isAfterOpen) {
    ...
    if (
      el.offsetTop + el.offsetHeight + this.list.offsetTop >
      this.container.offsetHeight + this.container.scrollTop - 1
    ) {
      this.container.scrollTop =
        el.offsetTop +
        this.list.offsetTop +
  ...
  content: function (items) {
    ...
    for (index = 0; index < len; ++index) {
      ...
      text =
        (text === undefined || text === null ? "" : text.toString()) || value;
      ...
      html.push(
        "<li ",
        !disabled
          ? 'onmousemove="Select.itemMouseMove(' +
              ind +
              ', this)" onmousedown="Select.itemMouseDown(' +
              ind +
              ', this)" onclick="Select.itemMouseDown(' +
              ind +
              ', this)"'
          : 'dis="1"',
        ' val="',
        ...
        (index ? "" : this.CSS.FIRST) +
          '" role="option" aria-selected="false" tabindex="-1" id="' +
          optId +
          '">',
        text,
        "</li>"
  ...
  removeItem: function (value) {
    ...
    for (i = 0; i < len; ++i) {
      var node = l[i];
      if (node.getAttribute("val") != value && node.innerHTML != value)
        continue;
...
createChildClass("Checkbox", UiControl, {
      ...
      "div",
      {
        ...
        className:
          ...
          (this.options.containerClass
            ...
            : ""),
        innerHTML:
          '<table cellpadding=0 cellspacing=0><tr><td class="checkbox"><div class="checkbox_off"></div></td><td class="checkbox_label">' +
          this.options.label +
          '<input type="hidden" name="' +
          this.options.resultField +
          '" id="' +
          ...
          (this.options.checked
            ...
            : this.options.notCheckedValue) +
          '"></td></tr></table>',
      },
      {
        width: isNumeric(this.options.width)
          ? this.options.width + "px"
          : "auto",
      }
    );
  ...
  setState: function (checked, fireEvent, forceUpdate) {
    ...
    this.updateClass();
    this.resultField.value = this.options.checked
      ? this.options.checkedValue
      : this.options.notCheckedValue;
  ...
  setOptions: function (new_options) {
    ...
    if (
      ...
      "checkedValue" in new_options ||
      "notCheckedValue" in new_options
    ) {
      this.setState(this.options.checked, false, true);
    }
  },
  ...
  createChildClass("Radiobutton", UiControl, {
    ...
    common: {
      ...
      destroy: function (name) {
        while (
          name in this._radio_buttons &&
          this._radio_buttons[name].length
        ) {
    ...
    initOptions: function (input, options) {
      ...
      this.options.checked = intval(this.options.checked) ? true : false;
      this.options.width =
        intval(this.options.width) > 0
          ? intval(this.options.width)
          : this.defaultOptions.width;
    },
    init: function () {
      this.disabled = false;
    ...
    initDOM: function (input, options) {
      this.container = ce(
        "div",
        {
          ...
          innerHTML:
            '<table cellpadding=0 cellspacing=0><tr><td class="radiobtn"><div class="radiobtn_off"><div></div></div></td><td class="radiobtn_label">' +
            this.options.label +
            '<input type="radio" id="' +
            input.id +
            '" name="' +
            this.options.resultField +
            '" value="' +
            (this.options.checked ? 'checked="true"' : "") +
            '"></td></tr></table>',
        },
        {
    ...
    destroy: function () {
      ...
      for (
        var i = 0;
        i < this.common._radio_buttons[this.inputName].length;
        ++i
      ) {
    ...
    setState: function (checked, fireEvent, forceUpdate) {
      ...
      if (this.options.checked == checked && !forceUpdate) return;
      if (checked) this.common.deselect(this.inputName);
      this.options.checked = checked;
      this.updateClass();
      ...
      if (fireEvent) {
        ...
        if (checked) {
          if (isFunction(this.common._callbacks[this.inputName]))
...
function Radiobuttons(input, buttons, options) {
  ...
  Radiobutton.select(
    id,
    options.selected !== undefined ? options.selected : input.value
  );
...
createChildClass("Autosize", UiControl, {
  ...
  initDOM: function (input) {
    this.minHeight =
      positive(this.options.minHeight) || positive(getStyle(input, "height"));
    ...
    this.common._autosize_helpers.appendChild(
      (this.helper = ce(
        this.options.isTextArea ? "textarea" : "div",
        false,
        helperStyle
      ))
    );
  ...
  updateSize: function (event) {
    ...
    if (self.options.isTextArea) {
      ...
      self.helper.innerHTML = trim(replaceChars(value)).replace(
        /<br>$/,
        "<br>&nbsp;"
      );
...
createChildClass("DropdownMenu", UiControl, {
  ...
  initOptions: function (items, options) {
    if (!options.title && options.target)
      options.title = options.target.innerHTML;
    this.options = extend({}, this.defaultOptions, options);
  },
  ...
  initDOM: function (input, options) {
    ...
    this.body = ce("div", {
      ...
      innerHTML:
        '<table cellspacing="0" cellpadding="0"><tbody><tr><td class="dd_menu_shad_l"><div></div></td><td><div class="dd_menu_shad_t2"></div><div class="dd_menu_shad_t"></div><div id="dd_rows_' +
        this.guid +
  ...
  afterInit: function (items, options) {
    ...
    var self = this;
    onDomReady(function () {
      (self.common.pageContainer || window.pageNode).appendChild(
        self.container
      );
  ...
  moveTo: function (left, top) {
    ...
    if (this.options.columnsCount && (!browser.msie || browser.version >= 10)) {
      ...
      if (rowsHeight > 500) {
        rowsHeight =
          Math.round(rowsHeight / itemsCount) *
          Math.ceil(itemsCount / this.options.columnsCount);
        setStyle(
          this.rows,
          "columnCount",
    ...
    var bodyRight =
      left + bodyWidth > windowWidth && left + headerWidth > bodyWidth
        ? -headerWidth - 1 + "px"
        : "auto";
  ...
  moveToTarget: function () {
    ...
    this.moveTo(
      tc[0] + this.options.offsetLeft + this.options.left,
      tc[1] + this.options.offsetTop + this.options.top
    );
  },
  alignBody: function () {
    this.body.style.marginLeft =
      getSize(this.header)[0] - getSize(this.body)[0] + 1 + "px";
  },
  ...
  addItem: function (item) {
    ...
    link.innerHTML =
      (this.options.checkable ? '<img src="/images/dropdead_check.gif">' : "") +
      item.l;
    ...
    addEvent(
      ...
      function (e) {
        ...
        var hide = true;
        if (isFunction(item.onClick) && item.onClick(e) === false) hide = false;
        if (self.options.onSelect(e) === false) hide = false;
        if (item.h) {
        ...
        if (self.options.updateTarget && hide) {
          var text = self.options.updateHeader(
            e.target.index,
            e.target.innerHTML
          );
  ...
  setOptions: function (options) {
    ...
    if (typeof this.options.hideOnClick != "undefined")
      this.header.onclick = this.options.hideOnClick
  ...
  menuToUp: function () {
    ...
    if (!pt && !browser.msie6)
      pt = document.getElementsByTagName("html")[0].scrollTop;
    if (ht - pt > bh) {
  ...
  hide: function (fade) {
    ...
    var fadeSpeed =
      this.options.fadeSpeed !== undefined ? this.options.fadeSpeed : 100;
    fade === false
      ? this.onHide(false)
      : fadeOut(this.container, fadeSpeed, function () {
          show(self.container);
  ...
  onEvent: function (e) {
    if (
      inArray(e.type, ["keydown", "keypress", "keyup"]) &&
      inArray(e.keyCode, [16, 17, 18, 91])
    ) {
      return;
    }
    var outside = true;
...
extend(UiUtil.prototype, {
  ...
  __construct__: function (args) {
    ...
    if (this.afterInit) this.afterInit.apply(this, args);
    this.__components[
      (this.componentName ? this.componentName : this.__className) +
        this.__cid++
    ] = this;
    return this;
  },
...
createChildClass("Indexer", UiUtil, {
  ...
  createIndex: function () {
    ...
    each(
      ...
      function (k, v) {
        if (
          (Selector.prototype.isClassEnabled(v[3], "label") &&
            this.options.includeLabelsOnMatch) ||
          (Selector.prototype.isClassEnabled(v[3], "section") &&
            this.options.includeSectionsOnMatch)
        ) {
          this.lastLabel = k;
        }
  ...
  indexItem: function (k, v, additionalKey) {
    ...
    for (i = 0; i < this.options.indexkeys.length; i++) {
      ...
      current_words +=
        " " +
        String(v[this.options.indexkeys[i]])
          .replace(this.options.delimeter, " ")
          .replace(/<[^>]*>/g, "")
          .replace(/[\u00AB\u00BB]/g, ""); // «»
    }
    current_words +=
      (parseLatin(current_words) || "") + (parseCyr(current_words) || "");
    ...
    for (i = 0; i < current_words.length; i++) {
      for (j = 1; j <= this.options.chars; j++) {
        ...
        if (this.storage.index[index_key] === undefined)
          this.storage.index[index_key] = [];
  ...
  search: function (pattern) {
    debug(
      "search start, index width: " +
        this.options.chars +
        ", data size: " +
        this.storage.data.length
    );
    ...
    self.already_added = {};
    each(
      self.storage.index[min_pattern.substr(0, self.options.chars)],
      function (k, v) {
        ...
        if (
          Selector.prototype.isClassEnabled(item[3], "label") ||
          Selector.prototype.isClassEnabled(item[3], "section")
        ) {
          lastLabel = v;
        }
        for (i = 0; i < self.options.indexkeys.length; i++) {
          ...
          current_words +=
            " " +
            item[self.options.indexkeys[i]]
              .replace(self.options.delimeter, " ")
              .replace(/<[^>]*>/, "")
              .replace(/[\u00AB\u00BB]/g, ""); // «»
        }
        current_words +=
        ...
        if (
          (self.options.includeLabelsOnMatch ||
            self.options.includeSectionsOnMatch) &&
          lastLabel
        ) {
        ...
        if (
          (self.options.preventDuplicates && !self.already_added[v]) ||
          !self.options.preventDuplicates
        ) {
          ret_arr.push(item);
        }
  ...
  window.inlineOnEvent = function (e) {
    ...
    if (e.type == "keydown") {
      ...
      if (e.keyCode == KEY.RETURN) {
        if (
          !curInlineEdit.options.onConfirm ||
          curInlineEdit.options.onConfirm.apply(curInlineEdit) !== false
        )
          curInlineEdit.hide();
      }
    }
...
createChildClass("InlineEdit", UiControl, {
  ...
  initDOM: function (target, options) {
    ...
    this.container = ce("div", {
      ...
      id: "container" + this.guid,
      innerHTML:
        '<table class="inlMainTable">' +
        this.options.mainTableHTML.replace(
          "{content_table}",
          '<table class="inlContentTable">' +
            this.options.contentTableHTML
              .replace("{content}", this.options.contentHTML)
              .replace("{nolabel}", this.options.cancelLabel)
              .replace("{yeslabel}", this.options.confirmLabel) +
            "</table>"
        ) +
        "</table>",
    });
  ...
  initEvents: function () {
    ...
    createButton(this.buttonOk, function () {
      if (
        ...
        self.options.onConfirm.apply(self) !== false
      )
        self.hide();
    });
    createButton(this.buttonCancel, function () {
      if (!self.options.onCancel || self.options.onCancel.apply(self) !== false)
        self.hide();
    });
...
function InlineDropdown(el, opts) {
  ...
  this._items = opts.items
    ? clone(opts.items)
    : JSON.parse(el.getAttribute("data-items"));
  if (!this._items) {
  ...
  this._disableCancelClickEvent = opts.disableCancelClickEvent
    ? !!opts.disableCancelClickEvent
    : false;
  // build
  this._iddEl = se(
    '<div class="idd_wrap" id="' +
      el.id +
      '">' +
      '<div class="idd_selected_value ' +
      (opts.withArrow ? "idd_arrow" : "") +
...
InlineDropdown.prototype._rebuildDropdown = function () {
  ...
  var headerHTML =
    '<div class="idd_header_wrap ' +
    iconCls +
    '">' +
    '<div class="idd_header ' +
    arrowCls +
    '" id="' +
    idPrefix +
    this._items[0][0] +
  ...
  var itemsHTML =
    '<div class="idd_items_wrap">' + '<div class="idd_items_content">';

  function buildItem(item, addClass) {
    addClass = addClass || "";

    var sublistCls =
      _this._opts.sublists && _this._opts.sublists[item[0]]
        ? "idd_sublist"
        : "";
    var itemHTML =
      '<div class="idd_item ' +
      ...
      (_this._opts.withIcon
        ? '<div class="idd_item_icon" id="' + item[0] + '"></div>'
        : "") +
      '<div class="idd_item_name">' +
      (_this._opts.html ? _this._opts.html(item) : item[1]) +
      "</div>" +
      "</div>";
    return itemHTML;
  }
...
InlineDropdown.prototype._onClick = function (event) {
  ...
  this.openToUp =
    this._opts.forceDir == 1 ||
    this._opts.forceDir == "up" ||
    (this._opts.forceDir != -1 &&
      this._opts.forceDir != "down" &&
      isOpenToUp());
  if (this.openToUp) {
  ...
  var popupElParams = {
    marginTop:
      (this._opts.headerTop || InlineDropdown.IDD_HEADER_CORRECTION_TOP) -
      wrapSize[1] +
      addTop, // .idd_header padding & border
    width: popupSize[0] + 8,
    opacity: 1,
  };

  if (this._opts.alignLeft) {
    popupElParams[vk.rtl ? "marginRight" : "marginLeft"] =
      wrapSize[0] - InlineDropdown.IDD_HEADER_CORRECTION_LEFT;
  } else {
    popupElParams.marginLeft =
      (this._opts.headerLeft || InlineDropdown.IDD_HEADER_CORRECTION_LEFT) -
      (this._opts.withIcon ? 20 : 0);
  }
...
InlineDropdown.prototype._highlightItem = function (itemId) {
  ...
  each(geByClass("idd_item", this._els.popupItems), function (i, itemEl) {
    if (itemEl == highlightedItemEl) {
      _this._els.popupItems.scrollTop =
        (i + 1) * getSize(itemEl)[1] - getSize(_this._els.popupItems)[1] / 2;
      return false;
    }
  });
};
...
InlineDropdown.prototype._onWheel = function (event) {
  var itemsContentHeight = getSize(
  ...
  if (itemsContentHeight != itemsWrapElHeight) {
    if (
      (this._els.popupItems.scrollTop == 0 && event.deltaY < 0) || // ceil
      (this._els.popupItems.scrollTop ==
        itemsContentHeight - itemsWrapElHeight &&
        event.deltaY > 0)
    ) {
      // floor
      cancelEvent(event);
  ...
  if (this._opts.sublists && this._opts.sublists[sublistId]) {
    ...
    function buildItem(item, addClass) {
      ...
      var itemHTML =
        ...
        (sublist.withIcon
          ...
          : "") +
        '<div class="idd_item_name">' +
        (sublist.html ? sublist.html(item) : item[1]) +
        "</div>" +
        "</div>";
      return itemHTML;
    }
...

    {
      ...
      setStyle(this._els.currCascade, {
        ...
        marginTop:
          itemElSize[1] * index +
          6 /*make little bit lower*/ -
          (this.openToUp ? popupSize[1] : 0),
        "z-index": 200,
      ...
      setTimeout(function () {
        cssAnim(
          _this._els.currCascade,
          { marginLeft: leftPos, opacity: 1.0 },
          { duration: 140 }
        );
      }, 10);
    }
  ...
  if (andScroll && itemEl) {
    ...
    each(geByClass("idd_item"), function (i, item) {
      if (item.getAttribute("id") == id) {
        _this._els.popupItems.scrollTop =
          getSize(itemEl)[1] * (i + 1) - getSize(_this._els.popupItems)[1] / 2;
...
InlineDropdown.prototype._onKey = function (code, event) {
  ...
  if (code == 38 || code == 40) {
    var _this = this,
      hoveredItemEl =
        this._hoveredItem ||
        geByClass1("idd_hl", this._els.popupItems) ||
        geByClass1("idd_item", this._els.popupItems);
...
InlineDropdown.prototype._quickSearch = function (code) {
  ...
  for (var i = this._currQuickSearchIndex; i < items.length; i++) {
    ...
    if (
      (this._currSearchStr.length == 1 && this._currSearchStr == inner[0]) ||
      (this._currSearchStr.length > 1 &&
        inner.indexOf(this._currSearchStr) >= 0)
    ) {
...
InlineDropdown.prototype._initKeypressEvent = function () {
  addEvent(
    window,
    "keypress",
    (InlineDropdown._window_onKeyPress = this._onKeyPress.bind(this))
  );
  addEvent(
    window,
    "keydown",
    (InlineDropdown._window_onKeyDown = this._onKeyDown.bind(this))
  );
};
...
InlineDropdown.prototype._initOutEvent = function () {
  ...
  setTimeout(function () {
    addEvent(
      window,
      "click",
      (InlineDropdown._window_onOuterClick = _this._onOuterClick.bind(_this))
    );
  });
...
function showMask(el, withSpinner) {
  ...
  withSpinner = withSpinner
    ? '<div class="el_mask_progress_wrap"><div class="el_mask_progress"></div></div>'
    : "";
