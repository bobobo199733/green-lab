! function(e) {
    ...
    "3vyS": function(e, t, n) {
        (function(e) {
            e.Promise || (e.Promise = n("B/eG").default), e.fetch || (e.fetch = n("zgjP"))
        }).call(this, n("yLpj"))
    },
    "B/eG": function(e, t, n) {
        "use strict";
        ...
        function u(e, t) {
            ...
            0 !== e._state ? (e._handled = !0, i._immediateFn((function() {
                ...
                if (null !== n) {
                    ...
                    c(t.promise, r)
                } else(1 === e._state ? c : f)(t.promise, e._value)
            }))) : e._deferreds.push(t)
        }
        ...
        i.prototype.catch = function(e) {
            ...
            return u(this, new a(e, t, n)), n
        }, i.prototype.finally = d, i.all = function(e) {
            return new i((function(t, n) {
                ...
                for (var u = i.length, c = 0; c < i.length; c++) o(c, i[c])
            }))
            ...
            return new i((function(t, n) {
                ...
                for (var o = 0, u = e.length; o < u; o++) i.resolve(e[o]).then(t, n)
            }))
            ...
            return t = t || {}, new Promise((function(n, r) {
                ...
                for (var f in o.open(t.method || "get", e, !0), o.onload = function() {
                        o.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, (function(e, t, n) {
                            i.push(t = t.toLowerCase()), u.push([t, n]), c[t] = c[t] ? c[t] + "," + n : n
                        })), n(function e() {
                            return {
                                ok: 2 == (o.status / 100 | 0),
                    ...
                    }, o.onerror = r, o.withCredentials = "include" == t.credentials, t.headers) o.setRequestHeader(f, t.headers[f]);
                o.send(t.body || null)
            }))
        }
    },
