(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [26612], {
        ...
        417610: (a, t, c) => {
            ...
            function h(a) {
                return a.replace(new RegExp(r, "gi"), (0, l.t)("@{username} wrote", {
                    replace: {
                        username: "$1"
                    }
            ...
            function g(a) {
                return a.replace(new RegExp(s, "ig"), "").trim()
            }

            function i(a) {
                const t = function(a) {
                    const t = new RegExp(r, "ig"),
                        c = new RegExp(e, "ig"),
                        s = t.exec(a),
                        h = c.exec(a);
                    return !s || !h || h.index < s.index ? null : {
                        converted: '<div class="ch-item-quote">' + (0, l.t)("@{username} wrote", {
                            replace: {
                                username: s[1]
                            }
                        }) + ":<br/>" + g(a.substring(t.lastIndex, h.index)) + "</div>",
                        end: c.lastIndex,
                        start: s.index
                    }
                }(a);
                return t ? a.substring(0, t.start) + t.converted + i(a.substring(t.end).trim()) : a
            }
        },
        884476: (a, t, c) => {
            "use strict";
            ...
            const r = {
                    ...
                    ":poop:": c(750441),
                    ":heart:": c(70465),
                    ":heartbroken:": c(291779),
                    ":sun:": c(531180),
                    ":moon:": c(497116),
                    ":sunflower:": c(655377),
                    ":star:": c(499764),
                    ":sunny:": c(912448),
                    ":partly_sunny:": c(918680),
                    ":cloud:": c(663180),
                    ":zap:": c(331849),
                    ":hammer:": c(346016),
                    ":idea:": c(688110),
                    ":slot_machine:": c(575029),
                    ":bullseye:": c(38011),
                    ":rocket:": c(802590),
                    ":inverted_rocket:": c(56970),
                    ":checkered_flag:": c(117773),
                    ":alarm_clock:": c(278491),
                    ":rip:": c(616600),
                    ":ghost:": c(279228),
                    ":up:": c(826449),
                    ":cool:": c(447245),
        ...
        626612: (a, t, c) => {
            ...
            function o(a) {
                for (let t = 0; t < v.length; t++)
                    if (a >= v[t].range[0] && a <= v[t].range[1]) return v[t].category;
            ...
            function d(a) {
                ...
                function r(t, c) {
                    var l = a.replace(t, c);
                    return encodeURI((0, e.htmlEscape)(b(l)))
                }
                if (c.length >= 2 && l(c[c.length - 1]) !== l(c[c.length - 2])) return r(t, (0, f.toASCII)(t));
                return r(t, c.map((function(a) {
                    var t = l(a);
                    return "Mixed" === t || "Supplementary" === t ? (0, f.toASCII)(a) : a
                })).join("."))
            }
            ...
            function m(a) {
                ...
                if (t)
                    for (var c = 0; c < t.length; c++) {
                        var r;
                        a.text = a.text.replace(t[c], "<" + a.count++ + ">"), -1 !== t[c].indexOf("amazonaws") && -1 === t[c].indexOf("_thumb") && ((r = t[c].split("."))[r.length - 2] += "_thumb", r = encodeURI(r.join(".")));
                        var s = (0, e.htmlEscape)((0, l.t)("Chart Snapshot")),
                            h = encodeURI(t[c]);
                        a.values.push(`<div class="ch-item-snapshot-link"><i class="icon icon-snapshot-small" title="${s}"></i><a href="${h}" target="_blank">${s}</a></div><div class="ch-item-snapshot-preview"><a target="_blank" href="${h}"><img src="${r||h}" loading="lazy" alt="" class="snapshot-preview"/>\t</a></div>`)
                    }
                return a
            }
            ...
            function M(a) {
                ...
                if (t)
                    for (var c = 0; c < t.length; c++) a.text = a.text.replace(t[c], "<" + a.count++ + ">"), a.values.push("<a target='_blank' href='" + (0, n.getSymbolPagePath)({
            ...
            function y(a) {
                var t = /fuck/gi;
                return a.text.search(t) >= 0 && (a.text = a.text.replace(t, "<" + a.count++ + ">"), a.values.push(r.emoji.getElementHTML(r.emoji.heart()))), a
            }

            function C(a) {
                return r.emoji.each((function(t) {
                    if (a.text.search(t.re) >= 0) {
                        ...
                        }(a)), a.text = a.text.replace(t.re, c), a.count++, a.values.push(r.emoji.getElementHTML(t))
                    }
                })), a
            }
            ...
            const A = function() {
                    ...
                    var t = "(?:https:\\/\\/|http:\\/\\/)(?:(?:[\\w\\d\\.\\_\\-]+\\.)?tradingview\\.com|webcharts\\d?|localhost\\:6285)",
                        c = "#tc[1-9][0-9]*",
                        l = s.urlsRegExp.publishedImage,
                        e = s.urlsRegExp.publishedChartOld,
                        r = s.urlsRegExp.publishedChart,
                        h = s.urlsRegExp.publishedScript,
                        g = s.urlsRegExp.amazonawsLinks;
                    return {
                        snapshots: new RegExp(t + l + "|" + g, "g"),
                        comments: new RegExp(t + a(e + c, r + c, h + c), "g"),
                        deprecatedCharts: new RegExp(t + a(e, r, h), "g")
                    }
                }(),
                H = [m, w, x, M, u, z, C],
                B = [m, w, function(a) {
                    ...
                    if (t)
                        for (var c = 0; c < t.length; c++) {
                            a.text = a.text.replace(t[c], "<" + a.count++ + ">");
                            var r = (0, h.parsePublishedChartUrl)(t[c]),
                                s = (0, e.htmlEscape)((0, h.createPublishedChartUrl)(r.image_url, r.symbol, r.title)),
                                g = (0, h.createPublishedChartImageUrl)(r.image_url),
                                i = encodeURI(r.image_url),
                                f = r.symbol ? (0, e.htmlEscape)(r.symbol) : void 0,
                                v = r.title ? (0, e.htmlEscape)(r.title) : void 0;
                            a.values.push(`<div class="ch-item-chart-link"><i class="icon icon-snapshot-small" title="${(0,l.t)("Published Idea")}"></i><a href="${s}" target="_blank" data-id="${i}" ` + (f ? `data-symbol="${f}"` : "") + " " + (v ? `data-title="${v}"` : "") + `>${(0,e.htmlEscape)((0,l.t)("Published Idea"))}</a></div><div class="ch-item-chart-preview"><a ` + ` href="${s}" target="_blank"` + ` data-id="${i}" ` + (f ? ` data-symbol="${f}"` : "") + " " + (v ? ` data-title="${v}"` : "") + ">" + `<img src="${g}" loading="lazy" alt="" class="idea-preview"/></a></div>`)
                        }
                    return a
                }, x, M, u, z, C];
            ...
            function L(a, t) {
                t = t || [];
                var c = new S((0, e.htmlEscape)(a));
                return (c = y(c)).text = (0, g.parseQuotes)(c.text), c.text = (0, i.parseBBCode)(c.text), V(c, B.concat(t))
            }
        },
        168895: (a, t, c) => {
            "use strict";
