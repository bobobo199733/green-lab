            ...
            e.exports = function e(n, t, r) {
                ...
                1: [function(e, n, r) {
                    (function(e) {
                        ...
                        if (o) {
                            ...
                            c.port1.onmessage = s, t = function() {
                ...
                2: [function(e, n, t) {
                    ...
                    function b(e) {
                        ...
                        for (var a = new Array(t), u = 0, c = -1, f = new this(o); ++c < t;) s(e[c], c);
                        return f;
                    ...
                    function m(e) {
                        ...
                        var t = e.length,
                            r = !1;
                        if (!t) return this.resolve([]);
                        for (var a = -1, u = new this(o); ++a < t;) c(e[a]);
                        return u;
                    ...
                    n.exports = f, f.prototype.catch = function(e) {
                        return this.then(null, e)
                    }, f.prototype.then = function(e, n) {
                        if ("function" != typeof e && this.state === u || "function" != typeof n && this.state === a) return this;
                        var t = new this.constructor(o);
                        return this.state !== c ? l(t, this.state === u ? e : n, this.outcome) : this.queue.push(new s(t, e, n)), t
                        ...
                        return e
                    }, f.resolve = y, f.reject = p, f.all = b, f.race = m
                }, {
                    1: 1
                }],
                3: [function(e, n, r) {
                ...
                4: [function(e, n, t) {
                    ...
                    function w(e) {
                        return new f((function(n) {
                            var t = e.transaction(h, g),
                                r = c([""]);
                            t.objectStore(h).put(r, "key"), t.onabort = function(e) {
                    ...
                    function I(e) {
                        return "boolean" == typeof y ? f.resolve(y) : w(e).then((function(e) {
                            return y = e
                        }))
                    }
                    ...
                    function j(e, n) {
                        return new f((function(t, r) {
                            ...
                            n && (i.onupgradeneeded = function(n) {
                                var t = i.result;
                                try {
                                    t.createObjectStore(e.storeName), n.oldVersion <= 1 && t.createObjectStore(h)
                                } catch (t) {
                    ...
                    function C(e) {
                        S(e);
                        for (var n = p[e.name], t = n.forages, r = 0; r < t.length; r++) {
                            var o = t[r];
                            o._dbInfo.db && (o._dbInfo.db.close(), o._dbInfo.db = null)
                        }
                        return e.db = null, R(e).then((function(n) {
                            return e.db = n, O(e) ? A(e) : n
                        })).then((function(r) {
                            e.db = n.db = r;
                    ...
                    function T(e, n, t, r) {
                        ...
                        try {
                            ...
                            if (r > 0 && (!e.db || "InvalidStateError" === o.name || "NotFoundError" === o.name)) return f.resolve().then((function() {
                                if (!e.db || "NotFoundError" === o.name && !e.db.objectStoreNames.contains(e.storeName) && e.version <= e.db.version) return e.db && (e.version = e.db.version + 1), A(e)
                            })).then((function() {
                    ...
                    function L(e) {
                        ...
                        var o = p[t.name];
                        o || (o = F(), p[t.name] = o), o.forages.push(n), n._initReady || (n._initReady = n.ready, n.ready = B);
                        var i = [];
                        ...
                        for (var u = 0; u < o.forages.length; u++) {
                            var c = o.forages[u];
                            c !== n && i.push(c._initReady().catch(a))
                        }
                        var s = o.forages.slice(0);
                        return f.all(i).then((function() {
                            return t.db = o.db, R(t)
                        })).then((function(e) {
                            return t.db = e, O(t, n._defaultConfig.version) ? A(t) : e
                        })).then((function(e) {
                    ...
                    function M(e, n) {
                        ...
                        var r = new f((function(n, r) {
                            t.ready().then((function() {
                                T(t._dbInfo, m, (function(o, i) {
                                    if (o) return r(o);
                                    try {
                                        var a = i.objectStore(t._dbInfo.storeName).get(e);
                                        a.onsuccess = function() {
                                            var e = a.result;
                                            void 0 === e && (e = null), x(e) && (e = k(e)), n(e)
                                        }, a.onerror = function() {
                                            r(a.error)
                                        }
                                    } catch (e) {
                    ...
                    function P(e, n, t) {
                        ...
                        var o = new f((function(t, o) {
                            ...
                            r.ready().then((function() {
                                return i = r._dbInfo, "[object Blob]" === b.call(n) ? I(i.db).then((function(e) {
                                    return e ? n : D(n)
                                })) : n
                            })).then((function(n) {
                                    ...
                                    T(t._dbInfo, m, (function(o, i) {
                                        ...
                                        try {
                                            ...
                                            c.onsuccess = function() {
                                                var t = c.result;
                                                t ? 0 === e || u ? n(t.key) : (u = !0, t.advance(e)) : n(null)
                                            }, c.onerror = function() {
                                                r(c.error)
                                            }
                                        } catch (e) {
                            ...
                            t = new f((function(e, t) {
                                n.ready().then((function() {
                                    T(n._dbInfo, m, (function(r, o) {
                                        if (r) return t(r);
                                        try {
                                            var i = o.objectStore(n._dbInfo.storeName).openKeyCursor(),
                                                a = [];
                                            i.onsuccess = function() {
                                                var n = i.result;
                    ...
                    function Q(e, n) {
                        ...
                        var r, o = this;
                        if (e.name) {
                            var i = e.name === t.name && o._dbInfo.db ? f.resolve(o._dbInfo.db) : R(e).then((function(n) {
                                var t = p[e.name],
                                    r = t.forages;
                                t.db = n;
                            ...
                            r = e.storeName ? i.then((function(n) {
                                if (n.objectStoreNames.contains(e.storeName)) {
                                    ...
                                    for (var i = 0; i < o.length; i++) {
                                        var u = o[i];
                                        u._dbInfo.db = null, u._dbInfo.version = t
                                    }
                                    var c = new f((function(n, r) {
                                        var o = a.open(e.name, t);
                                    ...
                                    return c.then((function(e) {
                                        ...
                                        for (var n = 0; n < o.length; n++) {
                                            var t = o[n];
                                            t._dbInfo.db = e, E(t._dbInfo)
                                        }
                                    })).catch((function(n) {
                                        throw (N(e, n) || f.resolve()).catch((function() {})), n
                                    }))
                                }
                            })) : i.then((function(n) {
                                S(e);
                                ...
                                return i.then((function(e) {
                                    t.db = e;
                                    for (var n = 0; n < r.length; n++) E(r[n]._dbInfo)
                                })).catch((function(n) {
                                    throw (N(e, n) || f.resolve()).catch((function() {})), n
                                }))
                            }))
                    ...
                    function ve(e) {
                        var n, t, r, o, i, a = .75 * e.length,
                            u = e.length,
                            c = 0;
                        "=" === e[e.length - 1] && (a--, "=" === e[e.length - 2] && a--);
                        var f = new ArrayBuffer(a),
                            s = new Uint8Array(f);
                        for (n = 0; n < u; n += 4) t = J.indexOf(e[n]), r = J.indexOf(e[n + 1]), o = J.indexOf(e[n + 2]), i = J.indexOf(e[n + 3]), s[c++] = t << 2 | r >> 4, s[c++] = (15 & r) << 4 | o >> 2, s[c++] = (3 & o) << 6 | 63 & i;
                        return f
                    }

                    function he(e) {
                        var n, t = new Uint8Array(e),
                            r = "";
                        for (n = 0; n < t.length; n += 3) r += J[t[n] >> 2], r += J[(3 & t[n]) << 4 | t[n + 1] >> 4], r += J[(15 & t[n + 1]) << 2 | t[n + 2] >> 6], r += J[63 & t[n + 2]];
                        return t.length % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : t.length % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="), r
                    }

                    function ye(e, n) {
                        var t = "";
                        if (e && (t = de.call(e)), e && ("[object ArrayBuffer]" === t || e.buffer && "[object ArrayBuffer]" === de.call(e.buffer))) {
                            var r, o = Z;
                            e instanceof ArrayBuffer ? (r = e, o += ee) : (r = e.buffer, "[object Int8Array]" === t ? o += te : "[object Uint8Array]" === t ? o += re : "[object Uint8ClampedArray]" === t ? o += oe : "[object Int16Array]" === t ? o += ie : "[object Uint16Array]" === t ? o += ue : "[object Int32Array]" === t ? o += ae : "[object Uint32Array]" === t ? o += ce : "[object Float32Array]" === t ? o += fe : "[object Float64Array]" === t ? o += se : n(new Error("Failed to get type for BinaryArray"))), n(o + he(r))
                        } else if ("[object Blob]" === t) {
                            var i = new FileReader;
                            i.onload = function() {
                                var t = V + e.type + "~" + he(this.result);
                                n(Z + ne + t)
                    ...
                    function ge(e) {
                        ...
                        if (e)
                            for (var r in e) t[r] = "string" != typeof e[r] ? e[r].toString() : e[r];
                        ...
                        return t.serializer = be, o
                    }

                    function _e(e, n, t, r, o, i) {
                        e.executeSql(t, r, o, (function(e, a) {
                            a.code === a.SYNTAX_ERR ? e.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [n.storeName], (function(e, u) {
                                u.rows.length ? i(e, a) : me(e, n, (function() {
                        ...
                        var r = new f((function(n, r) {
                            t.ready().then((function() {
                                ...
                                o.db.transaction((function(t) {
                                    _e(t, o, "SELECT * FROM " + o.storeName + " WHERE key = ? LIMIT 1", [e], (function(e, t) {
                        ...
                        var t = this,
                            r = new f((function(n, r) {
                                t.ready().then((function() {
                                    var o = t._dbInfo;
                                    o.db.transaction((function(t) {
                                        _e(t, o, "SELECT * FROM " + o.storeName, [], (function(t, r) {
                            ...
                            o.ready().then((function() {
                                ...
                                c.serializer.serialize(n, (function(n, f) {
                                    f ? a(f) : c.db.transaction((function(t) {
                                        _e(t, c, "INSERT OR REPLACE INTO " + c.storeName + " (key, value) VALUES (?, ?)", [e, n], (function() {
                                            i(u)
                                        }), (function(e, n) {
                                            a(n)
                                        }))
                                        ...
                                        if (n.code === n.QUOTA_ERR) {
                                            if (r > 0) return void i(Se.apply(o, [e, u, t, r - 1]));
                                            a(n)
                                        }
                                    }))
                                }))
                    ...
                    function Ne(e, n) {
                        ...
                        var r = new f((function(n, r) {
                            t.ready().then((function() {
                                var o = t._dbInfo;
                                o.db.transaction((function(t) {
                                    _e(t, o, "DELETE FROM " + o.storeName + " WHERE key = ?", [e], (function() {
                                        n()
                                    }), (function(e, n) {
                                        r(n)
                                    }))
                            ...
                            t = new f((function(e, t) {
                                n.ready().then((function() {
                                    ...
                                    r.db.transaction((function(n) {
                                        _e(n, r, "DELETE FROM " + r.storeName, [], (function() {
                                            e()
                                        }), (function(e, n) {
                                            t(n)
                                        }))
                        ...
                        var n = this,
                            t = new f((function(e, t) {
                                n.ready().then((function() {
                                    var r = n._dbInfo;
                                    r.db.transaction((function(n) {
                                        _e(n, r, "SELECT COUNT(key) as c FROM " + r.storeName, [], (function(n, t) {
                        ...
                        var t = this,
                            r = new f((function(n, r) {
                                t.ready().then((function() {
                                    var o = t._dbInfo;
                                    o.db.transaction((function(t) {
                                        _e(t, o, "SELECT key FROM " + o.storeName + " WHERE id = ? LIMIT 1", [e + 1], (function(e, t) {
                        ...
                        var n = this,
                            t = new f((function(e, t) {
                                n.ready().then((function() {
                                    var r = n._dbInfo;
                                    r.db.transaction((function(n) {
                                        _e(n, r, "SELECT key FROM " + r.storeName, [], (function(n, t) {
                    ...
                    function ke(e, n) {
                        ...
                        (e = "function" != typeof e && e || {}).name || (e.name = e.name || t.name, e.storeName = e.storeName || t.storeName);
                        var r, o = this;
                        return s(r = e.name ? new f((function(n) {
                            var r;
                            r = e.name === t.name ? o._dbInfo.db : openDatabase(e.name, "", "", 0), e.storeName ? n({
                                db: r,
                        ...
                        })) : f.reject("Invalid arguments"), n), r
                    }
                    var xe = {
                    ...
                    function Le(e) {
                        ...
                        if (e)
                            for (var r in e) t[r] = e[r];
                        return t.keyPrefix = Ce(e, n._defaultConfig), Fe() ? (n._dbInfo = t, t.serializer = be, f.resolve()) : f.reject()
                    }
                    ...
                    function Qe(e, n) {
                        if (n = v.apply(this, arguments), !(e = "function" != typeof e && e || {}).name) {
                            var t = this.config();
                            e.name = e.name || t.name, e.storeName = e.storeName || t.storeName
                        }
                        var r, o = this;
                        return r = e.name ? new f((function(n) {
                            e.storeName ? n(Ce(e, o._defaultConfig)) : n(e.name + "/")
                        })).then((function(e) {
                            for (var n = localStorage.length - 1; n >= 0; n--) {
                                var t = localStorage.key(n);
                                0 === t.indexOf(e) && localStorage.removeItem(t)
                            }
                        })) : f.reject("Invalid arguments"), s(r, n), r
                    }
                    var Xe = {
                        ...
                        en = [$e.INDEXEDDB._driver, $e.WEBSQL._driver, $e.LOCALSTORAGE._driver],
                        nn = ["dropInstance"],
                        tn = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(nn),
                        rn = {
                            description: "",
                            driver: en.slice(),
                            name: "localforage",
                    ...
                    function an() {
                        for (var e = 1; e < arguments.length; e++) {
                            var n = arguments[e];
                            if (n)
                                for (var t in n) n.hasOwnProperty(t) && (Ve(n[t]) ? arguments[0][t] = n[t].slice() : arguments[0][t] = n[t])
                        }
                        return arguments[0]
                    }
                    var un = function() {
                            function e(n) {
                                for (var t in o(this, e), $e)
                                    if ($e.hasOwnProperty(t)) {
                                        var r = $e[t],
                                            i = r._driver;
                                        this[t] = i, Ye[i] || this.defineDriver(r)
                                    }
                                this._defaultConfig = an({}, rn), this._config = an({}, this._defaultConfig, n), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch((function() {}))
                            }
                            return e.prototype.config = function(e) {
                                ...
                                var r = new f((function(n, t) {
                                    try {
                                        ...
                                        for (var i = tn.concat("_initStorage"), a = 0, u = i.length; a < u; a++) {
                                            var c = i[a];
                                            if ((!Je(nn, c) || e[c]) && "function" != typeof e[c]) return void t(o)
                                        }
                                        var l = function() {
                                            for (var n = function(e) {
                                                    return function() {
                                                        var n = new Error("Method " + e + " is not implemented by the current driver"),
                                                            t = f.reject(n);
                                                        return s(t, arguments[arguments.length - 1]), t
                                                    }
                                                }, t = 0, r = nn.length; t < r; t++) {
                                                var o = nn[t];
                                                e[o] || (e[o] = n(o))
                                            }
                                        };
                                        l();
                                        var d = function(t) {
                                            Ye[r] && console.info("Redefining LocalForage driver: " + r), Ye[r] = e, Ze[r] = t, n()
                                        };
                                        "_support" in e ? e._support && "function" == typeof e._support ? e._support().then(d, t) : d(!!e._support) : d(!0)
                                    } catch (e) {
                                        t(e)
                                    }
                                }));
                                ...
                                var r = Ye[e] ? f.resolve(Ye[e]) : f.reject(new Error("Driver not found."));
                                return l(r, n, t), r
                                ...
                                function u(e) {
                                    return function() {
                                        ...
                                        function t() {
                                            for (; n < e.length;) {
                                                var o = e[n];
                                                return n++, r._dbInfo = null, r._ready = null, r.getDriver(o).then(a).catch(t)
                                            }
                                            i();
                                ...
                                })), l(this._driverSet, n, t), this._driverSet
                                ...
                                for (var e = 0, n = tn.length; e < n; e++) on(this, tn[e])
