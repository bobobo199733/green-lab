...
export const getUserInformation = (callback, onError, delay) => {
    ...
    const knownHosts = [
        'lc-static-www-staging.jimdo-platform.net',
        'lc-static-www-prod.jimdo-platform.net',
        'www.jimdo.com',
        'www-master.jimdo-platform.net',
        'www-staging.jimdo-platform.net',
        'www-master-jimdo-com.global.ssl.fastly.net',
        'www-staging-jimdo-com.global.ssl.fastly.net',
        'www-develop.jimdo-platform.net',
        'www-develop-jimdo-com.global.ssl.fastly.net',
        'localhost',
    ];
