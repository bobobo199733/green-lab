...
const loadUserCentrics = (settingsId, suppressConsentBanner, onLoad) => {
  ...
  loadScript(createScriptWithSrc(`https://app.usercentrics.eu/browser-ui/latest/loader.js`), {
    loader: documentHeadLoader,
...
const getUserCentrics = () => {
  ...
  return Promise.race([timeoutPromise, waitingForUserCentricsPromise]);
};
...
const init = configuration => {
  ...
  try {
    if (userCentricsSettingsId && !skipCookieBanner) {
      loadUserCentrics(userCentricsSettingsId, suppressConsentBanner, () => {
...
const addApiToWindow = () => {
  ...
  window.__jimdo__ = { ...(window.__jimdo__ || {}),
    initConsent: init,
    getDpsCookieNames,
    seed,
