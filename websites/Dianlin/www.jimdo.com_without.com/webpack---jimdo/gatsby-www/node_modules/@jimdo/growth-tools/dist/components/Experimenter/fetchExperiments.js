...
var _consentManagementTracking = require("@jimdo/consent-management-tracking");

var _utilities = require("./utilities");

var STAGE_URL = 'https://dolphin-feature-flags-proxy-stage.jimdo-platform.net';
exports.STAGE_URL = STAGE_URL;
var PROD_URL = 'https://dolphin-feature-flags-proxy-prod.jimdo-platform.net';
/**
...
var fetchExperiments = function fetchExperiments(_ref) {
  ...
  try {
    var userAccountId = (0, _consentManagementTracking.getUserAccountId)();
    var shd = (0, _consentManagementTracking.getAnonId)();
