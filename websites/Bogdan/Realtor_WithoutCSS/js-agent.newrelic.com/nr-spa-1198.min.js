! function(t, n, e) {
    ...
    2: [function(t, n, e) {
        ...
        function o(t, n) {
            return n ? (n && !n.c && (n = {
                ...
                sos: n.t * n.t,
                c: 1
            }), n.c += 1, n.t += t, n.sos += t * t, t > n.max && (n.max = t), t < n.min && (n.min = t), n) : {
                t: t
            }
        }
        ...
        function s(t) {
            for (var n = {}, e = "", r = !1, i = 0; i < t.length; i++) e = t[i], n[e] = u(d[e]), n[e].length && (r = !0), delete d[e];
            return r ? n : null
        }
    ...
    3: [function(t, n, e) {
        function r(t, n, e) {
            "string" == typeof n && ("/" !== n.charAt(0) && (n = "/" + n), m.customTransaction = (e || "http://custom.transaction") + n)
        }
        ...
        function a(t, n, e, r, i, o, a) {
            if (n = window.encodeURIComponent(n), g += 1, m.info.beacon) {
                var s = "https://" + m.info.beacon + "/1/" + m.info.licenseKey;
                s += "?a=" + m.info.applicationID + "&", s += "t=" + n + "&", s += "qt=" + ~~e + "&", s += "ap=" + ~~r + "&", s += "be=" + ~~i + "&", s += "dc=" + ~~o + "&", s += "fe=" + ~~a + "&", s += "c=" + g, h.img(s)
            }
        }
    ...
    9: [function(t, n, e) {
        function r(t) {
            if (t.info.beacon) {
                ...
                if (e) {
                    var r = "1",
                        i = [l(t)];
                    if (i.push(e), i.push(g.param("tt", t.info.ttGuid)), i.push(g.param("us", t.info.user)), i.push(g.param("ac", t.info.account)), i.push(g.param("pr", t.info.product)), i.push(g.param("af", m(t.features, function(t) {
                            return t
                    ...
                    if (window.performance && window.performance.getEntriesByType) {
                        ...
                        a && a.length > 0 && a.forEach(function(t) {
                            !t.startTime || t.startTime <= 0 || ("first-paint" === t.name ? i.push(g.param("fp", String(Math.floor(t.startTime)))) : "first-contentful-paint" === t.name && i.push(g.param("fcp", String(Math.floor(t.startTime)))), U(t.name, Math.floor(t.startTime)))
                        })
                    }
                    i.push(g.param("xx", t.info.extra)), i.push(g.param("ua", t.info.userAttributes)), i.push(g.param("at", t.info.atts));
                    var s = x(t.info.jsAttributes);
                    i.push(g.param("ja", "{}" === s ? null : s));
                    var u = g.fromArray(i, t.maxBytes);
                    y.jsonp("https://" + t.info.beacon + "/" + r + "/" + t.info.licenseKey + u, S)
                }
            }
        }

        function i(t) {
            var n = m(N, function(n) {
                return s(n, t, {
                    unload: !0
                })
            });
        ...
        function a(t) {
            for (var n = h(), e = h(), r = N[t] || [], i = 0; i < r.length; i++) {
                var o = r[i]();
                o.body && m(o.body, n), o.qs && m(o.qs, e)
            }
            return {
                body: n(),
                qs: e()
        ...
        function l(t) {
            var n = !0;
            return "init" in NREUM && "privacy" in NREUM.init && (n = NREUM.init.privacy.cookies_enabled), ["?a=" + t.info.applicationID, g.param("sa", t.info.sa ? "" + t.info.sa : ""), g.param("v", E), f(t), g.param("ct", t.customTransaction), "&rst=" + t.now(), "&ck=" + (n ? "1" : "0"), g.param("ref", T(k.getLocation()))].join("")
        }
    ...
    11: [function(t, n, e) {
        ...
        window.NREUM.setToken = u, 6 === t(10) ? c.maxBytes = 2e3 : c.maxBytes = 3e4, c.releaseIds = {}, o(r), s("mark", i.mark, "api"), i.mark("done"), f("api"), l && a.sendRUM(c)
    }, {}],
    12: [function(t, n, e) {
        n.exports = function(t, n) {
    ...
    24: [function(t, n, e) {
        function r(t, n) {
            if (m()) {
                j = t, n || (n = {});
                var e = n.maxLCPTimeSeconds || 60,
                    r = n.harvestIntervalSeconds || 30,
                    u = n.initialHarvestSeconds || 10;
                T("timing", f), T("lcp", o), T("cls", a), T("pageHide", s), S(l), setTimeout(function() {
                    i(), R = !0
        ...
        function i() {
            if (!R && null !== C) {
                ...
                n && (e.cls = n), c("lcp", Math.floor(t.startTime), e, !1), R = !0
            }
        }
        ...
        function a(t) {
            null === A && (A = 0), A += t.value
        }

        function s(t, n) {
            U || "hidden" !== n || (c("pageHide", t, null, !0), U = !0)
        }
        ...
        function p(t) {
            for (var n = x(), e = "bel.6;", r = 0; r < t.length; r++) {
                var i = t[r];
                e += "e,", e += n(i.name) + ",", e += v(i.value, g, !1) + ",", h(i);
                var o = y(i.attrs, n);
                o && o.length > 0 && (e += g(o.length) + ";" + o.join(";")), r + 1 < t.length && (e += ";")
            }
            return e
        }
    ...
    29: [function(t, n, e) {
        ...
        function a(t) {
            for (var n = f(h.origin), e = 0; e < t.frames.length; e++) {
                var r = t.frames[e],
                    o = r.url,
                    a = i(o, n);
                a && a !== r.url && (r.url = a, t.stackString = t.stackString.split(o).join(a))
            }
            return t
        }
        ...
        function s(t, n, e, i) {
            ...
            if (n = n || h.now(), e || !h.onerror || !h.onerror(t)) {
                var c = a(d(t)),
                    f = o(c),
                    p = {
                        stackHash: l(f),
                ...
                c.message && (p.message = "" + c.message), m[p.stackHash] ? p.browser_stack_hash = l(c.stackString) : (m[p.stackHash] = !0, p.stack_trace = T(c.stackString)), p.releaseIds = w(h.releaseIds);
                var g = r(p);
                ...
                if (b("errorAgg", [x, g, p, y]), null != p._interactionId) E[p._interactionId] = E[p._interactionId] || [], E[p._interactionId].push([x, g, p, y, S, i]);
                else {
                    var j = {},
                        S = h.info.jsAttributes;
                    k(S, s), i && k(i, s);
                    var N = l(w(j)),
                        R = g + ":" + N;
                    u.store(x, R, p, y, j)
        ...
        if (t(20), h.features.err) {
            ...
            x.on("jserrors", function() {
                var t = u.take(["err", "ierr"]),
                    ...
                    e = w(h.releaseIds);
                return "{}" !== e && (n.qs.ri = e), t && t.err && t.err.length && !S && (n.qs.pve = "1", S = !0), n
            }), x.pingErrors(h), y(function() {
                var t = x.sendX("jserrors", h);
                t || x.pingErrors(h)
            }, 1e3 * N), p.on("feat-err", function() {
                g("err", s), g("ierr", s)
            }), j.on("interactionSaved", function(t) {
                E[t.id] && (E[t.id].forEach(function(n) {
                    function e(t, n) {
                    ...
                    var r = {},
                        i = n[4],
                        o = n[5];
                    k(i, e), k(t.root.attrs.custom, e), k(o, e);
                    var a = n[2];
    ...
    31: [function(t, n, e) {
        function r(t, n, e) {
            ...
            if (!(g.length >= v)) {
                ...
                u(d, r), u(x, r), e && "object" == typeof e && u(e, r), f.actionName = n || "", g.push(f)
            }
        }
            ...
            if (!e.checkingFinish) {
                ...
                r.newURL = t, r.newRoute = n, e.checkingFinish = !0, e.finishTimer = c(function() {
                    e.checkingFinish = !1, e.finishTimer = c(function() {
                        e.finishTimer = null, e[d] || e.finish()
                    }, 1)
                }, 0)
            }
    ...
    33: [function(t, n, e) {
        function r(t, n, e, r) {
            this[i] = t, this.parent = n, this.id = ++s, this.type = e, this.children = [], this.end = null, this.jsEnd = this.start = r, this.jsTime = 0, this.attrs = {}
        }
        var i = "interaction",
            o = 128,
            a = "remaining",
    ...
    34: [function(t, n, e) {
        ...
        function i() {
            this.resolved || (this.resolved = !0, this[P] = Z)
        }
        ...
        function a(t) {
            rt || t || !et || (t = et.root), Z && Z[B].checkFinish(G, J), tt = Z, Z = t && !t[B].root.end ? t : null
        }
        ...
        function c(t) {
            return t.ignored || !t.save && !t.routeChange ? void m.emit("interactionDiscarded", [t]) : (t.root.attrs.id = R.generateUuid(), "initialPageLoad" === t.root.attrs.trigger && (t.root.attrs.firstPaint = C["first-paint"], t.root.attrs.firstContentfulPaint = C["first-contentful-paint"]), m.emit("interactionSaved", [t]), at = h(t.root, 0, S, t.routeChange), void l.sendX("events", p))
        }
        var f = t(17),
            d = t(38),
            l = t(9),
        ...
        n.exports = function() {
            ...
            function t() {
                ot++, this.prevNode = Z, this.ct = it, it = 0, Y = L
            }
            ...
            function n() {
                ...
                var t = this.jsTime || 0,
                    n = t - it;
                it = this.ct + t, Z && (Z.callback(n, this[M]), this.isTraced && (Z.attrs.tracedTime = n)), this.jsTime = Z ? 0 : n, a(this.prevNode), this.prevNode = null, Y = L
            }
            ...
            function e(t, n, e) {
                ...
                if (r) {
                    var i = r[B],
                        o = this.inc;
                    this.isTraced = !0, o ? i[q]-- : r && r.finish(t), e ? a(r) : i.checkFinish(G, J)
                }
            }

            function c(t) {
                return Z && Z[B] === t ? Z : t.root
            }
            et = new A("initialPageLoad", 0, G, J, s), et.save = !0, Z = et.root, et[q]++, f.on(m, _, t), f.on(g, I, t);
            var l = {
                getCurrentNode: o,
                setCurrentNode: a
            };
            f("spa-register", function(t) {
                "function" == typeof t && t(l)
            }), f.on(m, M, n), f.on(g, "cb-end", n), f.on(y, _, function(t, n) {
                var e = t[0],
                    r = e.type,
                    i = e.__nrNode;
                if (rt || "load" !== r || n !== window || (rt = !0, this.prevNode = Z = null, et && (i = et.root, et[q]--, K(function() {
                        U.push("popstate")
                    }))), i) a(i);
                else if ("hashchange" === r) a(nt), nt = null;
                else if (n instanceof XMLHttpRequest) a(m.context(n).spaNode);
                else if (!Z && U.indexOf(r) !== -1) {
                    var o = new A(r, this[_], G, J, s);
                    if (a(o.root), "click" === r) {
                        var c = u(e.target);
                        c && (Z.attrs.custom.actionText = c)
                    }
                }
                e.__nrNode = Z
            }), f.on(w, "setTimeout-end", function(t, n, e) {
                !Z || Y - this.timerDuration < 0 || (Z[B][q]++, this.timerId = e, Q[e] = Z, this.timerBudget = Y - 50)
            }), f.on(w, "clearTimeout-start", function(t) {
                var n = t[0],
                    e = Q[n];
                if (e) {
                    var r = e[B];
                    r[q]--, r.checkFinish(G, J), delete Q[n]
                }
            }), f.on(w, _, function() {
                Y = this.timerBudget || L;
                var t = this.timerId,
                    n = Q[t];
                a(n), delete Q[t], n && n[B][q]--
            }), f.on(k, _, function() {
                a(this[P])
            }), f.on(k, "new-xhr", function() {
                Z && (this[P] = Z.child("ajax", null, null, !0))
            }), f.on(k, "send-xhr-start", function() {
                var t = this[P];
                t && !this.sent && (this.sent = !0, t.dt = this.dt, t.jsEnd = t.start = this["send-xhr-start"], t[B][q]++)
                ...
                if (Z) {
                    var n = this[O] = Z.child("ajax", this[H]);
                ...
                var t = this[O];
                if (t) {
                    if (null === this.status) return t[B][q]--, void(t.cancelled = !0);
                    var n = t.attrs,
                        e = n.params = {},
                        r = d(this.url);
                    e.method = "GET", e.pathname = r.pathname, e.host = r.hostname + ":" + r.port, e.status = this.status, n.metrics = {
                        txSize: 0,
                        rxSize: 0
                    }, n.isJSONP = !0, t.jsEnd = this[D], t.jsTime = this[I] ? this[D] - this[I] : 0, t.finish(t.jsEnd)
                }
            }), f.on(b, H, function(t, n) {
                Z && t && (this[P] = Z.child("ajax", this[H]), t.length >= 1 && (this.target = t[0]), t.length >= 2 && (this.opts = t[1]), n && this[P] && (this[P].dt = n))
            }), f.on(b, $ + "start", function(t) {
                Z && (this[P] = Z, Z[B][q]++)
            }), f.on(b, $ + "end", function(t, n, e) {
                var r = this[P];
                r && r[B][q]--
            }), f.on(b, z, function(t, n) {
                var e = this[P],
                    r = this.target,
                    i = this.opts || {};
                if (e) {
                    if (t) return e.cancelled = !0, void e[B][q]--;
                    var o, a;
                    "string" == typeof r ? o = r : "object" == typeof r && r instanceof V ? o = r.url : window.URL && "object" == typeof r && r instanceof URL && (o = r.href), a = ("" + (r && r instanceof V && r.method || i.method || "GET")).toUpperCase();
                    var s = e.attrs,
                        u = s.params = {},
                        c = d(o);
                    u.method = a, u.pathname = c.pathname, u.host = c.hostname + ":" + c.port, u.status = n.status, s.metrics = {
                        txSize: N(i.body) || 0,
                        rxSize: this.rxSize
                    }, s.isFetch = !0, e.finish(this[z])
                }
            }), f.on(x, "newURL", function(t, n) {
                Z && (G !== t && (Z[B].routeChange = !0), n && (nt = Z)), G = t
            }), j.on("dom-start", function(t) {
                function n() {
                    o[q]--, o.checkFinish(G, J)
                }
                ...
                if (Z) {
                    var r = t[0],
                        ...
                        o = Z.interaction;
                    i && (o[q]++, r.addEventListener("load", n, !1), r.addEventListener("error", e, !1))
                }
            }), f.on(v, _, function() {
                a(tt)
            }), f.on(g, "resolve-start", i), f.on(g, "executor-err", i), f.on(g, "propagate", r), f.on(g, I, function() {
                var t = this.getCtx ? this.getCtx() : this;
                a(t[P])
            }), f(F + "get", function(t) {
                var n = this.ixn = Z ? Z[B] : new A("api", t, G, J, s);
                Z || (n.checkFinish(G, J), ot && a(n.root))
            }), f(F + "actionText", function(t, n) {
                var e = this.ixn.root.attrs.custom;
                n && (e.actionText = n)
            }), f(F + "setName", function(t, n, e) {
                var r = this.ixn.root.attrs;
                n && (r.customName = n), e && (r.trigger = e)
            }), f(F + "setAttribute", function(t, n, e) {
                ...
                this.ixn.save = !0
            }), f(F + "tracer", function(t, n, e) {
                var r = this.ixn,
                    i = c(r),
                    o = m.context(e);
                return n ? void(o[P] = i.child("customTracer", t, n)) : (o.inc = ++r[q], o[P] = i)
            }), f.on(T, _, e), f.on(T, "no-" + _, e), f(F + "getContext", function(t, n) {
                var e = this.ixn.root.attrs.store;
                setTimeout(function() {
                    n(e)
                }, 0)
            }), f(F + "onEnd", function(t, n) {
    ...
    35: [function(t, n, e) {
        function r(t, n, e, r) {
            function d(t, c) {
                if ("customEnd" === t.type) return c.push([3, u(t.end - h)]);
                var g = t.type,
                    x = m[g],
                    y = t.start,
                    w = t.children.length,
                ...
                "undefined" == typeof h ? (y += n, h = y) : y -= h;
                var A = [u(y), u(t.end - t.start), u(t.jsEnd - t.end), u(t.jsTime)];
                switch (x) {
                    case 1:
                        A[2] = u(t.jsEnd - h), A.push(l(E.trigger), l(i(E.initialPageURL, v)), l(i(E.oldURL, v)), l(i(E.newURL, v)), l(E.customName), p ? "" : r ? 1 : 2, s(p && R, u, !0) + s(p && C, u, !0) + s(E.oldRoute, l, !0) + s(E.newRoute, l, !0) + l(E.id), l(t.id), s(E.firstPaint, u, !0) + s(E.firstContentfulPaint, u, !1));
                        var U = f(E.custom, l);
                        T = T.concat(U), b = U.length, j && (w++, T.push("a," + l(j)));
                        break;
                    case 2:
                        A.push(l(N.method), u(N.status), l(N.host), l(N.pathname), u(S.txSize), u(S.rxSize), E.isFetch ? 1 : E.isJSONP ? 2 : "", l(t.id), s(t.dt && t.dt.spanId, l, !0) + s(t.dt && t.dt.traceId, l, !0) + s(t.dt && t.dt.timestamp, u, !1));
                        break;
                    case 4:
                        var L = E.tracedTime;
                ...
                if (A.unshift(u(x), u(w += b)), c.push(A), w && c.push(T.join(";")), k) {
                    var M = ",",
                        I = "b",
                        F = 0;
                    a(e.slice(1, 21), function(t, n) {
                        void 0 !== n ? (I += M + u(n - F), M = ",", F = n) : (I += M + "!", M = "")
                    }), c.push(I)
                } else 1 === x && c.push("");
                return c
            }
            var l = c();
            n = n || 0;
            var h, p = "initialPageLoad" === t.attrs.trigger,
                m = {
                    interaction: 1,
                    ajax: 2,
                    customTracer: 4
    ...
    36: [function(t, n, e) {
        function r(t) {
            ...
            for (n in t) e = t[n], "number" == typeof e && e > 0 && e < i && (r = t[n] - w.offset, l({
                n: n,
                s: r,
                e: r,
                o: "document",
        ...
        function s(t, n) {
            ...
            } else t && "string" == typeof t.tagName && (e = t.tagName.toLowerCase(), t.id && (e += "#" + t.id), t.className && (e += "." + S(t.classList).join(".")));
        ...
        function p() {
            ...
            if (!C) {
                n.qs.ua = w.info.userAttributes, n.qs.at = w.info.atts;
            ...
            if (n.exports = {
                ...
                M.on("feat-stn", function() {
                    ...
                    t.addEventListener("load", function() {
                        ...
                        }), t > 30 && j.sendX("resources", w), void(t > 1e3 && (_ = {})))
                    }, 1e4)
                });
                var I = 0
            }
