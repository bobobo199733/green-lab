var COMSCORE = function(n) {
    ...
    (u = v) && u.o && Object.prototype.hasOwnProperty.call(u, "default") && u["default"];
    var p = v.t,
        l = v.i;
    ...
    function s() {
        ...
        if (r["cs_cmp_nc"] = n.p ? 1 : 0, r["cs_cmp_id"] = n.u, r["cs_cmp_sv"] = n.v, r["cs_cmp_rt"] = n.l, !n.m) return {
            s: !0,
            k: !0,
            labels: r
        };
    ...
    function C(n) {
        if (n) {
            ...
            if (t) {
                a(t, b("b3", i)), window != window.top && (t[1]["ns_if"] = 1), p(w);
                var f = function(n) {
                    var r = !0;
                    n && (r = n.k, o(t[1], n.labels)), _(e(r ? "https://sb.scorecardresearch.com/b?" : "https://sb.scorecardresearch.com/b2?", t, 2048), i)
                };
                if (c.disableTcfIntegration) f();
                else {
                    var u = s();
                    !u || u.s ? f(u) : d.push((function() {
                        var n = s();
                        f(n)
                    }))
                }
    ...
    function h(n) {
        n = n || _comscore;
        for (var e = 0; e < n.length; ++e) C(n[e]);
        _comscore = []
    }
    return window.udm_ = function(n) {
        var r = [{}, {}, {}];
        a(r, b("b3", i)), window != window.top && (r[1]["ns_if"] = 1), p(w);
        var c = function(a) {
                a && o(r[1], a.labels), _(e(n, r, 2048), i)
            },
            t = s();
        !t || t.s ? c(t) : d.push((function() {
            var n = s();
            c(n)
        }))
    }, "undefined" == typeof _comscore && (window._comscore = []), h(), n.beacon = C, n.purge = h, n
}({});